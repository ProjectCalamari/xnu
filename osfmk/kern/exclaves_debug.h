...
#define exclaves_debug_show_errors_flag                                        \
  (exclaves_debug_show_errors | exclaves_debug_show_test_output)
#else
...
#define exclaves_debug_show_notification_upcalls_flag                          \
  exclaves_debug_show_notification_upcalls
#else
...
#define exclaves_debug_show_lifecycle_upcalls_flag                             \
  exclaves_debug_show_lifecycle_upcalls
#else
  ...
  {                                                                            \
    if (exclaves_requirement_is_relaxed(requirement)) {                        \
      exclaves_debug_printf(                                                   \
          show_errors,                                                         \
          "exclaves: requirement was relaxed, ignoring error: " fmt "\n",      \
          ##__VA_ARGS__);                                                      \
    } else {                                                                   \
      panic("exclaves: requirement failed: " fmt, ##__VA_ARGS__);              \
    }                                                                          \
  };
