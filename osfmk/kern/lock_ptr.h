 ...
 */
extern void hw_lck_ptr_init(hw_lck_ptr_t *lck, void *val, lck_grp_t *grp);
 ...
 * @param grp           the lock group associated with this lock
 */
extern void hw_lck_ptr_destroy(hw_lck_ptr_t *lck, lck_grp_t *grp);
 ...
 */
extern bool hw_lck_ptr_held(hw_lck_ptr_t *lck) __result_use_check;
 ...
 * @param grp           the lock group associated with this lock
 */
extern void *hw_lck_ptr_lock(hw_lck_ptr_t *lck,
 ...
 * @param grp           the lock group associated with this lock
 */
extern void *hw_lck_ptr_lock_nopreempt(hw_lck_ptr_t *lck,
                                       lck_grp_t *grp) __result_use_check;

/* unlock */

#if !LCK_GRP_USE_ARG
#define hw_lck_ptr_unlock(lck, val, grp) hw_lck_ptr_unlock(lck, val)
 ...
 * @param grp           the lock group associated with this lock
 */
extern void hw_lck_ptr_unlock(hw_lck_ptr_t *lck, void *val, lck_grp_t *grp);
 ...
 * @param grp           the lock group associated with this lock
 */
extern void hw_lck_ptr_unlock_nopreempt(hw_lck_ptr_t *lck, void *val,
                                        lck_grp_t *grp);
...
static inline void *__hw_lck_ptr_value(hw_lck_ptr_t val) {
 ...
 */
static inline void *hw_lck_ptr_value(hw_lck_ptr_t *lck) {
  hw_lck_ptr_t tmp;

  tmp = atomic_load_explicit((hw_lck_ptr_t _Atomic *)lck, memory_order_relaxed);
 ...
 * @param grp           the lock group associated with this lock
 */
extern void hw_lck_ptr_wait_for_value(hw_lck_ptr_t *lck, void *val,
                                      lck_grp_t *grp);
