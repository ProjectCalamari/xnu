...
struct clock_ops {
  ...
  kern_return_t (*c_getattr)(/* get attributes */
                             clock_flavor_t flavor, clock_attr_t attr,
...
extern void clock_gettimeofday_set_commpage(uint64_t abstime, uint64_t sec,
                                            uint64_t frac, uint64_t scale,
                                            uint64_t tick_per_sec);

extern void machine_delay_until(uint64_t interval, uint64_t deadline);

extern uint32_t hz_tick_interval;

extern void nanotime_to_absolutetime(clock_sec_t secs, clock_nsec_t nanosecs,
                                     uint64_t *result);
...
extern void clock_adjtime(long *secs, int *microsecs);
...
extern void clock_gettimeofday_new(clock_sec_t *secs, clock_usec_t *microsecs);
extern void clock_gettimeofday(clock_sec_t *secs, clock_usec_t *microsecs);

extern void clock_gettimeofday_and_absolute_time(clock_sec_t *secs,
                                                 clock_usec_t *microsecs,
                                                 uint64_t *absolute_time);

extern void clock_set_calendar_microtime(clock_sec_t secs,
                                         clock_usec_t microsecs);

extern void clock_get_boottime_nanotime(clock_sec_t *secs,
                                        clock_nsec_t *nanosecs);

extern void clock_get_boottime_microtime(clock_sec_t *secs,
                                         clock_nsec_t *microsecs);

extern void clock_deadline_for_periodic_event(uint64_t interval,
                                              uint64_t abstime,
                                              uint64_t *deadline);

#if CONFIG_DTRACE

extern void clock_get_calendar_nanotime_nowait(clock_sec_t *secs,
                                               clock_nsec_t *nanosecs);
...
extern void clock_get_calendar_microtime(clock_sec_t *secs,
                                         clock_usec_t *microsecs);

extern void clock_get_calendar_absolute_and_microtime(clock_sec_t *secs,
                                                      clock_usec_t *microsecs,
                                                      uint64_t *abstime);

extern void clock_get_calendar_nanotime(clock_sec_t *secs,
                                        clock_nsec_t *nanosecs);

extern void clock_get_system_microtime(clock_sec_t *secs,
                                       clock_usec_t *microsecs);

extern void clock_get_system_nanotime(clock_sec_t *secs,
                                      clock_nsec_t *nanosecs);
...
extern void clock_interval_to_absolutetime_interval(uint32_t interval,
                                                    uint32_t scale_factor,
                                                    uint64_t *result);

extern void clock_absolutetime_interval_to_deadline(uint64_t abstime,
                                                    uint64_t *result);

extern void clock_continuoustime_interval_to_deadline(uint64_t abstime,
                                                      uint64_t *result);
...
extern void absolutetime_to_microtime(uint64_t abstime, clock_sec_t *secs,
                                      clock_usec_t *microsecs);
...
#define MACH_TIMESPEC_MAX                                                      \
  ((mach_timespec_t){MACH_TIMESPEC_SEC_MAX, MACH_TIMESPEC_NSEC_MAX})
...
extern mach_timespec_t clock_get_system_value(void)
    __OSX_AVAILABLE_BUT_DEPRECATED(__MAC_10_0, __MAC_10_8, __IPHONE_2_0,
                                   __IPHONE_6_0);
...
extern void delay_for_interval_with_leeway(uint32_t interval, uint32_t leeway,
                                           uint32_t scale_factor);
