...
#define FLAVOR_HIGH_WATERMARK                                                  \
  1 /* Indicates that the exception is due to memory limit warning */
#define FLAVOR_DIAG_MEMLIMIT                                                   \
  2 /* Indicates that the exception is due to a preset diagnostics memory      \
       consumption threshold */
#define FLAVOR_CONCLAVE_LIMIT                                                  \
  3 /* Indicates that the exception is due to the hard conclave memory limit   \
     */
...
#define EXC_RESOURCE_HWM_DECODE_LIMIT(code) ((code) & 0x1FFFULL)
...
#define EXC_RESOURCE_IO_DECODE_INTERVAL(code) (((code) >> 15) & 0x1FFFFULL)
#define EXC_RESOURCE_IO_DECODE_LIMIT(code) ((code) & 0x7FFFULL)
#define EXC_RESOURCE_IO_OBSERVED(subcode) ((subcode) & 0x7FFFULL)
...
#define EXC_RESOURCE_THREADS_DECODE_THREADS(code) ((code) & 0x7FFFULL)
 ...
 *
 */
#define EXC_RESOURCE_THREADS_DECODE_PORTS(code) ((code) & 0xFFFFFFULL)
...
/* RESOURCE_TYPE_IO::FLAVOR_IO_PHYSICAL_WRITES/FLAVOR_IO_LOGICAL_WRITES specific
 * encoding macros */
