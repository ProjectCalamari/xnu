...
extern wait_result_t lck_mtx_sleep(lck_mtx_t *lck,
...
extern boolean_t lck_mtx_yield(lck_mtx_t *lck);

extern boolean_t lck_mtx_try_lock_spin(lck_mtx_t *lck);

extern void lck_mtx_lock_spin(lck_mtx_t *lck);

extern boolean_t kdp_lck_mtx_lock_spin_is_acquired(lck_mtx_t *lck);

extern void lck_mtx_convert_spin(lck_mtx_t *lck);

extern void lck_mtx_lock_spin_always(lck_mtx_t *lck);

extern boolean_t lck_mtx_try_lock_spin_always(lck_mtx_t *lck);
...
extern void lck_mtx_startup_init(struct lck_mtx_startup_spec *spec);
...
#define LCK_MTX_DECLARE(var, grp) LCK_MTX_DECLARE_ATTR(var, grp, LCK_ATTR_NULL)
