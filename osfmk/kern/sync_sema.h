...
extern kern_return_t port_name_to_semaphore(mach_port_name_t name,
...
extern kern_return_t semaphore_signal_internal_trap(mach_port_name_t sema_name);
...
extern kern_return_t semaphore_timedwait_signal_trap_internal(
    ...
    clock_res_t nsec, semaphore_cont_t);

extern kern_return_t semaphore_timedwait_trap_internal(mach_port_name_t name,
                                                       unsigned int sec,
                                                       clock_res_t nsec,
                                                       semaphore_cont_t);

extern kern_return_t semaphore_wait_signal_trap_internal(
    mach_port_name_t wait_name, mach_port_name_t signal_name, semaphore_cont_t);

extern kern_return_t semaphore_wait_trap_internal(mach_port_name_t name,
                                                  semaphore_cont_t);
