...
static inline bool zone_id_shim_is_ro(zone_id_shim_t z) {
  return z.zval <= UINT16_MAX;
}

static inline zone_id_shim_t
zone_create_ro_shimmed(const char *name, vm_size_t size,
...
static inline void zalloc_ro_mut_shimmed(zone_id_shim_t zone_id, void *elem,
                                         vm_offset_t offset,
                                         const void *new_data,
...
static inline void zalloc_ro_clear_shimmed(zone_id_shim_t zone_id, void *elem,
...
static inline void *zalloc_ro_shimmed(zone_id_shim_t zone_id,
...
#undef zalloc_ro
#define zalloc_ro(zid, flags) zalloc_ro_shimmed(zid, flags)

static inline void zfree_ro_shimmed(zone_id_shim_t zone_id, void *addr) {
  if (zone_id_shim_is_ro(zone_id)) {
...
static inline uint64_t __zalloc_ro_mut_atomic_shimmed(vm_offset_t dst,
                                                      zro_atomic_op_t op,
                                                      uint64_t value) {
...
static inline uint64_t zalloc_ro_mut_atomic_shimmed(zone_id_shim_t zone_id,
                                                    void *elem,
                                                    vm_offset_t offset,
                                                    zro_atomic_op_t op,
                                                    uint64_t value) {
