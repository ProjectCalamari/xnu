...
#define DECLARE_TEST_IDENTITY(ident) extern test_identity_t const ident
...
#define thread_get_test_option(field)                                          \
  ({                                                                           \
    ...
    __improbable(_get_ctx != NULL) ? (_get_ctx->field)                         \
 ...
 */
static inline void thread_set_test_context(thread_test_context_t *new_ctx) {
 ...
 * Not available in release builds.
 */
extern void thread_test_context_deinit(thread_test_context_t *ctx);
...
static inline void thread_cleanup_test_context(thread_test_context_t *ctx) {
  /*
