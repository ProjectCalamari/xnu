...
mach_msg_return_t mach_msg_send_from_kernel(mach_msg_header_t *msg,
...
mach_msg_return_t mach_msg_send_from_kernel_with_options(
    mach_msg_header_t *msg, mach_msg_size_t send_size,
    mach_msg_option64_t option, mach_msg_timeout_t timeout_val) {
  return kernel_mach_msg_send(msg, send_size, option, timeout_val, NULL);
}

static mach_msg_return_t
kernel_mach_msg_send_common(ipc_kmsg_t kmsg, mach_msg_option64_t option,
...
mach_msg_return_t kernel_mach_msg_send(mach_msg_header_t *msg,
                                       mach_msg_size_t send_size,
...
mach_msg_return_t mach_msg_send_from_kernel_proper(mach_msg_header_t *msg,
                                                   mach_msg_size_t send_size) {
  mach_msg_option64_t option = MACH_SEND_KERNEL_DEFAULT;
  mach_msg_timeout_t timeout_val = MACH_MSG_TIMEOUT_NONE;
  ipc_kmsg_t kmsg;
...
mach_msg_return_t kernel_mach_msg_send_kmsg(ipc_kmsg_t kmsg) {
...
mach_msg_return_t kernel_mach_msg_send_with_builder_internal(
...
mach_msg_return_t kernel_mach_msg_send_with_builder(
    mach_msg_size_t desc_count, mach_msg_size_t udata_size,
    void (^builder)(mach_msg_header_t *, mach_msg_descriptor_t *, void *)) {
  mach_msg_option64_t options;

  options = MACH_SEND_KERNEL_DEFAULT | MACH64_POLICY_KERNEL_EXTENSION;
  return kernel_mach_msg_send_with_builder_internal(
      desc_count, udata_size, options, MACH_MSG_TIMEOUT_NONE, NULL, builder);
}
...
static mach_msg_return_t kernel_mach_msg_rpc_common(mach_msg_header_t *msg,
                                                    mach_msg_size_t send_size,
  ...
  mach_msg_option64_t option =
      MACH_SEND_KERNEL_DEFAULT & ~MACH_SEND_NOIMPORTANCE;
  ipc_port_t reply;
  ipc_kmsg_t kmsg;
  mach_msg_header_t *hdr;
  ...
  if (has_voucher &&
      thread_get_mach_voucher(self, 0, &voucher) == KERN_SUCCESS) {
  ...
  /* insert send-once right for the reply port and send right for the adopted
   * voucher */
  hdr->msgh_local_port = reply;
  hdr->msgh_bits |=
      MACH_MSGH_BITS_SET_PORTS(0, MACH_MSG_TYPE_MAKE_SEND_ONCE,
  ...
  for (;;) {
    ...
    ipc_port_link_special_reply_port(reply, dest, FALSE);
   ...
   */
  if (os_add_overflow(kmsg_size, MAX_TRAILER_SIZE,
                      &kmsg_and_max_trailer_size)) {
  ...
  mach_msg_format_0_trailer_t *trailer =
      (mach_msg_format_0_trailer_t *)ipc_kmsg_get_trailer(kmsg);
...
mach_msg_return_t kernel_mach_msg_rpc(mach_msg_header_t *msg,
                                      mach_msg_size_t send_size,
                                      mach_msg_size_t rcv_size,
                                      boolean_t interruptible,
                                      boolean_t *message_moved) {
  ...
  return kernel_mach_msg_rpc_common(msg, send_size, rcv_size, interruptible,
                                    options, message_moved);
}

mach_msg_return_t mach_msg_rpc_from_kernel(mach_msg_header_t *msg,
                                           mach_msg_size_t send_size,
                                           mach_msg_size_t rcv_size) {
  mach_msg_option64_t options = MACH64_MSG_OPTION_NONE;

  return kernel_mach_msg_rpc_common(msg, send_size, rcv_size, TRUE, options,
                                    NULL);
}
 ...
 */
void mach_msg_destroy_from_kernel(mach_msg_header_t *msg) {
  ...
  if (mbits & MACH_MSGH_BITS_COMPLEX) {
    ...
    ipc_kmsg_clean_descriptors(kbase->msgb_dsc_array, kbase->msgb_dsc_count);
  }
}
...
void mach_msg_destroy_from_kernel_proper(mach_msg_header_t *msg) {
  if (msg->msgh_bits & MACH_MSGH_BITS_COMPLEX) {
    ...
    ipc_kmsg_sign_descriptors(kbase->msgb_dsc_array, kbase->msgb_dsc_count);
  }
 ...
 *		to get a reply port.
 */
mach_port_t mig_get_reply_port(void) { return MACH_PORT_NULL; }
...
void mig_dealloc_reply_port(__unused mach_port_t reply_port) {}
 ...
 */
void mig_put_reply_port(__unused mach_port_t reply_port) {}
...
void *mig_user_allocate(vm_size_t size) {
  return kalloc_type_var_impl(KT_IPC_KMSG_KDATA_OOL, size, Z_WAITOK, NULL);
}

void mig_user_deallocate(char *data, vm_size_t size) {
