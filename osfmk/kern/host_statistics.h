...
SCALABLE_COUNTER_DECLARE(
    vm_statistics_compressions);                  /* # of pages compressed */
SCALABLE_COUNTER_DECLARE(vm_statistics_swapins);  /* # of pages swapped in (via
                                                     compression segments) */
SCALABLE_COUNTER_DECLARE(vm_statistics_swapouts); /* # of pages swapped out (via
                                                     compression segments) */
SCALABLE_COUNTER_DECLARE(
