...
OS_CLOSED_ENUM(
    hvg_hcall_code, uint32_t,
    HVG_HCALL_TRIGGER_DUMP = 0x0001, /* Collect guest dump */
    HVG_HCALL_SET_COREDUMP_DATA =
        0x0002, /* Set necessary info for reliable coredump */
    HVG_HCALL_GET_MABS_OFFSET =
        0x0003, /* Determine mach_absolute_time offset */
...
OS_CLOSED_OPTIONS(
    hvg_hcall_dump_option, uint32_t,
