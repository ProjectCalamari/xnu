...
#define THREAD_GROUP_FLAGS_EXCLUSIVE                                           \
  (THREAD_GROUP_FLAGS_EFFICIENT | THREAD_GROUP_FLAGS_APPLICATION |             \
   THREAD_GROUP_FLAGS_CRITICAL | THREAD_GROUP_FLAGS_BEST_EFFORT)

#define THREAD_GROUP_FLAGS_ABSENT 0xffffffff

static_assert((THREAD_GROUP_FLAGS_EXCLUSIVE &
               ~THREAD_GROUP_EXCLUSIVE_FLAGS_MASK) == 0,
              "valid exclusive flags");

/* Shared flags */
#define THREAD_GROUP_FLAGS_SHARED                                              \
  (THREAD_GROUP_FLAGS_UI_APP | THREAD_GROUP_FLAGS_MANAGED |                    \
   THREAD_GROUP_FLAGS_STRICT_TIMERS | THREAD_GROUP_FLAGS_GAME_MODE |           \
   THREAD_GROUP_FLAGS_CARPLAY_MODE)

static_assert((THREAD_GROUP_FLAGS_SHARED & THREAD_GROUP_EXCLUSIVE_FLAGS_MASK) ==
                  0,
              "valid shared flags");
