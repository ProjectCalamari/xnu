 ...
 */
extern btref_t btref_get(void *fp, btref_get_flags_t flags);
 ...
 */
extern btref_t btref_retain(btref_t ref);
 ...
 */
extern void btref_put(btref_t btref);
 ...
 */
extern uint32_t
btref_decode_unslide(btref_t btref,
 ...
 */
extern btlog_t btlog_create(btlog_type_t type, uint32_t num_records,
                            uint32_t sample);
 ...
 */
extern kern_return_t btlog_enable(btlog_t log);
 ...
 * and the caller is supposed to provide serialization.
 */
extern void btlog_disable(btlog_t log);
 ...
 */
extern void btlog_destroy(btlog_t btlog);
 ...
 */
extern btlog_type_t btlog_get_type(btlog_t btlog) __pure2;
 ...
 */
extern uint32_t btlog_get_count(btlog_t btlog) __pure2;
 ...
 */
extern bool btlog_sample(btlog_t btlog);
 ...
 */
extern void btlog_record(btlog_t btlog, void *element, uint8_t op,
                         btref_t btref);
 ...
 */
extern void btlog_erase(btlog_t btlog, void *element);
...
btlog_get_records(btlog_t btlog,
 ...
 */
extern uint32_t btlog_guess_top(btlog_t btlog,
...
extern void btlog_copy_backtraces_for_elements(
    btlog_t btlog, vm_address_t *__counted_by(*count) instances,
    uint32_t *count, uint32_t elem_size, leak_site_proc proc);
