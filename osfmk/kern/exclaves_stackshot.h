...
extern void *exclaves_scheduler_request_start_label __asm__(
    "EXCLAVES_SCHEDULER_REQUEST_START");
extern void *exclaves_scheduler_request_end_label __asm__(
    "EXCLAVES_SCHEDULER_REQUEST_END");
