...
kern_return_t hibernate_setup(IOHibernateImageHeader *header, boolean_t vmflush,
  ...
  HIBLOG("hibernate_alloc_pages act %d, inact %d, anon %d, throt %d, spec %d, "
         "wire %d, wireinit %d\n",
         vm_page_active_count, vm_page_inactive_count, vm_page_anonymous_count,
         vm_page_throttled_count, vm_page_speculative_count, vm_page_wire_count,
