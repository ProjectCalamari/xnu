...
#error                                                                         \
    "This file is for internal use and will be deleted in future versions of the SDK."
 ...
 * evaluation will happen at the AST boundary with the thread locked. If
 * possible,
 *
 */
...
ast_t sfi_thread_needs_ast(thread_t thread,
                           sfi_class_id_t *out_class /* optional */);
...
extern int sfi_ledger_entry_add(ledger_template_t template,
