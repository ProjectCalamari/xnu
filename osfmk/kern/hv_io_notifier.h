...
extern kern_return_t hv_io_notifier_grp_add(hv_ion_grp_t *grp,
                                            const hv_ion_t *);
extern kern_return_t hv_io_notifier_grp_remove(hv_ion_grp_t *,
                                               const hv_ion_t *);
extern kern_return_t hv_io_notifier_grp_fire(hv_ion_grp_t *, uint64_t, size_t,
                                             uint64_t);
