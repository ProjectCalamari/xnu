...
/* Version 0 trust caches: No defined sorting order (thus only suitable for
 * small trust caches). Used for loadable trust caches only, until phasing out
 * support. */
...
/* Version 1 trust caches: Always sorted by cdhash, added hash type and flags
 * field. Suitable for all trust caches. */
 ...
 *  bit  1: (obsolete) TC_LOOKUP_FALLBACK: set if found in legacy static trust
 * cache bit  2-7: reserved BB:  8-15: entry flags pass-through, see "Trust
 * Cache Entry Flags" above CC: 16-23: code directory hash type of entry, see
 * CS_HASHTYPE_* in cs_blobs.h XX: 24-31: reserved
 */
