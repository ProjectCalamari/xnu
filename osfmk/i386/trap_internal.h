...
#define DEFAULT_PANIC_ON_TRAP_MASK                                             \
  ((1U << T_INVALID_OPCODE) | (1U << T_GENERAL_PROTECTION) |                   \
   (1U << T_PAGE_FAULT) | (1U << T_SEGMENT_NOT_PRESENT) |                      \
   (1U << T_STACK_FAULT))

extern void i386_exception(int exc, mach_exception_code_t code,
...
typedef kern_return_t (*perfCallback)(int trapno, void *regs, uintptr_t *lo_spp,
                                      int);

extern void panic_i386_backtrace(void *, int, const char *, boolean_t,
                                 x86_saved_state_t *);
extern void print_one_backtrace(pmap_t pmap, vm_offset_t topfp,
                                const char *cur_marker, boolean_t is_64_bit);
...
#if MACH_KDP
extern boolean_t kdp_i386_trap(unsigned int, x86_saved_state64_t *,
                               kern_return_t, vm_offset_t);
#endif /* MACH_KDP */
