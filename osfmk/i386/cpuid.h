...
#define CPUID_LEAF7_FEATURE_FDPEO                                              \
  _Bit(6) /* x87 FPU Data Pointer updated only on x87 exceptions */
...
#define CPUID_LEAF7_FEATURE_VPCLMULQDQ _HBit(10) /* Vector Carryless-multiply  \
                                                  */
#define CPUID_LEAF7_FEATURE_AVX512VNNI                                         \
  _HBit(11) /* AVX512 Vector Neural Net Instructions */
#define CPUID_LEAF7_FEATURE_AVX512BITALG                                       \
  _HBit(12) /* AVX512 VPOPCNT{B,W} and VPSHUFBITQMB */
#define CPUID_LEAF7_FEATURE_AVX512VPCDQ                                        \
  _HBit(14)                                 /* AVX512 VPOPCNTDQ instruction */
...
#define CPUID_LEAF7_EXTFEATURE_SRBDS_CTRL                                      \
  _Bit(9) /* SRBDS MSR Presence and Mitigation Control */
#define CPUID_LEAF7_EXTFEATURE_MDCLEAR                                         \
  _Bit(10)                                    /* Overloaded VERW / L1D_FLUSH */
#define CPUID_LEAF7_EXTFEATURE_TSXFA _Bit(13) /* TSX RTM_FORCE_ABORT MSR */
#define CPUID_LEAF7_EXTFEATURE_IBRS _Bit(26)  /* IBRS / IBPB */
#define CPUID_LEAF7_EXTFEATURE_STIBP                                           \
  _Bit(27) /* Single Thread Indirect Branch Predictors */
...
#define CPUID_LEAF7_EXTFEATURE_SSBD                                            \
  _Bit(31) /* Speculative Store Bypass Disable */
 ...
 */
#define CPUID_X86_64_H_FEATURE_SUBSET                                          \
  (CPUID_FEATURE_FMA | CPUID_FEATURE_SSE4_2 | CPUID_FEATURE_MOVBE |            \
   CPUID_FEATURE_POPCNT | CPUID_FEATURE_AVX1_0)

#define CPUID_X86_64_H_EXTFEATURE_SUBSET (CPUID_EXTFEATURE_LZCNT)

#define CPUID_X86_64_H_LEAF7_FEATURE_SUBSET                                    \
  (CPUID_LEAF7_FEATURE_BMI1 | CPUID_LEAF7_FEATURE_AVX2 |                       \
...
/* Physical CPU info - this is exported out of the kernel (kexts), so be wary of
 * changes */
typedef struct i386_cpu_info {
  ...
  cpu_type_t
      cpuid_type; /* this is *not* a cpu_type_t in our <mach/machine.h> */
...
static inline int is_xeon_sp(uint8_t platid) {
