 ...
 */
static inline void ml_memory_to_timebase_fence(void) {
  /*
 ...
 */
static inline void ml_timebase_to_memory_fence(void) {}
...
/* Return the maximum number of CPUs set by ml_set_max_cpus(), blocking if
 * necessary */
...
#define ml_set_interrupts_enabled_with_debug(en, dbg)                          \
...
__private_extern__ uintptr_t pmap_verify_noncacheable(uintptr_t vaddr);
