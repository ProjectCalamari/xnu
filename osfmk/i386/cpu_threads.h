...
#define cpu_to_core(cpu)                                                       \
  ((cpu_to_lcpu(cpu) != NULL) ? _cpu_to_lcpu(cpu)->core : NULL)
#define cpu_to_die(cpu)                                                        \
  ((cpu_to_lcpu(cpu) != NULL) ? _cpu_to_lcpu(cpu)->die : NULL)
#define cpu_to_package(cpu)                                                    \
  ((cpu_to_lcpu(cpu) != NULL) ? _cpu_to_lcpu(cpu)->package : NULL)
...
#define cpu_is_same_package(cpu1, cpu2)                                        \
  (cpu_to_package(cpu1) == cpu_to_package(cpu2))
#define cpus_share_cache(cpu1, cpu2, _cl)                                      \
  (cpu_to_lcpu(cpu1)->caches[_cl] == cpu_to_lcpu(cpu2)->caches[_cl])
