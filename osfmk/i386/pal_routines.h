...
boolean_t pal_machine_sleep(uint8_t type_a, uint8_t type_b,
                            uint32_t bit_position, uint32_t disable_mask,
...
extern void _pal_rtc_nanotime_store(uint64_t tsc, uint64_t nsec, uint32_t scale,
                                    uint32_t shift,
