...
static kern_return_t net_stage_reset(struct kdp_output_stage *stage,
...
static kern_return_t net_stage_outproc(struct kdp_output_stage *stage,
...
static void net_stage_free(struct kdp_output_stage *stage) {
