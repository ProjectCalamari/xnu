...
void kdp_getstate(x86_thread_state64_t *state) {
...
void kdp_setstate(x86_thread_state64_t *state) {
  x86_saved_state64_t *saved_state;
...
void kdp_sync_cache(void) { return; /* No op here. */ }
...
boolean_t kdp_i386_trap(unsigned int trapno, x86_saved_state64_t *saved_state,
                        kern_return_t result, vm_offset_t va) {
...
void kdp_ml_enter_debugger(void) { __asm__ __volatile__("int3"); }
