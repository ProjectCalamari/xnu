 ...
 * NOTE: kgmacros has a non-symboled version of kdp_hdr_t so that some basic
 * information. can be gathered from a kernel without any symbols. changes to
 * this structure need to be reflected in kgmacros as well.
 */
typedef struct {
