...
/* Cortex-A53: 32KB I/D caches with 64-byte cache lines. */
#define MMU_I_CLINE 6
#define MMU_CLINE 6
...
#define PSR64_USER32_DEFAULT                                                   \
  (PSR64_MODE_RW_32 | PSR64_MODE_EL0 | PSR64_MODE_SP0 | PSR64_SSBS_U32_DEFAULT)
#define PSR64_USER64_DEFAULT                                                   \
  (PSR64_MODE_RW_64 | PSR64_MODE_EL0 | PSR64_MODE_SP0 | PSR64_SSBS_U64_DEFAULT)
#define PSR64_KERNEL_STANDARD                                                  \
  (DAIF_STANDARD_DISABLE | PSR64_MODE_RW_64 | PSR64_MODE_EL1 |                 \
   PSR64_MODE_SP0 | PSR64_SSBS_KRN_DEFAULT)
...
#define SCTLR_PAC_KEYS_ENABLED                                                 \
  (SCTLR_PACIA_ENABLED | SCTLR_PACIB_ENABLED | SCTLR_PACDA_ENABLED |           \
   SCTLR_PACDB_ENABLED)
...
// 10    EnRCTX         EL0 Access to FEAT_SPECRES speculation restriction
// instructions
...
#define SCTLR_EL1_REQUIRED                                                     \
  (SCTLR_RESERVED | SCTLR_UCI_ENABLED | SCTLR_nTWE_WFE_ENABLED |               \
   SCTLR_DZE_ENABLED | SCTLR_I_ENABLED | SCTLR_SED_DISABLED |                  \
   SCTLR_CP15BEN_ENABLED | SCTLR_BT_DEFAULT | SCTLR_SA0_ENABLED |              \
   SCTLR_SA_ENABLED | SCTLR_C_ENABLED | SCTLR_M_ENABLED | SCTLR_EPAN_DEFAULT | \
   SCTLR_EIS_DEFAULT | SCTLR_EOS_DEFAULT | SCTLR_DSSBS_DEFAULT |               \
   SCTLR_PAC_KEYS_DEFAULT | SCTLR_TP2_DEFAULT | SCTLR_OTHER)

#define SCTLR_EL1_OPTIONAL (SCTLR_EPAN_OPTIONAL)

#define SCTLR_EL1_DEFAULT (SCTLR_EL1_REQUIRED | SCTLR_EL1_OPTIONAL)
 ...
 * Legacy:
 *
 *  63  39   38   37 36   34 32    30 29 28 27 26 25 24   23 22 21  16    14 13
 * 12 11 10 9   8    7   5  0
 * +------+----+----+--+-+-----+-+---+-----+-----+-----+----+--+------+-+---+-----+-----+-----+----+-+----+
 * | zero |TBI1|TBI0|AS|z| IPS |z|TG1| SH1 |ORGN1|IRGN1|EPD1|A1| T1SZ |z|TG0|
 * SH0 |ORGN0|IRGN0|EPD0|z|T0SZ|
 * +------+----+----+--+-+-----+-+---+-----+-----+-----+----+--+------+-+---+-----+-----+-----+----+-+----+
 *
 ...
 * 12 11 10 9   8    7   5  0
 * +------+----+----+--+-+-----+-----+-----+-----+-----+----+--+------+-----+-----+-----+-----+----+-+----+
 * | zero |TBI1|TBI0|AS|z| IPS | TG1 | SH1 |ORGN1|IRGN1|EPD1|A1| T1SZ | TG0 |
 * SH0 |ORGN0|IRGN0|EPD0|z|T0SZ|
 * +------+----+----+--+-+-----+-----+-----+-----+-----+----+--+------+-----+-----+-----+-----+----+-+----+
 *
...
#define TCR_EL1_BASE                                                           \
  (TCR_IPS_VALUE | TCR_SH0_OUTER | TCR_ORGN0_WRITEBACK | TCR_IRGN0_WRITEBACK | \
   (T0SZ_BOOT << TCR_T0SZ_SHIFT) | TCR_SH1_OUTER | TCR_ORGN1_WRITEBACK |       \
   TCR_IRGN1_WRITEBACK | (TCR_TG1_GRANULE_SIZE) | TCR_TBI0_TOPBYTE_IGNORED |   \
   (TCR_TBID0_ENABLE) | TCR_E0PD_VALUE | TCR_EL1_DTBI | TCR_EL1_ASID |         \
   TCR_EL1_EXTRA)

#if __ARM64_PMAP_SUBPAGE_L1__ && CONFIG_SPTM
#define TCR_EL1_BASE_BOOT                                                      \
  (TCR_IPS_VALUE | TCR_SH0_OUTER | TCR_ORGN0_WRITEBACK | TCR_IRGN0_WRITEBACK | \
   (T0SZ_EARLY_BOOT << TCR_T0SZ_SHIFT) | TCR_SH1_OUTER | TCR_ORGN1_WRITEBACK | \
   TCR_IRGN1_WRITEBACK | (TCR_TG1_GRANULE_SIZE) | TCR_TBI0_TOPBYTE_IGNORED |   \
   (TCR_TBID0_ENABLE) | TCR_E0PD_VALUE | TCR_EL1_DTBI | TCR_EL1_ASID |         \
   TCR_EL1_EXTRA)
#endif /* __ARM64_PMAP_SUBPAGE_L1__ && CONFIG_SPTM */
...
#if __ARM_KERNEL_PROTECT__
#define TCR_EL1_BOOT                                                           \
  (TCR_EL1_BASE | (T1SZ_BOOT << TCR_T1SZ_SHIFT) | (TCR_TG0_GRANULE_SIZE))
#define T1SZ_USER (T1SZ_BOOT + 1)
#define TCR_EL1_USER                                                           \
  (TCR_EL1_BASE | (T1SZ_USER << TCR_T1SZ_SHIFT) | (TCR_TG0_GRANULE_SIZE))
#else
#if CONFIG_SPTM
#if __ARM64_PMAP_SUBPAGE_L1__
#define TCR_EL1_BOOT                                                           \
  (TCR_EL1_BASE_BOOT | (T1SZ_BOOT << TCR_T1SZ_SHIFT) | (TCR_TG0_GRANULE_SIZE))
#define TCR_EL1_FINAL                                                          \
  (TCR_EL1_BASE | (T1SZ_BOOT << TCR_T1SZ_SHIFT) | (TCR_TG0_GRANULE_SIZE))
#else /* !__ARM64_PMAP_SUBPAGE_L1__ */
#define TCR_EL1_BOOT                                                           \
  (TCR_EL1_BASE | (T1SZ_BOOT << TCR_T1SZ_SHIFT) | (TCR_TG0_GRANULE_SIZE))
...
#define TCR_EL1_4KB                                                            \
  (TCR_EL1_BASE | (T1SZ_BOOT << TCR_T1SZ_SHIFT) | (TCR_TG0_GRANULE_4KB))
#define TCR_EL1_16KB                                                           \
  (TCR_EL1_BASE | (T1SZ_BOOT << TCR_T1SZ_SHIFT) | (TCR_TG0_GRANULE_16KB))

/*
 * Bit 55 of the VA is used to select which TTBR to use during a translation
 * table walk.
 */
 ...
 * E (early-acknowledge): writes may return immediately (e.g. PCIe posted
 * writes)
 */
#if HAS_FEAT_XS

#define MAIR_DISABLE_XS                                                        \
  0x00                    /* Device Memory, nGnRnE (strongly ordered), XS=1 */
#define MAIR_DISABLE 0x01 /* Device Memory, nGnRnE (strongly ordered), XS=0 */
#define MAIR_POSTED_COMBINED_REORDERED_XS                                      \
  0x0C /* Device Memory, GRE (reorderable, gathered writes, posted writes),    \
          XS=1 */
#define MAIR_POSTED_COMBINED_REORDERED                                         \
  0x0D /* Device Memory, GRE (reorderable, gathered writes, posted writes),    \
          XS=0 */
 ...
 */
#define CACHE_ATTRINDX_WRITEBACK                                               \
  0x0 /* cache enabled, buffer enabled  (normal memory) */
#define CACHE_ATTRINDX_INNERWRITEBACK                                          \
  CACHE_ATTRINDX_WRITEBACK /* legacy compatibility only */
#define CACHE_ATTRINDX_WRITECOMB                                               \
  0x1 /* no cache, buffered writes (normal memory) */
#define CACHE_ATTRINDX_WRITETHRU                                               \
  0x2 /* cache enabled, buffer disabled (normal memory) */
#define CACHE_ATTRINDX_DISABLE                                                 \
  0x3 /* no cache, no buffer (device memory), XS = 0 */
#define CACHE_ATTRINDX_RESERVED 0x4 /* reserved for internal use */
#define CACHE_ATTRINDX_DISABLE_XS                                              \
  0x5 /* no cache, no buffer (device memory), XS = 1 */
/**
 * Posted mappings use XS by default, and on newer Apple SoCs there is no
 * fabric-level distinction between early-ack and non-early-ack, so just alias
 * POSTED to DISABLE_XS to save a MAIR index.
 */
#define CACHE_ATTRINDX_POSTED CACHE_ATTRINDX_DISABLE_XS
#define CACHE_ATTRINDX_POSTED_REORDERED                                        \
  CACHE_ATTRINDX_DISABLE /* no need for device-nGRE on newer SoCs, fallback to \
                            nGnRnE */
#define CACHE_ATTRINDX_POSTED_COMBINED_REORDERED                               \
  0x6 /* no cache, write gathering, reorderable access, posted writes (device  \
         memory), XS=0 */
#define CACHE_ATTRINDX_POSTED_COMBINED_REORDERED_XS                            \
  0x7 /* no cache, write gathering, reorderable access, posted writes (device  \
         memory), XS=1 */
...
#define MAIR_POSTED_REORDERED                                                  \
  0x08 /* Device Memory, nGRE (reorderable, posted writes) */
#define MAIR_POSTED_COMBINED_REORDERED                                         \
  0x0C /* Device Memory, GRE (reorderable, gathered writes, posted writes) */
#define MAIR_WRITECOMB                                                         \
  0x44 /* Normal Memory, Outer Non-Cacheable, Inner Non-Cacheable */
#define MAIR_WRITETHRU                                                         \
  0xBB /* Normal Memory, Outer Write-through, Inner Write-through */
#define MAIR_WRITEBACK                                                         \
  0xFF /* Normal Memory, Outer Write-back, Inner Write-back */
...
#define CACHE_ATTRINDX_RESERVED 0x4 /* reserved for internal use */
#define CACHE_ATTRINDX_POSTED                                                  \
  0x5 /* no cache, no buffer, posted writes (device memory) */
#define CACHE_ATTRINDX_POSTED_REORDERED                                        \
  0x6 /* no cache, reorderable access, posted writes (device memory) */
#define CACHE_ATTRINDX_POSTED_COMBINED_REORDERED                               \
  0x7 /* no cache, write gathering, reorderable access, posted writes (device  \
         memory) */
#define CACHE_ATTRINDX_DEFAULT CACHE_ATTRINDX_WRITEBACK
 ...
 *
 * Bit 1 controls access type (1=RO, 0=RW), bit 0 controls user (1=access, 0=no
 * access)
 */
...
#define SH_DEVICE                                                              \
  0x2 /* Normal memory Inner non shareable - Outer non shareable */
#define SH_OUTER_MEMORY                                                        \
  0x2 /* Normal memory Inner shareable - Outer shareable */
#define SH_INNER_MEMORY                                                        \
  0x3 /* Normal memory Inner shareable - Outer non shareable */
...
/* 16K L0 */
#define ARM_16K_TT_L0_SIZE                                                     \
  0x0000800000000000ULL /* size of area covered by a tte */
#define ARM_16K_TT_L0_OFFMASK                                                  \
  0x00007fffffffffffULL        /* offset within an L0 entry */
#define ARM_16K_TT_L0_SHIFT 47 /* page descriptor shift */
#define ARM_16K_TT_L0_INDEX_MASK                                               \
  0x0000800000000000ULL /* mask for getting index in L0 table from virtual     \
                           address */

/* 4K L0 */
#define ARM_4K_TT_L0_SIZE                                                      \
  0x0000008000000000ULL /* size of area covered by a tte */
#define ARM_4K_TT_L0_OFFMASK                                                   \
  0x0000007fffffffffULL       /* offset within an L0 entry */
#define ARM_4K_TT_L0_SHIFT 39 /* page descriptor shift */
#define ARM_4K_TT_L0_INDEX_MASK                                                \
  0x0000ff8000000000ULL /* mask for getting index in L0 table from virtual     \
                           address */
...
/* 16K L1 */
#define ARM_16K_TT_L1_SIZE                                                     \
  0x0000001000000000ULL /* size of area covered by a tte */
#define ARM_16K_TT_L1_OFFMASK                                                  \
  0x0000000fffffffffULL        /* offset within an L1 entry */
#define ARM_16K_TT_L1_SHIFT 36 /* page descriptor shift */
#define ARM_16K_TT_L1_INDEX_MASK 0x00007ff000000000ULL

/* 4K L1 */
#define ARM_4K_TT_L1_SIZE                                                      \
  0x0000000040000000ULL /* size of area covered by a tte */
#define ARM_4K_TT_L1_OFFMASK                                                   \
  0x000000003fffffffULL       /* offset within an L1 entry */
...
/* IPA[39:30] mask for getting index into L1 concatenated table from virtual
 * address */
...
#define L1_TABLE_T1_INDEX(va, tcr)                                             \
  (((va) & ARM_PTE_T1_REGION_MASK(tcr)) >> ARM_TT_L1_SHIFT)
...
#define L3_TABLE_VA(tte2)                                                      \
  ((pt_entry_t *)phystokv((*(tte2)) & ARM_TTE_TABLE_MASK))
...
/* 16K L2 */
#define ARM_16K_TT_L2_SIZE                                                     \
  0x0000000002000000ULL /* size of area covered by a tte */
#define ARM_16K_TT_L2_OFFMASK                                                  \
  0x0000000001ffffffULL        /* offset within an L2 entry */
#define ARM_16K_TT_L2_SHIFT 25 /* page descriptor shift */
#define ARM_16K_TT_L2_INDEX_MASK                                               \
  0x0000000ffe000000ULL /* mask for getting index in L2 table from virtual     \
                           address */

/* 4K L2 */
#define ARM_4K_TT_L2_SIZE                                                      \
  0x0000000000200000ULL /* size of area covered by a tte */
#define ARM_4K_TT_L2_OFFMASK                                                   \
  0x00000000001fffffULL       /* offset within an L2 entry */
#define ARM_4K_TT_L2_SHIFT 21 /* page descriptor shift */
#define ARM_4K_TT_L2_INDEX_MASK                                                \
  0x000000003fe00000ULL /* mask for getting index in L2 table from virtual     \
                           address */
...
/* 16K L3 */
#define ARM_16K_TT_L3_SIZE                                                     \
  0x0000000000004000ULL /* size of area covered by a tte */
...
#define ARM_16K_TT_L3_INDEX_MASK                                               \
  0x0000000001ffc000ULL /* mask for page descriptor index */

/* 4K L3 */
#define ARM_4K_TT_L3_SIZE                                                      \
  0x0000000000001000ULL /* size of area covered by a tte */
#define ARM_4K_TT_L3_OFFMASK 0x0000000000000fffULL /* offset within L3 PTE */
#define ARM_4K_TT_L3_SHIFT 12                      /* page descriptor shift */
#define ARM_4K_TT_L3_INDEX_MASK                                                \
  0x00000000001ff000ULL /* mask for page descriptor index */
 ...
 *
 *  63 59 58  55 54  53   52 51  48 47                  30 29  12 11 10 9  8 7
 * 6  5 4     2 1 0
 * +-----+------+--+---+----+------+----------------------+------+--+--+----+----+--+-------+-+-+
 * | ign |sw use|XN|PXN|HINT| zero | OutputAddress[47:30] | zero |nG|AF| SH | AP
 * |NS|AttrIdx|0|V|
 * +-----+------+--+---+----+------+----------------------+------+--+--+----+----+--+-------+-+-+
 *
 ...
 *
 *  63 59 58  55 54  53   52 51  48 47                  21 20  12 11 10 9  8 7
 * 6  5 4     2 1 0
 * +-----+------+--+---+----+------+----------------------+------+--+--+----+----+--+-------+-+-+
 * | ign |sw use|XN|PXN|HINT| zero | OutputAddress[47:21] | zero |nG|AF| SH | AP
 * |NS|AttrIdx|0|V|
 * +-----+------+--+---+----+------+----------------------+------+--+--+----+----+--+-------+-+-+
 *
 * 16KB granule size:
 ...
 * Level 2 Translation Block Entry
 *
 *  63 59 58  55 54  53   52 51  48 47                  25 24  12 11 10 9  8 7
 * 6  5 4     2 1 0
 * +-----+------+--+---+----+------+----------------------+------+--+--+----+----+--+-------+-+-+
 * | ign |sw use|XN|PXN|HINT| zero | OutputAddress[47:25] | zero |nG|AF| SH | AP
 * |NS|AttrIdx|0|V|
 * +-----+------+--+---+----+------+----------------------+------+--+--+----+----+--+-------+-+-+
 *
 * where:
...
#define ARM_TTE_TYPE_MASK                                                      \
  0x0000000000000002ULL /* mask for extracting the type */
...
#define ARM_TTE_ATTRINDX(x)                                                    \
  (((x) & ARM_TTE_ATTRINDXBITS)                                                \
   << ARM_TTE_ATTRINDXSHIFT) /* memory attributes index */
#define ARM_TTE_EXTRACT_ATTRINDX(x)                                            \
  (((x) >> ARM_TTE_ATTRINDXSHIFT) &                                            \
   ARM_TTE_ATTRINDXBITS) /* extract memory attributes index */
#define ARM_TTE_ATTRINDXMASK                                                   \
  ARM_TTE_ATTRINDX(ARM_TTE_ATTRINDXBITS) /* mask memory attributes index */
...
#define ARM_TTE_BLOCK_L0_SHIFT                                                 \
  ARM_TT_L0_SHIFT /* block shift for 128TB section */
#define ARM_TTE_BLOCK_L1_MASK                                                  \
  0x0000fff000000000ULL /* mask to extract phys address from L1 block entry */
#define ARM_TTE_BLOCK_L1_SHIFT                                                 \
  ARM_TT_L1_SHIFT /* block shift for 64GB section */
#define ARM_TTE_BLOCK_L2_MASK                                                  \
  0x0000fffffe000000ULL /* mask to extract phys address from Level 2           \
                           Translation Block entry */
#define ARM_TTE_BLOCK_L2_SHIFT                                                 \
  ARM_TT_L2_SHIFT /* block shift for 32MB section */
#else
#define ARM_TTE_BLOCK_SHIFT 12 /* entry shift for a 4KB L3 TTE entry */
#define ARM_TTE_BLOCK_L0_SHIFT                                                 \
  ARM_TT_L0_SHIFT /* block shift for 2048GB section */
#define ARM_TTE_BLOCK_L1_MASK                                                  \
  0x0000ffffc0000000ULL /* mask to extract phys address from L1 block entry */
#define ARM_TTE_BLOCK_L1_SHIFT ARM_TT_L1_SHIFT /* block shift for 1GB section  \
                                                */
#define ARM_TTE_BLOCK_L2_MASK                                                  \
  0x0000ffffffe00000ULL /* mask to extract phys address from Level 2           \
                           Translation Block entry */
...
#define ARM_TTE_BLOCK_ATTRINDX(x)                                              \
  (ARM_TTE_ATTRINDX_AIE(x) | ARM_TTE_ATTRINDX(x)) /* memory attributes index   \
                                                   */
#define ARM_TTE_BLOCK_ATTRINDXMASK                                             \
  (ARM_TTE_ATTRINDXMASK_AIE |                                                  \
   ARM_TTE_ATTRINDXMASK) /* mask memory attributes index */
...
#define ARM_TTE_BLOCK_PNX                                                      \
  0x0020000000000000ULL /* value for privilege no execute bit */
#define ARM_TTE_BLOCK_PNXMASK                                                  \
  0x0020000000000000ULL /* privilege no execute mask */
...
#define ARM_TTE_BLOCK_WIRED                                                    \
  0x0400000000000000ULL /* value for software wired bit */
#define ARM_TTE_BLOCK_WIREDMASK 0x0400000000000000ULL /* software wired mask   \
                                                       */

#define ARM_TTE_BLOCK_WRITEABLE                                                \
  0x0800000000000000ULL /* value for software writeable bit */
#define ARM_TTE_BLOCK_WRITEABLEMASK                                            \
  0x0800000000000000ULL /* software writeable mask */

#define ARM_TTE_TABLE_MASK                                                     \
  0x0000fffffffff000ULL /* mask for extracting pointer to next table (works at \
                           any level) */
...
#define ARM_TTE_TABLE_AP(x)                                                    \
  ((x) << ARM_TTE_TABLE_APSHIFT) /* access protection */
...
#define ARM_TTE_TABLE_PXN                                                      \
  0x0800000000000000ULL /* value for privilege no execute bit */
...
#define ARM_TTE_TABLE_RESERVED_MASK                                            \
  (~(ARM_TTE_VALID | ARM_TTE_TYPE_MASK | ARM_TTE_TABLE_MASK |                  \
     ARM_TTE_TABLE_SW_RESERVED_MASK | ARM_TTE_TABLE_PXNMASK |                  \
     ARM_TTE_TABLE_XNMASK | ARM_TTE_TABLE_AP_MASK | ARM_TTE_TABLE_NS_MASK))
 ...
 *
 *
 *  63 59 58  55 54  53   52  51 50  47 48                    12 11 10 9  8 7  6
 * 5 4     2 1 0
 * +-----+------+--+---+----+---+--+----+----------------------+--+--+----+----+--+-------+-+-+
 * | ign |sw use|XN|PXN|HINT|DBM|GP|zero| OutputAddress[47:12] |nG|AF| SH | AP
 * |NS|AttrIdx|1|V|
 * +-----+------+--+---+----+---+--+----+----------------------+--+--+----+----+--+-------+-+-+
 *
 * where:
...
#define ARM_PTE_COMPRESSED_ALT                                                 \
  0x4000000000000000ULL /* ... and was "alt_acct" */
#define ARM_PTE_COMPRESSED_MASK 0xC000000000000000ULL

#define ARM_PTE_TYPE_VALID                                                     \
  0x0000000000000003ULL /* valid L3 entry: includes bit #1                     \
                           (counterintuitively) */
...
/* This mask works for both 16K and 4K pages because bits 12-13 will be zero in
 * 16K pages */
#define ARM_PTE_PAGE_MASK                                                      \
  0x0000FFFFFFFFF000ULL /* output address mask for page */
#define ARM_PTE_PAGE_SHIFT                                                     \
  12 /* page shift for the output address in the entry */

#define ARM_PTE_AP(x) ((x) << 6)     /* access protections */
#define ARM_PTE_APMASK (0x3ULL << 6) /* mask access protections */
#define ARM_PTE_EXTRACT_AP(x)                                                  \
  (((x) >> 6) & 0x3ULL) /* extract access protections from PTE */

#define ARM_PTE_ATTRINDX(x)                                                    \
  (uint64_t)(ARM_TTE_ATTRINDX_AIE(x) |                                         \
             ARM_TTE_ATTRINDX(x)) /* memory attributes index */
#define ARM_PTE_ATTRINDXMASK                                                   \
  (ARM_TTE_ATTRINDXMASK_AIE |                                                  \
   ARM_TTE_ATTRINDXMASK) /* mask memory attributes index */
#define ARM_PTE_EXTRACT_ATTRINDX(x)                                            \
  (ARM_TTE_EXTRACT_ATTRINDX_AIE(x) |                                           \
   ARM_TTE_EXTRACT_ATTRINDX(x)) /* extract memory attributes index */
...
#define ARM_PTE_HINT                                                           \
  0x0010000000000000ULL /* value for contiguous entries hint */
#define ARM_PTE_HINT_MASK                                                      \
  0x0010000000000000ULL /* mask for contiguous entries hint */
...
#define ARM_PTE_HINT_ENTRIES_SHIFT                                             \
  7ULL /* shift to construct the number of entries */
#define ARM_PTE_HINT_ADDR_MASK                                                 \
  0x0000FFFFFFE00000ULL /* mask to extract the starting hint address */
#define ARM_PTE_HINT_ADDR_SHIFT 21 /* shift for the hint address */
#define ARM_KVA_HINT_ADDR_MASK                                                 \
  0xFFFFFFFFFFE00000ULL /* mask to extract the starting hint address */
#else
#define ARM_PTE_HINT_ENTRIES 16ULL /* number of entries the hint covers */
#define ARM_PTE_HINT_ENTRIES_SHIFT                                             \
  4ULL /* shift to construct the number of entries */
#define ARM_PTE_HINT_ADDR_MASK                                                 \
  0x0000FFFFFFFF0000ULL /* mask to extract the starting hint address */
#define ARM_PTE_HINT_ADDR_SHIFT 16 /* shift for the hint address */
#define ARM_KVA_HINT_ADDR_MASK                                                 \
  0xFFFFFFFFFFFF0000ULL /* mask to extract the starting hint address */
#endif
...
#define ARM_PTE_GUARDED                                                        \
  0x0004000000000000ULL /* value for "guarded"/BTI enforcing code page */
...
#define ARM_PTE_WRITEABLE                                                      \
  0x0800000000000000ULL /* value for software writeable bit */
#define ARM_PTE_WRITEABLE_MASK                                                 \
  0x0800000000000000ULL /* software writeable mask */
...
#define ARM_PTE_RESERVED_MASK                                                  \
  (~(ARM_PTE_TYPE_MASK | ARM_PTE_ATTRINDXMASK | ARM_PTE_NS_MASK |              \
     ARM_PTE_APMASK | ARM_PTE_SHMASK | ARM_PTE_AFMASK | ARM_PTE_NG_MASK |      \
     ARM_PTE_PAGE_MASK | ARM_PTE_GP_MASK | ARM_PTE_HINT_MASK |                 \
     ARM_PTE_PNXMASK | ARM_PTE_NXMASK | ARM_PTE_SW_RESERVED_MASK))
...
#define RTLBI_TG(_page_shift_)                                                 \
  ((uint64_t)((((_page_shift_) - 12) >> 1) + 1) << 46)
...
#define CNTKCTL_EL1_PL0PTEN                                                    \
  (0x1 << 9) /* 1: EL0 access to physical timer regs permitted */
#define CNTKCTL_EL1_PL0VTEN                                                    \
  (0x1 << 8) /* 1: EL0 access to virtual timer regs permitted */
#define CNTKCTL_EL1_EVENTI_MASK                                                \
  (0x000000f0) /* Mask for bits describing which bit to use for triggering     \
                  event stream */
#define CNTKCTL_EL1_EVENTI_SHIFT (0x4) /* Shift for same */
#define CNTKCTL_EL1_EVENTDIR                                                   \
  (0x1 << 3) /* 1: one-to-zero transition of specified bit causes event */
#define CNTKCTL_EL1_EVNTEN (0x1 << 2) /* 1: enable event stream */
#define CNTKCTL_EL1_PL0VCTEN                                                   \
  (0x1 << 1) /* 1: EL0 access to virtual timebase + frequency reg enabled */
#define CNTKCTL_EL1_PL0PCTEN                                                   \
  (0x1 << 0) /* 1: EL0 access to physical timebase + frequency reg enabled */

#define CNTV_CTL_EL0_ISTATUS                                                   \
  (0x1 << 2) /* (read only): whether interrupt asserted */
...
#define CORESIGHT_UTT                                                          \
  3 /* Not truly a coresight thing, but at a fixed convenient location right   \
       after the coresight region */
 ...
 *
 *  63    60 59   56 55  52 51   48 47  44 43   40 39   36 35  32 31   28 27 24
 * 23    20 19   16 15  12 11   8 7   4 3    0
 * +--------+-------+------+-------+------+-------+-------+------+-------+--------+--------+-------+------+------+-----+------+
 * |  rndr  |  tlb  |  ts  |  fhm  |  dp  |  sm4  |  sm3  | sha3 |  rdm  |  res0
 * | atomic | crc32 | sha2 | sha1 | aes | res0 |
 * +--------+-------+------+-------+------+-------+-------+------+-------+--------+--------+-------+------+------+-----+------+
 */
 ...
 *
 *  63  56 55  52 51 48 47  44 43     40 39  36 35     32 31 28 27 24 23   20 19
 * 16 15   12 11  8 7   4 3   0
 * +------+------+-----+------+---------+------+---------+-----+-----+-------+------+-------+-----+-----+-----+
 * | res0 | i8mm | dgh | bf16 | specres |  sb  | frintts | gpi | gpa | lrcpc |
 * fcma | jscvt | api | apa | dpb |
 * +------+------+-----+------+---------+------+---------+-----+-----+-------+------+-------+-----+-----+-----+
 */
...
#define ID_AA64ISAR1_EL1_SPECRES_MASK                                          \
  (0xfull << ID_AA64ISAR1_EL1_SPECRES_OFFSET)
...
#define ID_AA64ISAR1_EL1_FRINTTS_MASK                                          \
  (0xfull << ID_AA64ISAR1_EL1_FRINTTS_OFFSET)
 ...
 *  63   60 59   56 55        48 47   44 43      40 39       36 35       32 31
 ...
 *  63  60 59   56 55   52 51   48 47    44 43   40 39   36 35  32 31  28 27  24
 * 23   20 19     16 15  12 14    8 7     4 3     0
 * +------+-------+-------+-------+--------+-------+-------+------+------+------+-------+---------+------+-------+-------+-------+
 * | E0PD |  EVT  |  BBM  |  TTL  |  RES0  |  FWB  |  IDS  |  AT  |  ST  |  NV
 * | CCIDX | VARANGE | IESB |  LSM  |  UAO  |  CnP  |
 * +------+-------+-------+-------+--------+-------+-------+------+------+------+-------+---------+------+-------+-------+-------+
 */
...
#define ID_AA64MMFR2_EL1_VARANGE_MASK                                          \
  (0xfull << ID_AA64MMFR2_EL1_VARANGE_OFFSET)
 ...
 *  63    60 59    56 55    52 51   48 47   44 43    40 39    36 35   32 31   28
 * 27 24 23     20 19  16 15 12 11  8 7   4 3   0
 * +--------+--------+--------+-------+-------+--------+--------+-------+-------+-----+---------+------+-----+-----+-----+-----+
 * |  CSV3  |  CSV2  |  RES0  |  DIT  |  AMU  |  MPAM  |  SEL2  |  SVE  |  RAS
 * | GIC | AdvSIMD |  FP  | EL3 | EL2 | EL1 | EL0 |
 * +--------+--------+--------+-------+-------+--------+--------+-------+-------+-----+---------+------+-----+-----+-----+-----+
 */
...
#define ID_AA64PFR0_EL1_AdvSIMD_HPFPCVT                                        \
  (0x0ull << ID_AA64PFR0_EL1_AdvSIMD_OFFSET)
...
#define ID_AA64PFR1_EL1_CSV2_frac_MASK                                         \
  (0xfull << ID_AA64PFR1_EL1_CSV2_frac_OFFSET)
 ...
 *
 *  63  52 51    48 47 44 43 40 39 36 35 32 31  28 27     24 23   20 19  16 15
 * 12 11   8 7        4 3       0
 * +------+--------+-----+-----+-----+-----+------+---------+-------+------+------+------+----------+--------+
 * | res0 | nTLBPA | AFP | HCX | ETS | TWED | XNX | SpecSEI |  PAN  |  LO  |
 * HPDS |  VH  | VMIDBits | HAFDBS |
 * +------+--------+-----+-----+-----+-----+------+---------+-------+------+------+------+----------+--------+
 */
 ...
 *
 *      63 62  60 59    56 55    52 51  49       48 47    44 43  40 39   36 35
 * 34        33       32 31   0
 * +------+------+--------+--------+------+--------+--------+------+-------+--------+--------+---------+--------+------+
 * | FA64 | res0 | SMEver | I16I64 | res0 | F64F64 | I16I32 | res0 | I8I32 |
 * F16F32 | B16F32 | BI32I32 | F32F32 | res0 |
 * +------+------+--------+--------+------+--------+--------+------+-------+--------+--------+---------+--------+------+
 */
...
#if defined(HAS_APPLE_PAC)
// The value of ptrauth_string_discriminator("recover"), hardcoded so it can be
