...
#define ARM_MACHINE_THREAD_PRESERVE_X18                                        \
  (1 << ARM_MACHINE_THREAD_PRESERVE_X18_SHIFT)
#endif /* !__ARM_KERNEL_PROTECT__ */

#if defined(HAS_APPLE_PAC)
#define ARM_MACHINE_THREAD_DISABLE_USER_JOP_SHIFT 1
#define ARM_MACHINE_THREAD_DISABLE_USER_JOP                                    \
  (1 << ARM_MACHINE_THREAD_DISABLE_USER_JOP_SHIFT)
#endif /* HAS_APPLE_PAC */

/* Thread should use 1 GHz timebase */
#define ARM_MACHINE_THREAD_USES_1GHZ_TIMBASE_SHIFT 2
#define ARM_MACHINE_THREAD_USES_1GHZ_TIMBASE                                   \
  (1 << ARM_MACHINE_THREAD_USES_1GHZ_TIMBASE_SHIFT)
