...
#define KPC_ARM64_PMC_COUNT                                                    \
  (KPC_ARM64_FIXED_COUNT + KPC_ARM64_CONFIGURABLE_COUNT)

/* Size to the maximum number of counters we could read from every class in one
 * go */
#define KPC_MAX_COUNTERS                                                       \
  (KPC_ARM64_FIXED_COUNT + KPC_ARM64_CONFIGURABLE_COUNT + 1)
