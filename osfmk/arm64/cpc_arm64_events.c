...
static const struct cpc_event *_cpc_select_event(cpc_hw_t hw,
                                                 uint16_t selector) {
...
cpc_event_policy_t cpc_get_event_policy(void) { return _cpc_event_policy; }
    ...
    .cel_events =
        {
            ...
            {.cev_selector = 0x00c4,
             .cev_name = "ST_MEM_ORDER_VIOL_LD_NONSPEC"},
            {.cev_selector = 0x00c5, .cev_name = "BRANCH_COND_MISPRED_NONSPEC"},
            {.cev_selector = 0x00c6,
             .cev_name = "BRANCH_INDIR_MISPRED_NONSPEC"},
            {.cev_selector = 0x00c8,
             .cev_name = "BRANCH_RET_INDIR_MISPRED_NONSPEC"},
            {.cev_selector = 0x00ca,
             .cev_name = "BRANCH_CALL_INDIR_MISPRED_NONSPEC"},
    ...
    .cel_events =
        {
            ...
            {.cev_selector = 0x0290,
             .cev_name = "LDST_UNIT_OLD_L1D_CACHE_MISS"},
            {.cev_selector = 0x0291,
             .cev_name = "LDST_UNIT_WAITING_OLD_L1D_CACHE_MISS"},
    ...
    .cel_events =
        {
            ...
            {.cev_selector = 0x0288,
             .cev_name = "SME_ENGINE_ZA_ENABLED_SM_DISABLED"},
            {.cev_selector = 0x028c,
             .cev_name = "LDST_UNIT_WAITING_SME_ENGINE_INST_QUEUE_FULL"},
            {.cev_selector = 0x028e,
             .cev_name = "SCHEDULE_WAITING_SME_ENGINE_REG_DATA"},
            {.cev_selector = 0x028f,
             .cev_name = "LDST_UNIT_WAITING_SME_ENGINE_MEM_DATA"},
            {.cev_selector = 0x0290,
             .cev_name = "LDST_UNIT_OLD_L1D_CACHE_MISS"},
            {.cev_selector = 0x0291,
             .cev_name = "LDST_UNIT_WAITING_OLD_L1D_CACHE_MISS"},
            {.cev_selector = 0x0294,
             .cev_name = "LD_UNIT_WAITING_YOUNG_L1D_CACHE_MISS"},
            ...
            {.cev_selector = 0x0529,
             .cev_name = "INST_SME_ENGINE_PACKING_FUSED"},
            {.cev_selector = 0x052c, .cev_name = "LD_BLOCKED_BY_SME_LDST"},
            {.cev_selector = 0x052e,
             .cev_name = "ST_BARRIER_BLOCKED_BY_SME_LDST"},
