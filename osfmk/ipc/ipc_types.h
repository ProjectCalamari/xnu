 ...
 * `ENHANCED_V2` includes those opted into the FY25 platform restrictions
 * entitlement No new features should be placed into the previous versions for
 * bincompat reasons, and binaries opted into the newer versions always get the
...
/* flags to turn off security */
        ...
        IPC_SPACE_POLICY_MASK =
            (IPC_SPACE_POLICY_DEFAULT | IPC_SPACE_POLICY_ENHANCED |
             IPC_SPACE_POLICY_PLATFORM | IPC_SPACE_POLICY_KERNEL |
             IPC_SPACE_POLICY_SIMULATED | IPC_SPACE_POLICY_TRANSLATED |
             IPC_SPACE_POLICY_OPTED_OUT),

        /* platform restrictions Versioning Levels */
        IPC_SPACE_POLICY_ENHANCED_V0 =
            0x100, /* DEPRECATED - includes macos hardened runtime */
        IPC_SPACE_POLICY_ENHANCED_V1 =
            0x200, /* ES features exposed to 3P in FY2024 release */
        IPC_SPACE_POLICY_ENHANCED_V2 =
            0x400, /* ES features exposed to 3P in FY2025 release */
        IPC_SPACE_POLICY_ENHANCED_VERSION_MASK = (IPC_SPACE_POLICY_ENHANCED_V0 |
                                                  IPC_SPACE_POLICY_ENHANCED_V1 |
                                                  IPC_SPACE_POLICY_ENHANCED_V2),
    });
...
#define IPC_OBJECT_VALID(io)                                                   \
  (((io) != IPC_OBJECT_NULL) && ((io) != IPC_OBJECT_DEAD))
