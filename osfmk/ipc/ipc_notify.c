 ...
 * space reliably.
 */
static inline bool ipc_notify_should_send(ipc_port_t notification_port) {
  return ip_active(notification_port);
}

void ipc_notify_dead_name(ipc_port_t port, mach_port_name_t name) {
...
void ipc_notify_send_possible(ipc_port_t port, mach_port_name_t name) {
  if (ipc_notify_should_send(port)) {
...
void ipc_notify_port_deleted(ipc_port_t port, mach_port_name_t name) {
  if (ipc_notify_should_send(port)) {
...
ipc_notify_nsenders_t ipc_notify_no_senders_prepare(ipc_port_t port) {
...
void ipc_notify_no_senders_mqueue(ipc_port_t port,
...
void ipc_notify_no_senders_kobject(ipc_port_t port,
                                   mach_port_mscount_t mscount) {
  if (ipc_notify_should_send(port)) {
...
void ipc_notify_send_once_and_unlock(ipc_port_t port) {
  /*
