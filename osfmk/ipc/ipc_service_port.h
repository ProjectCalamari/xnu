...
struct ipc_service_port_label {
  ...
  struct ipc_conn_port_label *XNU_PTRAUTH_SIGNED_PTR_AUTH_NULL(
      "ipc_service_port_label.ispl_sblabel") ispl_sblabel;
  mach_port_context_t ispl_launchd_context; /* context used to guard the port,
                                               specific to launchd */
...
ipc_service_port_label_alloc(mach_service_port_info_t sp_info,
                             ipc_object_label_t *label);

extern void ipc_connection_port_label_dealloc(ipc_object_label_t label);

extern void ipc_service_port_label_dealloc(ipc_object_label_t label);
...
extern void
ipc_service_port_label_set_attr(ipc_service_port_label_t port_splabel,
...
extern void
ipc_service_port_label_get_info(ipc_service_port_label_t port_splabel,
