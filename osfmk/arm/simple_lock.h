...
extern machine_timeout_t
    LockTimeOut; /* Number of hardware ticks of a lock timeout */
extern machine_timeout_t
    LockTimeOutUsec; /* Number of microseconds for lock timeout */
...
#define simple_lock_try_nopreempt(l, grp)                                      \
  lck_spin_try_lock_nopreempt_grp(l, grp)
#else
