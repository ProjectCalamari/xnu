 ...
 */
void saved_state_to_thread_state32(const arm_saved_state_t *saved_state,
 ...
 */
void thread_state32_to_saved_state(const arm_thread_state32_t *ts32,
  ...
  set_user_saved_state_cpsr(saved_state,
                            (ts32->cpsr & ~PSR64_MODE_MASK) | PSR64_MODE_RW_32);
#else
