...
extern void commpage_set_timestamp(uint64_t tbr, uint64_t secs, uint64_t frac,
...
extern void commpage_set_remotetime_params(double rate, uint64_t base_local_ts,
