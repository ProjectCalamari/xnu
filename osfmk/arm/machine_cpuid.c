...
MARK_AS_FIXUP_TEXT uint32_t machine_read_midr(void) {
  uint64_t midr;
...
arm_debug_info_t *machine_arm_debug_info(void) { return &cpuid_debug_info; }

void machine_do_mvfpid() {
...
arm_mvfp_info_t *machine_arm_mvfp_info(void) { return &cpuid_mvfp_info; }
