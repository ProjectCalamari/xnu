...
extern kern_return_t cpu_signal(cpu_data_t *target, cpu_signal_t signal,
                                void *p0, void *p1);

extern kern_return_t cpu_signal_deferred(cpu_data_t *target,
                                         cpu_signal_t signal);

extern void cpu_signal_cancel(cpu_data_t *target, cpu_signal_t signal);
