...
#define BUF_INFO_INT(EVENTID, A1, A2, A3, A4)                                  \
  if (__improbable(kperf_debug_level >= KPERF_DEBUG_INFO))                     \
  KERNEL_DEBUG_CONSTANT(EVENTID, A1, A2, A3, A4, 0)
#else
#define BUF_INFO_INT(EVENTID, A1, A2, A3, A4)                                  \
  do {                                                                         \
    (void)(EVENTID);                                                           \
...
#define BUF_INFO_(EVENTID, A1, A2, A3, A4, N_ARGS, ...)                        \
  BUF_INFO##N_ARGS(EVENTID, A1, A2, A3, A4)
...
#if (KDEBUG_LEVEL >= KDEBUG_LEVEL_STANDARD)
#define BUF_VERB_INT(EVENTID, A1, A2, A3, A4)                                  \
  if (__improbable(kperf_debug_level >= KPERF_DEBUG_VERBOSE))                  \
  KERNEL_DEBUG_CONSTANT(EVENTID, A1, A2, A3, A4, 0)
#else
#define BUF_VERB_INT(EVENTID, A1, A2, A3, A4)                                  \
  do {                                                                         \
...
#define BUF_VERB_(EVENTID, A1, A2, A3, A4, N_ARGS, ...)                        \
  BUF_VERB##N_ARGS(EVENTID, A1, A2, A3, A4)
