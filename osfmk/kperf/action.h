...
#define SAMPLER_TASK_MASK                                                      \
  (SAMPLER_MEMINFO | SAMPLER_TK_SNAPSHOT | SAMPLER_TK_INFO)
#define SAMPLER_THREAD_MASK                                                    \
  (SAMPLER_TH_INFO | SAMPLER_TH_SNAPSHOT | SAMPLER_KSTACK | SAMPLER_USTACK |   \
   SAMPLER_PMC_THREAD | SAMPLER_TH_SCHEDULING | SAMPLER_TH_DISPATCH |          \
   SAMPLER_TH_INSCYC | SAMPLER_EXSTACK)
...
kern_return_t kperf_sample(struct kperf_sample *sbuf, struct kperf_context *ctx,
...
/* during this sample, the thread was idle. set only if
...
int kperf_action_get_ucallstack_depth(unsigned int actionid,
                                      uint32_t *depth_out);
int kperf_action_set_kcallstack_depth(unsigned int actionid, uint32_t depth);
int kperf_action_get_kcallstack_depth(unsigned int actionid,
                                      uint32_t *depth_out);
