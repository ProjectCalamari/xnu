...
mach_msg_trap(mach_msg_header_t *msg, mach_msg_option_t option,
              mach_msg_size_t send_size, mach_msg_size_t rcv_size,
              mach_port_name_t rcv_name, mach_msg_timeout_t timeout,
              mach_port_name_t notify);

#if defined(__LP64__) || defined(__arm64__)
extern mach_msg_return_t mach_msg2_trap(void *data, mach_msg_option64_t options,
...
semaphore_timedwait_signal_trap(mach_port_name_t wait_name,
...
extern kern_return_t clock_sleep_trap(mach_port_name_t clock_name,
                                      sleep_type_t sleep_type, int sleep_sec,
                                      int sleep_nsec,
...
extern kern_return_t
_kernelrpc_mach_vm_map_trap(mach_port_name_t target, mach_vm_offset_t *address,
                            mach_vm_size_t size, mach_vm_offset_t mask,
                            int flags, vm_prot_t cur_protection);

extern kern_return_t
_kernelrpc_mach_vm_purgable_control_trap(mach_port_name_t target,
...
extern kern_return_t
_kernelrpc_mach_port_deallocate_trap(mach_port_name_t target,
                                     mach_port_name_t name);
...
extern kern_return_t
_kernelrpc_mach_port_construct_trap(mach_port_name_t target,
                                    mach_port_options_t *options,
                                    uint64_t context, mach_port_name_t *name);

extern kern_return_t
_kernelrpc_mach_port_destruct_trap(mach_port_name_t target,
                                   mach_port_name_t name,
                                   mach_port_delta_t srdelta, uint64_t guard);

extern kern_return_t _kernelrpc_mach_port_guard_trap(mach_port_name_t target,
                                                     mach_port_name_t name,
                                                     uint64_t guard,
                                                     boolean_t strict);

extern kern_return_t _kernelrpc_mach_port_unguard_trap(mach_port_name_t target,
                                                       mach_port_name_t name,
                                                       uint64_t guard);

extern kern_return_t mach_generate_activity_id(mach_port_name_t target,
                                               int count,
                                               uint64_t *activity_id);

extern kern_return_t macx_swapon(uint64_t filename, int flags, int size,
                                 int priority);

extern kern_return_t macx_swapoff(uint64_t filename, int flags);

extern kern_return_t macx_triggers(int hi_water, int low_water, int flags,
...
extern kern_return_t thread_switch(mach_port_name_t thread_name, int option,
                                   mach_msg_timeout_t option_time);

extern mach_port_name_t task_self_trap(void);

extern kern_return_t
host_create_mach_voucher_trap(mach_port_name_t host,
                              mach_voucher_attr_raw_recipe_array_t recipes,
                              int recipes_size, mach_port_name_t *voucher);
...
extern kern_return_t _kernelrpc_mach_port_type_trap(ipc_space_t task,
                                                    mach_port_name_t name,
...
extern kern_return_t task_for_pid(mach_port_name_t target_tport, int pid,
                                  mach_port_name_t *t);

extern kern_return_t task_name_for_pid(mach_port_name_t target_tport, int pid,
                                       mach_port_name_t *tn);

extern kern_return_t pid_for_task(mach_port_name_t t, int *x);

extern kern_return_t debug_control_port_for_pid(mach_port_name_t target_tport,
                                                int pid, mach_port_name_t *t);

extern mach_error_t
mach_vm_reclaim_update_kernel_accounting_trap(mach_port_name_t target_tport,
...
#define PAD_(t)                                                                \
  (sizeof(uint64_t) <= sizeof(t) ? 0 : sizeof(uint64_t) - sizeof(t))
#define PAD_ARG_8
#else
#define PAD_(t)                                                                \
  (sizeof(uint32_t) <= sizeof(t) ? 0 : sizeof(uint32_t) - sizeof(t))
...
extern kern_return_t kern_invalid(struct kern_invalid_args *args);

struct mach_reply_port_args {
  int32_t dummy;
};
extern mach_port_name_t mach_reply_port(struct mach_reply_port_args *args);

struct thread_get_special_reply_port_args {
  int32_t dummy;
};
extern mach_port_name_t
thread_get_special_reply_port(struct thread_get_special_reply_port_args *args);

struct thread_self_trap_args {
  int32_t dummy;
};
extern mach_port_name_t thread_self_trap(struct thread_self_trap_args *args);

struct task_self_trap_args {
  int32_t dummy;
};
extern mach_port_name_t task_self_trap(struct task_self_trap_args *args);

struct host_self_trap_args {
  int32_t dummy;
};
extern mach_port_name_t host_self_trap(struct host_self_trap_args *args);
...
extern mach_msg_return_t mach_msg2_trap(struct mach_msg2_trap_args *args);
#endif
...
extern kern_return_t
semaphore_signal_trap(struct semaphore_signal_trap_args *args);

struct semaphore_signal_all_trap_args {
  PAD_ARG_(mach_port_name_t, signal_name);
};
extern kern_return_t
semaphore_signal_all_trap(struct semaphore_signal_all_trap_args *args);
...
extern kern_return_t
semaphore_signal_thread_trap(struct semaphore_signal_thread_trap_args *args);

struct semaphore_wait_trap_args {
  PAD_ARG_(mach_port_name_t, wait_name);
};
extern kern_return_t semaphore_wait_trap(struct semaphore_wait_trap_args *args);
...
extern kern_return_t
semaphore_wait_signal_trap(struct semaphore_wait_signal_trap_args *args);
...
extern kern_return_t
semaphore_timedwait_trap(struct semaphore_timedwait_trap_args *args);
...
extern kern_return_t task_for_pid(struct task_for_pid_args *args);
...
extern kern_return_t task_name_for_pid(struct task_name_for_pid_args *args);
...
extern kern_return_t macx_swapon(struct macx_swapon_args *args);

struct macx_swapoff_args {
  PAD_ARG_(uint64_t, filename);
  PAD_ARG_(int, flags);
};
extern kern_return_t macx_swapoff(struct macx_swapoff_args *args);
...
extern kern_return_t macx_triggers(struct macx_triggers_args *args);

struct macx_backing_store_suspend_args {
  PAD_ARG_(boolean_t, suspend);
};
extern kern_return_t
macx_backing_store_suspend(struct macx_backing_store_suspend_args *args);

struct macx_backing_store_recovery_args {
  PAD_ARG_(int, pid);
};
extern kern_return_t
macx_backing_store_recovery(struct macx_backing_store_recovery_args *args);
...
extern kern_return_t pfz_exit(struct pfz_exit_args *args);

struct swtch_args {
  int32_t dummy;
};
extern boolean_t swtch(struct swtch_args *args);
...
extern kern_return_t clock_sleep_trap(struct clock_sleep_trap_args *args);
...
extern kern_return_t thread_switch(struct thread_switch_args *args);
...
extern kern_return_t _exclaves_ctl_trap(struct exclaves_ctl_trap_args *args);
...
extern kern_return_t
mach_wait_until_trap(struct mach_wait_until_trap_args *args);

struct mk_timer_create_trap_args {
  int32_t dummy;
};
extern mach_port_name_t
mk_timer_create_trap(struct mk_timer_create_trap_args *args);

struct mk_timer_destroy_trap_args {
  PAD_ARG_(mach_port_name_t, name);
};
extern kern_return_t
mk_timer_destroy_trap(struct mk_timer_destroy_trap_args *args);

struct mk_timer_arm_trap_args {
  PAD_ARG_(mach_port_name_t, name);
  PAD_ARG_(uint64_t, expire_time);
};
extern kern_return_t mk_timer_arm_trap(struct mk_timer_arm_trap_args *args);
...
extern kern_return_t
mk_timer_cancel_trap(struct mk_timer_cancel_trap_args *args);
