...
/*	Send a catch_exception_raise_identity_protected message including
 * protected task and thread identity.
 */
...
#define MACH_EXCEPTION_MASK                                                    \
  (MACH_EXCEPTION_CODES | MACH_EXCEPTION_ERRORS |                              \
 ...
 */
#define EXC_MAY_BE_UNRECOVERABLE_BIT                                           \
  0x400 /* Set if this exception may be uncatchable by userspace */
