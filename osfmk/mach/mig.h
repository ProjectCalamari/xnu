...
typedef void (*mig_stub_kern_routine_t)(mach_msg_header_t *InHeadP,
                                        void *InDataP,
...
typedef mig_kern_routine_t (*mig_kern_server_routine_t)(
...
typedef struct mig_kern_subsystem {
  ...
  mach_msg_size_t maxsize;                 /* Max reply message size */
  vm_address_t reserved;                   /* reserved for MIG use */
  mig_kern_routine_descriptor kroutine[1]; /* Kernel routine descriptor array */
