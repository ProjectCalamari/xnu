...
#define host_get_host_port(host, port)                                         \
  (host_get_special_port((host), HOST_LOCAL_NODE, HOST_PORT, (port)))
...
#define host_get_io_main_port(host, port)                                      \
  (host_get_special_port((host), HOST_LOCAL_NODE, HOST_IO_MAIN_PORT, (port)))
...
#define host_get_dynamic_pager_port(host, port)                                \
  (host_get_special_port((host), HOST_LOCAL_NODE, HOST_DYNAMIC_PAGER_PORT,     \
                         (port)))
...
#define host_get_audit_control_port(host, port)                                \
  (host_get_special_port((host), HOST_LOCAL_NODE, HOST_AUDIT_CONTROL_PORT,     \
                         (port)))
...
#define host_get_user_notification_port(host, port)                            \
  (host_get_special_port((host), HOST_LOCAL_NODE, HOST_USER_NOTIFICATION_PORT, \
                         (port)))
...
#define host_get_automountd_port(host, port)                                   \
  (host_get_special_port((host), HOST_LOCAL_NODE, HOST_AUTOMOUNTD_PORT, (port)))
...
#define host_get_lockd_port(host, port)                                        \
  (host_get_special_port((host), HOST_LOCAL_NODE, HOST_LOCKD_PORT, (port)))
...
#define host_get_ktrace_background_port(host, port)                            \
  (host_get_special_port((host), HOST_LOCAL_NODE, HOST_KTRACE_BACKGROUND_PORT, \
                         (port)))
...
#define host_get_kextd_port(host, port)                                        \
  (host_get_special_port((host), HOST_LOCAL_NODE, HOST_KEXTD_PORT, (port)))
...
#define host_get_launchctl_port(host, port)                                    \
  (host_get_special_port((host), HOST_LOCAL_NODE, HOST_LAUNCHCTL_PORT, (port)))
...
#define host_get_unfreed_port(host, port)                                      \
  (host_get_special_port((host), HOST_LOCAL_NODE, HOST_UNFREED_PORT, (port)))
...
#define host_get_amfid_port(host, port)                                        \
  (host_get_special_port((host), HOST_LOCAL_NODE, HOST_AMFID_PORT, (port)))
#define host_set_amfid_port(host, port)                                        \
  (host_set_special_port((host), HOST_AMFID_PORT, (port)))

#define host_get_gssd_port(host, port)                                         \
  (host_get_special_port((host), HOST_LOCAL_NODE, HOST_GSSD_PORT, (port)))
...
#define host_get_telemetry_port(host, port)                                    \
  (host_get_special_port((host), HOST_LOCAL_NODE, HOST_TELEMETRY_PORT, (port)))
...
#define host_get_atm_notification_port(host, port)                             \
  (host_get_special_port((host), HOST_LOCAL_NODE, HOST_ATM_NOTIFICATION_PORT,  \
                         (port)))
...
#define host_get_coalition_port(host, port)                                    \
  (host_get_special_port((host), HOST_LOCAL_NODE, HOST_COALITION_PORT, (port)))
...
#define host_get_sysdiagnose_port(host, port)                                  \
  (host_get_special_port((host), HOST_LOCAL_NODE, HOST_SYSDIAGNOSE_PORT,       \
                         (port)))
...
#define host_get_container_port(host, port)                                    \
  (host_get_special_port((host), HOST_LOCAL_NODE, HOST_CONTAINERD_PORT, (port)))
...
#define host_get_node_port(host, port)                                         \
  (host_get_special_port((host), HOST_LOCAL_NODE, HOST_NODE_PORT, (port)))
#define host_set_node_port(host, port)                                         \
  (host_set_special_port((host), HOST_NODE_PORT, (port)))

#define host_get_closured_port(host, port)                                     \
  (host_get_special_port((host), HOST_LOCAL_NODE, HOST_CLOSURED_PORT, (port)))
...
#define host_get_syspolicyd_port(host, port)                                   \
  (host_get_special_port((host), HOST_LOCAL_NODE, HOST_SYSPOLICYD_PORT, (port)))
...
#define host_get_filecoordinationd_port(host, port)                            \
  (host_get_special_port((host), HOST_LOCAL_NODE, HOST_FILECOORDINATIOND_PORT, \
                         (port)))
...
#define host_get_fairplayd_port(host, port)                                    \
  (host_get_special_port((host), HOST_LOCAL_NODE, HOST_FAIRPLAYD_PORT, (port)))
...
#define host_get_iocompressionstats_port(host, port)                           \
  (host_get_special_port((host), HOST_LOCAL_NODE,                              \
                         HOST_IOCOMPRESSIONSTATS_PORT, (port)))
...
#define host_get_memory_error_port(host, port)                                 \
  (host_get_special_port((host), HOST_LOCAL_NODE, HOST_MEMORY_ERROR_PORT,      \
                         (port)))
...
#define host_get_managedappdistd_port(host, port)                              \
  (host_get_special_port((host), HOST_LOCAL_NODE, HOST_MANAGEDAPPDISTD_PORT,   \
                         (port)))
...
#define host_get_doubleagentd_port(host, port)                                 \
  (host_get_special_port((host), HOST_LOCAL_NODE, HOST_DOUBLEAGENTD_PORT,      \
                         (port)))
