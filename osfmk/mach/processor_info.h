...
#define PROCESSOR_PM_REGS_INFO                                                 \
  0x10000001                             /* performance monitor register info */
...
#define PROCESSOR_BASIC_INFO_COUNT                                             \
  ((mach_msg_type_number_t)(sizeof(processor_basic_info_data_t) /              \
                            sizeof(natural_t)))
...
#define PROCESSOR_CPU_LOAD_INFO_COUNT                                          \
  ((mach_msg_type_number_t)(sizeof(processor_cpu_load_info_data_t) /           \
                            sizeof(natural_t)))
...
#define PROCESSOR_SET_BASIC_INFO_COUNT                                         \
  ((mach_msg_type_number_t)(sizeof(processor_set_basic_info_data_t) /          \
                            sizeof(natural_t)))
...
#define PROCESSOR_SET_LOAD_INFO_COUNT                                          \
  ((mach_msg_type_number_t)(sizeof(processor_set_load_info_data_t) /           \
                            sizeof(natural_t)))
...
#define PROCESSOR_SET_ENABLED_POLICIES_COUNT                                   \
  ((mach_msg_type_number_t)(sizeof(policy_t) / sizeof(natural_t)))
