...
#define CPU_SUBTYPE_PTRAUTH_ABI                                                \
  0x80000000 /* pointer authentication with versioned ABI */
...
#define CPU_SUBTYPE_ARM64_PTR_AUTH_CURRENT_VERSION                             \
  CPU_SUBTYPE_ARM64_PTR_AUTHV0_VERSION
#if XNU_TARGET_OS_OSX
#define CPU_SUBTYPE_ARM64_PTR_AUTH_MAX_PREFERRED_VERSION                       \
  CPU_SUBTYPE_ARM64_PTR_AUTHV1_VERSION
