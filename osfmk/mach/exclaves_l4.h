 ...
 */
#define Exclaves_L4_Error(code, value)                                         \
  (((Exclaves_L4_Word(value)) << 8) | (Exclaves_L4_Word(code)))
 ...
 */
#define Exclaves_L4_ErrorCode(error)                                           \
  ((error) & (((Exclaves_L4_Word(1)) << 8) - 1))
...
Exclaves_L4_MessageTag_Unwrapped(Exclaves_L4_MessageTag_t tag) {
  return Exclaves_L4_Word(
      Exclaves_L4_BfxW(tag, Exclaves_L4_MessageTag_Unwrapped_Base,
                       Exclaves_L4_MessageTag_Unwrapped_Bits));
}

static inline Exclaves_L4_Word_t
Exclaves_L4_MessageTag_Label(Exclaves_L4_MessageTag_t tag) {
  return Exclaves_L4_Word(Exclaves_L4_BfxW(tag,
                                           Exclaves_L4_MessageTag_Label_Base,
                                           Exclaves_L4_MessageTag_Label_Bits));
}

static inline Exclaves_L4_MessageTag_t
Exclaves_L4_MessageTag(Exclaves_L4_Word_t mrs, Exclaves_L4_Word_t crs,
                       Exclaves_L4_Word_t label,
  ...
  Exclaves_L4_Word_t tag =
      (Exclaves_L4_BfW(Exclaves_L4_MessageTag_Mrs_Base,
       ...
       Exclaves_L4_BfW(Exclaves_L4_MessageTag_NonBlocking_Base,
                       Exclaves_L4_MessageTag_NonBlocking_Bits,
                       Exclaves_L4_Word(nonblocking)) |
       Exclaves_L4_BfW(Exclaves_L4_MessageTag_Label_Base,
                       Exclaves_L4_MessageTag_Label_Bits,
                       Exclaves_L4_Word(label)));
...
static inline Exclaves_L4_Word_t Exclaves_L4_GetMr(Exclaves_L4_Word32_t mr) {
  return Exclaves_L4_IpcBuffer()->mr[mr];
}

static inline Exclaves_L4_Void_t Exclaves_L4_SetMr(Exclaves_L4_Word32_t mr,
                                                   Exclaves_L4_Word_t word) {
...
static inline Exclaves_L4_Word_t Exclaves_L4_GetCr(Exclaves_L4_Word32_t cr,
                                                   Exclaves_L4_Bool_t dst) {
...
static inline Exclaves_L4_Void_t Exclaves_L4_SetCr(Exclaves_L4_Word32_t cr,
                                                   Exclaves_L4_Word_t word,
                                                   Exclaves_L4_Bool_t dst) {
  if (dst == Exclaves_L4_True) {
