 ...
 */
#define UNIX_SYSCALL_TRAP int $(UNIX_INT)
#define MACHDEP_SYSCALL_TRAP int $(MACHDEP_INT)
...
#define UNIX_SYSCALL_TRAP syscall
#define MACHDEP_SYSCALL_TRAP syscall
...
#define I386_SYSCALL_ARG_BYTES_MASK                                            \
  (((I386_SYSCALL_ARG_BYTES_NUM - 1) & ~0x3) << I386_SYSCALL_ARG_BYTES_SHIFT)
