...
#define THREAD_STATE_FLAVORS                                                   \
  26 /* This must be updated to 1 more than the highest numerical state flavor \
      */
...
#define FLAVOR_MODIFIES_CORE_CPU_REGISTERS(x)                                  \
  ((x == x86_THREAD_STATE) || (x == x86_THREAD_STATE32) ||                     \
   (x == x86_THREAD_STATE64) || (x == x86_THREAD_FULL_STATE64))
...
#define VALID_THREAD_STATE_FLAVOR(x)                                           \
  ((x == x86_THREAD_STATE32) || (x == x86_FLOAT_STATE32) ||                    \
   ...
   (x == x86_THREAD_STATE64) || (x == x86_THREAD_FULL_STATE64) ||              \
   (x == x86_FLOAT_STATE64) || (x == x86_EXCEPTION_STATE64) ||                 \
   (x == x86_DEBUG_STATE64) || (x == x86_THREAD_STATE) ||                      \
   (x == x86_FLOAT_STATE) || (x == x86_EXCEPTION_STATE) ||                     \
   (x == x86_DEBUG_STATE) || (x == x86_AVX_STATE32) ||                         \
   (x == x86_AVX_STATE64) || (x == x86_AVX_STATE) ||                           \
   (x == x86_AVX512_STATE32) || (x == x86_AVX512_STATE64) ||                   \
   (x == x86_AVX512_STATE) || (x == x86_PAGEIN_STATE) ||                       \
   (x == x86_INSTRUCTION_STATE) || (x == x86_LAST_BRANCH_STATE) ||             \
   (x == THREAD_STATE_NONE))
...
#define x86_THREAD_FULL_STATE64_COUNT                                          \
  ((mach_msg_type_number_t)(sizeof(x86_thread_full_state64_t) / sizeof(int)))
