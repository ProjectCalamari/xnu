 ...
 *
 *  When making a new VM_INHERIT_*, update tests
 * vm_parameter_validation_[user|kern] and their expected results; they
 * deliberately call VM functions with invalid inherit values and you may be
 * turning one of those invalid inherits valid.
 */
