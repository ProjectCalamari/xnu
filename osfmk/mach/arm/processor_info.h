...
#define PROCESSOR_CPU_STAT64                                                   \
  0x10000004 /* Low-level CPU statistics, in full 64-bit */
...
#define PROCESSOR_CPU_STAT_COUNT                                               \
  ((mach_msg_type_number_t)(sizeof(processor_cpu_stat_data_t) /                \
                            sizeof(natural_t)))
...
#define PROCESSOR_CPU_STAT64_COUNT                                             \
  ((mach_msg_type_number_t)(sizeof(processor_cpu_stat64_data_t) /              \
                            sizeof(integer_t)))
