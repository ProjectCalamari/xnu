...
#define _STRUCT_ARM_EXCEPTION_STATE64_V2                                       \
...
#define __DARWIN_ARM_THREAD_STATE64_CHECK_SIGRETURN_TOKEN(ts, token, mask)     \
  (((ts)->flags & (mask)) == (((uint32_t)(token)) & (mask)))
...
#define __darwin_arm_thread_state64_get_pc(ts)                                                                 \
  __extension__({                                                                                              \
    const _STRUCT_ARM_THREAD_STATE64 *__tsp = &(ts);                                                           \
    (uintptr_t)(__tsp->__opaque_pc &&                                                                          \
               ...
               ((__tsp->__opaque_flags &                                                            \
                ...
                (__tsp->__opaque_flags &                                                            \
                 __DARWIN_ARM_THREAD_STATE64_USER_DIVERSIFIER_MASK))                                \
                   ? ptrauth_blend_discriminator(                                                   \
                         (void                                                                      \
                              *)(unsigned long)(__tsp->__opaque_flags &                             \
                                                __DARWIN_ARM_THREAD_STATE64_USER_DIVERSIFIER_MASK), \
                         ptrauth_string_discriminator("pc"))                                        \
                   : ptrauth_string_discriminator("pc"))                                            \
         : NULL);                                                                                   \
...
#define __darwin_arm_thread_state64_set_pc_fptr(ts, fptr)                                                      \
  __extension__({                                                                                              \
    _STRUCT_ARM_THREAD_STATE64 *__tsp = &(ts);                                                                 \
    __typeof__(fptr) __f = (fptr);                                                                             \
    __tsp->__opaque_pc =                                                                                       \
        (__f ? (!(__tsp->__opaque_flags &                                                                      \
                  __DARWIN_ARM_THREAD_STATE64_FLAGS_NO_PTRAUTH)                                                \
                    ? ptrauth_auth_and_resign(                                                                 \
                          __f, ptrauth_key_function_pointer, 0,                                                \
                          ptrauth_key_process_independent_code,                                                \
                          (__tsp->__opaque_flags &                                                             \
                           __DARWIN_ARM_THREAD_STATE64_USER_DIVERSIFIER_MASK)                                  \
                              ? ptrauth_blend_discriminator(                                                   \
                                    ...
                                    ptrauth_string_discriminator("pc"))                                        \
                              : ptrauth_string_discriminator("pc"))                                            \
                    : ptrauth_auth_data(__f, ptrauth_key_function_pointer, 0))                                 \
             : __f);                                                                                           \
    __tsp->__opaque_flags &=                                                                                   \
        ~__DARWIN_ARM_THREAD_STATE64_FLAGS_KERNEL_SIGNED_PC;                                                   \
  })
...
#define __darwin_arm_thread_state64_set_pc_presigned_fptr(ts, presigned_fptr)  \
  __extension__({                                                              \
    _STRUCT_ARM_THREAD_STATE64 *__tsp = &(ts);                                 \
    __typeof__(presigned_fptr) __f = (presigned_fptr);                         \
    __tsp->__opaque_pc = __f;                                                  \
    __tsp->__opaque_flags &=                                                   \
        ~__DARWIN_ARM_THREAD_STATE64_FLAGS_KERNEL_SIGNED_PC;                   \
  })
...
#define __darwin_arm_thread_state64_set_sp(ts, ptr)                            \
  __extension__({                                                              \
    _STRUCT_ARM_THREAD_STATE64 *__tsp = &(ts);                                 \
    void *__p = (void *)(uintptr_t)(ptr);                                      \
    __tsp->__opaque_sp =                                                       \
        (__p && !(__tsp->__opaque_flags &                                      \
                  __DARWIN_ARM_THREAD_STATE64_FLAGS_NO_PTRAUTH)                \
             ? ptrauth_sign_unauthenticated(                                   \
                   __p, ptrauth_key_process_independent_data,                  \
                   ptrauth_string_discriminator("sp"))                         \
             : __p);                                                           \
  })
  ...
  __extension__({                                                              \
    ...
    __tsp->__opaque_pc =                                                       \
        ((__tsp->__opaque_flags &                                              \
          __DARWIN_ARM_THREAD_STATE64_FLAGS_NO_PTRAUTH)                        \
             ? __tsp->__opaque_pc                                              \
             : ptrauth_strip(__tsp->__opaque_pc,                               \
                             ptrauth_key_process_independent_code));           \
    __tsp->__opaque_lr =                                                       \
        ((__tsp->__opaque_flags &                                              \
          (__DARWIN_ARM_THREAD_STATE64_FLAGS_NO_PTRAUTH |                      \
           __DARWIN_ARM_THREAD_STATE64_FLAGS_IB_SIGNED_LR))                    \
             ? __tsp->__opaque_lr                                              \
             : ptrauth_strip(__tsp->__opaque_lr,                               \
                             ptrauth_key_process_independent_code));           \
    __tsp->__opaque_sp =                                                       \
        ((__tsp->__opaque_flags &                                              \
          __DARWIN_ARM_THREAD_STATE64_FLAGS_NO_PTRAUTH)                        \
             ? __tsp->__opaque_sp                                              \
             : ptrauth_strip(__tsp->__opaque_sp,                               \
                             ptrauth_key_process_independent_data));           \
    __tsp->__opaque_fp =                                                       \
        ((__tsp->__opaque_flags &                                              \
          __DARWIN_ARM_THREAD_STATE64_FLAGS_NO_PTRAUTH)                        \
             ? __tsp->__opaque_fp                                              \
             : ptrauth_strip(__tsp->__opaque_fp,                               \
                             ptrauth_key_process_independent_data));           \
    __tsp->__opaque_flags |= __DARWIN_ARM_THREAD_STATE64_FLAGS_NO_PTRAUTH;     \
    __tsp->__opaque_flags &=                                                   \
        ~(__DARWIN_ARM_THREAD_STATE64_FLAGS_KERNEL_SIGNED_PC |                 \
          __DARWIN_ARM_THREAD_STATE64_FLAGS_KERNEL_SIGNED_LR);                 \
  })
...
/* Return pc field of arm_thread_state64_t as a data pointer value */
#define __darwin_arm_thread_state64_get_pc(ts) ((uintptr_t)((ts).__opaque_pc))
/* Return pc field of arm_thread_state64_t as a function pointer */
#define __darwin_arm_thread_state64_get_pc_fptr(ts) ((ts).__opaque_pc)
/* Set pc field of arm_thread_state64_t to a function pointer */
#define __darwin_arm_thread_state64_set_pc_fptr(ts, fptr)                      \
  ((ts).__opaque_pc = (fptr))
/* Set pc field of arm_thread_state64_t to an already signed function pointer */
...
/* Return lr field of arm_thread_state64_t as a data pointer value */
#define __darwin_arm_thread_state64_get_lr(ts) ((uintptr_t)((ts).__opaque_lr))
/* Return lr field of arm_thread_state64_t as a function pointer */
#define __darwin_arm_thread_state64_get_lr_fptr(ts) ((ts).__opaque_lr)
/* Set lr field of arm_thread_state64_t to a function pointer */
#define __darwin_arm_thread_state64_set_lr_fptr(ts, fptr)                      \
  ((ts).__opaque_lr = (fptr))
...
/* Return sp field of arm_thread_state64_t as a data pointer value */
#define __darwin_arm_thread_state64_get_sp(ts) ((uintptr_t)((ts).__opaque_sp))
/* Set sp field of arm_thread_state64_t to a data pointer value */
#define __darwin_arm_thread_state64_set_sp(ts, ptr)                            \
  ((ts).__opaque_sp = (void *)(uintptr_t)(ptr))
/* Return fp field of arm_thread_state64_t as a data pointer value */
#define __darwin_arm_thread_state64_get_fp(ts) ((uintptr_t)((ts).__opaque_fp))
/* Set fp field of arm_thread_state64_t to a data pointer value */
#define __darwin_arm_thread_state64_set_fp(ts, ptr)                            \
...
/* Return pc field of arm_thread_state64_t as a data pointer value */
#define __darwin_arm_thread_state64_get_pc(ts) ((ts).pc)
/* Return pc field of arm_thread_state64_t as a function pointer */
#define __darwin_arm_thread_state64_get_pc_fptr(ts)                            \
...
/* Return lr field of arm_thread_state64_t as a data pointer value */
#define __darwin_arm_thread_state64_get_lr(ts) ((ts).lr)
/* Return lr field of arm_thread_state64_t as a function pointer */
#define __darwin_arm_thread_state64_get_lr_fptr(ts)                            \
...
/* Return sp field of arm_thread_state64_t as a data pointer value */
#define __darwin_arm_thread_state64_get_sp(ts) ((ts).sp)
/* Set sp field of arm_thread_state64_t to a data pointer value */
#define __darwin_arm_thread_state64_set_sp(ts, ptr) ((ts).sp = (uintptr_t)(ptr))
/* Return fp field of arm_thread_state64_t as a data pointer value */
#define __darwin_arm_thread_state64_get_fp(ts) ((ts).fp)
/* Set fp field of arm_thread_state64_t to a data pointer value */
#define __darwin_arm_thread_state64_set_fp(ts, ptr) ((ts).fp = (uintptr_t)(ptr))
/* Strip ptr auth bits from pc, lr, sp and fp field of arm_thread_state64_t */
#define __darwin_arm_thread_state64_ptrauth_strip(ts) (void)(ts)
...
_STRUCT_ARM_PAGEIN_STATE { int __pagein_error; };
...
_STRUCT_ARM_CPMU_STATE64 { __uint64_t __ctrs[16]; };
#else /* __DARWIN_UNIX03 */
#define _STRUCT_ARM_CPMU_STATE64 struct arm_cpmu_state64
_STRUCT_ARM_CPMU_STATE64 { __uint64_t ctrs[16]; };
#endif /* !__DARWIN_UNIX03 */
