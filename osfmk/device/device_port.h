...
_Static_assert(((DEVICE_PAGER_CONTIGUOUS | DEVICE_PAGER_NOPHYSCACHE) &
                VM_WIMG_MASK) == 0,
               "device pager flags overlap WIMG mask");

/* Assert on the backwards-compatible DEVICE_PAGER* values */
_Static_assert(DEVICE_PAGER_GUARDED == VM_MEM_GUARDED,
               "DEVICE_PAGER_GUARDED != VM_MEM_GUARDED");
_Static_assert(DEVICE_PAGER_COHERENT == VM_MEM_COHERENT,
               "DEVICE_PAGER_COHERENT != VM_MEM_COHERENT");
_Static_assert(DEVICE_PAGER_CACHE_INHIB == VM_MEM_NOT_CACHEABLE,
               "DEVICE_PAGER_CACHE_INHIB != VM_MEM_NOT_CACHEABLE");
_Static_assert(DEVICE_PAGER_WRITE_THROUGH == VM_MEM_WRITE_THROUGH,
               "DEVICE_PAGER_WRITE_THROUGH != VM_MEM_WRITE_THROUGH");
