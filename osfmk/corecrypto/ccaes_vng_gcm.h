...
#define CCMODE_GCM_VNG_KEY_Htable(K)                                           \
  (((struct _cc_vng_gcm_tables *)&_CCMODE_GCM_KEY(K)->u[0])->Htable)

int ccaes_vng_gcm_decrypt(ccgcm_ctx *key, size_t nbytes, const void *in,
                          void *out);

int ccaes_vng_gcm_encrypt(ccgcm_ctx *key, size_t nbytes, const void *in,
                          void *out);

extern void gcm_init(void *Htable, void *H) __asm__("_gcm_init");
extern void gcm_gmult(const void *X, const void *Htable,
                      void *out) __asm__("_gcm_gmult");
extern void gcm_ghash(void *X, void *Htable, const void *in,
                      size_t len) __asm__("_gcm_ghash");
#ifdef __x86_64__
extern void
gcmEncrypt_SupplementalSSE3(const void *, void *, void *, unsigned int, void *,
                            void *) __asm__("_gcmEncrypt_SupplementalSSE3");
extern void
gcmDecrypt_SupplementalSSE3(const void *, void *, void *, unsigned int, void *,
                            void *) __asm__("_gcmDecrypt_SupplementalSSE3");
extern void gcmEncrypt_avx1(const void *, void *, void *, unsigned int, void *,
                            void *) __asm__("_gcmEncrypt_avx1");
extern void gcmDecrypt_avx1(const void *, void *, void *, unsigned int, void *,
                            void *) __asm__("_gcmDecrypt_avx1");
#else
extern void gcmEncrypt(const void *, void *, void *, unsigned int, void *,
                       void *) __asm__("_gcmEncrypt");
extern void gcmDecrypt(const void *, void *, void *, unsigned int, void *,
                       void *) __asm__("_gcmDecrypt");
#endif
...
#define CCAES_VNG_GCM_ENCRYPT(ECB_ENCRYPT)                                     \
  {.size = ccn_sizeof_size(sizeof(struct _ccmode_gcm_key)) +                   \
           GCM_ECB_KEY_SIZE(ECB_ENCRYPT) + VNG_GCM_TABLE_SIZE,                 \
   .block_size = 1,                                                            \
 ...
 *  parameter. */
CC_INLINE
void ccaes_vng_factory_gcm_encrypt(struct ccmode_gcm *gcm) {
  struct ccmode_gcm gcm_encrypt =
      CCAES_VNG_GCM_ENCRYPT(ccaes_ecb_encrypt_mode());
  *gcm = gcm_encrypt;
}
 ...
 *  parameter. */
CC_INLINE
void ccaes_vng_factory_gcm_decrypt(struct ccmode_gcm *gcm) {
  struct ccmode_gcm gcm_decrypt =
      CCAES_VNG_GCM_DECRYPT(ccaes_ecb_encrypt_mode());
  *gcm = gcm_decrypt;
}
