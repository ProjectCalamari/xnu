...
int ccdrbg_init(const struct ccdrbg_info *info, struct ccdrbg_state *drbg,
  ...
  return info->init(info, drbg, entropyLength, entropy, nonceLength, nonce,
                    psLength, ps);
}
...
int ccdrbg_reseed(const struct ccdrbg_info *info, struct ccdrbg_state *drbg,
  ...
  return info->reseed(drbg, entropyLength, entropy, additionalLength,
                      additional);
}
...
int ccdrbg_generate(const struct ccdrbg_info *info, struct ccdrbg_state *drbg,
  ...
  return info->generate(drbg, dataOutLength, dataOut, additionalLength,
                        additional);
}
