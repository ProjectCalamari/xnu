/* Copyright (c) (2011,2014,2015,2018,2019,2021,2023) Apple Inc. All rights
 * reserved.
 *
...
static void bmul64(uint64_t x, uint64_t y, uint64_t *r_hi, uint64_t *r_lo) {
...
void ccmode_gcm_gf_mult_64(const unsigned char *a, const unsigned char *b,
                           unsigned char *c) {
...
static void bmul32(uint32_t x, uint32_t y, uint32_t *r_hi, uint32_t *r_lo) {
  ...
  z0 = ((uint64_t)x0 * y0) ^ ((uint64_t)x1 * y3) ^ ((uint64_t)x2 * y2) ^
       ((uint64_t)x3 * y1);
  z1 = ((uint64_t)x0 * y1) ^ ((uint64_t)x1 * y0) ^ ((uint64_t)x2 * y3) ^
       ((uint64_t)x3 * y2);
  z2 = ((uint64_t)x0 * y2) ^ ((uint64_t)x1 * y1) ^ ((uint64_t)x2 * y0) ^
       ((uint64_t)x3 * y3);
  z3 = ((uint64_t)x0 * y3) ^ ((uint64_t)x1 * y2) ^ ((uint64_t)x2 * y1) ^
       ((uint64_t)x3 * y0);
...
void ccmode_gcm_gf_mult_32(const unsigned char *a, const unsigned char *b,
                           unsigned char *c) {
  ...
  z_hi_l =
      (((uint64_t)z2_b_h << 32) | z2_b_l) ^ (((uint64_t)z1_a_h << 32) | z1_a_l);
  z_lo_h =
      (((uint64_t)z0_a_h << 32) | z0_a_l) ^ (((uint64_t)z1_b_h << 32) | z1_b_l);
