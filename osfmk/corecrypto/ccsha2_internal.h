...
void ccsha256_v6m_compress(ccdigest_state_t c, size_t num,
                           const void *p) __asm__("_ccsha256_v6m_compress");
#endif

void ccsha256_ltc_compress(ccdigest_state_t state, size_t nblocks,
                           const void *buf);
void ccsha512_ltc_compress(ccdigest_state_t state, size_t nblocks,
                           const void *in);
