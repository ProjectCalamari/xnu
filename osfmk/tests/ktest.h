...
void T_SYM(perf)(const char *metric, const char *unit, double value,
                 const char *desc);
...
#define T_SET_AUX_VARS                                                         \
  do {                                                                         \
    /* Only used in userspace lib for now */                                   \
  } while (0)

#define T_ASSERTION_CHECK                                                      \
  do {                                                                         \
    T_SYM(assertion_check)();                                                  \
  } while (0)

#define T_EXPECT_BLOCK2(type, fmt, cmp, lhs, rhs, msg, ...)                    \
  do {                                                                         \
    T_SAVEINFO;                                                                \
    T_SYM(temp1).type = (lhs);                                                 \
    T_SYM(temp2).type = (rhs);                                                 \
    T_SYM(set_current_expr)(                                                   \
        T_TOSTRING(lhs) " " T_TOSTRING(cmp) " " T_TOSTRING(rhs));              \
...
#define T_ASSERT_BLOCK2(type, fmt, cmp, lhs, rhs, msg, ...)                    \
  do {                                                                         \
...
#define T_EXPECT_NOTNULL(expr, msg, ...)                                       \
  do {                                                                         \
    T_SAVEINFO;                                                                \
    T_SYM(temp1)._int = (int)(!!(expr));                                       \
    T_SYM(set_current_expr)(T_TOSTRING(expr) " != NULL");                      \
    T_SYM(set_current_var)(T_TOSTRING(expr), "%s",                             \
...
#define T_ASSERT_NOTNULL(expr, msg, ...)                                       \
  do {                                                                         \
    T_EXPECT_NOTNULL(expr, msg, ##__VA_ARGS__);                                \
    T_ASSERTION_CHECK;                                                         \
  } while (0)

#define T_ASSERT_NULL(expr, msg, ...)                                          \
  do {                                                                         \
...
#define T_EXPECT_EQ_STR(lhs, rhs, msg, ...)                                    \
  do {                                                                         \
    T_SAVEINFO;                                                                \
...
#define T_EXPECT_NE_STR(lhs, rhs, msg, ...)                                    \
  do {                                                                         \
    T_SAVEINFO;                                                                \
    T_SYM(temp1)._ptr = (lhs);                                                 \
    T_SYM(temp2)._ptr = (rhs);                                                 \
...
#define T_ASSERT_EQ_STR(lhs, rhs, msg, ...)                                    \
  do {                                                                         \
    T_EXPECT_EQ_STR(lhs, rhs, msg, #__VA_ARGS__);                              \
    T_ASSERTION_CHECK;                                                         \
  } while (0)

#define T_ASSERT_NE_STR(lhs, rhs, msg, ...)                                    \
  do {                                                                         \
