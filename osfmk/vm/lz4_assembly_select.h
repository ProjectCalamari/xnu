...
//  To disable C
#define LZ4_ENABLE_ASSEMBLY_ENCODE                                             \
  ((LZ4_ENABLE_ASSEMBLY_ENCODE_ARMV7) || (LZ4_ENABLE_ASSEMBLY_ENCODE_ARM64))
#define LZ4_ENABLE_ASSEMBLY_DECODE                                             \
  (LZ4_ENABLE_ASSEMBLY_DECODE_ARM64 || LZ4_ENABLE_ASSEMBLY_DECODE_ARMV7 ||     \
   LZ4_ENABLE_ASSEMBLY_DECODE_X86_64)
