...
void testArray() {
  ...
  if (array1) {
    ...
    TEST_ASSERT('A', "2d", numStrCache == (int)array1->getCapacityIncrement());
...
void testSet() {
  ...
  if (set1) {
    ...
    TEST_ASSERT('S', "2d", numStrCache == (int)set1->getCapacityIncrement());
...
void testDictionary() {
  ...
  dict1 = OSDictionary::withObjects((OSObject **)symCache, symCache, numSymbols,
                                    numSymbols);
  ...
  if (dict1) {
    ...
    TEST_ASSERT('D', "2e", numSymbols == (int)dict1->getCapacityIncrement());
  ...
  dict1 = OSDictionary::withObjects((OSObject **)symCache, (OSString **)cache,
  ...
  if (dict1) {
    ...
    for (i = 0; i < numSymbols; i++) {
      sym = symCache[i];
      count1 += ((OSObject *)sym ==
                 dict1->setObject((OSObject *)sym, sym->getCStringNoCopy()));
