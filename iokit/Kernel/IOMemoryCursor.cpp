...
OSDefineMetaClassAndStructors(IOMemoryCursor, OSObject)
    ...
    OSSharedPtr<IOMemoryCursor> IOMemoryCursor::withSpecification(
        SegmentFunction inSegFunc, IOPhysicalLength inMaxSegmentSize,
        IOPhysicalLength inMaxTransferSize, IOPhysicalLength inAlignment) {
  OSSharedPtr<IOMemoryCursor> me = OSMakeShared<IOMemoryCursor>();

  if (me && !me->initWithSpecification(inSegFunc, inMaxSegmentSize,
                                       inMaxTransferSize, inAlignment)) {
    return nullptr;
  }
...
bool IOMemoryCursor::initWithSpecification(SegmentFunction inSegFunc,
...
// @@@ gvdl: Remove me
  ...
  if (!sMaxDBDMASegment) {
    ...
    if (PE_parse_boot_argn("mseg", &sMaxDBDMASegment,
...
UInt32 IOMemoryCursor::genPhysicalSegments(IOMemoryDescriptor *inDescriptor,
...
IONaturalMemoryCursor::withSpecification(IOPhysicalLength inMaxSegmentSize,
  ...
  if (me && !me->initWithSpecification(inMaxSegmentSize, inMaxTransferSize,
                                       inAlignment)) {
    return nullptr;
  }
...
bool IONaturalMemoryCursor::initWithSpecification(
    IOPhysicalLength inMaxSegmentSize, IOPhysicalLength inMaxTransferSize,
    IOPhysicalLength inAlignment) {
  return super::initWithSpecification(&IONaturalMemoryCursor::outputSegment,
                                      inMaxSegmentSize, inMaxTransferSize,
                                      inAlignment);
}
...
OSDefineMetaClassAndStructors(IOBigMemoryCursor, IOMemoryCursor)
    ...
    void IOBigMemoryCursor::outputSegment(PhysicalSegment inSegment,
                                          void *inSegments,
...
bool IOBigMemoryCursor::initWithSpecification(
    IOPhysicalLength inMaxSegmentSize, IOPhysicalLength inMaxTransferSize,
    IOPhysicalLength inAlignment) {
...
OSDefineMetaClassAndStructors(IOLittleMemoryCursor, IOMemoryCursor)
    ...
    void IOLittleMemoryCursor::outputSegment(PhysicalSegment inSegment,
                                             void *inSegments,
                                             UInt32 inSegmentIndex) {
  IOPhysicalAddress *segment;
...
bool IOLittleMemoryCursor::initWithSpecification(
    IOPhysicalLength inMaxSegmentSize, IOPhysicalLength inMaxTransferSize,
    IOPhysicalLength inAlignment) {
