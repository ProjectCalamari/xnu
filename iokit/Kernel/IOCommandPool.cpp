...
OSSharedPtr<IOCommandPool> IOCommandPool::withWorkLoop(IOWorkLoop *inWorkLoop) {
...
bool IOCommandPool::initWithWorkLoop(IOWorkLoop *inWorkLoop) {
  assert(inWorkLoop);
...
OSSharedPtr<IOCommandPool> IOCommandPool::commandPool(IOService *inOwner,
...
bool IOCommandPool::init(IOService * /* inOwner */, IOWorkLoop *inWorkLoop,
                         UInt32 /* inSize */) {
...
OSSharedPtr<IOCommand> IOCommandPool::getCommand(bool blockForCommand) {
  ...
  result =
      fSerializer->runAction(func, (void *)&command, (void *)blockForCommand);
...
IOReturn IOCommandPool::gatedGetCommand(IOCommand **command,
  ...
  queue_remove_first(&fQueueHead, *command, IOCommand *, fCommandChain);
...
void IOCommandPool::returnCommand(IOCommand *command) {
  IOCommandGate::Action func = OSMemberFunctionCast(
...
IOReturn IOCommandPool::gatedReturnCommand(IOCommand *command) {
