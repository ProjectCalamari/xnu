...
OSSharedPtr<IOReportLegend> IOReportLegend::with(OSArray *legend) {
...
IOReturn IOReportLegend::initWith(OSArray *legend) {
  if (legend) {
...
void IOReportLegend::free(void) { super::free(); }

OSArray *IOReportLegend::getLegend(void) { return _reportLegend.get(); }

IOReturn IOReportLegend::addReporterLegend(IOService *reportingService,
                                           IOReporter *reporter,
...
IOReturn IOReportLegend::addLegendEntry(IOReportLegendEntry *legendEntry,
                                        const char *groupName,
                                        const char *subGroupName) {
...
IOReturn IOReportLegend::addReporterLegend(IOReporter *reporter,
                                           const char *groupName,
                                           const char *subGroupName) {
  IOReturn res = kIOReturnError;
...
IOReturn IOReportLegend::organizeLegend(IOReportLegendEntry *legendEntry,
