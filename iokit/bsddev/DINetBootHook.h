 ...
 *	Kernel API Cleanup
 *	Bug #: 2853781
 *	Changes from Josh(networking), Rick(IOKit), Jim & David(osfmk), Umesh,
 * Dan & Ramesh(BSD) Submitted by: Ramesh Reviewed by: Vincent
 *
 ...
 * set the rootdevice global variable dev_p	<-		combination of
 * major/minor node Comments:
 */
