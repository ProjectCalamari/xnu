...
#define kIOMaximumMappedIOByteCountKey                                         \
  "IOMaximumMappedIOByteCount" /* value is OSNumber */

// properties found in the console user dict
#define kIOConsoleSessionAuditIDKey                                            \
  "kCGSSessionAuditIDKey" /* value is OSNumber */

#define kIOConsoleSessionUserNameKey                                           \
  "kCGSSessionUserNameKey"                             /* value is OSString */
#define kIOConsoleSessionUIDKey "kCGSSessionUserIDKey" /* value is OSNumber */
#define kIOConsoleSessionConsoleSetKey                                         \
  "kCGSSessionConsoleSetKey" /* value is OSNumber */
#define kIOConsoleSessionOnConsoleKey                                          \
  "kCGSSessionOnConsoleKey" /* value is OSBoolean */
#define kIOConsoleSessionLoginDoneKey                                          \
  "kCGSessionLoginDoneKey" /* value is OSBoolean */
#define kIOConsoleSessionSecureInputPIDKey                                     \
  "kCGSSessionSecureInputPID" /* value is OSNumber */
#define kIOConsoleSessionScreenLockedTimeKey                                   \
  "CGSSessionScreenLockedTime" /* value is OSNumber, secs - 1970 */
#define kIOConsoleSessionScreenIsLockedKey                                     \
  "CGSSessionScreenIsLocked" /* value is OSBoolean */
...
#define kIOProgressColorThemeKey "IOProgressColorTheme" /* value is OSNumber   \
                                                         */
#define kIOBridgeBootSessionUUIDKey                                            \
  "bridge-boot-session-uuid" /* value is OSData   */
...
// some clients still need a stricter NVRAM commit contract. Please use this
// with care.
...
#define kIOPlatformSleepActionKey                                              \
  "IOPlatformSleepAction" /* value is OSNumber (priority) */
#define kIOPlatformWakeActionKey                                               \
  "IOPlatformWakeAction" /* value is OSNumber (priority) */
#define kIOPlatformQuiesceActionKey                                            \
  "IOPlatformQuiesceAction" /* value is OSNumber (priority) */
#define kIOPlatformActiveActionKey                                             \
  "IOPlatformActiveAction" /* value is OSNumber (priority) */
#define kIOPlatformHaltRestartActionKey                                        \
  "IOPlatformHaltRestartAction" /* value is OSNumber (priority) */
#define kIOPlatformPanicActionKey                                              \
  "IOPlatformPanicAction" /* value is OSNumber (priority) */

#define kIOPlatformFunctionHandlerSet "IOPlatformFunctionHandlerSet"

#define kIOPlatformFunctionHandlerMaxBusDelay                                  \
  "IOPlatformFunctionHandlerMaxBusDelay"
#define kIOPlatformMaxBusDelay "IOPlatformMaxBusDelay"

#if defined(__i386__) || defined(__x86_64__)

#define kIOPlatformFunctionHandlerMaxInterruptDelay                            \
  "IOPlatformFunctionHandlerMaxInterruptDelay"
...
#define kIOWaitQuietPanicsEntitlement                                          \
...
#define kIOMapSharedMemoryWritableEntitlement                                  \
...
#define kIODriverKitAllowsPublishEntitlementsKey                               \
  "com.apple.private.driverkit.allows-publish"
// Property is an array of strings containing entitlements, one of which needs
// to be present in the dext looking up the service with this property
...
#define kIOServiceLegacyMatchingRegistryIDKey                                  \
...
#define IONVRAMSystemVariableList                                              \
  "allow-root-hash-mismatch", "auto-boot", "auto-boot-halt-stage",             \
      "base-system-path", "boot-args", "boot-command", "boot-image",           \
      "bootdelay", "com.apple.System.boot-nonce", "darkboot", "emu",           \
      "one-time-boot-command", "policy-nonce-digests", "prevent-restores",     \
      "prev-lang:kbd", "root-live-fs", "sep-debug-args", "StartupMute",        \
      "SystemAudioVolume", "SystemAudioVolumeExtension",                       \
