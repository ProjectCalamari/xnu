...
enum PMLogEnum {
  ...
  kPMLogControllingDriverErr1,    //  5	0x05070014 - bad power state array
                                  //  version
  kPMLogControllingDriverErr2,    //  6	0x05070018 - power states already
                                  //  registered
  ...
  kPMLogAcknowledgeErr1,          // 10	0x05070028 - unknown entity called
                                  // acknowledgePowerChange
  kPMLogChildAcknowledge,         // 11	0x0507002c
  kPMLogDriverAcknowledge,        // 12	0x05070030 - interested driver
                                  // acknowledges
  kPMLogAcknowledgeErr2,          // 13	0x05070034 - object has already acked
  kPMLogAcknowledgeErr3,          // 14	0x05070038 - not expecting any acks
  kPMLogAcknowledgeErr4,          // 15	0x0507003c - not expecting
                                  // acknowledgeSetPowerState
  kPMLogDriverAcknowledgeSet,     // 16	0x05070040 - controlling driver
                                  // acknowledges
  ...
  kPMLogCtrlDriverTardy,          // 30	0x05070078 - controlling driver didn't
                                  // acknowledge
  kPMLogIntDriverTardy,           // 31	0x0507007c - interested driver didn't
                                  // acknowledge
  ...
  kPMLogRequestDenied, // 36	0x05070090 - parent denied domain state change
                       // request
