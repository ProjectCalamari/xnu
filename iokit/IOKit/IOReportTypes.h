...
enum { kIOReportCopyChannelData = 1, kIOReportTraceChannelData = 2 };
...
#define kIOReportScaleNano                                                     \
  ((-9LL + kIOReportExpZeroOffset) << kIOReportScaleSIShift)
#define kIOReportScaleMicro                                                    \
  ((-6LL + kIOReportExpZeroOffset) << kIOReportScaleSIShift)
#define kIOReportScaleMilli                                                    \
  ((-3LL + kIOReportExpZeroOffset) << kIOReportScaleSIShift)
...
#define kIOReportScaleBytes                                                    \
  ((3LL + kIOReportExpZeroOffset) << kIOReportScaleIECShift)
// (bytes have to be added to the exponents up front, can't just OR in)
#define kIOReportScaleKibi                                                     \
  ((10LL + kIOReportExpZeroOffset) << kIOReportScaleIECShift)
#define kIOReportScaleKiBytes                                                  \
  ((13LL + kIOReportExpZeroOffset) << kIOReportScaleIECShift)
#define kIOReportScaleMebi                                                     \
  ((20LL + kIOReportExpZeroOffset) << kIOReportScaleIECShift)
#define kIOReportScaleMiBytes                                                  \
  ((23LL + kIOReportExpZeroOffset) << kIOReportScaleIECShift)
#define kIOReportScaleGibi                                                     \
  ((30LL + kIOReportExpZeroOffset) << kIOReportScaleIECShift)
#define kIOReportScaleGiBytes                                                  \
  ((33LL + kIOReportExpZeroOffset) << kIOReportScaleIECShift)
#define kIOReportScaleTebi                                                     \
  ((40LL + kIOReportExpZeroOffset) << kIOReportScaleIECShift)
#define kIOReportScaleTiBytes                                                  \
  ((43LL + kIOReportExpZeroOffset) << kIOReportScaleIECShift)
...
#define kIOReportUnitNone                                                      \
  __IOR_MAKEUNIT(kIOReportQuantityUndefined, kIOReportScaleUnity)

#define kIOReportUnit_s                                                        \
  __IOR_MAKEUNIT(kIOReportQuantityTime, kIOReportScaleUnity)
#define kIOReportUnit_ms                                                       \
  __IOR_MAKEUNIT(kIOReportQuantityTime, kIOReportScaleMilli)
#define kIOReportUnit_us                                                       \
  __IOR_MAKEUNIT(kIOReportQuantityTime, kIOReportScaleMicro)
#define kIOReportUnit_ns                                                       \
  __IOR_MAKEUNIT(kIOReportQuantityTime, kIOReportScaleNano)

#define kIOReportUnit_J                                                        \
  __IOR_MAKEUNIT(kIOReportQuantityEnergy, kIOReportScaleUnity)
#define kIOReportUnit_mJ                                                       \
  __IOR_MAKEUNIT(kIOReportQuantityEnergy, kIOReportScaleMilli)
#define kIOReportUnit_uJ                                                       \
  __IOR_MAKEUNIT(kIOReportQuantityEnergy, kIOReportScaleMicro)
#define kIOReportUnit_nJ                                                       \
  __IOR_MAKEUNIT(kIOReportQuantityEnergy, kIOReportScaleNano)
#define kIOReportUnit_pJ                                                       \
  __IOR_MAKEUNIT(kIOReportQuantityEnergy, kIOReportScalePico)

#define kIOReportUnitHWTicks                                                   \
  __IOR_MAKEUNIT(kIOReportQuantityTime, kIOReportScaleMachHWTicks)
#define kIOReportUnit24MHzTicks                                                \
  __IOR_MAKEUNIT(kIOReportQuantityTime, kIOReportScale24MHz)
#define kIOReportUnit1GHzTicks                                                 \
  __IOR_MAKEUNIT(kIOReportQuantityTime, kIOReportScale1GHz)

#define kIOReportUnitBits                                                      \
  __IOR_MAKEUNIT(kIOReportQuantityData, kIOReportScaleBits)
#define kIOReportUnitBytes                                                     \
  __IOR_MAKEUNIT(kIOReportQuantityData, kIOReportScaleBytes)
#define kIOReportUnit_KiB                                                      \
  __IOR_MAKEUNIT(kIOReportQuantityData, kIOReportScaleKiBytes)
#define kIOReportUnit_MiB                                                      \
  __IOR_MAKEUNIT(kIOReportQuantityData, kIOReportScaleMiBytes)
#define kIOReportUnit_GiB                                                      \
  __IOR_MAKEUNIT(kIOReportQuantityData, kIOReportScaleGiBytes)
#define kIOReportUnit_TiB                                                      \
  __IOR_MAKEUNIT(kIOReportQuantityData, kIOReportScaleTiBytes)

#define kIOReportUnitEvents                                                    \
  __IOR_MAKEUNIT(kIOReportQuantityEventCount, kIOReportScaleUnity)

#define kIOReportUnitPackets                                                   \
  __IOR_MAKEUNIT(kIOReportQuantityPacketCount, kIOReportScaleUnity)

#define kIOReportUnitInstrs                                                    \
  __IOR_MAKEUNIT(kIOReportQuantityCPUInstrs, kIOReportScaleUnity)
#define kIOReportUnit_KI                                                       \
  __IOR_MAKEUNIT(kIOReportQuantityCPUInstrs, kIOReportScaleKilo)
#define kIOReportUnit_MI                                                       \
  __IOR_MAKEUNIT(kIOReportQuantityCPUInstrs, kIOReportScaleMega)
#define kIOReportUnit_GI                                                       \
  __IOR_MAKEUNIT(kIOReportQuantityCPUInstrs, kIOReportScaleGiga)
