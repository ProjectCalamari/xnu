...
public:
  ...
  virtual void enableVector(IOInterruptVectorNumber vectorNumber,
                            IOInterruptVector *vector);
  virtual void causeVector(IOInterruptVectorNumber vectorNumber,
                           IOInterruptVector *vector);
...
public:
  ...
  void timeStampInterruptHandlerStart(IOInterruptVectorNumber vectorNumber,
                                      IOInterruptVector *vector);
  void timeStampInterruptHandlerEnd(IOInterruptVectorNumber vectorNumber,
                                    IOInterruptVector *vector);

private:
  void timeStampInterruptHandlerInternal(bool isStart,
...
public:
  virtual IOReturn
  initInterruptController(IOInterruptController *parentController,
                          OSData *parentSource);
  ...
  virtual IOInterruptAction
  getInterruptHandlerAddress(void) APPLE_KEXT_OVERRIDE;
