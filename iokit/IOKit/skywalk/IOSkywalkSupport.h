...
IOSKMemoryArrayRef
IOSKMemoryArrayCreate(const IOSKMemoryRef refs[__counted_by(count)],
                      uint32_t count);
...
void IOSKMemoryMapDestroy(IOSK_CONSUMED IOSKMemoryMapRef reference);
...
void IOSKArenaDestroy(IOSK_CONSUMED IOSKArenaRef arena);
...
void IOSKRegionDestroy(IOSK_CONSUMED IOSKRegionRef region);
...
void IOSKMapperDestroy(IOSK_CONSUMED IOSKMapperRef mapper);
