...
static inline void IOTimeStampStartConstant(unsigned int csc, uintptr_t a = 0,
                                            uintptr_t b = 0, uintptr_t c = 0,
                                            uintptr_t d = 0) {
  (void)csc;
  (void)a;
  (void)b;
...
static inline void IOTimeStampEndConstant(uintptr_t csc, uintptr_t a = 0,
                                          uintptr_t b = 0, uintptr_t c = 0,
                                          uintptr_t d = 0) {
  (void)csc;
  (void)a;
...
static inline void IOTimeStampConstant(uintptr_t csc, uintptr_t a = 0,
                                       uintptr_t b = 0, uintptr_t c = 0,
                                       uintptr_t d = 0) {
  (void)csc;
  (void)a;
...
static inline void IOTimeStampConstantFiltered(uintptr_t csc, uintptr_t a = 0,
                                               uintptr_t b = 0, uintptr_t c = 0,
                                               uintptr_t d = 0) {
  (void)csc;
  (void)a;
  ...
  (void)c;
  (void)d;
  KERNEL_DEBUG_CONSTANT_FILTERED(((uint32_t)csc) | DBG_FUNC_NONE, a, b, c, d,
                                 0);
}
...
public:
  IOTimeStampIntervalConstantFiltered(unsigned int csc, uintptr_t arg1 = 0,
                                      uintptr_t arg2 = 0, uintptr_t arg3 = 0,
                                      uintptr_t arg4 = 0)
  ...
  void setEndCodes(uintptr_t arg1 = 0, uintptr_t arg2 = 0, uintptr_t arg3 = 0,
                   uintptr_t arg4 = 0) {
    _endArg1 = arg1;
    _endArg2 = arg2;
    _endArg3 = arg3;
  ...
  void setEndArg1(uintptr_t arg) { _endArg1 = arg; }
  void setEndArg2(uintptr_t arg) { _endArg2 = arg; }
  void setEndArg3(uintptr_t arg) { _endArg3 = arg; }
  void setEndArg4(uintptr_t arg) { _endArg4 = arg; }
  ~IOTimeStampIntervalConstantFiltered() {
    KDBG_FILTERED(((uint32_t)_csc) | DBG_FUNC_END, _endArg1, _endArg2, _endArg3,
                  _endArg4);
  }
...
#endif /* KDEBUG_LEVEL < KDEBUG_LEVEL_STANDARD */
      uintptr_t _endArg1,
      _endArg2, _endArg3, _endArg4;
};

#if KDEBUG

static inline void IOTimeStampStart(uintptr_t csc, uintptr_t a = 0,
                                    uintptr_t b = 0, uintptr_t c = 0,
                                    uintptr_t d = 0) {
  (void)csc;
  (void)a;
...
static inline void IOTimeStampEnd(uintptr_t csc, uintptr_t a = 0,
                                  uintptr_t b = 0, uintptr_t c = 0,
                                  uintptr_t d = 0) {
  (void)csc;
  (void)a;
...
static inline void IOTimeStamp(uintptr_t csc, uintptr_t a = 0, uintptr_t b = 0,
...
#define IODBG_PARALLELSCSI(code)                                               \
  (KDBG_CODE(DBG_IOKIT, DBG_IOPARALLELSCSI, code))
#define IODBG_SATA(code) (KDBG_CODE(DBG_IOKIT, DBG_IOSATA, code))
#define IODBG_SAS(code) (KDBG_CODE(DBG_IOKIT, DBG_IOSAS, code))
#define IODBG_FIBRECHANNEL(code)                                               \
  (KDBG_CODE(DBG_IOKIT, DBG_IOFIBRECHANNEL, code))
