...
typedef kern_return_t (*_libkernel_exc_raise_func_t)(mach_port_t, mach_port_t,
                                                     mach_port_t,
                                                     exception_type_t,
                                                     exception_data_t,
                                                     mach_msg_type_number_t);

typedef kern_return_t (*_libkernel_exc_raise_state_func_t)(
...
typedef kern_return_t (*_libkernel_exec_raise_state_identity_t)(
