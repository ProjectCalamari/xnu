...
static void do_compat(mach_error_t *org_err) {
...
static int err_sparse_mapit(int old, const struct error_sparse_map *map_table,
                            int mapcnt) {
...
__private_extern__ char *mach_error_string_int(mach_error_t err,
                                               boolean_t *diag) {
  const struct error_system *sys_p;
