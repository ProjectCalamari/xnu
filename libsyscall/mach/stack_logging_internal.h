...
#define stack_logging_type_vm_allocate                                         \
  16 // mach_vm_allocate, mmap, mach_vm_map, mach_vm_remap, etc
#define stack_logging_type_vm_deallocate 32 // mach_vm_deallocate or munmap
#define stack_logging_type_mapped_file_or_shared_mem                           \
  128 // a hint that the VM region *might* be a mapped file or shared memory
