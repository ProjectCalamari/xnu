...
int os_channel_event_get_next_event(
    const os_channel_event_handle_t event_handle,
...
int os_channel_event_get_event_data(const os_channel_event_t event,
  ...
  event_data->event_more = (kev->ev_flags & CHANNEL_EVENT_FLAG_MORE_EVENT) != 0;
