...
__attribute__((visibility("hidden"))) void *realloc(void *ptr, size_t size) {
...
__attribute__((visibility("hidden"))) void *reallocf(void *ptr, size_t size) {
...
__attribute__((visibility("hidden"))) void __bzero(void *s, size_t n) {
  return _libkernel_string_functions->bzero(s, n);
}

__attribute__((visibility("hidden"))) void *memchr(const void *s, int c,
                                                   size_t n) {
  return _libkernel_string_functions->memchr(s, c, n);
}

__attribute__((visibility("hidden"))) int memcmp(const void *s1, const void *s2,
                                                 size_t n) {
  return _libkernel_string_functions->memcmp(s1, s2, n);
}

__attribute__((visibility("hidden"))) void *memmove(void *dst, const void *src,
                                                    size_t n) {
...
__attribute__((visibility("hidden"))) void *memset(void *b, int c, size_t len) {
  return _libkernel_string_functions->memset(b, c, len);
}

__attribute__((visibility("hidden"))) char *strchr(const char *s, int c) {
  return _libkernel_string_functions->strchr(s, c);
}

__attribute__((visibility("hidden"))) char *index(const char *s, int c) {
  return _libkernel_string_functions->strchr(s, c);
}

__attribute__((visibility("hidden"))) int strcmp(const char *s1,
                                                 const char *s2) {
  return _libkernel_string_functions->strcmp(s1, s2);
}

__attribute__((visibility("hidden"))) char *strcpy(char *restrict dst,
                                                   const char *restrict src) {
  return _libkernel_string_functions->strcpy(dst, src);
}

__attribute__((visibility("hidden"))) size_t strlcat(char *restrict dst,
                                                     const char *restrict src,
                                                     size_t maxlen) {
  return _libkernel_string_functions->strlcat(dst, src, maxlen);
}

__attribute__((visibility("hidden"))) size_t strlcpy(char *restrict dst,
                                                     const char *restrict src,
                                                     size_t maxlen) {
  return _libkernel_string_functions->strlcpy(dst, src, maxlen);
}

__attribute__((visibility("hidden"))) size_t strlen(const char *str) {
  return _libkernel_string_functions->strlen(str);
}

__attribute__((visibility("hidden"))) int strncmp(const char *s1,
...
__attribute__((visibility("hidden"))) size_t strnlen(const char *s,
                                                     size_t maxlen) {
  return _libkernel_string_functions->strnlen(s, maxlen);
}

__attribute__((visibility("hidden"))) char *strstr(const char *s,
                                                   const char *find) {
...
mach_msg_size_t voucher_mach_msg_fill_aux(mach_msg_aux_header_t *aux_hdr,
                                          mach_msg_size_t sz) {
