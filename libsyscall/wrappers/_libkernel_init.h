...
typedef const struct _libkernel_functions {
  ...
  int (*LIBKERNEL_FUNCTION_PTRAUTH(pthread_current_stack_contains_np))(
      const void *, size_t);

  /* The following functions are included in version 5 of this structure */
  void *(*LIBKERNEL_FUNCTION_PTRAUTH(malloc_type_malloc))(size_t,
                                                          malloc_type_id_t);
  void (*LIBKERNEL_FUNCTION_PTRAUTH(malloc_type_free))(void *,
                                                       malloc_type_id_t);
  void *(*LIBKERNEL_FUNCTION_PTRAUTH(malloc_type_realloc))(void *, size_t,
                                                           malloc_type_id_t);
