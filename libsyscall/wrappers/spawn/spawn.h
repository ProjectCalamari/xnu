...
int posix_spawn(pid_t *__restrict, const char *__restrict,
    ...
    __API_AVAILABLE(macos(10.5), ios(2.0))
        __SPI_AVAILABLE(watchos(2.0), tvos(9.0), bridgeos(1.0));
...
int posix_spawn_file_actions_addchdir(posix_spawn_file_actions_t *,
    ...
    __API_AVAILABLE(macos(16.0))
        __SPI_AVAILABLE(ios(19.0), tvos(19.0), watchos(12.0), visionos(3.0),
                        bridgeos(10.0));
...
int posix_spawnattr_getbinpref_np(const posix_spawnattr_t *__restrict, size_t,
                                  cpu_type_t *__restrict, size_t *__restrict)
    __API_AVAILABLE(macos(10.5), ios(2.0))
        __SPI_AVAILABLE(watchos(2.0), tvos(9.0), bridgeos(1.0));

int posix_spawnattr_getarchpref_np(const posix_spawnattr_t *__restrict, size_t,
                                   cpu_type_t *__restrict,
                                   cpu_subtype_t *__restrict,
                                   size_t *__restrict)
    __API_AVAILABLE(macos(10.16), ios(14.0))
        __SPI_AVAILABLE(watchos(7.0), tvos(14.0), bridgeos(5.0));

int posix_spawnattr_setauditsessionport_np(posix_spawnattr_t *__restrict,
                                           mach_port_t)
    __API_AVAILABLE(macos(10.6), ios(3.2));

int posix_spawnattr_setbinpref_np(posix_spawnattr_t *__restrict, size_t,
                                  cpu_type_t *__restrict, size_t *__restrict)
    __API_AVAILABLE(macos(10.5), ios(2.0))
        __SPI_AVAILABLE(watchos(2.0), tvos(9.0), bridgeos(1.0));

int posix_spawnattr_setarchpref_np(posix_spawnattr_t *__restrict, size_t,
                                   cpu_type_t *__restrict,
                                   cpu_subtype_t *__restrict,
                                   size_t *__restrict)
    __API_AVAILABLE(macos(10.16), ios(14.0))
...
int posix_spawnattr_set_csm_np(const posix_spawnattr_t *__restrict attr,
                               uint32_t flags) __API_AVAILABLE(macos(10.16));
/*
...
int posix_spawn_file_actions_addchdir_np(posix_spawn_file_actions_t *,
                                         const char *__restrict)
    __API_DEPRECATED("posix_spawn_file_actions_addchdir(3) has replaced "
                     "posix_spawn_file_actions_addchdir_np(3)",
                     macos(10.15, 16.0))
        __SPI_DEPRECATED("posix_spawn_file_actions_addchdir(3) has replaced "
                         "posix_spawn_file_actions_addchdir_np(3)",
                         ios(13.0, 19.0), tvos(13.0, 19.0), watchos(6.0, 12.0),
                         visionos(1.0, 3.0), bridgeos(4.0, 10.0));

int posix_spawn_file_actions_addfchdir_np(posix_spawn_file_actions_t *, int)
    __API_DEPRECATED("posix_spawn_file_actions_addfchdir(3) has replaced "
                     "posix_spawn_file_actions_addfchdir_np(3)",
                     macos(10.15, 16.0))
        __SPI_DEPRECATED("posix_spawn_file_actions_addfchdir(3) has replaced "
                         "posix_spawn_file_actions_addfchdir_np(3)",
                         ios(13.0, 19.0), tvos(13.0, 19.0), watchos(6.0, 12.0),
                         visionos(1.0, 3.0), bridgeos(4.0, 10.0));
