...
void *kdebug_typefilter(void) {
  ...
  if (__builtin_expect(!typefilter, 0)) {
    ...
    if (__kdebug_typefilter(&ptr, &ptr_size) == 0) {
      void *old_value = NULL;
      if (ptr && !atomic_compare_exchange_strong(
                     (void *_Atomic volatile *)&typefilter, &old_value, ptr)) {
        mach_vm_deallocate(mach_task_self(), (mach_vm_offset_t)ptr,
...
bool kdebug_is_enabled(uint32_t debugid) {
...
uint64_t kdebug_timestamp_from_absolute(uint64_t abstime) {
...
uint64_t kdebug_timestamp_from_continuous(uint64_t conttime) {
  if (kdebug_using_continuous_time()) {
    return conttime;
  } else {
...
int kdebug_signpost(uint32_t code, uintptr_t arg1, uintptr_t arg2,
  ...
  return kdebug_signpost_internal(code << KDBG_CODE_OFFSET, arg1, arg2, arg3,
                                  arg4);
}

int kdebug_signpost_start(uint32_t code, uintptr_t arg1, uintptr_t arg2,
                          uintptr_t arg3, uintptr_t arg4) {
  return kdebug_signpost_internal((code << KDBG_CODE_OFFSET) | DBG_FUNC_START,
                                  arg1, arg2, arg3, arg4);
}

int kdebug_signpost_end(uint32_t code, uintptr_t arg1, uintptr_t arg2,
                        uintptr_t arg3, uintptr_t arg4) {
  return kdebug_signpost_internal((code << KDBG_CODE_OFFSET) | DBG_FUNC_END,
                                  arg1, arg2, arg3, arg4);
}
