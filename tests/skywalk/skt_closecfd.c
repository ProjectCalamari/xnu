...
static int skt_closecfd_main(int argc, char *argv[]) {
  int error;
  channel_t channel;
  uuid_t channel_uuid;
  int channelfd;
...
struct skywalk_test skt_closecfd = {
    "closecfd",
    "test closing guarded channel fd",
...
static int skt_writecfd_main(int argc, char *argv[]) {
  int error;
  ssize_t ret;
  channel_t channel;
  uuid_t channel_uuid;
...
static int skt_readcfd_main(int argc, char *argv[]) {
  int error;
  ssize_t ret;
  channel_t channel;
  uuid_t channel_uuid;
