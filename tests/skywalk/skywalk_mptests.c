...
#define BATS_TESTS                                                             \
  ...
  X(mpprotons, "test skywalk protocol namespace with two process doing "       \
  ...
  X(xferudpnsp, "UDP bi-directional transfer over native fake ethernet pair "  \
                "with split rx/tx pools")                                      \
  X(xferudpfcs, "UDP bi-directional transfer over fake ethernet pair with "    \
                "link frame check sequence")                                   \
  X(xferudptrailer,                                                            \
    "UDP bi-directional transfer over fake ethernet pair with link trailer")   \
  X(xferudpnfcs, "UDP bi-directional transfer over native fake ethernet pair " \
                 "with link frame check sequence")                             \
  X(xferudpntrailer, "UDP bi-directional transfer over native fake ethernet "  \
                     "pair with link trailer")                                 \
  X(xferudpoverwhelm,                                                          \
  ...
  X(xferudpoverwhelmnsp, "UDP bi-directional transfer over native fake "       \
                         "ethernet pair overwhelm with split rx/tx pools")     \
  ...
  X(xferudpwitherrors, "UDP bi-directional transfer over native fake "         \
                       "ethernet pair with injected errors")                   \
  X(xferudpwitherrorscompat, "UDP bi-directional transfer over compat fake "   \
                             "ethernet pair with injected errors")             \
  ...
  X(xferudppingn_wmm,                                                          \
    "UDP ping-pong over native fake ethernet pair in wmm mode")                \
  X(xferflowmatch,                                                             \
  ...
  X(xferudppingn_mb,                                                           \
    "UDP ping-pong over native fake ethernet pair with multi-buflet packet")   \
...
#define RDAR_133412076_FAILING_TESTS                                           \
  ...
  X(xferrxflowsteeringdroprxpackets,                                           \
