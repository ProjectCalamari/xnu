...
/*
 * I discovered a couple of issues with __os_nexus_flow_add, so here's some
 * tests
 */
...
int skt_fswbind_common(nexus_port_t nx_port1, nexus_port_t nx_port2,
                       bool use_port2) {
  ...
  T_LOG("before: nx_port %3d Flow %s %s addr %s port %d\n", nfr.nfr_nx_port,
        uuidstr, (nfr.nfr_ip_protocol == IPPROTO_TCP) ? "tcp" : "udp", buf,
...
struct skywalk_test skt_fswbindany = {
    "fswbindany",
    "attempts to bind to port -1 of flow switch",
...
struct skywalk_test skt_fswbind0 = {
    "fswbind0",
    "attempts to bind to port 0 of flow switch",
    SK_FEATURE_SKYWALK | SK_FEATURE_NEXUS_NETIF | SK_FEATURE_NEXUS_FLOWSWITCH,
    skt_fswbind0_main,
    {NULL},
    sktc_ifnet_feth0_create,
...
struct skywalk_test skt_fswbind512 = {
    "fswbind512",
    "attempts to bind to port 512 of flow switch",
    SK_FEATURE_SKYWALK | SK_FEATURE_NEXUS_NETIF | SK_FEATURE_NEXUS_FLOWSWITCH,
    skt_fswbind512_main,
    {NULL},
    sktc_ifnet_feth0_create,
...
struct skywalk_test skt_fswbind2 = {
    "fswbind2",
    "attempts to bind to port 2 of flow switch",
    SK_FEATURE_SKYWALK | SK_FEATURE_NEXUS_NETIF | SK_FEATURE_NEXUS_FLOWSWITCH |
        SK_FEATURE_NETNS,
    skt_fswbind2_main,
    {NULL},
...
struct skywalk_test skt_fswbind5 = {
    "fswbind5",
    "attempts to bind to port 5 of flow switch",
    SK_FEATURE_SKYWALK | SK_FEATURE_NEXUS_NETIF | SK_FEATURE_NEXUS_FLOWSWITCH |
        SK_FEATURE_NETNS,
    skt_fswbind5_main,
    {NULL},
...
struct skywalk_test skt_fswbind25 = {
    "fswbind25",
    "attempts to bind to port 2 and 5 of flow switch",
    SK_FEATURE_SKYWALK | SK_FEATURE_NEXUS_NETIF | SK_FEATURE_NEXUS_FLOWSWITCH |
        SK_FEATURE_NETNS,
    skt_fswbind25_main,
    {NULL},
