...
static int skt_badringtx_common(int argc, char *argv[], int method) {
  int error;
  channel_t channel;
  uuid_t channel_uuid;
  ...
  struct __user_channel_ring *cr =
      (struct __user_channel_ring *)ring->chrd_ring; // deconst
  ...
  *(slot_idx_t *)(uintptr_t)&cr->ring_tail = -1;
  ...
  case 0:
    ...
    assert(FD_ISSET(
        channelfd,
        &wfdset)); // XXX is it correct to return writable as well as error?
...
static int skt_badringrx_common(int argc, char *argv[], int method) {
  int error;
  channel_t channel;
  uuid_t channel_uuid;
  fd_set rfdset, wfdset, efdset;
...
static int skt_badringtl_main(int argc, char *argv[]) {
  return skt_badringtx_common(argc, argv, 0);
}

struct skywalk_test skt_badringtl = {
    "badringtl",
    "calls select with bad tx ring pointers",
...
static int skt_badringtp_main(int argc, char *argv[]) {
  return skt_badringtx_common(argc, argv, 1);
}

struct skywalk_test skt_badringtp = {
    "badringtp",
    "calls poll with bad tx ring pointers",
    SK_FEATURE_SKYWALK | SK_FEATURE_NEXUS_USER_PIPE,
    skt_badringtp_main,
    SKTC_GENERIC_UPIPE_ARGV,
    sktc_generic_upipe_null_init,
...
static int skt_badringtk_main(int argc, char *argv[]) {
  return skt_badringtx_common(argc, argv, 2);
}

struct skywalk_test skt_badringtk = {
    "badringtk",
    "calls kqueue with bad tx ring pointers",
    SK_FEATURE_SKYWALK | SK_FEATURE_NEXUS_USER_PIPE,
    skt_badringtk_main,
    SKTC_GENERIC_UPIPE_ARGV,
    sktc_generic_upipe_null_init,
...
static int skt_badringts_main(int argc, char *argv[]) {
  return skt_badringtx_common(argc, argv, 3);
}

struct skywalk_test skt_badringts = {
    "badringts",
    "calls sync with bad tx ring pointers",
    SK_FEATURE_SKYWALK | SK_FEATURE_NEXUS_USER_PIPE,
    skt_badringts_main,
    SKTC_GENERIC_UPIPE_ARGV,
    sktc_generic_upipe_null_init,
...
static int skt_badringrl_main(int argc, char *argv[]) {
  return skt_badringrx_common(argc, argv, 0);
}

struct skywalk_test skt_badringrl = {
    "badringrl",
    "calls select with bad rx ring pointers",
    SK_FEATURE_SKYWALK | SK_FEATURE_NEXUS_USER_PIPE,
    skt_badringrl_main,
    SKTC_GENERIC_UPIPE_ARGV,
    sktc_generic_upipe_null_init,
...
static int skt_badringrp_main(int argc, char *argv[]) {
  return skt_badringrx_common(argc, argv, 1);
}

struct skywalk_test skt_badringrp = {
    "badringrp",
    "calls poll with bad rx ring pointers",
    SK_FEATURE_SKYWALK | SK_FEATURE_NEXUS_USER_PIPE,
    skt_badringrp_main,
    SKTC_GENERIC_UPIPE_ARGV,
    sktc_generic_upipe_null_init,
...
static int skt_badringrk_main(int argc, char *argv[]) {
  return skt_badringrx_common(argc, argv, 2);
}

struct skywalk_test skt_badringrk = {
    "badringrk",
    "calls kqueue with bad rx ring pointers",
    SK_FEATURE_SKYWALK | SK_FEATURE_NEXUS_USER_PIPE,
    skt_badringrk_main,
    SKTC_GENERIC_UPIPE_ARGV,
    sktc_generic_upipe_null_init,
...
static int skt_badringrs_main(int argc, char *argv[]) {
  return skt_badringrx_common(argc, argv, 3);
}

struct skywalk_test skt_badringrs = {
    "badringrs",
    "calls sync with bad rx ring pointers",
    SK_FEATURE_SKYWALK | SK_FEATURE_NEXUS_USER_PIPE,
    skt_badringrs_main,
    SKTC_GENERIC_UPIPE_ARGV,
    sktc_generic_upipe_null_init,
