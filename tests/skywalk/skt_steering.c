...
static void fill_traffic_descriptor_eth(struct ifnet_traffic_descriptor_eth *td,
...
static int skt_steering_main(int argc, char *argv[]) {
  ...
  err = os_nexus_controller_add_traffic_rule(
      ctl, FETH0_NAME, (struct ifnet_traffic_descriptor_common *)&td,
  ...
  err = os_nexus_controller_add_traffic_rule(
      ctl, FETH0_NAME, (struct ifnet_traffic_descriptor_common *)&td_eth,
...
static void skt_steering_init(void) {
  ...
  sktc_ifnet_feth_pair_create(FETH_FLAGS_NATIVE | FETH_FLAGS_NXATTACH);
}

static void skt_steering_fini(void) {
