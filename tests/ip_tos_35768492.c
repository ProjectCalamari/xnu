...
static void my_sendmsg(int sock, int level, int type, char *data,
                       uint8_t tos_byte, tos_method_t method,
...
static void my_recvmsg(int sock, int level, int type, const char *expected_data,
...
#define BUF_SIZE 1024
  ...
  uint8_t tos_byte = 0;
  for (struct cmsghdr *cmsg = CMSG_FIRSTHDR(&msgvec); cmsg;
       cmsg = CMSG_NXTHDR(&msgvec, cmsg)) {
    if (cmsg->cmsg_level == level && cmsg->cmsg_len &&
        cmsg->cmsg_type == type) {
...
T_DECL(ip_tos, "IPv4 TOS") {
  ...
  my_sendmsg(client4, IPPROTO_IP, IP_TOS, "hello", 0xff, use_setsockopt,
             "IPv4 setsockopt 0xff");
  my_recvmsg(server4, IPPROTO_IP, IP_RECVTOS, "hello", 0xff,
             "IPv4 setsockopt 0xff");
  my_sendmsg(client4, IPPROTO_IP, IP_TOS, "hello", 0xd0, use_setsockopt,
             "IPv4 setsocktop 0xd0");
  my_recvmsg(server4, IPPROTO_IP, IP_RECVTOS, "hello", 0xd0,
             "IPv4 setsockopt 0xd0");
  my_sendmsg(client4, IPPROTO_IP, IP_TOS, "hello", 0xff, use_header,
             "IPv4 header 0xff");
  my_recvmsg(server4, IPPROTO_IP, IP_RECVTOS, "hello", 0xff,
             "IPv4 header 0xff");
  my_sendmsg(client4, IPPROTO_IP, IP_TOS, "hello", 0xd0, use_header,
             "IPv4 header 0xd0");
  my_recvmsg(server4, IPPROTO_IP, IP_RECVTOS, "hello", 0xd0,
             "IPv4 header 0xd0");
}
...
T_DECL(ip6_tclass, "IPv6 TCLASS") {
  ...
  my_sendmsg(client6, IPPROTO_IPV6, IPV6_TCLASS, "hello", 0xff, use_setsockopt,
             "IPv6 setsockopt 0xff");
  my_recvmsg(server6, IPPROTO_IPV6, IPV6_TCLASS, "hello", 0xff,
             "IPv6 setsockopt 0xff");
  my_sendmsg(client6, IPPROTO_IPV6, IPV6_TCLASS, "hello", 0xd0, use_setsockopt,
             "IPv6 setsockopt 0xd0");
  my_recvmsg(server6, IPPROTO_IPV6, IPV6_TCLASS, "hello", 0xd0,
             "IPv6 setsockopt 0xd0");
  my_sendmsg(client6, IPPROTO_IPV6, IPV6_TCLASS, "hello", 0xfe, use_header,
             "IPv6 header 0xff");
  my_recvmsg(server6, IPPROTO_IPV6, IPV6_TCLASS, "hello", 0xfe,
             "IPv6 header 0xff");
  my_sendmsg(client6, IPPROTO_IPV6, IPV6_TCLASS, "hello", 0xa0, use_header,
             "IPv6 header 0xd0");
  my_recvmsg(server6, IPPROTO_IPV6, IPV6_TCLASS, "hello", 0xa0,
             "IPv6 header 0xd0");

  my_sendmsg(client6, IPPROTO_IPV6, IPV6_TCLASS, "hello", 0x60,
             use_header_socket, "IPv6 header & socket 0x60");
  my_recvmsg(server6, IPPROTO_IPV6, IPV6_TCLASS, "hello", 0x60,
             "IPv6 header 0x60");
