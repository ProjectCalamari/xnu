...
static inline void raw_printf(const char *fmt, ...)
...
extern int64_t run_sysctl_test(const char *t, int64_t value, int argc,
                               char *const *argv);
