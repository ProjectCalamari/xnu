...
T_GLOBAL_META(T_META_NAMESPACE("xnu.perf"), T_META_CHECK_LEAKS(false),
              T_META_TAG_PERF);
...
T_DECL(posix_spawn_platform_binary_latency,
       "posix_spawn platform binary latency", T_META_TAG_VM_NOT_ELIGIBLE) {
  {
