...
T_DECL(kqueue_nesting_level, "rdar://100277117 (Reduce kqueue nesting level so "
                             "that we don't overflow kernel stack)") {
      ...
      .header =
          {
              ...
              .msgh_id = 0x88888888,
              .msgh_bits =
                  MACH_MSGH_BITS_SET(MACH_MSG_TYPE_MAKE_SEND_ONCE, 0, 0, 0),
          },
      .data = 0x8888888888888,
  };

  kr = mach_msg(&message.header, MACH_SEND_MSG, sizeof(message), 0,
