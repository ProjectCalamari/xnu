...
T_DECL(port_exhaustion_test_max_ports, "Allocate maximum ipc ports possible",
       T_META_IGNORECRASHES(".*port_exhaustion_client.*"),
  ...
  err = posix_spawn(&child_pid, child_args[0], NULL, &attrs, &child_args[0],
                    environ);
