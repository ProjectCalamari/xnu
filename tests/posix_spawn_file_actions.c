...
T_DECL(posix_spawn_file_actions_addchdir,
       "Check posix_spawn_file_actions_addchdir", T_META_ASROOT(true),
...
T_DECL(posix_spawn_file_actions_addchdir_errors,
...
T_DECL(posix_spawn_file_actions_addfchdir,
       "Check posix_spawn_file_actions_addfchdir", T_META_ASROOT(true),
       T_META_TAG_VM_PREFERRED) {
  posix_spawn_file_actions_t file_actions;
  int ret;
  int test_fd;
...
T_DECL(posix_spawn_file_actions_addfchdir_errors,
       "Check posix_spawn_file_actions_addfchdir errors", T_META_ASROOT(true),
       T_META_TAG_VM_PREFERRED) {
  posix_spawn_file_actions_t file_actions;
  int ret;
