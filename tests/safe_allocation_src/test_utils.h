...
struct malloc_allocator {
  ...
  static void *allocate_zero(size_t n) {
...
struct tracking_allocator {
  ...
  static void *allocate_zero(std::size_t n) {
...
struct tracking_trapping_policy {
  static void reset() { did_trap = false; }
...
template <typename T>
using test_safe_allocation =
    libkern::safe_allocation<T, malloc_allocator, assert_trapping_policy>;

template <typename T>
using tracked_safe_allocation =
    libkern::safe_allocation<T, tracking_allocator, assert_trapping_policy>;
