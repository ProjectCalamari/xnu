 ...
 * direntries_permissions direntries_permissions.c -g -Weverything */
...
T_DECL(direntries_permissions_no_write,
  ...
  snprintf(template, sizeof(template),
           "%s/direntries_permissions_no_write-XXXXXX", dt_tmpdir());
  ...
  T_EXPECT_POSIX_FAILURE(rename(dir1, dir2), EACCES,
                         "Renaming dir1 -> dir2. should fail with EACCES");
  T_EXPECT_POSIX_FAILURE(rename(dir2, dir1), EACCES,
                         "Renaming dir2 -> dir1. should fail with EACCES");
}
