...
T_DECL(memorystatus_convert_limit_bytes,
       "memorystatus_convert_limit_bytes default limit",
  ...
  T_QUIET;
  T_ASSERT_EQ(ret, max_task_pmem, "default limit is converted correctly");
}
...
T_DECL(memorystatus_set_task_limit_always_fatal,
  ...
  T_EXPECT_BITS_SET(mmprops.v1.memlimit_active_attr,
                    MEMORYSTATUS_MEMLIMIT_ATTR_FATAL,
                    "Active limit (task limit) should be fatal");
  T_EXPECT_BITS_SET(mmprops.v1.memlimit_inactive_attr,
                    MEMORYSTATUS_MEMLIMIT_ATTR_FATAL,
...
T_DECL(memorystatus_memlimit_gt_task_limit,
  ...
  T_EXPECT_EQ(mmprops.v1.memlimit_active, expected_memlimit,
              "Active limit can exceed task limit");
  T_EXPECT_EQ(mmprops.v1.memlimit_inactive, expected_memlimit,
              "Inactive limit can exceed task limit");
  T_EXPECT_BITS_NOTSET(mmprops.v1.memlimit_active_attr,
                       MEMORYSTATUS_MEMLIMIT_ATTR_FATAL,
                       "Active limit should be non-fatal");
  T_EXPECT_BITS_NOTSET(mmprops.v1.memlimit_inactive_attr,
                       MEMORYSTATUS_MEMLIMIT_ATTR_FATAL,
