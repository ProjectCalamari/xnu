 ...
 */
static void checker_perform_vm_inherit(checker_list_t *checker_list,
 ...
 */
static test_result_t successful_vm_inherit(checker_list_t *checker_list,
                                           mach_vm_address_t start,
                                           mach_vm_size_t size) {
  kern_return_t kr;
...
T_DECL(vm_inherit, "run vm_inherit with various vm configurations") {
  vm_tests_t tests = {
