...
T_GLOBAL_META(T_META_NAMESPACE("vm_page_size_overrides"));

static void verify_page_size(int expected_shift, int page_shift,
...
T_DECL(kernel_4k, "Can override vm_kernel_page_size",
  ...
  verify_page_size(12, vm_kernel_page_shift, vm_kernel_page_size,
                   vm_kernel_page_mask);
}

T_DECL(invalid, "Invalid overrides", T_META_ENVVAR("VM_KERNEL_PAGE_SIZE_4K=2"),
