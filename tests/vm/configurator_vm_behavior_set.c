...
static void write_one_memory(checker_list_t *checker_list,
...
static void write_memory(checker_list_t *checker_list, mach_vm_address_t start,
                         mach_vm_size_t size) {
  ...
  FOREACH_CHECKER(checker, limit) { write_one_memory(checker_list, checker); }
}

/* Test vm_behavior_set(behavior). This supports several behaviors. */
static test_result_t vm_behavior_common_no_cow(checker_list_t *checker_list,
  ...
  if (kr != expected_kr) {
    T_FAIL("mach_vm_behavior_set(%s) failed (%s)", name_for_behavior(behavior),
           name_for_kr(kr));
    return TestFailed;
  }
...
static test_result_t vm_behavior_no_cow_maybe_rw_maybe_holes(
    checker_list_t *checker_list, mach_vm_address_t start, mach_vm_size_t size,
    vm_behavior_t behavior, bool rw, bool has_holes) {
  test_result_t result;

  result =
      vm_behavior_common_no_cow(checker_list, start, size, behavior, has_holes);
  ...
  if (rw) {
    ...
    result = vm_behavior_common_no_cow(checker_list, start, size, behavior,
                                       has_holes);
    if (result != TestSucceeded) {
      return result;
    }
...
vm_behavior_default_no_cow_rw_no_holes(checker_list_t *checker_list,
                                       mach_vm_address_t start,
                                       mach_vm_size_t size) {
  return vm_behavior_no_cow_maybe_rw_maybe_holes(
      checker_list, start, size, VM_BEHAVIOR_DEFAULT, true /* rw */,
      false /* holes */);
}

static test_result_t
vm_behavior_default_no_cow_rw_with_holes(checker_list_t *checker_list,
                                         mach_vm_address_t start,
                                         mach_vm_size_t size) {
  return vm_behavior_no_cow_maybe_rw_maybe_holes(
      checker_list, start, size, VM_BEHAVIOR_DEFAULT, true /* rw */,
...
static test_result_t
vm_behavior_default_no_cow_ro_no_holes(checker_list_t *checker_list,
                                       mach_vm_address_t start,
                                       mach_vm_size_t size) {
  return vm_behavior_no_cow_maybe_rw_maybe_holes(
      checker_list, start, size, VM_BEHAVIOR_DEFAULT, false /* rw */,
      false /* holes */);
}

static test_result_t
vm_behavior_default_no_cow_ro_with_holes(checker_list_t *checker_list,
                                         mach_vm_address_t start,
                                         mach_vm_size_t size) {
  return vm_behavior_no_cow_maybe_rw_maybe_holes(
      checker_list, start, size, VM_BEHAVIOR_DEFAULT, false /* rw */,
...
static test_result_t
vm_behavior_free_no_cow_rw_no_holes(checker_list_t *checker_list,
                                    mach_vm_address_t start,
                                    mach_vm_size_t size) {
  return vm_behavior_no_cow_maybe_rw_maybe_holes(
      checker_list, start, size, VM_BEHAVIOR_FREE, true /* rw */,
      false /* holes */);
}

static test_result_t
vm_behavior_free_no_cow_rw_with_holes(checker_list_t *checker_list,
                                      mach_vm_address_t start,
                                      mach_vm_size_t size) {
  return vm_behavior_no_cow_maybe_rw_maybe_holes(
      checker_list, start, size, VM_BEHAVIOR_FREE, true /* rw */,
...
static test_result_t
vm_behavior_free_no_cow_ro_no_holes(checker_list_t *checker_list,
                                    mach_vm_address_t start,
                                    mach_vm_size_t size) {
  return vm_behavior_no_cow_maybe_rw_maybe_holes(
      checker_list, start, size, VM_BEHAVIOR_FREE, false /* rw */,
      false /* holes */);
}

static test_result_t
vm_behavior_free_no_cow_ro_with_holes(checker_list_t *checker_list,
                                      mach_vm_address_t start,
                                      mach_vm_size_t size) {
  return vm_behavior_no_cow_maybe_rw_maybe_holes(
      checker_list, start, size, VM_BEHAVIOR_FREE, false /* rw */,
...
static test_result_t
vm_behavior_can_reuse_no_cow_rw_no_holes(checker_list_t *checker_list,
                                         mach_vm_address_t start,
                                         mach_vm_size_t size) {
  return vm_behavior_no_cow_maybe_rw_maybe_holes(
      checker_list, start, size, VM_BEHAVIOR_CAN_REUSE, true /* rw */,
      false /* holes */);
}

static test_result_t
vm_behavior_can_reuse_no_cow_rw_with_holes(checker_list_t *checker_list,
                                           mach_vm_address_t start,
                                           mach_vm_size_t size) {
  return vm_behavior_no_cow_maybe_rw_maybe_holes(
      checker_list, start, size, VM_BEHAVIOR_CAN_REUSE, true /* rw */,
...
static test_result_t
vm_behavior_can_reuse_no_cow_ro_no_holes(checker_list_t *checker_list,
                                         mach_vm_address_t start,
                                         mach_vm_size_t size) {
  return vm_behavior_no_cow_maybe_rw_maybe_holes(
      checker_list, start, size, VM_BEHAVIOR_CAN_REUSE, false /* rw */,
      false /* holes */);
}

static test_result_t
vm_behavior_can_reuse_no_cow_ro_with_holes(checker_list_t *checker_list,
                                           mach_vm_address_t start,
                                           mach_vm_size_t size) {
  return vm_behavior_no_cow_maybe_rw_maybe_holes(
      checker_list, start, size, VM_BEHAVIOR_CAN_REUSE, false /* rw */,
...
static test_result_t vm_behavior_zero_once(checker_list_t *checker_list,
                                           mach_vm_address_t start,
                                           mach_vm_size_t size,
...
checker_update_done:
  ...
  if (kr != expected_kr) {
    T_EXPECT_MACH_ERROR(kr, expected_kr,
                        "mach_vm_behavior_set(VM_BEHAVIOR_ZERO)");
    return TestFailed;
  }

  TEMP_CSTRING(when, "after vm_behavior_set(VM_BEHAVIOR_ZERO) %s",
               message_suffix);
  return verify_vm_state(checker_list, when);
}

static test_result_t vm_behavior_zero(checker_list_t *checker_list,
                                      mach_vm_address_t start,
                                      mach_vm_size_t size) {
  test_result_t result;
