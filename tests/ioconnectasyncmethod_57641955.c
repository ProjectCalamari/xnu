...
T_DECL(ioconnectasyncmethod_referenceCnt,
  ...
  service = IOServiceGetMatchingService(
      kIOMasterPortDefault, IOServiceMatching(kAppleKeyStoreServiceName));
  if (service == IO_OBJECT_NULL) {
    T_SKIP("Service " kAppleKeyStoreServiceName
           " could not be opened. skipping test");
  }
  T_ASSERT_NE(service, MACH_PORT_NULL,
              "got " kAppleKeyStoreServiceName " service");
  ...
  T_ASSERT_MACH_ERROR(
      IOConnectCallAsyncMethod(
          conn, 0 /* selector */, wakePort, &reference, 0 /* referenceCnt */,
          NULL /* input */, 0 /* inputCnt */, NULL /* inputStruct */,
          0 /* inputStructCnt */, NULL /* output */, 0 /* outputCnt */,
          NULL /* outputStruct */, 0 /* outputStructCntP */),
