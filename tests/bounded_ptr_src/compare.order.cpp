...
template <typename T, typename U> static void check_lt(T t, U u) {
  _assert(t < u);
  _assert(t <= u);
  _assert(!(t >= u));
  _assert(!(t > u));
...
template <typename T, typename U> static void check_eq(T t, U u) {
  _assert(!(t < u));
  _assert(t <= u);
  _assert(t >= u);
  _assert(!(t > u));
...
template <typename T, typename TQual> static void tests() {
  ...
  {
    test_bounded_ptr<TQual> const a(array.begin(), array.begin(), array.end());
    test_bounded_ptr<TQual> const b(array.begin() + 1, array.begin(),
                                    array.end());
    check_lt(a, b);
  }
  {
    test_bounded_ptr<TQual> const a(array.begin(), array.begin(), array.end());
    test_bounded_ptr<TQual> const b(array.begin() + 2, array.begin(),
                                    array.end());
    check_lt(a, b);
  }
  {
  ...
  // Pointers with different bounds
  {
    ...
    test_bounded_ptr<TQual> const a(array.begin(), array.begin() + 2,
                                    array.end());
    test_bounded_ptr<TQual> const b(array.begin(), array.begin(), array.end());
    check_eq(a, b);
  }
  ...
  }
  {
    ...
    test_bounded_ptr<TQual> const a(array.begin(), array.begin(),
                                    array.begin() + 1);
    test_bounded_ptr<TQual> const b(array.begin(), array.begin() + 2,
                                    array.end());
    check_eq(a, b);
  }
  {
    ...
    test_bounded_ptr<TQual> const a(array.begin(), array.begin(),
                                    array.begin() + 1);
    test_bounded_ptr<TQual> const b(array.begin() + 3, array.begin() + 2,
                                    array.end());
    check_lt(a, b);
  }
  ...
  {
    libkern::bounded_ptr<TQual, dummy_policy1> const a(
        array.begin(), array.begin(), array.end());
    libkern::bounded_ptr<TQual, dummy_policy2> const b(
        array.begin(), array.begin(), array.end());
    check_eq(a, b);
  }
}
...
template <typename Related> static void tests_convert() {
  std::array<Derived, 5> array = {Derived{0}, Derived{1}, Derived{2},
                                  Derived{3}, Derived{4}};
  test_bounded_ptr<Derived> const a(array.begin(), array.begin(),
                                    array.end() - 1);
  test_bounded_ptr<Related> const b(array.begin(), array.begin(),
                                    array.end() - 1);
  check_eq(a, b);
}
