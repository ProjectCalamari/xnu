...
template <typename T, typename TQual> static void tests() {
  ...
  }
  {
    ...
    //   |        |                                       |
    // begin     a,b                                     end
    test_bounded_ptr<TQual> const a(array.begin() + 1, array.begin(),
                                    array.end());
  ...
  }
  {
    ...
    //   |                 |        |        |
    // begin               a       end       b
    test_bounded_ptr<TQual> const a(array.begin() + 2, array.begin(),
                                    array.begin() + 3);
  ...
  }
  {
    ...
    //   |                          |        |
    // begin                       end      a,b
    test_bounded_ptr<TQual> const a(array.end() - 1, array.begin(),
                                    array.end() - 2);
    TQual *b = array.end() - 1;
    check_eq(a, b);
  }
  {
    ...
    //   |                                   |            |
    // begin                                end          a,b
    test_bounded_ptr<TQual> const a(array.end(), array.begin(),
                                    array.end() - 1);
    TQual *b = array.end();
    check_eq(a, b);
  }
...
template <typename Related> static void tests_convert() {
  ...
  {
    test_bounded_ptr<Derived> const a(array.begin() + 1, array.begin(),
                                      array.end() - 1);
    Related *b = array.begin();
    check_lt(b, a);
  }
  {
    test_bounded_ptr<Related> const a(array.begin(), array.begin(),
                                      array.end() - 1);
