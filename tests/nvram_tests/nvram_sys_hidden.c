...
// xcrun -sdk macosx.internal make -C tests nvram_sys_hidden && sudo
// ./tests/build/sym/nvram_sys_hidden

// Test that reading of variables with SystemReadHidden bit set using
// entitlement should succeed
T_DECL(TestSysReadHidEntitled,
       "Test SystemReadHidden bit set variable with entitlement") {
