...
// xcrun -sdk macosx.internal make -C tests nvram_sys_hid_nonentitled && sudo
// ./tests/build/sym/nvram_sys_hid_nonentitled

// Test that reading of variables with SystemReadHidden bit set without
// entitlement should fail NOTE: Test wasn't added to nvram_nonentitled.c as it
// requires system entitlement to set the variable
