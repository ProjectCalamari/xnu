...
// xcrun -sdk iphoneos.internal make -C tests nvram_ve_mod && sudo
// ./tests/build/sym/nvram_ve_mod

// Test that writing, deleting and reseting of entitled variables with
// entitlement should succeed To reset nvram, call the test with -r argument:
...
// Test that writing, deleting and reseting of entitled system variables with
// entitlement should succeed To reset nvram, call the test with -r argument:
