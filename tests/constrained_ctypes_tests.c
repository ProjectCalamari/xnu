...
T_DECL(enacted_constrained_types_are_size_compatible_with_plain_types,
       "rdar://101223528") {
  T_ASSERT_EQ(sizeof(int_ref_t), sizeof(int *), NULL);
  T_ASSERT_EQ(sizeof(int_ref_ref_t), sizeof(int **), NULL);
}

T_DECL(enacted_constrained_types_are_assignable_from_plain_types,
       "rdar://101223528") {
  int s = 1;
...
T_DECL(enabled_constrained_types_are_size_compatible_with_plain_types,
       "rdar://101223528") {
  T_ASSERT_EQ(sizeof(int_ref_t), sizeof(int *), NULL);
  T_ASSERT_EQ(sizeof(int_ref_ref_t), sizeof(int **), NULL);
}
 ...
 * to the type constraints.
 */
T_DECL(enabled_constrained_types_are_assignable_from_plain_types,
       "rdar://101223528") {
  int s = 1;
  T_ASSERT_EQ(s, 1, NULL);
