...
/* <rdar://problem/28139044> EVFILT_USER doesn't properly support add&fire
 * atomic combination
 *
 * Chek that using EV_ADD and EV_TRIGGER on a EV_USER actually trigger the event
 * just added.
 *
 */

T_DECL(kqueue_add_and_trigger_evfilt_user,
  ...
  T_ASSERT_EQ(ret_kev.filter, EVFILT_USER,
