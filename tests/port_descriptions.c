...
static void expect_special_port_description(const char *(*fn)(int),
                                            mach_port_t port,
                                            const char *namestr) {
  ...
  if (desc) {
    T_QUIET;
    T_EXPECT_GT(strlen(desc), strlen(""),
...
#define TEST_HSP(portdef)                                                      \
  expect_special_port_description(mach_host_special_port_description, portdef, \
                                  #portdef)
...
#define TEST_TSP(portdef)                                                      \
  expect_special_port_description(mach_task_special_port_description, portdef, \
                                  #portdef)
...
static void expect_special_port_id(int (*fn)(const char *id), int port,
                                   const char *portid) {
...
T_DECL(host_special_port_mapping,
       ...
       T_META_TAG_VM_PREFERRED) {
#define TEST_HSP(portdef)                                                      \
  expect_special_port_id(mach_host_special_port_for_id, portdef, #portdef)
...
T_DECL(task_special_port_mapping,
       ...
       T_META_TAG_VM_PREFERRED) {
#define TEST_TSP(portdef)                                                      \
  expect_special_port_id(mach_task_special_port_for_id, portdef, #portdef)
...
T_DECL(thread_special_port_mapping,
       ...
       T_META_TAG_VM_PREFERRED) {
#define TEST_TSP(portdef)                                                      \
  expect_special_port_id(mach_thread_special_port_for_id, portdef, #portdef)
