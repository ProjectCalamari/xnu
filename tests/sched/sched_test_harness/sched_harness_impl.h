...
extern test_thread_t impl_create_thread(int th_sched_bucket,
...
extern bool impl_thread_avoid_processor(test_thread_t thread, int cpu_id,
                                        bool quantum_expiry);
...
extern int *impl_iterate_pset_search_order(int src_pset_id,
                                           uint64_t candidate_map,
                                           int sched_bucket);

/* Realtime */
extern void impl_set_thread_realtime(test_thread_t thread, uint32_t period,
