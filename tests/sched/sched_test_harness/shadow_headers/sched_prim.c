...
/*
 * This version of osfmk/kern/sched_prim.c contains the limited subset of
 * dependencies strictly required by the Clutch runqueue test harness in
 * tests/sched/sched_test_harness/sched_clutch_harness.c. The dependencies have
 * been copied here in order to isolate maintenance of the Clutch test harness
 * from the rest of xnu.
 */
