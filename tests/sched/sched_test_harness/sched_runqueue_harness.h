...
extern test_thread_t create_thread(int th_sched_bucket, struct thread_group *tg,
                                   int pri);
...
extern void enqueue_thread(test_runq_target_t runq_target,
                           test_thread_t thread);
extern void enqueue_threads(test_runq_target_t runq_target, int num_threads,
                            ...);
extern void enqueue_threads_arr(test_runq_target_t runq_target, int num_threads,
                                test_thread_t *threads);
extern void enqueue_threads_rand_order(test_runq_target_t runq_target,
                                       unsigned int random_seed,
                                       int num_threads, ...);
extern void enqueue_threads_arr_rand_order(test_runq_target_t runq_target,
                                           unsigned int random_seed,
                                           int num_threads,
                                           test_thread_t *threads);
extern bool dequeue_thread_expect(test_runq_target_t runq_target,
                                  test_thread_t expected_thread);
extern int dequeue_threads_expect_ordered(test_runq_target_t runq_target,
                                          int num_threads, ...);
extern int dequeue_threads_expect_ordered_arr(test_runq_target_t runq_target,
                                              int num_threads,
                                              test_thread_t *threads);
extern bool
cpu_dequeue_thread_expect_compare_current(int cpu_id,
                                          test_thread_t expected_thread);
extern bool cpu_check_preempt_current(int cpu_id, bool preemption_expected);
extern bool tracepoint_expect(uint64_t trace_code, uint64_t arg1, uint64_t arg2,
...
extern void set_thread_realtime(test_thread_t thread, uint32_t period,
