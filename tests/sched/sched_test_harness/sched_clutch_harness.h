...
extern void clutch_impl_set_thread_processor_bound(test_thread_t thread,
                                                   int cpu_id);
...
extern void clutch_impl_log_tracepoint(uint64_t trace_code, uint64_t a1,
                                       uint64_t a2, uint64_t a3, uint64_t a4);
extern void clutch_impl_pop_tracepoint(uint64_t *clutch_trace_code,
