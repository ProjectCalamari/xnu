...
extern void network_interface_create(network_interface_t if_p,
                                     const if_name_t name);

extern void network_interface_destroy(network_interface_t if_p);

extern network_interface_pair_list_t network_interface_pair_list_alloc(u_int n);
...
extern bool inet6_get_linklocal_address(unsigned int if_index,
...
extern int ifnet_set_flags(const char *ifname, uint16_t flags_set,
...
extern int siocdrvspec(const char *ifname, u_long op, void *arg, size_t argsize,
                       bool set);
...
extern u_int ethernet_udp4_frame_populate(
    void *buf, size_t buf_len, const ether_addr_t *src, struct in_addr src_ip,
    uint16_t src_port, const ether_addr_t *dst, struct in_addr dst_ip,
    uint16_t dst_port, const void *data, u_int data_len);

extern u_int ethernet_udp6_frame_populate(
    void *buf, size_t buf_len, const ether_addr_t *src, struct in6_addr *src_ip,
    uint16_t src_port, const ether_addr_t *dst, struct in6_addr *dst_ip,
    uint16_t dst_port, const void *data, u_int data_len);
