...
extern int fsw_vp_na_txsync(struct __kern_channel_ring *kring, struct proc *p,
                            uint32_t flags);
extern int fsw_vp_na_rxsync(struct __kern_channel_ring *kring, struct proc *p,
                            uint32_t flags);
...
extern int fsw_dev_input_netem_dequeue(void *handle,
                                       pktsched_pkt_t *__counted_by(n_pkts)
                                           pkts,
                                       uint32_t n_pkts);
...
extern void dp_flow_tx_process(struct nx_flowswitch *fsw, struct flow_entry *fe,
                               uint32_t flags);
extern void dp_flow_rx_process(struct nx_flowswitch *fsw, struct flow_entry *fe,
...
extern struct __kern_channel_ring *
...
extern struct fsw_ip_frag_mgr *fsw_ip_frag_mgr_create(struct nx_flowswitch *fsw,
                                                      struct ifnet *ifp,
                                                      size_t f_limit);
