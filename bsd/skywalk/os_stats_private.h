...
#define IP_STATS_TABLE(X)                                                      \
  ...
  X(IP_STATS_RCV_SWCSUM, "RcvSWCsumPkt",                                       \
    "\t\t%llu header checksummed in software")                                 \
  X(IP_STATS_RCV_SWCSUM_BYTES, "RcvSWCsumByte", " (%llu byte)\n")              \
  X(IP_STATS_TOOSMALL, "DataTooSmall",                                         \
    "\t\t%llu with size smaller than minimum\n")                               \
  X(IP_STATS_TOOSHORT, "PktTooShort",                                          \
    "\t\t%llu with data size < data length\n")                                 \
  X(IP_STATS_ADJ, "TotalAdj", "\t\t%llu with data size > data length\n")       \
  X(IP_STATS_ADJ_HWCSUM_CLR, "HWCsumDisc",                                     \
    "\t\t\t%llu packet forced to software checksum\n")                         \
  X(IP_STATS_TOOLONG, "TooLong",                                               \
    "\t\t%llu with ip length > max ip packet size\n")                          \
  X(IP_STATS_BADHLEN, "BadHdrLen",                                             \
  ...
  X(IP_STATS_FRAGDROPPED, "FragDrop",                                          \
  ...
  X(IP_STATS_NOTMEMBER, "UnRegGroup",                                          \
    "\t\t%llu packet received for unknown multicast group\n")                  \
  X(IP_STATS_REDIRECTSENT, "FwdSameNet", "\t\t%llu redirect sent\n")           \
  X(IP_STATS_RXC_COLLISIONS, "RxChnColl",                                      \
    "\t\t%llu input packet not chained due to collision\n")                    \
  X(IP_STATS_RXC_CHAINED, "RxChn",                                             \
    "\t\t%llu input packet processed in a chain\n")                            \
  X(IP_STATS_RXC_NOTCHAIN, "RxBypChn",                                         \
    "\t\t%llu input packet unable to chain\n")                                 \
  X(IP_STATS_RXC_CHAINSZ_GT2, "RxChnGT2",                                      \
    "\t\t%llu input packet chain processed with length greater than 2\n")      \
  X(IP_STATS_RXC_CHAINSZ_GT4, "RxChnGT4",                                      \
    "\t\t%llu input packet chain processed with length greater than 4\n")      \
                                                                               \
  /* Output stats */                                                           \
  X(IP_STATS_LOCALOUT, "LocalOut", "\t%llu packet sent from this host\n")      \
  X(IP_STATS_RAWOUT, "RawPktOut",                                              \
    "\t\t%llu packet sent with fabricated ip header\n")                        \
  X(IP_STATS_ODROPPED, "DropNoBuf",                                            \
    "\t\t%llu output packet dropped due to no bufs, etc.\n")                   \
  X(IP_STATS_NOROUTE, "NoRoute",                                               \
    "\t\t%llu output packet discarded due to no route\n")                      \
  X(IP_STATS_FRAGMENTED, "Fragmented",                                         \
    "\t\t%llu output datagram fragmented\n")                                   \
  X(IP_STATS_OFRAGMENTS, "OutFraged", "\t\t%llu fragment created\n")           \
  X(IP_STATS_CANTFRAG, "CantFrag",                                             \
    "\t\t%llu datagram that can't be fragmented\n")                            \
  X(IP_STATS_NOGIF, "NoGif",                                                   \
    "\t\t%llu tunneling packet that can't find gif\n")                         \
  X(IP_STATS_BADADDR, "BadAddr",                                               \
    "\t\t%llu datagram with bad address in header\n")                          \
  X(IP_STATS_PKTDROPCNTRL, "DropNoCtl",                                        \
    "\t\t%llu packet dropped due to no bufs for control data\n")               \
  X(IP_STATS_SND_SWCSUM, "SndSWCsumPkt",                                       \
    "\t\t%llu header checksummed in software")                                 \
  X(IP_STATS_SND_SWCSUM_BYTES, "SndSWCsumByte", " (%llu byte)\n")              \
  X(IP_STATS_RXC_NOTLIST, "IPInPkt",                                           \
    "\t\t%llu input packet did not go through list processing path\n")         \
...
#define IP6_STATS_TABLE(X)                                                     \
  ...
  X(IP6_STATS_TOOSMALL, "DataTooSmall",                                        \
    "\t\t%llu with size smaller than minimum\n")                               \
  X(IP6_STATS_TOOSHORT, "PktTooShort",                                         \
    "\t\t%llu with data size < data length\n")                                 \
  X(IP6_STATS_ADJ, "TotalAdj", "\t\t%llu with data size > data length\n")      \
  X(IP6_STATS_ADJ_HWCSUM_CLR, "HWCsumDisc",                                    \
    "\t\t\t%llu packet forced to software checksum\n")                         \
  ...
  X(IP6_STATS_FRAGDROPPED, "FragDrop",                                         \
    "\t\t\t%llu dropped (dup or out of space)\n")                              \
  ...
  X(IP6_STATS_ATMFRAG_RCVD, "RAtomicFrag",                                     \
    "\t\t\t%llu atomic fragments received\n")                                  \
  ...
  X(IP6_STATS_NOTMEMBER, "NoMCGrp",                                            \
    "\t\t%llu multicast packet which we don't join\n")                         \
  X(IP6_STATS_EXTHDRTOOLONG, "ExtHdrNotCont",                                  \
    "\t\t\t%llu packet whose headers are not continuous\n")                    \
  X(IP6_STATS_NOGIF, "NoGif",                                                  \
    "\t\t%llu tunneling packet that can't find gif\n")                         \
  X(IP6_STATS_TOOMANYHDR, "TooManyHdr",                                        \
    "\t\t%llu packet discarded due to too may headers\n")                      \
  X(IP6_STATS_FORWARD_CACHEHIT, "FwdCacheHit", "\t\t%llu forward cache hit\n") \
  X(IP6_STATS_FORWARD_CACHEMISS, "FwdCacheMiss",                               \
    "\t\t%llu forward cache miss\n")                                           \
  X(IP6_STATS_PKTDROPCNTRL, "DropNoCtl",                                       \
    "\t\t%llu packet dropped due to no bufs for control data\n")               \
  /* Output stats */                                                           \
  X(IP6_STATS_LOCALOUT, "LocalOut", "\t%llu packet sent from this host\n")     \
  X(IP6_STATS_RAWOUT, "RawPktOut",                                             \
    "\t\t%llu packet sent with fabricated ip header\n")                        \
  X(IP6_STATS_ODROPPED, "DropNoBuf",                                           \
    "\t\t%llu output packet dropped due to no bufs, etc.\n")                   \
  X(IP6_STATS_NOROUTE, "NoRoute",                                              \
    "\t\t%llu output packet discarded due to no route\n")                      \
  X(IP6_STATS_FRAGMENTED, "Fragmented",                                        \
    "\t\t%llu output datagram fragmented\n")                                   \
  X(IP6_STATS_OFRAGMENTS, "OutFraged", "\t\t%llu fragment created\n")          \
  X(IP6_STATS_CANTFRAG, "CantFrag",                                            \
    "\t\t%llu datagram that can't be fragmented\n")                            \
  X(IP6_STATS_BADSCOPE, "BadScope",                                            \
    "\t\t%llu packet that violated scope rules\n")                             \
  X(IP6_STATS_SOURCES_NONE, "AddrSelFail",                                     \
    "\t\t%llu failure of source address selection\n")                          \
  X(IP6_STATS_DAD_COLLIDE, "DADColl",                                          \
    "\t\t%llu duplicate address detection collision\n")                        \
  X(IP6_STATS_DAD_LOOPCOUNT, "DADLoop",                                        \
    "\t\t%llu duplicate address detection NS loop\n")                          \
  X(IP6_STATS_SOURCES_SKIP6_EXPENSIVE_SECONDARY_IF, "Ign2ndIf",                \
    "\t\t%llu time ignored source on secondary expensive I/F\n")               \
...
#define TCP_STATS_TABLE(X)                                                     \
  ...
  X(TCP_STATS_FCHOLDPACKET, "FlowCtlWh",                                       \
    "\t\t%llu data packet sent after flow control\n")                          \
  X(TCP_STATS_SYNCHALLENGE, "SYNChallenge",                                    \
    "\t\t%llu challenge ACK sent due to unexpected SYN\n")                     \
  X(TCP_STATS_RSTCHALLENGE, "RSTChallenge",                                    \
  ...
  X(TCP_STATS_SND6_SWCSUM, "SndSWCsumPkt6",                                    \
    "\t\t%llu checksummed in software")                                        \
  ...
  X(TCP_STATS_RCVMEMDROP, "RcvMemDrop",                                        \
    "\t\t%llu received packet dropped due to low memory\n")                    \
  X(TCP_STATS_RCVPARTDUPPACK, "RcvDupData",                                    \
  ...
  X(TCP_STATS_RCVPACKAFTERWIN, "RcvAftWinPkt",                                 \
  ...
  X(TCP_STATS_RCVAFTERCLOSE, "RcvAftCloPkt",                                   \
    "\t\t%llu packet received after close\n")                                  \
  X(TCP_STATS_BADRST, "BadRST", "\t\t%llu bad reset\n")                        \
  X(TCP_STATS_RCVBADSUM, "RcvBadCsum",                                         \
  ...
  X(TCP_STATS_CACHEDRTT, "RTTCacheUpd",                                        \
    "\t\t%llu connection updated cached RTT on close\n")                       \
  X(TCP_STATS_CACHEDRTTVAR, "RTTVarCacheUpd",                                  \
    "\t\t%llu connection updated cached RTT variance on close\n")              \
  X(TCP_STATS_CACHEDSSTHRESH, "SSTholdCacheUpd",                               \
    "\t\t%llu connection updated cached ssthresh on close\n")                  \
  ...
  X(TCP_STATS_KEEPDROPS, "KADrop",                                             \
    "\t\t%llu connection dropped by keepalive\n")                              \
  X(TCP_STATS_PREDACK, "PredAck", "\t%llu correct ACK header prediction\n")    \
  X(TCP_STATS_PREDDAT, "PredData",                                             \
    "\t%llu correct data packet header prediction\n")                          \
  X(TCP_STATS_PCBCACHEMISS, "Pcb$Miss", "\t%llu times pcb cahce miss")         \
                                                                               \
  /* SACK/RACK related stats */                                                \
  X(TCP_STATS_SACK_RECOVERY_EPISODE, "SACKRecEpi",                             \
    "\t%llu SACK recovery episode\n")                                          \
  X(TCP_STATS_SACK_REXMITS, "SACKReXmt",                                       \
    "\t%llu segment rexmit in SACK recovery episodes\n")                       \
  X(TCP_STATS_SACK_REXMIT_BYTES, "SACKReXmtB",                                 \
    "\t%llu byte rexmit in SACK recovery episodes\n")                          \
  X(TCP_STATS_SACK_RCV_BLOCKS, "SACKRcvBlk",                                   \
    "\t%llu SACK option (SACK blocks) received\n")                             \
  X(TCP_STATS_SACK_SEND_BLOCKS, "SACKSntBlk",                                  \
    "\t%llu SACK option (SACK blocks) sent\n")                                 \
  X(TCP_STATS_SACK_SBOVERFLOW, "SACKSndBlkOF",                                 \
    "\t%llu SACK scoreboard overflow\n")                                       \
  X(TCP_STATS_RACK_REXMITS, "RACKReXmt",                                       \
    "\t%llu segment rexmit in RACK recovery episodes\n")                       \
  X(TCP_STATS_RACK_RECOVERY_EPISODE, "RACKRecEpi",                             \
    "\t%llu RACK recovery episode\n")                                          \
  X(TCP_STATS_RACK_REORDERING_TIMEOUT_RECOVERY_EPISODE,                        \
    "RACKReorderTimeoutRecEpi",                                                \
    "\t%llu RACK recovery episode due to reordering timeout\n")                \
                                                                               \
  /* LRO related stats */                                                      \
  X(TCP_STATS_COALESCED_PACK, "CoalPkt", "\t%llu LRO coalesced packet\n")      \
  X(TCP_STATS_FLOWTBL_FULL, "FlowTblFull",                                     \
    "\t\t%llu time LRO flow table was full\n")                                 \
  X(TCP_STATS_FLOWTBL_COLLISION, "FlowTblColl",                                \
    "\t\t%llu collision in LRO flow table\n")                                  \
  X(TCP_STATS_LRO_TWOPACK, "LRO2Pkt",                                          \
    "\t\t%llu time LRO coalesced 2 packets\n")                                 \
  X(TCP_STATS_LRO_MULTPACK, "LROMultiPkt",                                     \
    "\t\t%llu time LRO coalesced 3 or 4 packets\n")                            \
  X(TCP_STATS_LRO_LARGEPACK, "LROLargePkt",                                    \
    "\t\t%llu time LRO coalesced 5 or more packets\n")                         \
                                                                               \
  X(TCP_STATS_LIMITED_TXT, "LimitedXmt", "\t%llu limited transmit done\n")     \
  X(TCP_STATS_EARLY_REXMT, "EarlyReXmt", "\t%llu early retransmit done\n")     \
  X(TCP_STATS_SACK_ACKADV, "SACKAdvAck",                                       \
    "\t%llu time cumulative ack advanced along with SACK\n")                   \
  X(TCP_STATS_PTO, "ProbTO", "\t%llu probe timeout\n")                         \
  X(TCP_STATS_RTO_AFTER_PTO, "RTOAfProb",                                      \
    "\t\t%llu time retransmit timeout triggered after probe\n")                \
  X(TCP_STATS_PROBE_IF, "ProbeIF",                                             \
    "\t\t%llu time probe packets were sent for an interface\n")                \
  X(TCP_STATS_PROBE_IF_CONFLICT, "ProbeIFConfl",                               \
    "\t\t%llu time couldn't send probe packets for an interface\n")            \
  X(TCP_STATS_TLP_RECOVERY, "TLPFastRecvr",                                    \
    "\t\t%llu time fast recovery after tail loss\n")                           \
  X(TCP_STATS_TLP_RECOVERLASTPKT, "TLPRecvrLPkt",                              \
    "\t\t%llu time recovered last packet \n")                                  \
  X(TCP_STATS_PTO_IN_RECOVERY, "PTOInRecvr",                                   \
    "\t\t%llu SACK based rescue retransmit\n")                                 \
                                                                               \
  /* ECN related stats */                                                      \
  X(TCP_STATS_ECN_CLIENT_SETUP, "ECNCliSetup",                                 \
    "\t%llu client connection attempted to negotiate ECN\n")                   \
  X(TCP_STATS_ECN_CLIENT_SUCCESS, "ECNNegoSucc",                               \
    "\t\t%llu client connection successfully negotiated ECN\n")                \
  X(TCP_STATS_ECN_NOT_SUPPORTED, "ECNSvrNoSupt",                               \
    "\t\t%llu time graceful fallback to Non-ECN connection\n")                 \
  X(TCP_STATS_ECN_LOST_SYN, "ECNLOSSSYN",                                      \
    "\t\t%llu time lost ECN negotiating SYN, followed by retransmission\n")    \
  X(TCP_STATS_ECN_SERVER_SETUP, "ECNSvrSetup",                                 \
    "\t\t%llu server connection attempted to negotiate ECN\n")                 \
  X(TCP_STATS_ECN_SERVER_SUCCESS, "ECNSvrSucc",                                \
    "\t\t%llu server connection successfully negotiate ECN\n")                 \
  X(TCP_STATS_ECN_ACE_SYN_NOT_ECT, "ACESynNotECT",                             \
    "\t\t%llu received AccECN SYN packet with Not-ECT\n")                      \
  X(TCP_STATS_ECN_ACE_SYN_ECT1, "ACESynECT1",                                  \
    "\t\t%llu received AccECN SYN packet with ECT1\n")                         \
  X(TCP_STATS_ECN_ACE_SYN_ECT0, "ACESynECT0",                                  \
    "\t\t%llu received AccECN SYN packet with ECT0\n")                         \
  X(TCP_STATS_ECN_ACE_SYN_CE, "ACESynCE",                                      \
    "\t\t%llu received AccECN SYN packet with CE\n")                           \
  X(TCP_STATS_ECN_LOST_SYNACK, "ECNLossSYNACK",                                \
    "\t\t%llu time lost ECN negotiating SYN-ACK, followed by "                 \
    "retransmission\n")                                                        \
  X(TCP_STATS_ECN_RECV_CE, "ECNRcv",                                           \
    "\t\t%llu time received congestion experienced (CE) notification\n")       \
  X(TCP_STATS_ECN_RECV_ECE, "ECNRcvECE",                                       \
    "\t\t%llu time CWR was sent in response to ECE\n")                         \
  X(TCP_STATS_ECN_SENT_ECE, "ECNSndECE",                                       \
    "\t\t%llu time sent ECE notification\n")                                   \
  X(TCP_STATS_ECN_ACE_RECV_CE, "ACERcvECE",                                    \
    "\t\t%llu CE count received in ACE field\n")                               \
  X(TCP_STATS_ECN_CONN_RECV_CE, "ECNConnRcvCE",                                \
    "\t\t%llu connection received CE atleast once\n")                          \
  X(TCP_STATS_ECN_CONN_RECV_ECE, "ECNConnRcvECE",                              \
    "\t\t%llu connection received ECE atleast once\n")                         \
  X(TCP_STATS_ECN_CONN_PLNOCE, "ECNConnPLNoCE",                                \
    "\t\t%llu connection using ECN have seen packet loss but no CE\n")         \
  X(TCP_STATS_ECN_CONN_PL_CE, "ECNConnPLCE",                                   \
    "\t\t%llu connection using ECN have seen packet loss and CE\n")            \
  X(TCP_STATS_ECN_CONN_NOPL_CE, "ECNConnNoPLCE",                               \
    "\t\t%llu connection using ECN received CE but no packet loss\n")          \
  X(TCP_STATS_ECN_FALLBACK_SYNLOSS, "ECNFbSYNLoss",                            \
    "\t\t%llu connection fell back to non-ECN due to SYN-loss\n")              \
  X(TCP_STATS_ECN_FALLBACK_REORDER, "ECNFbReOrd",                              \
    "\t\t%llu connection fell back to non-ECN due to reordering\n")            \
  X(TCP_STATS_ECN_FALLBACK_CE, "ECNFbCE",                                      \
    "\t\t%llu connection fell back to non-ECN due to excessive CE-markings\n") \
  X(TCP_STATS_ECN_FALLBACK_DROPRST, "ECNFbDrpRST",                             \
    "\t\t%llu ECN fallback caused by connection drop due to RST\n")            \
  X(TCP_STATS_ECN_FALLBACK_DROPRXMT, "ECNFbDrpReXmt",                          \
    "\t\t%llu ECN fallback due to drop after multiple retransmits\n")          \
  X(TCP_STATS_DETECT_REORDERING, "ReOrdDetect",                                \
    "\t%llu time packet reordering was detected on a connection\n")            \
  X(TCP_STATS_REORDERED_PKTS, "ReOrdPkt",                                      \
    "\t\t%llu time transmitted packets were reordered\n")                      \
  X(TCP_STATS_DELAY_RECOVERY, "DlyFastRecvr",                                  \
    "\t\t%llu time fast recovery was delayed to handle reordering\n")          \
  X(TCP_STATS_AVOID_RXMT, "AvoidReXmt",                                        \
    "\t\t%llu time retransmission was avoided by delaying recovery\n")         \
  X(TCP_STATS_UNNECESSARY_RXMT, "UnNeedReXmt",                                 \
    "\t\t%llu retransmission not needed\n")                                    \
                                                                               \
  /* DSACK related statistics */                                               \
  X(TCP_STATS_DSACK_SENT, "DSACKSnd", "\t%llu time DSACK option was sent\n")   \
  X(TCP_STATS_DSACK_RECVD, "DSACKRcv",                                         \
    "\t\t%llu time DSACK option was received\n")                               \
  X(TCP_STATS_DSACK_DISABLE, "DSACKDisable",                                   \
    "\t\t%llu time DSACK was disabled on a connection\n")                      \
  X(TCP_STATS_DSACK_BADREXMT, "DSACKBadReXmt",                                 \
    "\t\t%llu time recovered from bad retransmission using DSACK\n")           \
  X(TCP_STATS_DSACK_ACKLOSS, "DSACKAckLoss",                                   \
    "\t\t%llu time ignored DSACK due to ack loss\n")                           \
  X(TCP_STATS_DSACK_RECVD_OLD, "DSACKRcvOld",                                  \
    "\t\t%llu time ignored old DSACK options\n")                               \
  X(TCP_STATS_PMTUDBH_REVERTED, "PMTUDBHRevert",                               \
    "\t%llu time PMTU Blackhole detection, size reverted\n")                   \
  X(TCP_STATS_DROP_AFTER_SLEEP, "DropAPSleep",                                 \
    "\t%llu connection were dropped after long sleep\n")                       \
                                                                               \
  /* TFO-related statistics */                                                 \
  X(TCP_STATS_TFO_COOKIE_SENT, "TFOCkSnd",                                     \
    "\t%llu time a TFO-cookie has been announced\n")                           \
  X(TCP_STATS_TFO_SYN_DATA_RCV, "TFOSYNDataRcv",                               \
    "\t%llu SYN with data and a valid TFO-cookie have been received\n")        \
  X(TCP_STATS_TFO_COOKIE_REQ_RCV, "TFOCkReqRcv",                               \
    "\t%llu SYN with TFO-cookie-request received\n")                           \
  X(TCP_STATS_TFO_COOKIE_INVALID, "TFOCkInv",                                  \
    "\t%llu time an invalid TFO-cookie has been received\n")                   \
  X(TCP_STATS_TFO_COOKIE_REQ, "TFOCkReq",                                      \
    "\t%llu time we requested a TFO-cookie\n")                                 \
  X(TCP_STATS_TFO_COOKIE_RCV, "TFOCkRcv",                                      \
    "\t\t%llu time the peer announced a TFO-cookie\n")                         \
  X(TCP_STATS_TFO_SYN_DATA_SENT, "TFOSYNDataSnd",                              \
    "\t%llu time we combined SYN with data and a TFO-cookie\n")                \
  X(TCP_STATS_TFO_SYN_DATA_ACKED, "TDOSYNDataAck",                             \
    "\t\t%llu time our SYN with data has been acknowledged\n")                 \
  X(TCP_STATS_TFO_SYN_LOSS, "TFOSYNLoss",                                      \
    "\t%llu time a connection-attempt with TFO fell back to regular TCP\n")    \
  X(TCP_STATS_TFO_BLACKHOLE, "TFOBlackhole",                                   \
    "\t%llu time a TFO-connection blackhole'd\n")                              \
  X(TCP_STATS_TFO_COOKIE_WRONG, "TFOCkWrong",                                  \
    "\t%llu time TFO-cookie we sent was wrong\n")                              \
  X(TCP_STATS_TFO_NO_COOKIE_RCV, "TFONoCkRcv",                                 \
    "\t%llu time ee asked for a cookie but didn't get one\n")                  \
  X(TCP_STATS_TFO_HEURISTICS_DISABLE, "TFOHeuDisable",                         \
    "\t%llu time TFO got disabled due to heuristics\n")                        \
  X(TCP_STATS_TFO_SNDBLACKHOLE, "TFOSndBH",                                    \
    "\t%llu time TFO got blackholed in the sending direction\n")               \
  X(TCP_STATS_MSS_TO_DEFAULT, "MSSToDefault",                                  \
    "\t%llu time maximum segment size was changed to default\n")               \
  X(TCP_STATS_MSS_TO_MEDIUM, "MSSToMedium",                                    \
    "\t%llu time maximum segment size was changed to medium\n")                \
  X(TCP_STATS_MSS_TO_LOW, "MSSToLow",                                          \
    "\t%llu time maximum segment size was changed to low\n")                   \
                                                                               \
  /* TCP timer statistics */                                                   \
  X(TCP_STATS_TIMER_DRIFT_LE_1_MS, "TmrDriftLE1Ms",                            \
    "\t%llu timer drift less or equal to 1 ms\n")                              \
  X(TCP_STATS_TIMER_DRIFT_LE_10_MS, "TmrDriftLE10Ms",                          \
    "\t%llu timer drift less or equal to 10 ms\n")                             \
  X(TCP_STATS_TIMER_DRIFT_LE_20_MS, "TmrDriftLE20Ms",                          \
    "\t%llu timer drift less or equal to 20 ms\n")                             \
  X(TCP_STATS_TIMER_DRIFT_LE_50_MS, "TmrDriftLE50Ms",                          \
    "\t%llu timer drift less or equal to 50 ms\n")                             \
  X(TCP_STATS_TIMER_DRIFT_LE_100_MS, "TmrDriftLE100Ms",                        \
    "\t%llu timer drift less or equal to 100 ms\n")                            \
  X(TCP_STATS_TIMER_DRIFT_LE_200_MS, "TmrDriftLE200Ms",                        \
    "\t%llu timer drift less or equal to 200 ms\n")                            \
  X(TCP_STATS_TIMER_DRIFT_LE_500_MS, "TmrDriftLE500Ms",                        \
    "\t%llu timer drift less or equal to 500 ms\n")                            \
  X(TCP_STATS_TIMER_DRIFT_LE_1000_MS, "TmrDriftLE1000Ms",                      \
    "\t%llu timer drift less or equal to 1000 ms\n")                           \
  X(TCP_STATS_TIMER_DRIFT_GT_1000_MS, "TmrDriftGT1000Ms",                      \
    "\t%llu timer drift greater than 1000 ms\n")                               \
  X(TCP_STATS_USEDRTT, "RTTUsed", "\t%llu times RTT initialized from route\n") \
  X(TCP_STATS_USEDRTTVAR, "RTTVarUsed",                                        \
    "\t%llu times RTTVAR initialized from rt\n")                               \
  X(TCP_STATS_USEDSSTHRESH, "SSTholdUsed",                                     \
    "\t%llu times ssthresh initialized from rt\n")                             \
  X(TCP_STATS_MINMSSDROPS, "MinMssDrop",                                       \
    "\t%llu average minmss too low drops\n")                                   \
  X(TCP_STATS_SNDREXMITBAD, "BadReXmt",                                        \
    "\t%llu unnecessary packet retransmissions\n")                             \
                                                                               \
  /* SYN Cache relaetd stats */                                                \
  X(TCP_STATS_SC_ADDED, "SCAdded", "\t%llu entry added to syncache\n")         \
  X(TCP_STATS_SC_RETRANSMITTED, "SCReXmt",                                     \
    "\t%llu syncache entry was retransmitted\n")                               \
  X(TCP_STATS_SC_DUPSYN, "SCDupSYN", "\t%llu duplicate SYN packet\n")          \
  X(TCP_STATS_SC_DROPPED, "SCDrop", "\t%llu could not reply to packet\n")      \
  X(TCP_STATS_SC_COMPLETED, "SCCompl",                                         \
    "\t%llu successful extraction of entry\n")                                 \
  X(TCP_STATS_SC_BUCKETOVERFLOW, "SCBktOF",                                    \
    "\t%llu syncache per-bucket limit hit\n")                                  \
  ...
  X(TCP_STATS_HC_BUCKETOVERFLOW, "HCBktOF",                                    \
    "\t%llu hostcache per bucket limit hit\n")                                 \
                                                                               \
  /* Misc. */                                                                  \
  X(TCP_STATS_BG_RCVTOTAL, "RcvBkgrdPkt",                                      \
    "\t%llu total background packets received\n")                              \
  X(TCP_STATS_MSG_UNOPKTS, "MsgUnOrdPkt",                                      \
    "\t%llu unordered packet on TCP msg stream\n")                             \
  X(TCP_STATS_MSG_UNOAPPENDFAIL, "MsgUnOrdFail",                               \
    "\t%llu failed to append unordered pkt\n")                                 \
  X(TCP_STATS_MSG_SNDWAITHIPRI, "MsgSndW8HPrio",                               \
    "\t%llu send waiting for high priority data\n")                            \
                                                                               \
  /* MPTCP Related stats */                                                    \
  ...
  X(TCP_STATS_INVALID_MPCAP, "InvMPCap",                                       \
    "\t%llu packet with an invalid MPCAP option\n")                            \
  X(TCP_STATS_INVALID_JOINS, "InvMPJoin",                                      \
    "\t%llu packet with an invalid MPJOIN option\n")                           \
  X(TCP_STATS_MPCAP_FALLBACK, "MPCapFail",                                     \
    "\t%llu time primary subflow fell back to TCP\n")                          \
  X(TCP_STATS_JOIN_FALLBACK, "MPJoinFallBk",                                   \
    "\t%llu time secondary subflow fell back to TCP\n")                        \
  X(TCP_STATS_ESTAB_FALLBACK, "EstFallBk", "\t%llu DSS option drop\n")         \
  X(TCP_STATS_INVALID_OPT, "InvOpt", "\t%llu other invalid MPTCP option\n")    \
  X(TCP_STATS_MP_REDUCEDWIN, "MPReducedWin",                                   \
    "\t%llu time the MPTCP subflow window was reduced\n")                      \
  X(TCP_STATS_MP_BADCSUM, "MPBadCSum", "\t%llu bad DSS checksum\n")            \
  X(TCP_STATS_MP_OODATA, "MPOOData",                                           \
    "\t%llu time received out of order data\n")                                \
  X(TCP_STATS_MP_OUTOFWIN, "MPOutOfWin",                                       \
    "\t%llu Packet lies outside the shared recv window\n")                     \
  ...
  /* ToDo - to be removed */                                                   \
  X(TCP_STATS_NOSTRETCHACK, "NoStrechAck",                                     \
    "\t%llu disabled stretch ack algorithm on a connection\n")                 \
  ...
  X(TCP_STATS_MP_SEL_SYMTOMSD, "MPSelSymp",                                    \
    "\t%llu subflow switch due to advisory\n")                                 \
  ...
  X(TCP_STATS_MP_VERDOWNGRADE, "MPVerDowngrd",                                 \
    "\t%llu times MPTCP version downgrade\n")                                  \
                                                                               \
...
#define UDP_STATS_TABLE(X)                                                     \
  ...
  X(UDP_STATS_RCV6_SWCSUM_BYTES, "RcvSWCsumBytes",                             \
    " (%llu bytes) over IPv6\n")                                               \
  X(UDP_STATS_NOPORT, "NoPort", "\t\t%llu dropped due to no socket\n")         \
  X(UDP_STATS_NOPORTBCAST, "NoPortBCast",                                      \
    "\t\t%llu broadcast/multicast datagram undelivered\n")                     \
  X(UDP_STATS_FILTERMCAST, "FilterMCast",                                      \
    "\t\t%llu time multicast source filter matched\n")                         \
  X(UDP_STATS_FULLSOCK, "FullSock",                                            \
    "\t\t%llu dropped due to full socket buffers\n")                           \
  X(UDP_STATS_PCBCACHEMISS, "PCBCacheMiss", "\t\t%llu not for hashed pcb\n")   \
  X(UDP_STATS_PCBHASHMISS, "PCBHashMiss",                                      \
    "\t\t%llu input packets not for hashed pcb")                               \
                                                                               \
  /* Output stats */                                                           \
  ...
  X(UDP_STATS_SND6_SWCSUM_BYTES, "SndSWCsumBytes6",                            \
    " (%llu bytes) over IPv6\n")                                               \
  X(UDP_STATS_FASTOUT, "SndFastPath",                                          \
    "\t\t%llu output packets on fast path\n")                                  \
  X(UDP_STATS_NOPORTMCAST, "SndNoPortMCast",                                   \
    "\t\t%llu output no socket on port, multicast\n")                          \
                                                                               \
...
#define QUIC_STATS_TABLE(X)                                                    \
  ...
  /* Tx Stream */                                                              \
  X(QUIC_STATS_SNDSTREAMFRAME, "SndStreamFrame",                               \
    "\t\tSTREAM\n\t\t\t%llu stream frames sent")                               \
  X(QUIC_STATS_SNDSTREAMBYTE, "SndStreamByte", " (%llu bytes)\n")              \
  X(QUIC_STATS_SNDSTREAMRESET, "SndStreamReset",                               \
    "\t\t\t%llu RESET_STREAM frames sent\n")                                   \
  X(QUIC_STATS_SNDSTOPSENDING, "SndStopSending",                               \
    "\t\t\t%llu STOP_SENDING frames sent\n")                                   \
  X(QUIC_STATS_SNDSTREAMBLKFRAME, "SndStreamBlockedFrame",                     \
    "\t\t\t%llu STREAM_BLOCKED frames sent\n")                                 \
  X(QUIC_STATS_SNDSTMDATABLKFRAME, "SndStreamDataBlocked",                     \
    "\t\t\t%llu STREAM_DATA_BLOCKED frames sent\n")                            \
  /* Tx CRYPTO */                                                              \
  X(QUIC_STATS_SNDINITCRYPTOFRAME, "SndInitCryptoFrame",                       \
    "\t\tCRYPTO\n\t\t\t%llu initial CRYPTO frames sent")                       \
  X(QUIC_STATS_SNDINITCRYPTOBYTE, "SndInitCryptoByte", " (%llu bytes)\n")      \
  X(QUIC_STATS_SNDHDSHKCRYPTOFRAME, "SndHdShkCryptoFrame",                     \
    "\t\t\t%llu handshake CRYPTO frames sent")                                 \
  X(QUIC_STATS_SNDHDSHKCRYPTOBYTE, "SndHdShkCryptoByte", " (%llu bytes)\n")    \
  X(QUIC_STATS_SND1RTTCRYPTOFRAME, "Snd1RttCryptoFrame",                       \
    "\t\t\t%llu 1-RTT CRYPTO frames sent")                                     \
  X(QUIC_STATS_SND1RTTCRYPTOBYTE, "Snd1RttCryptoByte", " (%llu bytes)\n")      \
  X(QUIC_STATS_SND0RTTCRYPTOFRAME, "Snd1RttCryptoFrame",                       \
    "\t\t\t%llu 0-RTT CRYPTO frames sent")                                     \
  X(QUIC_STATS_SND0RTTCRYPTOBYTE, "Snd1RttCryptoByte", " (%llu bytes)\n")      \
  X(QUIC_STATS_SNDCRYPTOREXMTFRAME, "SndReXmtCryptoFrame",                     \
    "\t\t\t%llu CRYPTO frames retransmitted")                                  \
  X(QUIC_STATS_SNDCRYPTOREXMTBYTE, "SndReXmtCryptoByte", " (%llu bytes)\n")    \
  X(QUIC_STATS_SNDDATABLKFRAME, "SndDataBlockedFrame",                         \
    "\t\t%llu DATA_BLOCKED frames sent\n")                                     \
  ...
  /* Rx Stream */                                                              \
  X(QUIC_STATS_RCVSTREAMFRAME, "RcvStreamFrame",                               \
    "\t\tSTREAM\n\t\t\t%llu stream frames received")                           \
  X(QUIC_STATS_RCVSTREAMBYTE, "RcvStreamByte", " (%llu bytes)\n")              \
  X(QUIC_STATS_RCVSTREAMRESET, "RcvStreamReset",                               \
    "\t\t\t%llu RESET_STREAM frames received\n")                               \
  X(QUIC_STATS_RCVSTOPSENDING, "RcvStopSending",                               \
    "\t\t\t%llu STOP_SENDING frames received\n")                               \
  X(QUIC_STATS_RCVSTREAMBLKFRAME, "RcvStreamBlockedFrame",                     \
    "\t\t\t%llu STREAM_BLOCKED frames received\n")                             \
  X(QUIC_STATS_RCVSTMDATABLKFRAME, "RcvStreamDataBlocked",                     \
    "\t\t\t%llu STREAM_DATA_BLOCKED frames received\n")                        \
  /* Rx CRYPTO */                                                              \
  X(QUIC_STATS_RCVINITCRYPTOFRAME, "RcvInitCryptoFrame",                       \
    "\t\tCRYPTO\n\t\t\t%llu initial CRYPTO frames received")                   \
  X(QUIC_STATS_RCVINITCRYPTOBYTE, "RcvInitCryptoByte", " (%llu bytes)\n")      \
  X(QUIC_STATS_RCVHDSHKCRYPTOFRAME, "RcvHdShkCryptoFrame",                     \
    "\t\t\t%llu handshake CRYPTO frames received")                             \
  X(QUIC_STATS_RCVHDSHKCRYPTOBYTE, "RcvHdShkCryptoByte", " (%llu bytes)\n")    \
  X(QUIC_STATS_RCV1RTTCRYPTOFRAME, "Rcv1RttCryptoFrame",                       \
    "\t\t\t%llu 1-RTT CRYPTO frames received")                                 \
  X(QUIC_STATS_RCV1RTTCRYPTOBYTE, "Rcv1RttCryptoByte", " (%llu bytes)\n")      \
  X(QUIC_STATS_RCV0RTTCRYPTOFRAME, "Rcv0RttCryptoFrame",                       \
    "\t\t\t%llu 0-RTT CRYPTO frames received")                                 \
  X(QUIC_STATS_RCV0RTTCRYPTOBYTE, "Rcv0RttCryptoByte", " (%llu bytes)\n")      \
  X(QUIC_STATS_RCVDATABLKFRAME, "RcvDataBlockedFrame",                         \
    "\t\t%llu DATA_BLOCKED frames received\n")                                 \
  X(QUIC_STATS_RCVREORDERPKT, "RcvReorderedPkt",                               \
    "\t\t%llu packets received reordered")                                     \
  ...
  X(QUIC_STATS_SNDCCRINTERROR, "SndCCRInternalError",                          \
    "\t\t\t%llu INTERNAL_ERROR sent\n")                                        \
  X(QUIC_STATS_SNDCCRSVRBUSY, "SndCCRSererBusy",                               \
    "\t\t\t%llu SERVER_BUSY sent\n")                                           \
  X(QUIC_STATS_SNDCCRFLOWCTLERR, "SndCCRFlowCtl",                              \
    "\t\t\t%llu FLOW_CONTROL_ERROR sent\n")                                    \
  X(QUIC_STATS_SNDCCRSTREAMLIMIT, "SndCCRStreamLimit",                         \
    "\t\t\t%llu STREAM_LIMIT_ERROR sent\n")                                    \
  X(QUIC_STATS_SNDCCRSTREAMSTATE, "SndCCRStreamState",                         \
    "\t\t\t%llu STREAM_STATE_ERROR sent\n")                                    \
  X(QUIC_STATS_SNDCCRFINALOFFSET, "SndCCRFinalOffset",                         \
    "\t\t\t%llu FINAL_SIZE_ERROR sent\n")                                      \
  X(QUIC_STATS_SNDCCRFRAMEENCODING, "SndCCRFrameEncoding",                     \
    "\t\t\t%llu FRAME_ENCODING_ERROR sent\n")                                  \
  X(QUIC_STATS_SNDCCRTRNASPARAMS, "SndCCRTransportParams",                     \
    "\t\t\t%llu TRANSPORT_PARAMETER_ERROR sent\n")                             \
  X(QUIC_STATS_SNDCCRVERSIONNEGO, "SndCCRVersionNego",                         \
    "\t\t\t%llu VERSION_NEGOTIATION_ERROR sent\n")                             \
  X(QUIC_STATS_SNDCCRPROTOVIOLATION, "SndCCRProtoViolation",                   \
    "\t\t\t%llu PROTOCOL_VIOLATION sent\n")                                    \
  X(QUIC_STATS_SNDCCRINVALMIGRATION, "SndCCRInvalMigration",                   \
    "\t\t\t%llu INVALID_MIGRATION sent\n")                                     \
  X(QUIC_STATS_SNDCCRCRYPTO, "SndCCRCryptoError",                              \
    "\t\t\t%llu CRYPTO_ERROR sent\n")                                          \
  X(QUIC_STATS_RCVCCR, "RcvCCR",                                               \
    "\t\t%llu connection close reasons received\n")                            \
  X(QUIC_STATS_RCVCCRINTERROR, "RcvCCRInternalError",                          \
    "\t\t\t%llu INTERNAL_ERROR received\n")                                    \
  X(QUIC_STATS_RCVCCRSVRBUSY, "RcvCCRSererBusy",                               \
    "\t\t\t%llu SERVER_BUSY received\n")                                       \
  X(QUIC_STATS_RCVCCRFLOWCTLERR, "RcvCCRFlowCtl",                              \
    "\t\t\t%llu FLOW_CONTROL_ERROR received\n")                                \
  X(QUIC_STATS_RCVCCRSTREAMLIMIT, "RcvCCRStreamLimit",                         \
    "\t\t\t%llu STREAM_LIMIT_ERROR received\n")                                \
  X(QUIC_STATS_RCVCCRSTREAMSTATE, "RcvCCRStreamState",                         \
    "\t\t\t%llu STREAM_STATE_ERROR received\n")                                \
  X(QUIC_STATS_RCVCCRFINALOFFSET, "RcvCCRFinalOffset",                         \
    "\t\t\t%llu FINAL_SIZE_ERROR received\n")                                  \
  X(QUIC_STATS_RCVCCRFRAMEENCODING, "RcvCCRFrameEncoding",                     \
    "\t\t\t%llu FRAME_ENCODING_ERROR received\n")                              \
  X(QUIC_STATS_RCVCCRTRNASPARAMS, "RcvCCRTransportParams",                     \
    "\t\t\t%llu TRANSPORT_PARAMETER_ERROR received\n")                         \
  X(QUIC_STATS_RCVCCRVERSIONNEGO, "RcvCCRVersionNego",                         \
    "\t\t\t%llu VERSION_NEGOTIATION_ERROR received\n")                         \
  X(QUIC_STATS_RCVCCRPROTOVIOLATION, "RcvCCRProtoViolation",                   \
    "\t\t\t%llu PROTOCOL_VIOLATION received\n")                                \
  X(QUIC_STATS_RCVCCRINVALMIGRATION, "RcvCCRInvalMigration",                   \
    "\t\t\t%llu INVALID_MIGRATION received\n")                                 \
  X(QUIC_STATS_RCVCCRCRYPTO, "RcvCCRCryptoError",                              \
    "\t\t\t%llu CRYPTO_ERROR received\n")                                      \
  ...
  X(QUIC_STATS_KEEPALIVETTIMEOUT, "KeepAliveTimeOut",                          \
    "\t%llu keepalive timeout\n")                                              \
...
#define NETIF_STATS_TABLE(X)                                                   \
  ...
  X(NETIF_STATS_RX_IRQ_MIT, "RxIRQMIT",                                        \
    "\t\t\t%llu interrupt mitigation thread wakeup\n")                         \
  X(NETIF_STATS_RX_IRQ_BUSY, "RxIRQBusy",                                      \
    "\t\t\t%llu interrupt notify return busy\n")                               \
  X(NETIF_STATS_RX_IRQ_AGAIN, "RxIRQAgain",                                    \
    "\t\t\t%llu interrupt notify return retry again\n")                        \
  X(NETIF_STATS_RX_IRQ_ERR, "RxIRQErr",                                        \
    "\t\t\t%llu interrupt notify return error\n")                              \
  ...
  X(NETIF_STATS_RX_COPY_ATTACH, "RxCopyAttach",                                \
    "\t\t%llu copy by attaching mbuf under pkt\n")                             \
  ...
  X(NETIF_STATS_TX_IRQ_MIT, "TxIRQMIT",                                        \
    "\t\t\t%llu interrupt mitigation thread wakeup\n")                         \
  X(NETIF_STATS_TX_IRQ_BUSY, "TxIRQBusy",                                      \
    "\t\t\t%llu interrupt notify return busy\n")                               \
  X(NETIF_STATS_TX_IRQ_AGAIN, "TxIRQAgain",                                    \
    "\t\t\t%llu interrupt notify return retry again\n")                        \
  X(NETIF_STATS_TX_IRQ_ERR, "TxIRQErr",                                        \
    "\t\t\t%llu interrupt notify return error\n")                              \
  ...
  X(NETIF_STATS_TX_DROP_ENQ_AQM, "TxDropEnqueueAQM",                           \
    "\t\t%llu dropped due to AQM enqueue failure\n")                           \
  X(NETIF_STATS_GSO_SEG, "GSOSegments", "\t\t%llu GSO segments created\n")     \
  X(NETIF_STATS_GSO_PKT, "GSOPackets", "\t\t%llu GSO packets \n")              \
  X(NETIF_STATS_GSO_PKT_DROP_NOMEM, "GSODropNoMem",                            \
    "\t\t%llu GSO packet dropped due to allocation failure\n")                 \
  X(NETIF_STATS_GSO_PKT_DROP_NA_INACTIVE, "GSODropNaInactive",                 \
    "\t\t%llu GSO packet dropped due to inactive netif\n")                     \
  X(NETIF_STATS_GSO_PKT_DROP_BADLEN, "GSODropBadLen",                          \
    "\t\t%llu GSO packet dropped due to bad packet length\n")                  \
  X(NETIF_STATS_GSO_PKT_DROP_NONTCP, "GSODropNonTcp",                          \
    "\t\t%llu GSO packet dropped as it is not a TCP packet\n")                 \
                                                                               \
  X(NETIF_STATS_DROP, "Drop", "\t%llu dropped\n")                              \
  X(NETIF_STATS_DROP_NOMEM_BUF, "DropNoMemBuf",                                \
    "\t\t%llu dropped due to packet alloc failure\n")                          \
  X(NETIF_STATS_DROP_NOMEM_PKT, "DropNoMemPkt",                                \
    "\t\t%llu dropped due to buflet alloc failure\n")                          \
  X(NETIF_STATS_DROP_NOMEM_MBUF, "DropNoMemMbuf",                              \
    "\t\t%llu dropped due to mbuf alloc failure\n")                            \
  X(NETIF_STATS_DROP_BADLEN, "DropBadLen",                                     \
    "\t\t%llu dropped due to bad packet length\n")                             \
  X(NETIF_STATS_DROP_NA_INACTIVE, "DropNaInactive",                            \
    "\t\t%llu dropped due to dst na inactive\n")                               \
  X(NETIF_STATS_DROP_KRDROP_MODE, "DropKrDropMode",                            \
    "\t\t%llu dropped due to dst kring in drop mode\n")                        \
  X(NETIF_STATS_DROP_RXQ_OVFL, "DropRxqOverflow",                              \
    "\t\t%llu dropped due to RX Queue overflow\n")                             \
  X(NETIF_STATS_DROP_NO_RX_CB, "DropNoRxCallback",                             \
    "\t\t%llu dropped due to missing RX callback\n")                           \
  X(NETIF_STATS_DROP_NO_DELEGATE, "DropNoDelegate",                            \
    "\t\t%llu dropped due to missing delegate interface\n")                    \
  X(NETIF_STATS_DROP_INPUT_DISABLED, "DropInputDisabled",                      \
    "\t\t%llu dropped due to input disabled on interface\n")                   \
                                                                               \
  /* Channel event stats */                                                    \
  X(NETIF_STATS_EV_RECV, "EvRecv", "\t%llu channel event received\n")          \
  X(NETIF_STATS_EV_RECV_TX_STATUS, "EvRecvTxStatus",                           \
    "\t\t%llu channel event received, TX status\n")                            \
  X(NETIF_STATS_EV_RECV_TX_EXPIRED, "EvRecvTxExpired",                         \
    "\t\t%llu channel event received, TX expired\n")                           \
  X(NETIF_STATS_EV_SENT, "EvSent", "\t%llu channel event delivered\n")         \
  X(NETIF_STATS_EV_DROP, "EvDrop", "\t%llu channel event dropped\n")           \
  X(NETIF_STATS_EV_DROP_NOMEM_PKT, "EvDropNoMemPkt",                           \
    "\t%llu channel event dropped due to packet alloc failure\n")              \
  X(NETIF_STATS_EV_DROP_NA_INACTIVE, "EvDropNaInactive",                       \
    "\t%llu channel event dropped due to na inactive\n")                       \
  X(NETIF_STATS_EV_DROP_NA_DEFUNCT, "EvDropNaDefunct",                         \
    "\t%llu channel event dropped due to na defunct\n")                        \
  X(NETIF_STATS_EV_DROP_KRDROP_MODE, "EvDropKrDropMode",                       \
    "\t%llu channel event dropped due to dst kring in drop mode\n")            \
  X(NETIF_STATS_EV_DROP_KEVENT_INACTIVE, "EvDropKevInactive",                  \
    "\t%llu channel event dropped due to kevent not registered on channel\n")  \
  X(NETIF_STATS_EV_DROP_KRSPACE, "EvDropKrSpaceDrop",                          \
    "\t%llu channel event dropped due to lack of space in user channel "       \
    "ring\n")                                                                  \
  X(NETIF_STATS_EV_DROP_DEMUX_ERR, "EvDropDemuxErr",                           \
    "\t%llu channel event dropped due to demux error\n")                       \
  X(NETIF_STATS_EV_DROP_EV_VPNA_NOTSUP, "EvDropVpnaEvNotSup",                  \
    "\t%llu channel event dropped due to vpna not having event ring\n")        \
  X(NETIF_STATS_EV_DROP_NO_VPNA, "EvDropNoVpna",                               \
    "\t%llu channel event dropped due to no vpna ports\n")                     \
                                                                               \
  /* Interface advisory update stats */                                        \
  X(NETIF_STATS_IF_ADV_UPD_RECV, "IfAdvUpdRecv",                               \
    "\t%llu interface advisory update received\n")                             \
  X(NETIF_STATS_IF_ADV_UPD_SENT, "IfAdvUpdSent",                               \
    "\t%llu interface advisory update event sent\n")                           \
  X(NETIF_STATS_IF_ADV_UPD_DROP, "IfAdvUpdDrop",                               \
    "\t%llu interface advisory update event dropped\n")                        \
                                                                               \
  /* Interface filter stats */                                                 \
  X(NETIF_STATS_FILTER_DROP_NO_RX_CB, "FilterDropNoRxCB",                      \
    "\t%llu dropped due to missing RX callback\n")                             \
  X(NETIF_STATS_FILTER_DROP_DISABLED, "FilterDropDisabled",                    \
    "\t%llu dropped due to disabled filter\n")                                 \
  X(NETIF_STATS_FILTER_DROP_REMOVED, "FilterDropRemoved",                      \
    "\t%llu dropped due to removed filter\n")                                  \
  X(NETIF_STATS_FILTER_DROP_PKTQ_FULL, "FilterDropPktqFull",                   \
    "\t%llu dropped due to packet queue full\n")                               \
  X(NETIF_STATS_FILTER_DROP_MBQ_FULL, "FilterDropMbqFull",                     \
    "\t%llu dropped due to mbuf queue full\n")                                 \
  X(NETIF_STATS_FILTER_DROP_DISABLED_RING, "FilterDropDisabledRing",           \
    "\t%llu dropped due to disabled ring\n")                                   \
  X(NETIF_STATS_FILTER_DROP_NO_SPACE, "FilterDropNoSpace",                     \
    "\t%llu dropped due to lack of space in RX ring\n")                        \
  X(NETIF_STATS_FILTER_DROP_INTERNALIZE, "FilterDropInternalize",              \
    "\t%llu dropped due to internalize failure\n")                             \
  X(NETIF_STATS_FILTER_DROP_PKT_ALLOC_FAIL, "FilterDropPktAllocFail",          \
    "\t%llu dropped due to packet allocation failure\n")                       \
  X(NETIF_STATS_FILTER_DROP_DEFAULT, "FilterDropDefault",                      \
    "\t%llu dropped due to default drop policy\n")                             \
  X(NETIF_STATS_FILTER_PKT_TRUNCATED, "FilterPktTruncated",                    \
    "\t%llu inbound packets truncated\n")                                      \
  X(NETIF_STATS_FILTER_TX_DELIVER, "FilterTxDeliver",                          \
    "\t%llu outbound packets delivered to filter\n")                           \
  X(NETIF_STATS_FILTER_RX_DELIVER, "FilterRxDeliver",                          \
    "\t%llu inbound packets delivered to filter\n")                            \
  X(NETIF_STATS_FILTER_TX_INJECT, "FilterTxInject",                            \
    "\t%llu outbound packets injected by filter\n")                            \
  X(NETIF_STATS_FILTER_RX_INJECT, "FilterRxInject",                            \
    "\t%llu inbound packets injected by filter\n")                             \
  X(NETIF_STATS_FILTER_TX_ENTER, "FilterTxEnter",                              \
    "\t%llu outbound packets entered the filter chain\n")                      \
  X(NETIF_STATS_FILTER_RX_ENTER, "FilterRxEnter",                              \
    "\t%llu inbound packets entered the filter chain\n")                       \
  X(NETIF_STATS_FILTER_TX_EXIT, "FilterTxExit",                                \
    "\t%llu outbound packets exited the filter chain\n")                       \
  X(NETIF_STATS_FILTER_RX_EXIT, "FilterRxExit",                                \
    "\t%llu inbound packets exited the filter chain\n")                        \
  X(NETIF_STATS_FILTER_SYNC_NO_PKTS, "FilterSyncNoPkts",                       \
    "\t%llu filter syncs called with an empty ring\n")                         \
  X(NETIF_STATS_FILTER_ADD, "FilterAdd", "\t%llu filters added\n")             \
  X(NETIF_STATS_FILTER_REMOVE, "FilterRemove", "\t%llu filters removed\n")     \
  X(NETIF_STATS_FILTER_TX_FLUSH, "FilterTxFlush",                              \
    "\t%llu TX packets flushed due to closing filters\n")                      \
  X(NETIF_STATS_FILTER_RX_NOT_FILTERABLE, "FilterRxNotFilterable",             \
    "\t%llu RX packets not filterable\n")                                      \
  X(NETIF_STATS_FILTER_BAD_PKT_LEN, "FilterBadPktLen",                         \
    "\t%llu invalid packet length\n")                                          \
                                                                               \
  /* Custom ether and sidecar stats */                                         \
  X(NETIF_STATS_VP_DROP_USER_RING_DISABLED, "VPDropUserRingDisabled",          \
    "\t%llu dropped due to disabled user ring\n")                              \
  X(NETIF_STATS_VP_DROP_DEV_RING_DISABLED, "VPDropDevRingDisabled",            \
    "\t%llu dropped due to disabled device ring\n")                            \
  X(NETIF_STATS_VP_DROP_USER_RING_NO_SPACE, "VPDropUserRingNoSpace",           \
    "\t%llu dropped due to lack of user ring space\n")                         \
  X(NETIF_STATS_VP_DROP_DEV_RING_NO_SPACE, "VPDropDevRingNoSpace",             \
    "\t%llu dropped due to lack of device ring space\n")                       \
  X(NETIF_STATS_VP_DROP_RX_ALLOC_FAIL, "VPDropRxAllocFail",                    \
    "\t%llu dropped due to RX allocation failure\n")                           \
  X(NETIF_STATS_VP_DROP_TX_ALLOC_FAIL, "VPDropTxAllocFail",                    \
    "\t%llu dropped due to TX allocation failure\n")                           \
  X(NETIF_STATS_VP_DROP_PKT_TOO_BIG, "VPDropPktTooBig",                        \
    "\t%llu dropped due to packet being too big\n")                            \
  X(NETIF_STATS_VP_DROP_INTERNALIZE_FAIL, "VPDropInternalizeFail",             \
    "\t%llu dropped due to internalize failure\n")                             \
  X(NETIF_STATS_VP_DROP_UNEXPECTED_ERR, "VPDropUnexpectedErr",                 \
    "\t%llu dropped due to unexpected TX sync error\n")                        \
  X(NETIF_STATS_VP_BAD_MADDR_LEN, "VPBadMaddrLen",                             \
    "\t%llu packets with invalid mac address length\n")                        \
  X(NETIF_STATS_VP_BAD_MADDR, "VPBadMaddr",                                    \
    "\t%llu packets with invalid mac address\n")                               \
  X(NETIF_STATS_VP_BAD_PKT_LEN, "VPBadPktLen",                                 \
    "\t%llu packets invalid packet length\n")                                  \
  X(NETIF_STATS_VP_FLOW_INFO_ERR, "VPFlowInfoErr",                             \
    "\t%llu packets cannot be classified due to flow info error\n")            \
  X(NETIF_STATS_VP_FLOW_NOT_MATCH, "VPFlowNotMatch",                           \
    "\t%llu packets not matching flow description\n")                          \
  X(NETIF_STATS_VP_KR_ENTER_FAIL, "VPKrEnterFail",                             \
    "\t%llu failed attempts to acquire RX ring lock\n")                        \
  X(NETIF_STATS_VP_DEV_RING_DISABLED, "VPDevRingDisabled",                     \
    "\t%llu failed attempts to get packets due to disabled dev ring\n")        \
  X(NETIF_STATS_VP_SYNC_UNKNOWN_ERR, "VPSyncUnknownErr",                       \
    "\t%llu unknown errors returned by RX sync\n")                             \
  X(NETIF_STATS_VP_SYNC_NO_PKTS, "VPSyncNoPkts",                               \
    "\t%llu syncs called with an empty ring\n")                                \
  X(NETIF_STATS_VP_SPURIOUS_NOTIFY, "VPSpuriousNotify",                        \
    "\t%llu spurious notifies delivered\n")                                    \
  X(NETIF_STATS_VP_ENQUEUE_FAILED, "VPEnqueueFailed",                          \
    "\t%llu packets failed to enqueue\n")                                      \
  X(NETIF_STATS_VP_ENQUEUED, "VPEnqueued", "\t%llu packets enqueued\n")        \
  X(NETIF_STATS_VP_LL_ENQUEUED, "VPLLEnqueued",                                \
    "\t%llu low latency packets enqueued\n")                                   \
  X(NETIF_STATS_VP_LL_SENT, "VPLLSent", "\t%llu low latency packets sent\n")   \
  X(NETIF_STATS_VP_LL_DELIVERED, "VPLLDelivered",                              \
    "\t%llu low latency packets delivered\n")                                  \
  X(NETIF_STATS_VP_DELIVERED, "VPDelivered", "\t%llu packets delivered\n")     \
  X(NETIF_STATS_VP_FLOW_FOUND, "VPFlowFound",                                  \
    "\t%llu packets found a matching flow\n")                                  \
  X(NETIF_STATS_VP_FLOW_NOT_FOUND, "VPFlowNotFound",                           \
    "\t%llu packets found no matching flow\n")                                 \
  X(NETIF_STATS_VP_FLOW_DISABLED, "VPFlowDisabled",                            \
    "\t%llu lookup failures due to disabled flow\n")                           \
  X(NETIF_STATS_VP_FLOW_EMPTY_TABLE, "VPFlowEmptyTable",                       \
    "\t%llu lookup failures due to empty flow table\n")                        \
  X(NETIF_STATS_VP_FLOW_TABLE_INIT_FAIL, "VPFlowTableInitFail",                \
    "\t%llu failed attempts to initialize flow table\n")                       \
  X(NETIF_STATS_VP_FLOW_INSERT_FAIL, "VPFlowInsertFail",                       \
    "\t%llu failed attempts to insert flow\n")                                 \
  X(NETIF_STATS_VP_FLOW_ADD, "VPFlowAdd", "\t%llu flows added\n")              \
  X(NETIF_STATS_VP_FLOW_REMOVE, "VPFlowRemove", "\t%llu flows removed\n")      \
                                                                               \
  /* Netif agent stats */                                                      \
  X(NETIF_STATS_AGENT_BAD_ETHERTYPE, "AgentBadEthertype",                      \
    "\t%llu flow add failures due to invalid ethertype\n")                     \
  X(NETIF_STATS_AGENT_BAD_IPV6_ADDR, "AgentBadIPv6Addr",                       \
    "\t%llu flow add failures due to invalid IPv6 address\n")                  \
  X(NETIF_STATS_AGENT_DUP_FLOW, "AgentDupFlow",                                \
    "\t%llu duplicate flows added\n")                                          \
                                                                               \
  /* Netif llink stats */                                                      \
  X(NETIF_STATS_LLINK_ADD, "LLinkAdd", "\t%llu logical links added\n")         \
  X(NETIF_STATS_LLINK_REMOVE, "LLinkRemove", "\t%llu logical links removed\n") \
  X(NETIF_STATS_LLINK_DEF_QSET_USED, "LLinkDefQSetUsed",                       \
    "\t%llu uses of the default qset\n")                                       \
  X(NETIF_STATS_LLINK_NONDEF_QSET_USED, "LLinkNonDefQSetUsed",                 \
    "\t%llu uses of a non-default qset\n")                                     \
  X(NETIF_STATS_LLINK_HINT_NOT_USEFUL, "LLinkHintNotUseful",                   \
    "\t%llu hints specified but qset not found\n")                             \
  X(NETIF_STATS_LLINK_DUP_INT_ID_GENERATED, "LLinkDupIntIDGenerated",          \
    "\t%llu duplicate internal llink IDs generated\n")                         \
  X(NETIF_STATS_LLINK_DUP_ID_GIVEN, "LLinkDupIDGiven",                         \
    "\t%llu duplicate llink IDs given by the provider\n")                      \
  X(NETIF_STATS_LLINK_QSET_INIT_FAIL, "LLinkQSetInitFail",                     \
    "\t%llu queue set initialization failures\n")                              \
  X(NETIF_STATS_LLINK_RXQ_INIT_FAIL, "LLinkRXQInitFail",                       \
    "\t%llu RX queue initialization failures\n")                               \
  X(NETIF_STATS_LLINK_TXQ_INIT_FAIL, "LLinkTXQInitFail",                       \
    "\t%llu TX queue initialization failures\n")                               \
  X(NETIF_STATS_LLINK_NOT_FOUND_REMOVE, "LLinkNotFoundRemove",                 \
    "\t%llu not found during remove\n")                                        \
  X(NETIF_STATS_LLINK_TX_DROP_BAD_STATE, "LLinkTxDroppedBadState",             \
    "\t%llu TX packets dropped due to bad llink state\n")                      \
  X(NETIF_STATS_LLINK_RX_DROP_BAD_STATE, "LLinkRxDroppedBadState",             \
    "\t%llu RX packets dropped due to bad llink state\n")                      \
  X(NETIF_STATS_LLINK_AQM_QFULL, "LLinkAQMQFull",                              \
    "\t%llu occurances of the queue full condition\n")                         \
  X(NETIF_STATS_LLINK_AQM_DROPPED, "LLinkAQMDropped",                          \
    "\t%llu packets dropped due to AQM\n")                                     \
  X(NETIF_STATS_LLINK_AQM_DEQ_BAD_STATE, "LLinkAQMDeqBadState",                \
    "\t%llu dequeues occurred while llink is in a bad state\n")                \
  X(NETIF_STATS_LLINK_QSET_BAD_STATE, "LLinkQSetAccessBadState",               \
    "\t%llu attempts to access a queue set while in bad llink state\n")        \
  X(NETIF_STATS_LLINK_ADD_BAD_PARAMS, "LLinkAddBadParams",                     \
    "\t%llu attempts to add an llink with bad parameters\n")                   \
                                                                               \
...
#define FSW_STATS_TABLE(X)                                                     \
  ...
  X(FSW_STATS_RX_DEMUX_ERR, "RxDemuxErr",                                      \
    "\t\t%llu demux error (passed to BSD)\n")                                  \
  X(FSW_STATS_RX_DEMUX_UNSPEC, "RxDemuxUnspec",                                \
    "\t\t%llu demux AF unkown (passed to BSD)\n")                              \
  X(FSW_STATS_RX_DEMUX_PROMISC, "RxDemuxPromisc",                              \
    "\t\t%llu promiscuous packets (passed to BSD)\n")                          \
  X(FSW_STATS_RX_FLOW_EXTRACT_ERR, "RxFlowExtractErr",                         \
    "\t\t%llu flow extract error (passed to BSD)\n")                           \
  X(FSW_STATS_RX_PKT_NOT_FINALIZED, "RxPktNotFinalized",                       \
    "\t\t%llu packet not finalized\n")                                         \
  X(FSW_STATS_RX_FLOW_NOT_FOUND, "RxFlowNotFound",                             \
    "\t\t%llu dropped, flow lookup failure\n")                                 \
  X(FSW_STATS_RX_FLOW_TRACK_ERR, "RxFlowTrackErr",                             \
    "\t\t%llu dropped, flow tracker error\n")                                  \
  X(FSW_STATS_RX_FLOW_NONVIABLE, "RxFlowNonviable",                            \
    "\t\t%llu dropped, flow already nonviable\n")                              \
  X(FSW_STATS_RX_FLOW_TORNDOWN, "RxFlowTornDown",                              \
    "\t\t%llu dropped, flow already torndown\n")                               \
  X(FSW_STATS_RX_DST_RING_FULL, "RxDstRingFull",                               \
    "\t\t%llu dropped, destination ring full\n")                               \
  X(FSW_STATS_RX_COPY_PKT2PKT, "RxCopyPktToPkt",                               \
    "\t\t%llu copied pkt  -> pkt\n")                                           \
  X(FSW_STATS_RX_COPY_PKT2MBUF, "RxCopyPktToMbuf",                             \
    "\t\t%llu copied pkt  -> mbuf\n")                                          \
  X(FSW_STATS_RX_COPY_MBUF2PKT, "RxCopyMbufToPkt",                             \
    "\t\t%llu copied mbuf -> pkt\n")                                           \
  X(FSW_STATS_RX_COPY_SUM, "RxCopySum", "\t\t%llu copy+checksumed\n")          \
  X(FSW_STATS_RX_COPY_BAD_LEN, "RxCopyBadLen",                                 \
    "\t\t%llu dropped, bad packet length\n")                                   \
  X(FSW_STATS_RX_DROP_NOMEM_BUF, "RxDropNoMemBuf",                             \
    "\t\t%llu dropped due to mbuf alloc failure\n")                            \
  X(FSW_STATS_RX_DEMUX_SHORT_ERR, "RxDemuxShortErr",                           \
    "\t\t%llu demux failed, classify length short\n")                          \
  X(FSW_STATS_RX_WASTED_16KMBUF, "RxWasted16KMbuf",                            \
    "\t\t%llu wasted an entire pre-allocated 16K mbuf\n")                      \
  X(FSW_STATS_RX_PKT_NOT_LISTENER, "RxPktNotListener",                         \
    "\t\t%llu packet not for listener\n")                                      \
  X(FSW_STATS_RX_FLOW_IN_USE, "RxFlowInUse", "\t\t%llu flow in use\n")         \
  X(FSW_STATS_RX_STALL, "RxRingStall", "\t\t%llu Rx rings stalled\n")          \
  X(FSW_STATS_RX_DISABLED, "RxDisabled",                                       \
    "\t\t%llu dropped, flow Rx disabled\n")                                    \
  /* Rx frag stats (fsw doesn't manage fragments on Tx) */                     \
  X(FSW_STATS_RX_FRAG_V4, "RxFragV4",                                          \
    "\t\t%llu total received ipv4 fragments\n")                                \
  X(FSW_STATS_RX_FRAG_V6, "RxFragV6",                                          \
    "\t\t%llu total received ipv6 fragments\n")                                \
  X(FSW_STATS_RX_FRAG_REASSED, "RxFragReassed",                                \
    "\t\t\t%llu frag successfully reassembled\n")                              \
  X(FSW_STATS_RX_FRAG_DROP_NOSLOT, "RxFragDropNoSlot",                         \
    "\t\t\t%llu dropped no slot in dring\n")                                   \
  X(FSW_STATS_RX_FRAG_BAD, "RxFragBad",                                        \
    "\t\t\t%llu dropped due to bad fragments\n")                               \
  X(FSW_STATS_RX_FRAG_DROP_BAD_LEN, "RxFragBadLen",                            \
    "\t\t\t%llu dropped due to bad fragment length\n")                         \
  X(FSW_STATS_RX_FRAG_DROP_NOMEM, "RxFragNoMem",                               \
    "\t\t\t%llu dropped due to no memory\n")                                   \
  X(FSW_STATS_RX_FRAG_DROP_TIMEOUT, "RxFragTimeOut",                           \
    "\t\t\t%llu dropped due to time out\n")                                    \
  X(FSW_STATS_RX_FRAG_DROP_FRAG_LIMIT, "RxFragHitFragLimit",                   \
    "\t\t\t%llu dropped due to ipf max limit\n")                               \
  X(FSW_STATS_RX_FRAG_DROP_REAPED, "RxFragDrained",                            \
    "\t\t\t%llu dropped due to draining\n")                                    \
  X(FSW_STATS_RX_FRAG_DROP_PER_QUEUE_LIMIT, "RxFragHitPerQueueLimit",          \
    "\t\t\t%llu dropped due to ipf max per queue limit\n")                     \
  /* Rx aggregation stats */                                                   \
  X(FSW_STATS_RX_AGG_PKT2PKT, "RxAggPktToPkt",                                 \
    "\t\t%llu aggregated pkt  -> super pkt\n")                                 \
  X(FSW_STATS_RX_AGG_PKT2MBUF, "RxAggPktToMbuf",                               \
    "\t\t%llu aggregated pkt  -> super mbuf\n")                                \
  X(FSW_STATS_RX_AGG_MBUF2PKT, "RxAggMbufToPkt",                               \
    "\t\t%llu aggregated mbuf  -> super pkt\n")                                \
  X(FSW_STATS_RX_AGG_MBUF2MBUF, "RxAggMbufToMbuf",                             \
    "\t\t%llu aggregated mbuf  -> super mbuf\n")                               \
  X(FSW_STATS_RX_AGG_LIMIT, "RxAggHitAggLimit",                                \
    "\t\t%llu reached aggregation limit\n")                                    \
  X(FSW_STATS_RX_AGG_NO_HLEN_IP, "RxAggNoHdrLenIP",                            \
    "\t\t%llu IP header length compare mismatch\n")                            \
  X(FSW_STATS_RX_AGG_NO_TTL_IP, "RxAggNoTTLIP",                                \
    "\t\t%llu IP TTL compare mismatch\n")                                      \
  X(FSW_STATS_RX_AGG_NO_TOS_IP, "RxAggNoTOSIP",                                \
    "\t\t%llu IP TOS compare mismatch\n")                                      \
  X(FSW_STATS_RX_AGG_NO_OFF_IP, "RxAggNoOffsetIP",                             \
    "\t\t%llu IP offset compare mismatch\n")                                   \
  X(FSW_STATS_RX_AGG_NO_OPT_IP, "RxAggNoOptionIP",                             \
    "\t\t%llu IP option compare mismatch\n")                                   \
  X(FSW_STATS_RX_AGG_MERGE_FASTPATH_IP, "RxAggMergeFastpathIP",                \
    "\t\t%llu IP header merge via fastpath\n")                                 \
  X(FSW_STATS_RX_AGG_MERGE_SLOWPATH_IP, "RxAggMergeSlowpathIP",                \
    "\t\t%llu IP header merge via slowpath\n")                                 \
  X(FSW_STATS_RX_AGG_MERGE_FASTPATH_TCP, "RxAggMergeFastpathTCP",              \
    "\t\t%llu TCP header merge via fastpath\n")                                \
  X(FSW_STATS_RX_AGG_MERGE_SLOWPATH_TCP, "RxAggMergeSlowpathTCP",              \
    "\t\t%llu TCP header merge via slowpath\n")                                \
  X(FSW_STATS_RX_AGG_OK_FASTPATH_TCP, "RxAggFastpathTCP",                      \
    "\t\t%llu TCP aggregation via fastpath\n")                                 \
  X(FSW_STATS_RX_AGG_OK_SLOWPATH_TCP, "RxAggSlowpathTCP",                      \
    "\t\t%llu TCP aggregation via slowpath\n")                                 \
  X(FSW_STATS_RX_AGG_NO_SHORT_TCP, "RxAggNoShortTCP",                          \
    "\t\t%llu TCP packet too short for mask compare\n")                        \
  X(FSW_STATS_RX_AGG_NO_MASK_TCP, "RxAggNoMaskTCP",                            \
    "\t\t%llu TCP mask compare mismatch\n")                                    \
  X(FSW_STATS_RX_AGG_NO_HLEN_TCP, "RxAggNoHdrLenTCP",                          \
    "\t\t%llu TCP header length compare mismatch\n")                           \
  X(FSW_STATS_RX_AGG_NO_ULEN_TCP, "RxAggNoULenTCP",                            \
    "\t\t%llu TCP ulength compare mismatch\n")                                 \
  X(FSW_STATS_RX_AGG_NO_SEQN_TCP, "RxAggNoSeqNTCP",                            \
    "\t\t%llu TCP sequence number compare mismatch\n")                         \
  X(FSW_STATS_RX_AGG_NO_ACKWIN_TCP, "RxAggNoAckWinTCP",                        \
    "\t\t%llu TCP ACK or window compare mismatch\n")                           \
  X(FSW_STATS_RX_AGG_NO_FLAGS_TCP, "RxAggNoFlagsTCP",                          \
    "\t\t%llu TCP flags compare mismatch\n")                                   \
  X(FSW_STATS_RX_AGG_NO_EXOPT_TCP, "RxAggNoExtraOptionTCP",                    \
    "\t\t%llu TCP extra option compare mismatch\n")                            \
  X(FSW_STATS_RX_AGG_NO_OPTTS_TCP, "RxAggNoOptionTStampTCP",                   \
    "\t\t%llu TCP timestamp option compare mismatch\n")                        \
  X(FSW_STATS_RX_AGG_BAD_CSUM, "RxAggIncorrectChecksum",                       \
    "\t\t%llu Incorrect TCP/IP checksum\n")                                    \
  X(FSW_STATS_RX_AGG_NO_SHORT_MBUF, "RxAggNoShortMbuf",                        \
    "\t\t%llu mbuf too short for mask compare\n")                              \
  X(FSW_STATS_RX_WASTED_MBUF, "RxAggWastedMbuf",                               \
    "\t\t%llu wasted pre-allocate mbufs\n")                                    \
  X(FSW_STATS_RX_WASTED_BFLT, "RxAggWastedBflt",                               \
    "\t\t%llu wasted pre-allocate buflets\n")                                  \
                                                                               \
  /* Tx stats */                                                               \
  X(FSW_STATS_TX_PACKETS, "TXPackets", "\t%llu total Tx packets\n")            \
  X(FSW_STATS_TX_DEMUX_ERR, "TxDemuxErr", "\t\t%llu dropped, demux error\n")   \
  X(FSW_STATS_TX_FLOW_EXTRACT_ERR, "TxFlowExtractErr",                         \
    "\t\t%llu dropped, flow extract error\n")                                  \
  X(FSW_STATS_TX_FRAG_BAD_ID, "TxFragID",                                      \
    "\t\t%llu dropped, invalid fragment ID\n")                                 \
  X(FSW_STATS_TX_FRAG_BAD_CONT, "TxContFrag",                                  \
    "\t\t%llu dropped, invalid continuation fragment\n")                       \
  X(FSW_STATS_TX_FLOW_NOT_FOUND, "TxFlowNotFound",                             \
    "\t\t%llu dropped, flow lookup failure\n")                                 \
  X(FSW_STATS_TX_FLOW_TRACK_ERR, "TxFlowTrackErr",                             \
    "\t\t%llu dropped, flow tracker error\n")                                  \
  X(FSW_STATS_TX_FLOW_BAD_ID, "TxFLowBadID",                                   \
    "\t\t%llu dropped, flow id invalid\n")                                     \
  X(FSW_STATS_TX_FLOW_NONVIABLE, "TxFlowNonviable",                            \
    "\t\t%llu dropped, flow already nonviable\n")                              \
  X(FSW_STATS_TX_FLOW_TORNDOWN, "TxFlowTornDown",                              \
    "\t\t%llu dropped, flow already torndown\n")                               \
  X(FSW_STATS_TX_BAD_LISTENER, "TxBadListener",                                \
    "\t\t%llu dropped, flow as listener only\n")                               \
  X(FSW_STATS_TX_AQM_DROP, "TxAQMDrop",                                        \
    "\t\t%llu dropped, AQM enqueue failure\n")                                 \
  X(FSW_STATS_TX_RESOLV_PENDING, "TxResolvePending",                           \
    "\t\t%llu pending resolve\n")                                              \
  X(FSW_STATS_TX_RESOLV_FAIL, "TxResolveFail",                                 \
    "\t\t%llu dropped due to resolution failure\n")                            \
  X(FSW_STATS_TX_RESOLV_STALE, "TxResolveStale",                               \
    "\t\t%llu resolved using existing info\n")                                 \
  X(FSW_STATS_TX_COPY_PKT2PKT, "TxCopyPktToPkt",                               \
    "\t\t%llu copied pkt  ->  pkt\n")                                          \
  X(FSW_STATS_TX_COPY_PKT2MBUF, "TxCopyPktToMbuf",                             \
    "\t\t%llu copied pkt  ->  mbuf\n")                                         \
  X(FSW_STATS_TX_COPY_SUM, "TxCopySum", "\t\t%llu copy+checksumed\n")          \
  X(FSW_STATS_TX_COPY_BAD_LEN, "TxCopyBadLen",                                 \
    "\t\t%llu dropped, bad packet length\n")                                   \
  X(FSW_STATS_TX_DISABLED, "TxDisabled",                                       \
    "\t\t%llu dropped, flow tx disabled\n")                                    \
                                                                               \
  /* Drop stats (generic bidirectional) */                                     \
  X(FSW_STATS_DROP, "Drop", "\t%llu total dropped\n")                          \
  X(FSW_STATS_DROP_NOMEM_PKT, "DropNoMemPkt",                                  \
    "\t\t%llu dropped, packet alloc failure\n")                                \
  X(FSW_STATS_DROP_NOMEM_MBUF, "DropNoMemMbuf",                                \
    "\t\t%llu dropped, mbuf alloc failure\n")                                  \
                                                                               \
  /* Channel event stats */                                                    \
  X(FSW_STATS_EV_RECV, "EvRecv", "\t%llu channel event received\n")            \
  X(FSW_STATS_EV_RECV_TX_STATUS, "EvRecvTxStatus",                             \
    "\t\t%llu channel event received, TX status\n")                            \
  X(FSW_STATS_EV_RECV_TX_EXPIRED, "EvRecvTxExpired",                           \
    "\t\t%llu channel event received, TX expired\n")                           \
  X(FSW_STATS_EV_SENT, "EvSent", "\t%llu channel event delivered\n")           \
  X(FSW_STATS_EV_DROP, "EvDrop", "\t%llu channel event dropped\n")             \
  X(FSW_STATS_EV_DROP_NOMEM_PKT, "EvDropNoMemPkt",                             \
    "\t%llu channel event dropped due to packet alloc failure\n")              \
  X(FSW_STATS_EV_DROP_NA_INACTIVE, "EvDropNaInactive",                         \
    "\t%llu channel event dropped due to na inactive\n")                       \
  X(FSW_STATS_EV_DROP_NA_DEFUNCT, "EvDropNaDefunct",                           \
    "\t%llu channel event dropped due to na defunct\n")                        \
  X(FSW_STATS_EV_DROP_KRDROP_MODE, "EvDropKrDropMode",                         \
    "\t%llu channel event dropped due to dst kring in drop mode\n")            \
  X(FSW_STATS_EV_DROP_KEVENT_INACTIVE, "EvDropKevInactive",                    \
    "\t%llu channel event dropped due to kevent not registered on channel\n")  \
  X(FSW_STATS_EV_DROP_KRSPACE, "EvDropKrSpaceDrop",                            \
    "\t%llu channel event dropped due to lack of space in user channel "       \
    "ring\n")                                                                  \
  X(FSW_STATS_EV_DROP_DEMUX_ERR, "EvDropDemuxErr",                             \
    "\t%llu channel event dropped due to demux error\n")                       \
  X(FSW_STATS_EV_DROP_EV_VPNA_NOTSUP, "EvDropVpnaEvNotSup",                    \
    "\t%llu channel event dropped due to vpna not having event ring\n")        \
  /* Misc. stats */                                                            \
  X(FSW_STATS_FLOWS_ABORTED, "FlowsAborted", "\t%llu flow aborted\n")          \
  X(FSW_STATS_DST_NXPORT_INVALID, "DestNexusPortInvalid",                      \
    "\t%llu times dst nexus port invalid\n")                                   \
  X(FSW_STATS_DST_NXPORT_INACTIVE, "DestNexusPortInactive",                    \
    "\t%llu times dst nexus port inactive\n")                                  \
  X(FSW_STATS_DST_NXPORT_DEFUNCT, "DestNexusPortDefunct",                      \
    "\t%llu times dst nexus port defunct\n")                                   \
  X(FSW_STATS_DST_RING_DROPMODE, "DestRingDropMode",                           \
    "\t\t%llu dropped, dst kring in drop mode\n")                              \
  X(FSW_STATS_CHAN_ERR_UPP_ALLOC, "ChanErrUppAlloc",                           \
    "\t%llu user packet pool alloc failure\n")                                 \
  X(FSW_STATS_CHAN_DEFUNCT_SKIP, "ChanDefunctSkipped",                         \
    "\t%llu defunct skipped due to outstanding packets\n")                     \
                                                                               \
  X(_FSW_STATS_ERROR_INJECTIONS, "_ErrorInjections",                           \
    "(\t%llu errors injected)\n")                                              \
  X(FSW_STATS_IF_ADV_UPD_SENT, "IfAdvUpdSent",                                 \
    "\t%llu interface advisory update event sent\n")                           \
                                                                               \
  X(FSW_STATS_IF_ADV_UPD_DROP, "IfAdvUpdDrop",                                 \
    "\t%llu interface advisory update event dropped\n")                        \
                                                                               \
  /* FPD stats */                                                              \
  FSW_FPD_STATS(X)                                                             \
  ...
  X(FSW_STATS_RX_FS_ADD_SUCCESS, "RxFSAddSuccess",                             \
    "\t%llu rx flow steering add success\n")                                   \
  X(FSW_STATS_RX_FS_REMOVE_SUCCESS, "RxFSRemoveSuccess",                       \
    "\t%llu rx flow steering remove success\n")                                \
  X(FSW_STATS_RX_FS_ADD_FAILURE, "RxFSAddFailure",                             \
    "\t%llu rx flow steering add failure\n")                                   \
  X(FSW_STATS_RX_FS_REMOVE_FAILURE, "RxFSRemoveFailure",                       \
    "\t%llu rx flow steering remove failure\n")                                \
  X(FSW_STATS_RX_FS_REMOVE_SKIPPED, "RxFSRemoveSkipped",                       \
...
static inline void __attribute__((always_inline))
__stats_fold(uint64_t *__counted_by(len) dst, uint64_t *__counted_by(len) src,
             size_t len) {
...
#define DEFINE_STATS_FOLD_FUNC(type, len)                                      \
  static inline void __attribute__((always_inline)) type##_fold(               \
      struct type *dst, struct type *src) {                                    \
...
#define DEFINE_STATS_RESET_FUNC(type, len)                                     \
  static inline void __attribute__((always_inline)) type##_reset(              \
      struct type *s) {                                                        \
...
typedef struct {
  ...
  union {
    ...
    uint64_t crs_seconds_since_last_update; /* published to userspace as time
                                               lapsed */
  };
...
typedef struct {
  ...
  nexus_channel_ring_entry
      nce_ring_entries[__counted_by(nce_ring_count)]; /* tx followed by rx */
...
typedef struct {
  ...
  nexus_channel_entry nci_channel_entries[__counted_by(
      nci_channel_entries_count)]; /* variable length */
 ...
 * Nexus advisories.
 */
#define NX_INTF_ADV_SIZE                                                       \
  (sizeof(uint64_t) + sizeof(struct ifnet_interface_advisory))
...
struct sk_stats_flow_route {
  ...
  uint8_t sfr_ether_dhost[ETHER_ADDR_LEN] __attribute__((aligned(64)));
};
...
struct sk_stats_flow_adv {
  ...
  struct sk_stats_flow_adv_ent
      sfa_entries[__counted_by(sfa_entries_count)]; /* flow adv entries */
};
...
#define NS_DUMP_SIZE(records)                                                  \
  (sizeof(struct netns_ctl_dump_header) +                                      \
