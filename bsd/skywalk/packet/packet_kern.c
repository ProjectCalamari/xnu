...
errno_t kern_packet_set_headroom(const kern_packet_t ph,
                                 const uint8_t headroom) {
  return __packet_set_headroom(ph, headroom);
}

uint8_t kern_packet_get_headroom(const kern_packet_t ph) {
  return __packet_get_headroom(ph);
}

errno_t kern_packet_set_link_header_offset(const kern_packet_t ph,
                                           const uint8_t off) {
  return __packet_set_headroom(ph, off);
}

uint16_t kern_packet_get_link_header_offset(const kern_packet_t ph) {
  return __packet_get_headroom(ph);
}

errno_t kern_packet_set_link_header_length(const kern_packet_t ph,
                                           const uint8_t off) {
  return __packet_set_link_header_length(ph, off);
}

uint8_t kern_packet_get_link_header_length(const kern_packet_t ph) {
  return __packet_get_link_header_length(ph);
}

errno_t kern_packet_set_link_broadcast(const kern_packet_t ph) {
  return __packet_set_link_broadcast(ph);
}

boolean_t kern_packet_get_link_broadcast(const kern_packet_t ph) {
  return __packet_get_link_broadcast(ph);
}

errno_t kern_packet_set_link_multicast(const kern_packet_t ph) {
  return __packet_set_link_multicast(ph);
}

errno_t kern_packet_set_link_ethfcs(const kern_packet_t ph) {
  return __packet_set_link_ethfcs(ph);
}

boolean_t kern_packet_get_link_multicast(const kern_packet_t ph) {
  return __packet_get_link_multicast(ph);
}

boolean_t kern_packet_get_link_ethfcs(const kern_packet_t ph) {
  return __packet_get_link_ethfcs(ph);
}

/* deprecated -- no effect, use set_link_header_length instead  */
errno_t kern_packet_set_network_header_offset(const kern_packet_t ph,
                                              const uint16_t off) {
...
uint16_t kern_packet_get_network_header_offset(const kern_packet_t ph) {
  return (uint16_t)__packet_get_headroom(ph) +
         (uint16_t)__packet_get_link_header_length(ph);
}

/* deprecated */
errno_t kern_packet_set_transport_header_offset(const kern_packet_t ph,
                                                const uint16_t off) {
#pragma unused(ph, off)
  return 0;
}
...
/* deprecated */
uint16_t kern_packet_get_transport_header_offset(const kern_packet_t ph) {
#pragma unused(ph)
  return 0;
}

boolean_t kern_packet_get_transport_traffic_background(const kern_packet_t ph) {
  return __packet_get_transport_traffic_background(ph);
}

boolean_t kern_packet_get_transport_traffic_realtime(const kern_packet_t ph) {
  return __packet_get_transport_traffic_realtime(ph);
}

boolean_t kern_packet_get_transport_retransmit(const kern_packet_t ph) {
  return __packet_get_transport_retransmit(ph);
}

boolean_t kern_packet_get_transport_new_flow(const kern_packet_t ph) {
  return __packet_get_transport_new_flow(ph);
}

boolean_t kern_packet_get_transport_last_packet(const kern_packet_t ph) {
  return __packet_get_transport_last_packet(ph);
}

int kern_packet_set_service_class(const kern_packet_t ph,
                                  const kern_packet_svc_class_t sc) {
  return __packet_set_service_class(ph, sc);
}

kern_packet_svc_class_t kern_packet_get_service_class(const kern_packet_t ph) {
  return __packet_get_service_class(ph);
}

errno_t kern_packet_set_compression_generation_count(const kern_packet_t ph,
                                                     uint32_t gencnt) {
  return __packet_set_comp_gencnt(ph, gencnt);
}

errno_t kern_packet_get_compression_generation_count(const kern_packet_t ph,
                                                     uint32_t *pgencnt) {
  return __packet_get_comp_gencnt(ph, pgencnt);
}

errno_t kern_packet_get_service_class_index(const kern_packet_svc_class_t svc,
                                            uint32_t *index) {
...
boolean_t kern_packet_is_high_priority(const kern_packet_t ph) {
  uint32_t sc;
...
errno_t kern_packet_set_traffic_class(const kern_packet_t ph,
...
errno_t kern_packet_set_inet_checksum(const kern_packet_t ph,
                                      const packet_csum_flags_t flags,
...
packet_csum_flags_t kern_packet_get_inet_checksum(const kern_packet_t ph,
                                                  uint16_t *start,
                                                  uint16_t *val,
                                                  const boolean_t tx) {
...
void kern_packet_set_flow_uuid(const kern_packet_t ph, const uuid_t flow_uuid) {
  __packet_set_flow_uuid(ph, flow_uuid);
}

void kern_packet_get_flow_uuid(const kern_packet_t ph, uuid_t *flow_uuid) {
  __packet_get_flow_uuid(ph, *flow_uuid);
}

void kern_packet_clear_flow_uuid(const kern_packet_t ph) {
  __packet_clear_flow_uuid(ph);
}

void kern_packet_get_euuid(const kern_packet_t ph, uuid_t euuid) {
  uuid_copy(euuid, PKT_ADDR(ph)->pkt_policy_euuid);
}

void kern_packet_set_policy_id(const kern_packet_t ph, uint32_t policy_id) {
  PKT_ADDR(ph)->pkt_policy_id = policy_id;
}

uint32_t kern_packet_get_policy_id(const kern_packet_t ph) {
  return PKT_ADDR(ph)->pkt_policy_id;
}

void kern_packet_set_skip_policy_id(const kern_packet_t ph,
                                    uint32_t skip_policy_id) {
  PKT_ADDR(ph)->pkt_skip_policy_id = skip_policy_id;
}

uint32_t kern_packet_get_skip_policy_id(const kern_packet_t ph) {
  return PKT_ADDR(ph)->pkt_skip_policy_id;
}

uint32_t kern_packet_get_data_length(const kern_packet_t ph) {
  return __packet_get_data_length(ph);
}

uint32_t kern_packet_get_buflet_count(const kern_packet_t ph) {
  return __packet_get_buflet_count(ph);
}

kern_buflet_t kern_packet_get_next_buflet(const kern_packet_t ph,
                                          const kern_buflet_t bprev) {
  return __packet_get_next_buflet(ph, bprev);
}

errno_t kern_packet_finalize(const kern_packet_t ph) {
  return __packet_finalize(ph);
}

kern_packet_idx_t kern_packet_get_object_index(const kern_packet_t ph) {
  return __packet_get_object_index(ph);
}

errno_t kern_packet_get_timestamp(const kern_packet_t ph, uint64_t *ts,
                                  boolean_t *valid) {
  return __packet_get_timestamp(ph, ts, valid);
}

errno_t kern_packet_set_timestamp(const kern_packet_t ph, uint64_t ts,
                                  boolean_t valid) {
  return __packet_set_timestamp(ph, ts, valid);
}

struct mbuf *kern_packet_get_mbuf(const kern_packet_t pkt) {
...
errno_t kern_packet_get_timestamp_requested(const kern_packet_t ph,
                                            boolean_t *requested) {
  return __packet_get_timestamp_requested(ph, requested);
}

void kern_packet_tx_completion(const kern_packet_t ph, ifnet_t ifp) {
...
errno_t kern_packet_get_tx_completion_status(const kern_packet_t ph,
                                             kern_return_t *status) {
  return __packet_get_tx_completion_status(ph, status);
}

errno_t kern_packet_set_tx_completion_status(const kern_packet_t ph,
                                             kern_return_t status) {
  return __packet_set_tx_completion_status(ph, status);
}

void kern_packet_set_group_start(const kern_packet_t ph) {
  (void)__packet_set_group_start(ph);
}

boolean_t kern_packet_get_group_start(const kern_packet_t ph) {
  return __packet_get_group_start(ph);
}

void kern_packet_set_group_end(const kern_packet_t ph) {
  (void)__packet_set_group_end(ph);
}

boolean_t kern_packet_get_group_end(const kern_packet_t ph) {
  return __packet_get_group_end(ph);
}

errno_t kern_packet_get_expire_time(const kern_packet_t ph, uint64_t *ts) {
  return __packet_get_expire_time(ph, ts);
}

errno_t kern_packet_set_expire_time(const kern_packet_t ph, const uint64_t ts) {
  return __packet_set_expire_time(ph, ts);
}

errno_t kern_packet_get_expiry_action(const kern_packet_t ph,
                                      packet_expiry_action_t *pea) {
  return __packet_get_expiry_action(ph, pea);
}

errno_t kern_packet_set_expiry_action(const kern_packet_t ph,
                                      packet_expiry_action_t pea) {
  return __packet_set_expiry_action(ph, pea);
}

errno_t kern_packet_get_token(const kern_packet_t ph,
                              void *__sized_by(*len) token, uint16_t *len) {
  return __packet_get_token(ph, token, len);
}

errno_t kern_packet_set_token(const kern_packet_t ph,
                              const void *__sized_by(len) token,
                              const uint16_t len) {
  return __packet_set_token(ph, token, len);
}

errno_t kern_packet_get_packetid(const kern_packet_t ph, packet_id_t *pktid) {
  return __packet_get_packetid(ph, pktid);
}

errno_t kern_packet_set_vlan_tag(const kern_packet_t ph, const uint16_t tag) {
  return __packet_set_vlan_tag(ph, tag);
}

errno_t kern_packet_get_vlan_tag(const kern_packet_t ph, uint16_t *tag) {
  return __packet_get_vlan_tag(ph, tag);
}

uint16_t kern_packet_get_vlan_id(const uint16_t tag) {
  return __packet_get_vlan_id(tag);
}

uint8_t kern_packet_get_vlan_priority(const uint16_t tag) {
  return __packet_get_vlan_priority(tag);
}

errno_t kern_packet_get_app_metadata(const kern_packet_t ph,
                                     packet_app_metadata_type_t *app_type,
                                     uint8_t *app_metadata) {
  return __packet_get_app_metadata(ph, app_type, app_metadata);
}

void kern_packet_set_wake_flag(const kern_packet_t ph) {
  return __packet_set_wake_flag(ph);
}

boolean_t kern_packet_get_wake_flag(const kern_packet_t ph) {
  return __packet_get_wake_flag(ph);
}

void kern_packet_set_ulpn_flag(const kern_packet_t ph) {
  return __packet_set_ulpn_flag(ph);
}

boolean_t kern_packet_get_ulpn_flag(const kern_packet_t ph) {
  return __packet_get_ulpn_flag(ph);
}

boolean_t kern_packet_get_lpw_flag(const kern_packet_t ph) {
  return __packet_get_lpw_flag(ph);
}

uint32_t kern_inet_checksum(const void *data, uint32_t len, uint32_t sum0) {
  return __packet_cksum(data, len, sum0);
}

uint32_t kern_copy_and_inet_checksum(const void *__sized_by(len) src,
 ...
 */
static int kern_packet_clone_internal(const kern_packet_t ph1,
                                      kern_packet_t *ph2, uint32_t skmflag,
  ...
  if ((p1->pkt_qum.qum_qflags & QUM_F_DROPPED) != 0 || p1->pkt_bufs_cnt == 0) {
    return EINVAL;
  }
  ...
  *ph2 = 0;
  ...
  case KPKT_COPY_HEAVY:
    ...
    if (__probable(p1->pkt_bufs_cnt != 0)) {
      ...
      saddr = __unsafe_forge_bidi_indexable(void *, p1_buf->buf_addr, copy_len);
      daddr = __unsafe_forge_bidi_indexable(void *, p2_buf->buf_addr, copy_len);
      if (copy_len != 0) {
        bcopy(saddr, daddr, copy_len);
      }
      *__DECONST(uint32_t *, &p2_buf->buf_dlim) = p1_buf->buf_dlim;
  ...
  case KPKT_COPY_LIGHT:
    ...
    if (__probable(p1->pkt_bufs_cnt != 0)) {
      ...
      *__DECONST(uint16_t *, &p2->pkt_bufs_cnt) = p1->pkt_bufs_cnt;
...
errno_t kern_packet_clone(const kern_packet_t ph1, kern_packet_t *ph2,
                          kern_packet_copy_mode_t mode) {
  return kern_packet_clone_internal(ph1, ph2, 0, mode);
}

errno_t kern_packet_clone_nosleep(const kern_packet_t ph1, kern_packet_t *ph2,
                                  kern_packet_copy_mode_t mode) {
  return kern_packet_clone_internal(ph1, ph2, SKMEM_NOSLEEP, mode);
}

errno_t kern_packet_add_buflet(const kern_packet_t ph,
                               const kern_buflet_t bprev,
                               const kern_buflet_t bnew) {
  return __packet_add_buflet(ph, bprev, bnew);
}

void kern_packet_append(const kern_packet_t ph1, const kern_packet_t ph2) {
  /*
   * TODO:
...
kern_packet_t kern_packet_get_next(const kern_packet_t ph) {
...
void kern_packet_set_next(const kern_packet_t ph1, const kern_packet_t ph2) {
...
void kern_packet_set_chain_counts(const kern_packet_t ph, uint32_t count,
                                  uint32_t bytes) {
...
void kern_packet_get_chain_counts(const kern_packet_t ph, uint32_t *count,
                                  uint32_t *bytes) {
  struct __kern_packet *p;
...
errno_t kern_buflet_set_data_offset(const kern_buflet_t buf,
                                    const uint32_t doff) {
  return __buflet_set_data_offset(buf, doff);
}

uint32_t kern_buflet_get_data_offset(const kern_buflet_t buf) {
  return __buflet_get_data_offset(buf);
}

errno_t kern_buflet_set_data_length(const kern_buflet_t buf,
                                    const uint32_t dlen) {
  return __buflet_set_data_length(buf, dlen);
}

uint32_t kern_buflet_get_data_length(const kern_buflet_t buf) {
  return __buflet_get_data_length(buf);
}

void *kern_buflet_get_object_address(const kern_buflet_t buf) {
  return __buflet_get_object_address(buf);
}

uint32_t kern_buflet_get_object_limit(const kern_buflet_t buf) {
  return __buflet_get_object_limit(buf);
}

void *kern_buflet_get_data_address(const kern_buflet_t buf) {
  return __buflet_get_data_address(buf);
}

errno_t kern_buflet_set_data_address(const kern_buflet_t buf,
                                     const void *daddr) {
  return __buflet_set_data_address(buf, daddr);
}

errno_t kern_buflet_set_buffer_offset(const kern_buflet_t buf,
                                      const uint32_t off) {
  return __buflet_set_buffer_offset(buf, off);
}

kern_segment_t kern_buflet_get_object_segment(const kern_buflet_t buf,
                                              kern_obj_idx_seg_t *idx) {
  return __buflet_get_object_segment(buf, idx);
}

uint32_t kern_buflet_get_data_limit(const kern_buflet_t buf) {
  return __buflet_get_data_limit(buf);
}

errno_t kern_buflet_set_data_limit(const kern_buflet_t buf,
                                   const uint32_t dlim) {
  return __buflet_set_data_limit(buf, dlim);
}

packet_trace_id_t kern_packet_get_trace_id(const kern_packet_t ph) {
  return __packet_get_trace_id(ph);
}

void kern_packet_set_trace_id(const kern_packet_t ph,
                              packet_trace_id_t trace_id) {
  return __packet_set_trace_id(ph, trace_id);
}

void kern_packet_trace_event(const kern_packet_t ph, uint32_t event) {
  return __packet_trace_event(ph, event);
}

errno_t kern_packet_copy_bytes(kern_packet_t pkt, size_t off, size_t len,
...
errno_t kern_packet_set_fpd_sequence_number(__unused const kern_packet_t ph,
                                            __unused uint32_t seq_num) {
  return 0;
}

errno_t kern_packet_set_fpd_context_id(__unused const kern_packet_t ph,
                                       __unused uint16_t ctx_id) {
  return 0;
}

errno_t kern_packet_set_fpd_command(__unused const kern_packet_t ph,
                                    __unused uint8_t cmd) {
  return 0;
}

errno_t kern_packet_get_flowid(const kern_packet_t ph,
                               packet_flowid_t *pflowid) {
  return __packet_get_flowid(ph, pflowid);
}

void kern_packet_set_trace_tag(const kern_packet_t ph, packet_trace_tag_t tag) {
  __packet_set_trace_tag(ph, tag);
}

packet_trace_tag_t kern_packet_get_trace_tag(const kern_packet_t ph) {
  return __packet_get_trace_tag(ph);
}

errno_t kern_packet_get_tx_nexus_port_id(const kern_packet_t ph,
                                         uint32_t *nx_port_id) {
  return __packet_get_tx_nx_port_id(ph, nx_port_id);
}

uint16_t kern_packet_get_protocol_segment_size(const kern_packet_t ph) {
  return __packet_get_protocol_segment_size(ph);
}

void kern_packet_set_segment_count(const kern_packet_t ph, uint8_t segcount) {
  __packet_set_segment_count(ph, segcount);
}

void *kern_packet_get_priv(const kern_packet_t ph) {
  return __packet_get_priv(ph);
}

void kern_packet_set_priv(const kern_packet_t ph, void *priv) {
  return __packet_set_priv(ph, priv);
}

void kern_packet_get_tso_flags(const kern_packet_t ph,
                               packet_tso_flags_t *flags) {
  return __packet_get_tso_flags(ph, flags);
}

errno_t kern_packet_check_for_expiry_and_notify(const kern_packet_t ph,
                                                ifnet_t ifp, uint16_t origin,
                                                uint16_t status) {
  errno_t err = 0;
  ...
  if (exp_notif.packet_tx_expiration_timestamp <
      exp_notif.packet_tx_expiration_deadline) {
  ...
  err = kern_channel_event_transmit_expired(ifp, &exp_notif, nx_port_id);
