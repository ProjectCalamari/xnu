    ...
    [SKMEM_REGION_GUARD_HEAD] =
        {
            ...
            .srp_cflags = SKMEM_REGION_CR_MMAPOK | SKMEM_REGION_CR_GUARD |
    ...
    [SKMEM_REGION_SCHEMA] =
        {
            ...
            .srp_cflags = SKMEM_REGION_CR_MMAPOK | SKMEM_REGION_CR_UREADONLY |
                          SKMEM_REGION_CR_NOMAGAZINES |
    ...
    [SKMEM_REGION_RING] =
        {
            ...
            .srp_cflags = SKMEM_REGION_CR_MMAPOK | SKMEM_REGION_CR_NOMAGAZINES |
    ...
    [SKMEM_REGION_RXBUF_DEF] =
        {
            ...
            .srp_cflags = SKMEM_REGION_CR_MMAPOK | SKMEM_REGION_CR_NOMAGAZINES |
                          SKMEM_REGION_CR_IODIR_IN | SKMEM_REGION_CR_SHAREOK |
                          SKMEM_REGION_CR_PUREDATA,
            .srp_r_obj_cnt = 0,
            .srp_md_type = NEXUS_META_TYPE_INVALID,
            .srp_md_subtype = NEXUS_META_SUBTYPE_INVALID,
    ...
    [SKMEM_REGION_USTATS] =
        {
            ...
            .srp_cflags = SKMEM_REGION_CR_MMAPOK | SKMEM_REGION_CR_MONOLITHIC |
                          SKMEM_REGION_CR_NOMAGAZINES |
                          SKMEM_REGION_CR_PUREDATA,
            .srp_md_type = NEXUS_META_TYPE_INVALID,
            .srp_md_subtype = NEXUS_META_SUBTYPE_INVALID,
    ...
    [SKMEM_REGION_NEXUSADV] =
        {
            ...
            .srp_cflags = SKMEM_REGION_CR_MMAPOK | SKMEM_REGION_CR_UREADONLY |
                          SKMEM_REGION_CR_MONOLITHIC |
                          SKMEM_REGION_CR_NOMAGAZINES |
                          SKMEM_REGION_CR_PERSISTENT | SKMEM_REGION_CR_PUREDATA,
            .srp_md_type = NEXUS_META_TYPE_INVALID,
            .srp_md_subtype = NEXUS_META_SUBTYPE_INVALID,
        },
    ...
    [SKMEM_REGION_KMD] =
        {
            ...
            .srp_cflags = SKMEM_REGION_CR_NOMAGAZINES | SKMEM_REGION_CR_MEMTAG,
            .srp_md_type = NEXUS_META_TYPE_PACKET,
            .srp_md_subtype = NEXUS_META_SUBTYPE_RAW,
            .srp_max_frags = 1,
        },
...
const skmem_region_id_t skmem_pp_region_ids[SKMEM_PP_REGIONS] = {
    SKMEM_REGION_BUF_DEF,     SKMEM_REGION_BUF_LARGE, SKMEM_REGION_RXBUF_DEF,
    SKMEM_REGION_RXBUF_LARGE, SKMEM_REGION_TXBUF_DEF, SKMEM_REGION_TXBUF_LARGE,
    SKMEM_REGION_KMD,         SKMEM_REGION_RXKMD,     SKMEM_REGION_TXKMD,
    SKMEM_REGION_UMD,         SKMEM_REGION_KBFT,      SKMEM_REGION_RXKBFT,
    SKMEM_REGION_TXKBFT,      SKMEM_REGION_UBFT};
...
SYSCTL_NODE(_kern_skywalk, OID_AUTO, mem, CTLFLAG_RW | CTLFLAG_LOCKED, 0,
            "Skywalk kmem");
 ...
 */
const struct skmem_region_params *skmem_get_default(skmem_region_id_t id) {
 ...
 */
uint32_t skmem_cpu_cache_line_size(void) {
 ...
 */
void skmem_dispatch(thread_call_t tcall, void (*func)(void), uint64_t delay) {
...
static void skmem_sys_region_init(void) {
  ...
  sk_sys_obj =
      skmem_region_alloc(sk_sys_region, &maddr, NULL, NULL, SKMEM_SLEEP,
                         sk_sys_region->skr_c_obj_size, &msize);
...
struct skmem_region *skmem_get_sysctls_region(void) { return sk_sys_region; }

void *__sized_by(sk_sys_objsize) skmem_get_sysctls_obj(size_t *size) {
  if (size != NULL) {
    *size = sk_sys_objsize;
  }
...
__attribute__((noinline, cold,
               not_tail_called)) char *skmem_dump(struct skmem_region *skr) {
  ...
  if (skmem_dump_buf == NULL) {
    skmem_dump_buf =
        (char *)kalloc_data(SKMEM_DUMP_BUF_SIZE, (Z_ZERO | Z_WAITOK));
  ...
  k = sk_snprintf(
      ...
      vm_page_free_count, vm_page_speculative_count, vm_page_active_count,
      vm_page_inactive_count, vm_page_wire_count, vm_page_throttled_count,
      vm_lopage_free_count, vm_page_purgeable_count, vm_page_purged_count);
  SKMEM_WDT_DUMP_BUF_CHK();
...
boolean_t skmem_lowmem_check(void) {
