...
/** @flowswitch subclass */
#define SK_KTRACE_FSW_DEV_RING_FLUSH                                           \
  SKYWALKDBG_CODE(DBG_SKYWALK_FLOWSWITCH, 0x001)
#define SK_KTRACE_FSW_USER_RING_FLUSH                                          \
  SKYWALKDBG_CODE(DBG_SKYWALK_FLOWSWITCH, 0x002)
#define SK_KTRACE_FSW_FLOW_TRACK_RTT                                           \
  SKYWALKDBG_CODE(DBG_SKYWALK_FLOWSWITCH, 0x004)
...
#define SK_KTRACE_NETIF_RX_NOTIFY_DEFAULT                                      \
  SKYWALKDBG_CODE(DBG_SKYWALK_NETIF, 0x005)
