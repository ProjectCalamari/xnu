...
#ifndef P2ALIGN
#define P2ALIGN(x, align) ((uintptr_t)(x) & -((uintptr_t)(align)))
#endif /* P2ALIGN */
...
typedef unsigned int (*mcache_allocfn_t)(void *, mcache_obj_t ***, unsigned int,
                                         int);
...
typedef struct mcache {
   ...
   */
  mcache_cpu_t mc_cpu[1] __attribute__((aligned(MAX_CPU_CACHE_LINE_SIZE)));
} mcache_t;
...
__private_extern__ mcache_t *mcache_create(const char *, size_t, size_t,
                                           u_int32_t, int);
...
mcache_create_ext(const char *, size_t, mcache_allocfn_t, mcache_freefn_t,
                  mcache_auditfn_t, mcache_logfn_t, mcache_notifyfn_t,
                  void *__unsafe_indexable, u_int32_t, int);
...
__private_extern__ void mcache_audit_free_verify(mcache_audit_t *, void *,
                                                 size_t, size_t);
__private_extern__ void mcache_audit_free_verify_set(mcache_audit_t *, void *,
                                                     size_t, size_t);
__private_extern__ char *mcache_dump_mca(char buf[DUMP_MCA_BUF_SIZE],
                                         mcache_audit_t *);
