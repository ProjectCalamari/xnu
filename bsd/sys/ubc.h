...
#define UBC_PUSHDIRTY                                                          \
  0x01 /* clean any dirty pages in the specified range to the backing store */
#define UBC_PUSHALL                                                            \
  0x02 /* push both dirty and precious pages to the backing store */
#define UBC_INVALIDATE                                                         \
  0x04 /* invalidate pages in the specified range... may be used with          \
          UBC_PUSHDIRTY/ALL */
...
enum { UBC_SETSIZE_NO_FS_REENTRY = 1 };
...
int ubc_cs_blob_revalidate(vnode_t, struct cs_blob *, struct image_params *,
                           int, uint32_t);
...
/* cluster IO routines */
void cluster_update_state(vnode_t, vm_object_offset_t, vm_object_offset_t,
                          boolean_t);

int advisory_read(vnode_t, off_t, off_t, int);
int advisory_read_ext(vnode_t, off_t, off_t, int, int (*)(buf_t, void *),
                      void *, int);

int cluster_read(vnode_t, struct uio *, off_t, int);
int cluster_read_ext(vnode_t, struct uio *, off_t, int, int (*)(buf_t, void *),
                     void *);

int cluster_write(vnode_t, struct uio *, off_t, off_t, off_t, off_t, int);
int cluster_write_ext(vnode_t, struct uio *, off_t, off_t, off_t, off_t, int,
                      int (*)(buf_t, void *), void *);

int cluster_pageout(vnode_t, upl_t, upl_offset_t, off_t, int, off_t, int);
int cluster_pageout_ext(vnode_t, upl_t, upl_offset_t, off_t, int, off_t, int,
                        int (*)(buf_t, void *), void *);

int cluster_pagein(vnode_t, upl_t, upl_offset_t, off_t, int, off_t, int);
int cluster_pagein_ext(vnode_t, upl_t, upl_offset_t, off_t, int, off_t, int,
                       int (*)(buf_t, void *), void *);
...
int ubc_create_upl_external(vnode_t, off_t, int, upl_t *, upl_page_info_t **,
                            int);
#ifdef XNU_KERNEL_PRIVATE
int ubc_create_upl_kernel(vnode_t, off_t, int, upl_t *, upl_page_info_t **, int,
                          vm_tag_t);
#endif /* XNU_KERNEL_PRIVATE */
