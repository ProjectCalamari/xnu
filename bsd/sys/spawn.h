...
/*
 * Possible values to be set for the process control actions on resource
 * starvation. POSIX_SPAWN_PCONTROL_THROTTLE indicates that the process is to be
 * throttled on starvation. POSIX_SPAWN_PCONTROL_SUSPEND indicates that the
 * process is to be suspended on starvation. POSIX_SPAWN_PCONTROL_KILL indicates
 * that the process is to be terminated  on starvation.
 */
