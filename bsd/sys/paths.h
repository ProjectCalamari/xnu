...
#define RESOLVE_LOCAL                                                          \
  0x00000004 /* prevent a path lookup into a network filesystem */
#define RESOLVE_NODEVFS                                                        \
  0x00000008 /* prevent a path lookup into `devfs` filesystem */
#define RESOLVE_IMMOVABLE                                                      \
  0x00000010 /* prevent a path lookup into a removable filesystem */
#define RESOLVE_UNIQUE                                                         \
  0x00000020 /* prevent a path lookup on a vnode with multiple links */
