...
/*
 * KERN_CTL_REG_OPAQUE means that kern_ctl_reg is an opaque structure
 * in the public header, and redeclared in kern_control_private.h.
 */
#define KERN_CTL_REG_OPAQUE
 ...
 */
errno_t ctl_enqueuedata(kern_ctl_ref kctlref, u_int32_t unit,
