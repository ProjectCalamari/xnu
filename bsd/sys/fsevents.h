...
#define FSE_UNMOUNT_PENDING                                                    \
  13 // iOS-only: client must respond via FSEVENTS_UNMOUNT_PENDING_ACK
#define FSE_CLONE 14
...
#define FSE_ARG_MODE                                                           \
  0x000a // next arg is the file's mode (as an int32, file type only)
#define FSE_ARG_GID 0x000b // next arg is the file's gid (gid_t)
#define FSE_ARG_FINFO                                                          \
  0x000c // next arg is a packed finfo (dev, ino, mode, uid, gid)
...
#define FSE_REMOTE_DIR_EVENT                                                   \
  (1U << 29) // this is a remotely generated directory-level granularity event
#define FSE_TRUNCATED_PATH                                                     \
  (1U << 28)                      // the path for this item had to be truncated
