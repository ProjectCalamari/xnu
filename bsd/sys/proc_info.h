...
#define PROC_FLAG_PC_THROTTLE                                                  \
  0x200 /* In resource starvation situations, this process is to be throttled  \
         */
#define PROC_FLAG_PC_SUSP                                                      \
  0x400 /* In resource starvation situations, this process is to be suspended  \
         */
#define PROC_FLAG_PC_KILL                                                      \
  0x600 /* In resource starvation situations, this process is to be terminated \
         */
