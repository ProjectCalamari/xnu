...
int fs_snapshot_create(int, const char *, uint32_t) __OSX_AVAILABLE(10.12)
...
int fs_snapshot_delete(int, const char *, uint32_t) __OSX_AVAILABLE(10.12)
    __IOS_AVAILABLE(10.0) __TVOS_AVAILABLE(10.0) __WATCHOS_AVAILABLE(3.0);
...
#define SNAPSHOT_MNT_IGNORE_OWNERSHIP                                          \
  0x00200000                             /* same as MNT_IGNORE_OWNERSHIP */
...
int fs_snapshot_revert(int, const char *, uint32_t) __OSX_AVAILABLE(10.12)
    __IOS_AVAILABLE(10.0) __TVOS_AVAILABLE(10.0) __WATCHOS_AVAILABLE(3.0);

#ifdef PRIVATE
int fs_snapshot_root(int, const char *, uint32_t) __OSX_AVAILABLE(10.12.4)
    __IOS_AVAILABLE(10.3) __TVOS_AVAILABLE(10.3) __WATCHOS_AVAILABLE(3.3);
#endif
