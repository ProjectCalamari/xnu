 ...
 * DKIOCGETMAXSEGMENTBYTECOUNTREAD       get maximum segment byte count for
 * reads DKIOCGETMAXSEGMENTBYTECOUNTWRITE      get maximum segment byte count
 * for writes
 *
 ...
 * DKIOCGETIOMINSATURATIONBYTECOUNT      get minimum byte count to saturate
 * storage bandwidth
 *
 * DKIOCGETERRORDESCRIPTION              get description of any drive error
 *
 * DKIOCGETMAXSWAPWRITE                  get maximum swap file write per day in
 * bytes
 */
