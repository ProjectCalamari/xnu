...
#define _DKIOCCSPINTOFASTMEDIA                                                 \
  (0) /* Pin extent to the fast (SSD) media             */
#define _DKIOCCSPINFORHIBERNATION                                              \
  (1 << 0) /* Pin of hibernation file, content not preserved */
#define _DKIOCCSPINDISCARDDENYLIST                                             \
  (1 << 1) /* Hibernation complete/error, stop denylist-ing  */
#define _DKIOCCSPINTOSLOWMEDIA                                                 \
  (1 << 2) /* Pin extent to the slow (HDD) media             */
#define _DKIOCCSTEMPORARYPIN                                                   \
  (1 << 3) /* Relocate, but do not pin, to indicated media   */
#define _DKIOCCSHIBERNATEIMGSIZE                                               \
  (1 << 4) /* Anticipate/Max size of the upcoming hibernate  */
#define _DKIOCCSPINFORSWAPFILE                                                 \
  (1 << 5) /* Pin of swap file, content not preserved        */
...
typedef enum { DK_APFS_ONE_DEVICE = 1, DK_APFS_FUSION } dk_apfs_flavour_t;
