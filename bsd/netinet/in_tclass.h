...
#define SO_TCDBG_PNAME                                                         \
  0x02 /* Set/get traffic class policy for processes of that name */
...
#define NET_QOS_MARKING_POLICY_DEFAULT                                         \
  QOS_MODE_MARKING_POLICY_DEFAULT /* obsolete, to be removed */
#define NET_QOS_MARKING_POLICY_ENABLE                                          \
  QOS_MODE_MARKING_POLICY_ENABLE /* obsolete, to be removed */
#define NET_QOS_MARKING_POLICY_DISABLE                                         \
  QOS_MODE_MARKING_POLICY_DISABLE /* obsolete, to be removed */
