...
extern uint64_t
    hwcksum_in_invalidated; /* Inbound packets with invalid hw cksum. */
...
extern uint32_t
    hwcksum_dbg_partial_rxoff_forced; /* Forced partial cksum rx offset. */
extern uint32_t
    hwcksum_dbg_partial_rxoff_adj; /* Adjusted partial cksum rx offset. */
extern uint64_t
    hwcksum_dbg_verified; /* Packets verified for having good cksum. */
