...
SYSCTL_PROC(_net_link_generic_system, OID_AUTO, sndq_maxlen,
            CTLTYPE_INT | CTLFLAG_RW | CTLFLAG_LOCKED, &if_sndq_maxlen,
            IFQ_MAXLEN, sysctl_sndq_maxlen, "I",
            "Default transmit queue max length");

uint32_t if_rcvq_maxlen = IF_RCVQ_MAXLEN;
SYSCTL_PROC(_net_link_generic_system, OID_AUTO, rcvq_maxlen,
            CTLTYPE_INT | CTLFLAG_RW | CTLFLAG_LOCKED, &if_rcvq_maxlen,
            IFQ_MAXLEN, sysctl_rcvq_maxlen, "I",
            "Default receive queue max length");
...
SYSCTL_PROC(_net_link_generic_system, OID_AUTO, rcvq_burst_limit,
            CTLTYPE_INT | CTLFLAG_RW | CTLFLAG_LOCKED, &if_rcvq_burst_limit,
            IF_RCVQ_BURST_LIMIT_DEFAULT, sysctl_rcvq_burst_limit, "I",
            "Upper memory limit for inbound data");
...
SYSCTL_PROC(_net_link_generic_system, OID_AUTO, rcvq_trim_pct,
            CTLTYPE_INT | CTLFLAG_RW | CTLFLAG_LOCKED, &if_rcvq_trim_pct,
            IF_RCVQ_TRIM_PCT_DEFAULT, sysctl_rcvq_trim_pct, "I",
            "Percentage (0 - 100) of the queue limit to keep after detecting "
            "an overflow burst");

struct chain_len_stats tx_chain_len_stats;
SYSCTL_PROC(_net_link_generic_system, OID_AUTO, tx_chain_len_stats,
            CTLFLAG_RD | CTLFLAG_LOCKED, 0, 9, sysctl_tx_chain_len_stats, "S",
            "");
...
SYSCTL_PROC(_net_link_generic_system, OID_AUTO, rxpoll_freeze_time,
            ...
            &if_rxpoll_mode_holdtime, IF_RXPOLL_MODE_HOLDTIME,
            sysctl_rxpoll_mode_holdtime, "Q", "input poll mode freeze time");
...
SYSCTL_PROC(_net_link_generic_system, OID_AUTO, rxpoll_sample_time,
            CTLTYPE_QUAD | CTLFLAG_RW | CTLFLAG_LOCKED,
            &if_rxpoll_sample_holdtime, IF_RXPOLL_SAMPLETIME,
            sysctl_rxpoll_sample_holdtime, "Q", "input poll sampling time");
...
SYSCTL_PROC(_net_link_generic_system, OID_AUTO, rxpoll_interval_time,
            ...
            sysctl_rxpoll_interval_time, "Q", "input poll interval (time)");
...
SYSCTL_PROC(_net_link_generic_system, OID_AUTO, rxpoll_wakeups_lowat,
            ...
            IF_RXPOLL_WLOWAT, sysctl_rxpoll_wlowat, "I",
...
SYSCTL_PROC(_net_link_generic_system, OID_AUTO, rxpoll_wakeups_hiwat,
            ...
            IF_RXPOLL_WHIWAT, sysctl_rxpoll_whiwat, "I",
...
SYSCTL_PROC(_net_link_generic_system, OID_AUTO, input_thread_termination_spin,
            ...
            sysctl_input_thread_termination_spin, "I",
            "input thread termination spin limit");
#endif /* TEST_INPUT_THREAD_TERMINATION */
...
SYSCTL_QUAD(_net_link_generic_system, OID_AUTO, hwcksum_in_invalidated,
            CTLFLAG_RD | CTLFLAG_LOCKED, &hwcksum_in_invalidated,
...
SYSCTL_PROC(_net_link_generic_system, OID_AUTO, hwcksum_dbg_mode,
            CTLTYPE_INT | CTLFLAG_RW | CTLFLAG_LOCKED, &hwcksum_dbg_mode, 0,
            sysctl_hwcksum_dbg_mode, "I", "hardware cksum debugging mode");

uint64_t hwcksum_dbg_partial_forced = 0;
SYSCTL_QUAD(_net_link_generic_system, OID_AUTO, hwcksum_dbg_partial_forced,
            CTLFLAG_RD | CTLFLAG_LOCKED, &hwcksum_dbg_partial_forced,
...
SYSCTL_PROC(_net_link_generic_system, OID_AUTO, hwcksum_dbg_partial_rxoff_adj,
            CTLTYPE_INT | CTLFLAG_RW | CTLFLAG_LOCKED,
            &hwcksum_dbg_partial_rxoff_adj, 0,
            sysctl_hwcksum_dbg_partial_rxoff_adj, "I",
            "adjusted partial cksum rx offset");

uint64_t hwcksum_dbg_verified = 0;
SYSCTL_QUAD(_net_link_generic_system, OID_AUTO, hwcksum_dbg_verified,
            CTLFLAG_RD | CTLFLAG_LOCKED, &hwcksum_dbg_verified,
            "packets verified for having good checksum");

uint64_t hwcksum_dbg_bad_cksum = 0;
SYSCTL_QUAD(_net_link_generic_system, OID_AUTO, hwcksum_dbg_bad_cksum,
            CTLFLAG_RD | CTLFLAG_LOCKED, &hwcksum_dbg_bad_cksum,
            "packets with bad hardware calculated checksum");

uint64_t hwcksum_dbg_bad_rxoff = 0;
SYSCTL_QUAD(_net_link_generic_system, OID_AUTO, hwcksum_dbg_bad_rxoff,
            CTLFLAG_RD | CTLFLAG_LOCKED, &hwcksum_dbg_bad_rxoff,
            "packets with invalid rxoff");

uint64_t hwcksum_dbg_adjusted = 0;
SYSCTL_QUAD(_net_link_generic_system, OID_AUTO, hwcksum_dbg_adjusted,
            CTLFLAG_RD | CTLFLAG_LOCKED, &hwcksum_dbg_adjusted,
            "packets with rxoff adjusted");

uint64_t hwcksum_dbg_finalized_hdr = 0;
SYSCTL_QUAD(_net_link_generic_system, OID_AUTO, hwcksum_dbg_finalized_hdr,
            CTLFLAG_RD | CTLFLAG_LOCKED, &hwcksum_dbg_finalized_hdr,
            "finalized headers");

uint64_t hwcksum_dbg_finalized_data = 0;
SYSCTL_QUAD(_net_link_generic_system, OID_AUTO, hwcksum_dbg_finalized_data,
            CTLFLAG_RD | CTLFLAG_LOCKED, &hwcksum_dbg_finalized_data,
            "finalized payloads");
...
SYSCTL_INT(_net_link_generic_system, OID_AUTO, dlil_verbose,
           CTLFLAG_RW | CTLFLAG_LOCKED, &dlil_verbose, 0,
           "Log DLIL error messages");
...
SYSCTL_PROC(_net_link_generic_system, OID_AUTO, if_attach_nx,
            ...
            &if_attach_nx_sysctl, "IU", "attach nexus");

#endif /* DEVELOPMENT || DEBUG */

SYSCTL_PROC(_net_link_generic_system, OID_AUTO, enable_netagent,
            CTLTYPE_INT | CTLFLAG_RW | CTLFLAG_LOCKED, 0, 0,
            &if_enable_fsw_transport_netagent_sysctl, "IU",
...
SYSCTL_UINT(_net_link_generic_system, OID_AUTO, link_heuristics_flags,
            CTLFLAG_RW | CTLFLAG_LOCKED, &if_link_heuristics_flags,
            DEFAULT_IF_LINK_HEURISTIC, "");

int if_link_heuristics_lqm_max = 0;
SYSCTL_INT(_net_link_generic_system, OID_AUTO, link_heuristics_lqm_max,
           CTLFLAG_RW | CTLFLAG_LOCKED, &if_link_heuristics_lqm_max, 0,
...
SYSCTL_UINT(_net_link_generic_system, OID_AUTO, link_heuristics_delay,
            CTLFLAG_RW | CTLFLAG_LOCKED, &if_link_heuristics_delay,
            IF_LINK_HEURISTICS_DELAY_MSECS, "");
...
#pragma unused(oidp, arg1, arg2)
  ...
  err = SYSCTL_OUT(req, &tx_chain_len_stats, sizeof(struct chain_len_stats));
...
#pragma unused(oidp)
  ...
  error =
      ifnet_get_keepalive_offload_frames(ifp, frames_array, frames_array_count,
...
#pragma unused(oidp, arg1, arg2)
  ...
  error = sysctl_io_number(req, if_enable_fsw_transport_netagent,
                           sizeof(if_enable_fsw_transport_netagent), &new_value,
                           &changed);
