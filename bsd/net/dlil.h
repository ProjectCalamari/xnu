...
enum { BPF_TAP_DISABLE, BPF_TAP_INPUT, BPF_TAP_OUTPUT, BPF_TAP_INPUT_OUTPUT };
...
#define net_timeradd(tvp, uvp, vvp)                                            \
  do {                                                                         \
...
#define net_timersub(tvp, uvp, vvp)                                            \
  do {                                                                         \
    (vvp)->tv_sec = (tvp)->tv_sec - (uvp)->tv_sec;                             \
    (vvp)->tv_nsec = (tvp)->tv_nsec - (uvp)->tv_nsec;                          \
    if ((vvp)->tv_nsec < 0) {                                                  \
...
struct dlil_threading_info {
  ...
  errno_t (*dlth_strategy)(struct dlil_threading_info *, struct ifnet *,
...
__CCT_DECLARE_CONSTRAINED_PTR_TYPES(struct dlil_threading_info,
                                    dlil_threading_info);
...
__CCT_DECLARE_CONSTRAINED_PTR_TYPES(struct dlil_main_threading_info,
                                    dlil_main_threading_info);
...
#define DLIL_IFF_INTERNAL                                                      \
  0x02                       /* Apple internal -- do not count towards stats */
...
extern errno_t dlil_resolve_multi(struct ifnet *, const struct sockaddr *,
...
extern errno_t ifnet_input_poll(struct ifnet *, struct mbuf *, struct mbuf *,
...
extern int ifnet_set_flowswitch_rx_callback(ifnet_t ifp, ifnet_fsw_rx_cb_t cb,
                                            void *arg);
extern int ifnet_get_flowswitch_rx_callback(ifnet_t ifp, ifnet_fsw_rx_cb_t *cbp,
                                            void **argp);
...
extern void ifnet_set_detach_notify_locked(ifnet_t ifp,
                                           ifnet_detach_notify_cb_t cb,
                                           void *arg);
extern void ifnet_get_detach_notify_locked(ifnet_t ifp,
                                           ifnet_detach_notify_cb_t *cbp,
                                           void **argp);
extern void ifnet_set_detach_notify(ifnet_t ifp, ifnet_detach_notify_cb_t cb,
                                    void *arg);
extern void ifnet_get_detach_notify(ifnet_t ifp, ifnet_detach_notify_cb_t *cbp,
                                    void **argp);
 ...
 */
extern int dlil_if_acquire(u_int32_t, const void *__sized_by(uniqueid_len),
                           size_t uniqueid_len, const char *__null_terminated,
                           struct ifnet **);
/*
...
extern int dlil_node_present_v2(struct ifnet *, struct sockaddr *,
...
static inline const void *__header_indexable __attribute__((always_inline))
dlil_ifaddr_bytes_indexable(const struct sockaddr_dl *sdl, size_t *sizep,
                            kauth_cred_t *cred) {
  const void *__unsafe_indexable raw_bytes =
      dlil_ifaddr_bytes(sdl, sizep, cred);
...
extern errno_t dlil_input_handler(struct ifnet *, struct mbuf *, struct mbuf *,
                                  const struct ifnet_stat_increment_param *,
...
ifnet_set_nat64prefix(struct ifnet *,
                      struct ipv6_prefix *__counted_by(NAT64_MAX_NUM_PREFIXES));
__private_extern__ int
ifnet_get_nat64prefix(struct ifnet *,
                      struct ipv6_prefix *__counted_by(NAT64_MAX_NUM_PREFIXES));
