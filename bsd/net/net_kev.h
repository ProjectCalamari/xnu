...
#else
#define KEV_DL_MASTER_ELECTED                                                  \
  (_Pragma("gcc warn Use KEV_DL_PRIMARY_ELECTED instead")                      \
...
#define KEV_ND6_ADDR_DEPRECATED                                                \
  7                            /* IPv6 address's preferred lifetime expired */
...
#define KEV_IPSEC_WAKE_PACKET                                                  \
  1 /* IPsec wake packet available, the                                        \
     * first packet processed after a wake event */

#define KEV_POWER_SUBCLASS 14
#define KEV_POWER_WAKE_PACKET                                                  \
  1 /* wake attributable to process with port offloaded to driver */
#define KEV_POWER_UNATTRIBUTED_WAKE                                            \
  2 /* wake without port offloaded to driver */
