...
__private_extern__ void skmem_sysctl_init(void) {
  // TCP values
...
__private_extern__ int skmem_sysctl_handle_int(__unused struct sysctl_oid *oidp,
                                               void *arg1, int arg2,
                                               struct sysctl_req *req) {
  int changed = 0;
  int result = sysctl_io_number(req, *(int *)arg1, sizeof(int), arg1, &changed);
  if (changed) {
