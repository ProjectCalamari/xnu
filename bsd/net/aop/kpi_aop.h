...
typedef errno_t (*net_aop_config_fn_t)(void *prov_ctx, net_aop_capab_t capab,
...
typedef errno_t (*net_aop_flow_setup_fn_t)(void *prov_ctx, uint32_t flow_id,
                                           bool add, uint32_t *stats_index);
...
typedef errno_t (*net_aop_flow_stats_fn_t)(void *prov_ctx, uint32_t stats_index,
...
typedef errno_t (*net_aop_stats_fn_t)(void *prov_ctx, net_aop_stats_type_t type,
                                      uint8_t *stats, size_t stats_len);
...
typedef errno_t (*net_aop_proc_activity_bitmap_fn_t)(
    void *prov_ctx, struct aop_proc_activity_bitmap *proc_activity_bitmaps,
...
extern void net_aop_deregister_provider(net_aop_provider_handle_t prov);
