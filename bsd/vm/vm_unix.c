...
SYSCTL_INT(_vm, OID_AUTO, map_debug_apple_protect, CTLFLAG_RW | CTLFLAG_LOCKED,
           &vm_map_debug_apple_protect, 0, "");
#endif /* VM_MAP_DEBUG_APPLE_PROTECT */

#if DEVELOPMENT || DEBUG

extern int vm_object_cache_evict_all(void);
static int sysctl_vm_object_cache_evict SYSCTL_HANDLER_ARGS {
#pragma unused(arg1, arg2, req)
  (void)vm_object_cache_evict_all();
  return 0;
}

SYSCTL_PROC(_vm, OID_AUTO, object_cache_evict,
            CTLTYPE_INT | CTLFLAG_WR | CTLFLAG_LOCKED | CTLFLAG_MASKED, 0, 0,
            &sysctl_vm_object_cache_evict, "I", "");

static int sysctl_kmem_alloc_contig SYSCTL_HANDLER_ARGS {
#pragma unused(arg1, arg2)
  ...
  kr = kmem_alloc_contig(kernel_map, &kaddr, (vm_size_t)size, 0, 0, 0, KMA_DATA,
...
SYSCTL_PROC(_vm, OID_AUTO, kmem_alloc_contig,
            CTLTYPE_INT | CTLFLAG_WR | CTLFLAG_LOCKED | CTLFLAG_MASKED, 0, 0,
            &sysctl_kmem_alloc_contig, "I", "");

extern int vm_region_footprint;
SYSCTL_INT(_vm, OID_AUTO, region_footprint,
           CTLFLAG_RW | CTLFLAG_ANYBODY | CTLFLAG_LOCKED, &vm_region_footprint,
           0, "");

static int sysctl_kmem_gobj_stats SYSCTL_HANDLER_ARGS {
...
SYSCTL_PROC(_vm, OID_AUTO, kmem_gobj_stats,
            CTLTYPE_STRUCT | CTLFLAG_RD | CTLFLAG_LOCKED | CTLFLAG_MASKED, 0, 0,
            &sysctl_kmem_gobj_stats, "S,kmem_gobj_stats", "");

#endif /* DEVELOPMENT || DEBUG */

static int sysctl_vm_self_region_footprint SYSCTL_HANDLER_ARGS {
#pragma unused(arg1, arg2, oidp)
  int error = 0;
  int value;
...
SYSCTL_PROC(_vm, OID_AUTO, self_region_footprint,
            CTLTYPE_INT | CTLFLAG_RW | CTLFLAG_ANYBODY | CTLFLAG_LOCKED |
                CTLFLAG_MASKED,
            0, 0, &sysctl_vm_self_region_footprint, "I", "");

static int sysctl_vm_self_region_page_size SYSCTL_HANDLER_ARGS {
#pragma unused(arg1, arg2, oidp)
  int error = 0;
  int value;
...
SYSCTL_PROC(_vm, OID_AUTO, self_region_page_size,
            CTLTYPE_INT | CTLFLAG_RW | CTLFLAG_ANYBODY | CTLFLAG_LOCKED |
                CTLFLAG_MASKED,
            0, 0, &sysctl_vm_self_region_page_size, "I", "");

static int sysctl_vm_self_region_info_flags SYSCTL_HANDLER_ARGS {
#pragma unused(arg1, arg2, oidp)
  int error = 0;
  int value;
  kern_return_t kr;
...
SYSCTL_PROC(_vm, OID_AUTO, self_region_info_flags,
            CTLTYPE_INT | CTLFLAG_RW | CTLFLAG_ANYBODY | CTLFLAG_LOCKED |
                CTLFLAG_MASKED,
            0, 0, &sysctl_vm_self_region_info_flags, "I", "");

#if DEVELOPMENT || DEBUG
extern int panic_on_unsigned_execute;
SYSCTL_INT(_vm, OID_AUTO, panic_on_unsigned_execute,
           CTLFLAG_RW | CTLFLAG_LOCKED, &panic_on_unsigned_execute, 0, "");

extern int vm_log_xnu_user_debug;
SYSCTL_INT(_vm, OID_AUTO, log_xnu_user_debug, CTLFLAG_RW | CTLFLAG_LOCKED,
           &vm_log_xnu_user_debug, 0, "");
#endif /* DEVELOPMENT || DEBUG */

extern int vm_log_map_delete_permanent_prot_none;
SYSCTL_INT(_vm, OID_AUTO, log_map_delete_permanent_prot_none,
           CTLFLAG_RW | CTLFLAG_LOCKED, &vm_log_map_delete_permanent_prot_none,
           0, "");

extern int cs_executable_create_upl;
extern int cs_executable_wire;
SYSCTL_INT(_vm, OID_AUTO, cs_executable_create_upl, CTLFLAG_RD | CTLFLAG_LOCKED,
           &cs_executable_create_upl, 0, "");
SYSCTL_INT(_vm, OID_AUTO, cs_executable_wire, CTLFLAG_RD | CTLFLAG_LOCKED,
           &cs_executable_wire, 0, "");
...
SYSCTL_INT(_vm, OID_AUTO, apple_protect_pager_count,
           CTLFLAG_RD | CTLFLAG_LOCKED, &apple_protect_pager_count, 0, "");
SYSCTL_INT(_vm, OID_AUTO, apple_protect_pager_count_mapped,
           CTLFLAG_RD | CTLFLAG_LOCKED, &apple_protect_pager_count_mapped, 0,
           "");
SYSCTL_UINT(_vm, OID_AUTO, apple_protect_pager_cache_limit,
            CTLFLAG_RW | CTLFLAG_LOCKED, &apple_protect_pager_cache_limit, 0,
            "");

#if DEVELOPMENT || DEBUG
extern int radar_20146450;
SYSCTL_INT(_vm, OID_AUTO, radar_20146450, CTLFLAG_RW | CTLFLAG_LOCKED,
           &radar_20146450, 0, "");

extern int macho_printf;
SYSCTL_INT(_vm, OID_AUTO, macho_printf, CTLFLAG_RW | CTLFLAG_LOCKED,
           &macho_printf, 0, "");

extern int apple_protect_pager_data_request_debug;
SYSCTL_INT(_vm, OID_AUTO, apple_protect_pager_data_request_debug,
...
EXPERIMENT_FACTOR_LEGACY_UINT(_vm, vm_object_copy_delayed_paging_wait_disable,
                              &vm_object_copy_delayed_paging_wait_disable,
                              FALSE, TRUE, "");

__enum_closed_decl(
    vm_submap_test_op, uint32_t,
...
static int sysctl_vm_submap_test_ctl SYSCTL_HANDLER_ARGS {
  int error;
  struct {
  ...
  case vsto_remap_submap:
    vm_map_testing_remap_submap(current_map(), args.submap_base_address,
                                args.start, args.end, args.offset);
    break;
  default:
    return EINVAL;
  }
...
SYSCTL_PROC(_vm, OID_AUTO, submap_test_ctl, CTLFLAG_WR | CTLFLAG_LOCKED, 0, 0,
            &sysctl_vm_submap_test_ctl, "-", "");
...
SYSCTL_UINT(_vm, OID_AUTO, native_hw_pagesize, CTLFLAG_RD | CTLFLAG_LOCKED,
            &arm_hardware_page_size, 0, "");
SYSCTL_UINT(_vm, OID_AUTO, arm_pt_desc_size, CTLFLAG_RD | CTLFLAG_LOCKED,
            &arm_pt_desc_size, 0, "");
SYSCTL_UINT(_vm, OID_AUTO, arm_pt_root_size, CTLFLAG_RD | CTLFLAG_LOCKED,
            &arm_pt_root_size, 0, "");
SYSCTL_UINT(_vm, OID_AUTO, user_tte_root, CTLFLAG_RD | CTLFLAG_LOCKED,
            &inuse_user_tteroot_count, 0, "");
SYSCTL_UINT(_vm, OID_AUTO, kernel_tte_root, CTLFLAG_RD | CTLFLAG_LOCKED,
            &inuse_kernel_tteroot_count, 0, "");
SYSCTL_UINT(_vm, OID_AUTO, user_tte_pages, CTLFLAG_RD | CTLFLAG_LOCKED,
            &inuse_user_ttepages_count, 0, "");
SYSCTL_UINT(_vm, OID_AUTO, kernel_tte_pages, CTLFLAG_RD | CTLFLAG_LOCKED,
            &inuse_kernel_ttepages_count, 0, "");
SYSCTL_UINT(_vm, OID_AUTO, user_pte_pages, CTLFLAG_RD | CTLFLAG_LOCKED,
            &inuse_user_ptepages_count, 0, "");
SYSCTL_UINT(_vm, OID_AUTO, kernel_pte_pages, CTLFLAG_RD | CTLFLAG_LOCKED,
            &inuse_kernel_ptepages_count, 0, "");
#if !CONFIG_SPTM
extern unsigned int free_page_size_tt_count;
extern unsigned int free_tt_count;
SYSCTL_UINT(_vm, OID_AUTO, free_1page_tte_root, CTLFLAG_RD | CTLFLAG_LOCKED,
            &free_page_size_tt_count, 0, "");
SYSCTL_UINT(_vm, OID_AUTO, free_tte_root, CTLFLAG_RD | CTLFLAG_LOCKED,
            &free_tt_count, 0, "");
#endif
#if DEVELOPMENT || DEBUG
extern unsigned long pmap_asid_flushes;
SYSCTL_ULONG(_vm, OID_AUTO, pmap_asid_flushes, CTLFLAG_RD | CTLFLAG_LOCKED,
             &pmap_asid_flushes, "");
extern unsigned long pmap_asid_hits;
SYSCTL_ULONG(_vm, OID_AUTO, pmap_asid_hits, CTLFLAG_RD | CTLFLAG_LOCKED,
             &pmap_asid_hits, "");
extern unsigned long pmap_asid_misses;
SYSCTL_ULONG(_vm, OID_AUTO, pmap_asid_misses, CTLFLAG_RD | CTLFLAG_LOCKED,
             &pmap_asid_misses, "");
extern unsigned long pmap_speculation_restrictions;
SYSCTL_ULONG(_vm, OID_AUTO, pmap_speculation_restrictions,
             CTLFLAG_RD | CTLFLAG_LOCKED, &pmap_speculation_restrictions, "");
#endif
#endif /* __arm64__ */
#endif /* DEVELOPMENT || DEBUG */

SYSCTL_INT(_vm, OID_AUTO, vm_do_collapse_compressor,
           CTLFLAG_RD | CTLFLAG_LOCKED, &vm_counters.do_collapse_compressor, 0,
           "");
SYSCTL_INT(_vm, OID_AUTO, vm_do_collapse_compressor_pages,
           CTLFLAG_RD | CTLFLAG_LOCKED,
           &vm_counters.do_collapse_compressor_pages, 0, "");
SYSCTL_INT(_vm, OID_AUTO, vm_do_collapse_terminate, CTLFLAG_RD | CTLFLAG_LOCKED,
           &vm_counters.do_collapse_terminate, 0, "");
SYSCTL_INT(_vm, OID_AUTO, vm_do_collapse_terminate_failure,
           CTLFLAG_RD | CTLFLAG_LOCKED,
           &vm_counters.do_collapse_terminate_failure, 0, "");
SYSCTL_INT(_vm, OID_AUTO, vm_should_cow_but_wired, CTLFLAG_RD | CTLFLAG_LOCKED,
           &vm_counters.should_cow_but_wired, 0, "");
SYSCTL_INT(_vm, OID_AUTO, vm_create_upl_extra_cow, CTLFLAG_RD | CTLFLAG_LOCKED,
           &vm_counters.create_upl_extra_cow, 0, "");
SYSCTL_INT(_vm, OID_AUTO, vm_create_upl_extra_cow_pages,
           CTLFLAG_RD | CTLFLAG_LOCKED, &vm_counters.create_upl_extra_cow_pages,
           0, "");
SYSCTL_INT(_vm, OID_AUTO, vm_create_upl_lookup_failure_write,
           CTLFLAG_RD | CTLFLAG_LOCKED,
           &vm_counters.create_upl_lookup_failure_write, 0, "");
SYSCTL_INT(_vm, OID_AUTO, vm_create_upl_lookup_failure_copy,
           CTLFLAG_RD | CTLFLAG_LOCKED,
           &vm_counters.create_upl_lookup_failure_copy, 0, "");
#if VM_SCAN_FOR_SHADOW_CHAIN
static int vm_shadow_max_enabled = 0; /* Disabled by default */
extern int proc_shadow_max(void);
static int vm_shadow_max SYSCTL_HANDLER_ARGS {
#pragma unused(arg1, arg2, oidp)
  int value = 0;
...
SYSCTL_PROC(_vm, OID_AUTO, vm_shadow_max,
            CTLTYPE_INT | CTLFLAG_RD | CTLFLAG_LOCKED, 0, 0, &vm_shadow_max,
            "I", "");

SYSCTL_INT(_vm, OID_AUTO, vm_shadow_max_enabled, CTLFLAG_RW | CTLFLAG_LOCKED,
           &vm_shadow_max_enabled, 0, "");

#endif /* VM_SCAN_FOR_SHADOW_CHAIN */

SYSCTL_INT(_vm, OID_AUTO, vm_debug_events, CTLFLAG_RW | CTLFLAG_LOCKED,
           &vm_debug_events, 0, "");

#if PAGE_SLEEP_WITH_INHERITOR
#if DEVELOPMENT || DEBUG
extern uint32_t page_worker_table_size;
SYSCTL_INT(_vm, OID_AUTO, page_worker_table_size, CTLFLAG_RD | CTLFLAG_LOCKED,
           &page_worker_table_size, 0, "");
SCALABLE_COUNTER_DECLARE(page_worker_hash_collisions);
SYSCTL_SCALABLE_COUNTER(_vm, page_worker_hash_collisions,
                        page_worker_hash_collisions, "");
SCALABLE_COUNTER_DECLARE(page_worker_inheritor_sleeps);
SYSCTL_SCALABLE_COUNTER(_vm, page_worker_inheritor_sleeps,
                        page_worker_inheritor_sleeps, "");
#endif /* DEVELOPMENT || DEBUG */
...
#if DEVELOPMENT || DEBUG
SYSCTL_UINT(_vm, OID_AUTO, compressor_heads, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_cheads, 0, "");
SYSCTL_UINT(_vm, OID_AUTO, compressor_head_select, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_chead_select, 0, "");
SYSCTL_INT(_vm, OID_AUTO, compressor_head_rehint, CTLFLAG_RD | CTLFLAG_LOCKED,
           &vm_chead_rehint, 0, "");
#endif /* DEVELOPMENT || DEBUG */
EXPERIMENT_FACTOR_UINT(compressor_heads, &vm_cheads, 1,
                       COMPRESSOR_PAGEOUT_CHEADS_MAX_COUNT, "");
EXPERIMENT_FACTOR_UINT(compressor_head_select, &vm_chead_select, CSEL_MIN,
                       CSEL_MAX, "");
...
SYSCTL_INT(_vm, OID_AUTO, allow_stack_exec, CTLFLAG_RW | CTLFLAG_LOCKED,
           &allow_stack_exec, 0, "");
SYSCTL_INT(_vm, OID_AUTO, allow_data_exec, CTLFLAG_RW | CTLFLAG_LOCKED,
           &allow_data_exec, 0, "");

#endif /* DEVELOPMENT || DEBUG */

static const char *prot_values[] = {
    "none",         "read-only",    "write-only",    "read-write",
    "execute-only", "read-execute", "write-execute", "read-write-execute"};

void log_stack_execution_failure(addr64_t vaddr, vm_prot_t prot) {
  printf("Data/Stack execution not permitted: %s[pid %d] at virtual address "
         "0x%qx, protections were %s\n",
         current_proc()->p_comm, proc_getpid(current_proc()), vaddr,
         prot_values[prot & VM_PROT_ALL]);
}
...
SYSCTL_INT(_vm, OID_AUTO, shared_region_unnest_logging,
           CTLFLAG_RW | CTLFLAG_LOCKED, &shared_region_unnest_logging, 0, "");
...
static char *scdir_path[] = {
    ...
    "/System/Cryptexes/OS/System/Library/dyld", NULL};
...
static char *scdir_path[] = {
    ...
    "/System/Cryptexes/OS/System/Library/Caches/com.apple.dyld", NULL};
...
#endif /* XNU_TARGET_OS_OSX */
    "/System/Cryptexes/OS/System/DriverKit/System/Library/dyld", NULL};
...
SYSCTL_PROC(_vm, OID_AUTO, enforce_shared_cache_dir,
            CTLTYPE_INT | CTLFLAG_RW | CTLFLAG_LOCKED, &scdir_enforce, 0,
            sysctl_scdir_enforce, "I", "");
#endif
...
void log_unnest_badness(vm_map_t m, vm_map_offset_t s, vm_map_offset_t e,
  ...
  if (shared_region_unnest_logging <= 2 && is_nested_map &&
  ...
  DTRACE_VM4(log_unnest_badness, vm_map_t, m, vm_map_offset_t, s,
             vm_map_offset_t, e, vm_map_offset_t, lowest_unnestable_addr);
  printf("%s[%d] triggered unnest of range 0x%qx->0x%qx of DYLD shared region "
         "in VM map %p. While not abnormal for debuggers, this increases "
         "system memory footprint until the target exits.\n",
         current_proc()->p_comm, proc_getpid(current_proc()), (uint64_t)s,
         (uint64_t)e, (void *)VM_KERNEL_ADDRPERM(m));
}

uint64_t vm_purge_filebacked_pagers(void) {
...
int useracc(user_addr_ut addr_u, user_size_ut len_u, int prot) {
  vm_map_t map;
  ...
  return vm_map_check_protection(map, addr_u,
                                 vm_sanitize_compute_ut_end(addr_u, len_u),
                                 vm_prot, VM_SANITIZE_CALLER_USERACC);
}

#if XNU_PLATFORM_MacOSX
static __attribute__((always_inline, warn_unused_result)) kern_return_t
vslock_sanitize(vm_map_t map, user_addr_ut addr_u, user_size_ut len_u,
                vm_sanitize_caller_t vm_sanitize_caller, vm_map_offset_t *start,
                vm_map_offset_t *end, vm_map_size_t *size) {
  return vm_sanitize_addr_size(addr_u, len_u, vm_sanitize_caller, map,
...
int vslock(user_addr_ut addr, user_size_ut len) {
  ...
  kret = vslock_sanitize(current_map(), addr, len, VM_SANITIZE_CALLER_VSLOCK,
                         &start, &end, &size);
...
int vsunlock(user_addr_ut addr, user_size_ut len, __unused int dirtied) {
#if FIXME /* [ */
  pmap_t pmap;
  vm_page_t pg;
  ...
  if (dirtied) {
    ...
    for (vaddr = vm_map_trunc_page(addr, PAGE_MASK);
         vaddr < vm_map_round_page(addr + len, PAGE_MASK); vaddr += PAGE_SIZE) {
  ...
  kret = vslock_sanitize(map, addr, len, VM_SANITIZE_CALLER_VSUNLOCK, &start,
                         &end, &size);
  if (__improbable(kret != KERN_SUCCESS)) {
    switch (vm_sanitize_get_kr(kret)) {
    case KERN_SUCCESS:
  ...
  kret = vm_map_unwire(map, addr, vm_sanitize_compute_ut_end(addr, len), false);
  switch (kret) {
  case KERN_SUCCESS:
    return 0;
  case KERN_INVALID_ADDRESS:
...
/*
 * With a 32-bit kernel and mixed 32/64-bit user tasks, this interface allows
 * the fetching and setting of process-sized size_t and pointer values.
 */
int sulong(user_addr_t addr, int64_t word) {
...
int suulong(user_addr_t addr, uint64_t uword) {
  if (IS_64BIT_PROCESS(current_proc())) {
...
int swapon(__unused proc_t procp, __unused struct swapon_args *uap,
           __unused int *retval) {
  return ENOTSUP;
}
...
SYSCTL_INT(_kern, OID_AUTO, secure_kernel, CTLFLAG_RD | CTLFLAG_LOCKED,
           &kern_secure_kernel, 0, "");
SYSCTL_INT(_vm, OID_AUTO, shared_region_trace_level,
           CTLFLAG_RW | CTLFLAG_LOCKED, &shared_region_trace_level, 0, "");
SYSCTL_INT(_vm, OID_AUTO, shared_region_version, CTLFLAG_RD | CTLFLAG_LOCKED,
           &shared_region_version, 0, "");
SYSCTL_INT(_vm, OID_AUTO, shared_region_persistence,
           CTLFLAG_RW | CTLFLAG_LOCKED, &shared_region_persistence, 0, "");
 ...
 */
int shared_region_check_np(__unused struct proc *p,
  ...
  SHARED_REGION_TRACE_DEBUG(("shared_region: %p [%d(%s)] -> check_np(0x%llx)\n",
                             (void *)VM_KERNEL_ADDRPERM(current_thread()),
                             proc_getpid(p), p->p_comm,
                             (uint64_t)uap->start_address));

  /*
   * Special value of start_address used to indicate that map_with_linking()
   * should no longer be allowed in this process
   */
  if (uap->start_address == (task_get_64bit_addr(task)
                                 ? DYLD_VM_END_MWL
                                 : (uint32_t)DYLD_VM_END_MWL)) {
  ...
  if (shared_region != NULL) {
    ...
    if (uap->start_address == 0) {
      ...
      if (kr != KERN_SUCCESS) {
        SHARED_REGION_TRACE_ERROR(
            ("shared_region: %p [%d(%s)] "
             ...
             (void *)VM_KERNEL_ADDRPERM(current_thread()), proc_getpid(p),
             p->p_comm, (uint64_t)uap->start_address, kr));
        error = ENOMEM;
      }
      if (error == 0) {
        /* Insert the shared region submap and various bits of debug info into
         * the task. */
       ...
       */
      if ((error == 0) &&
          (vm_shared_region_auth_remap(shared_region) != KERN_SUCCESS)) {
      ...
      if (error == 0) {
        error = copyout(&start_address, (user_addr_t)uap->start_address,
        ...
        if (error != 0) {
          SHARED_REGION_TRACE_ERROR(
              ("shared_region: %p [%d(%s)] "
               ...
               (void *)VM_KERNEL_ADDRPERM(current_thread()), proc_getpid(p),
               p->p_comm, (uint64_t)uap->start_address, (uint64_t)start_address,
               error));
        }
      }
    }
  ...
  SHARED_REGION_TRACE_DEBUG(
      ("shared_region: %p [%d(%s)] check_np(0x%llx) <- 0x%llx %d\n",
       (void *)VM_KERNEL_ADDRPERM(current_thread()), proc_getpid(p), p->p_comm,
       (uint64_t)uap->start_address, (uint64_t)start_address, error));

  return error;
}

static int shared_region_copyin(struct proc *p, user_addr_t user_addr,
                                unsigned int count, unsigned int element_size,
                                void *kernel_data) {
  int error = 0;
  ...
  if (error) {
    SHARED_REGION_TRACE_ERROR(("shared_region: %p [%d(%s)] map(): "
                               ...
                               (void *)VM_KERNEL_ADDRPERM(current_thread()),
                               proc_getpid(p), p->p_comm, (uint64_t)user_addr,
                               (long)size, error));
  }
  return error;
}
...
shared_region_map_and_slide_cleanup(struct proc *p, uint32_t files_count,
 ...
 */
__attribute__((noinline)) static int shared_region_map_and_slide_setup(
    struct proc *p, uint32_t files_count, struct shared_file_np *files,
    uint32_t mappings_count, struct shared_file_mapping_slide_np *mappings,
    struct _sr_file_mappings **sr_file_mappings,
    struct vm_shared_region **shared_region_ptr, struct vnode *rdir_vp) {
  int error = 0;
  ...
  *sr_file_mappings =
      kalloc_type(struct _sr_file_mappings, files_count, Z_WAITOK | Z_ZERO);
  ...
  *shared_region_ptr = shared_region;
  ...
  for (srfmp = &(*sr_file_mappings)[0];
       srfmp < &(*sr_file_mappings)[files_count]; srfmp++) {
    ...
    if (srfmp->fd == -1) {
      ...
      if (!vm_map_page_aligned(dest_addr, vm_map_page_mask(current_map()))) {
        SHARED_REGION_TRACE_ERROR(("shared_region: %p [%d(%s)] map data "
                                   "destination 0x%llx not aligned\n",
                                   (void *)VM_KERNEL_ADDRPERM(current_thread()),
    ...
    if (srfmp->vp->v_type != VREG) {
      SHARED_REGION_TRACE_ERROR(("shared_region: %p [%d(%s)] map(%p:'%s'): "
                                 "not a file (type=%d)\n",
                                 (void *)VM_KERNEL_ADDRPERM(current_thread()),
                                 proc_getpid(p), p->p_comm,
     ...
     *       of the shared cache */
    error = mac_file_check_mmap(
        vfs_context_ucred(vfs_context_current()), srfmp->fp->fp_glob,
        VM_PROT_ALL, MAP_FILE | MAP_PRIVATE | MAP_FIXED, 0, &maxprot);
    if (error) {
      goto done;
    }
#endif /* MAC */
    ...
    if (blob == NULL) {
      SHARED_REGION_TRACE_ERROR((
          ...
          "missing CS blob\n",
          (void *)VM_KERNEL_ADDRPERM(current_thread()), proc_getpid(p),
          p->p_comm, (void *)VM_KERNEL_ADDRPERM(srfmp->vp), srfmp->vp->v_name));
      goto root_check;
    }
    ...
    if (query_trust_cache(kTCQueryTypeAll, cdhash, &qt) == KERN_SUCCESS) {
      ...
      in_trust_cache =
          (tc_ret.error == kTCReturnSuccess &&
           (tc_type == kTCTypeCryptex1BootOS || tc_type == kTCTypeStatic ||
      ...
      if (error) {
        SHARED_REGION_TRACE_ERROR(
            ("shared_region: %p [%d(%s)] map(%p:'%s'): "
             "vnode_getattr(%p) failed (error=%d)\n",
             (void *)VM_KERNEL_ADDRPERM(current_thread()), proc_getpid(p),
             p->p_comm, (void *)VM_KERNEL_ADDRPERM(srfmp->vp),
             srfmp->vp->v_name, (void *)VM_KERNEL_ADDRPERM(srfmp->vp), error));
        goto done;
      }
...
#define PREBOOT_CRYPTEX_PATH "/private/preboot/Cryptexes"
#endif
      error = vnode_lookup(PREBOOT_CRYPTEX_PATH, 0, &preboot_vp,
                           vfs_context_current());
    ...
    if (scdir_enforce) {
      char **expected_scdir_path =
          is_driverkit ? driverkit_scdir_path : scdir_path;
      struct vnode *scdir_vp = NULL;
      for (expected_scdir_path = is_driverkit ? driverkit_scdir_path
                                              : scdir_path;
           *expected_scdir_path != NULL; expected_scdir_path++) {
        /* get vnode for expected_scdir_path */
        error = vnode_lookup(*expected_scdir_path, 0, &scdir_vp,
                             vfs_context_current());
        if (error) {
          SHARED_REGION_TRACE_ERROR(
              ("shared_region: %p [%d(%s)]: "
               ...
               (void *)VM_KERNEL_ADDRPERM(current_thread()), proc_getpid(p),
               p->p_comm, *expected_scdir_path, error));
          continue;
        }
    ...
    if (!cs_system_enforcement()) {
      ...
      for (i = 0; i < srfmp->mappings_count; i++) {
        ...
        SHARED_REGION_TRACE_ERROR((
            ...
            (void *)VM_KERNEL_ADDRPERM(current_thread()), proc_getpid(p),
            p->p_comm, (void *)VM_KERNEL_ADDRPERM(srfmp->vp), srfmp->vp->v_name,
            i, srfmp->mappings_count, srfmp->mappings[i].sms_address,
            srfmp->mappings[i].sms_size, srfmp->mappings[i].sms_file_offset,
            srfmp->mappings[i].sms_max_prot, srfmp->mappings[i].sms_init_prot));
        error = EINVAL;
        goto done;
      }
    }
  ...
  if (error != 0) {
    shared_region_map_and_slide_cleanup(p, files_count, *sr_file_mappings,
                                        shared_region);
 ...
 */
static int _shared_region_map_and_slide(
    struct proc *p, uint32_t files_count, struct shared_file_np *files,
    uint32_t mappings_count, struct shared_file_mapping_slide_np *mappings) {
  int error = 0;
   ...
   */
  error = shared_region_map_and_slide_setup(
      p, files_count, files, mappings_count, mappings, &sr_file_mappings,
      &shared_region, rdir_vp);
  if (error != 0) {
    vnode_put(rdir_vp);
    return error;
  }
...
shared_region_map_and_slide_cleanup(struct proc *p, uint32_t files_count,
  ...
  if (sr_file_mappings != NULL) {
    for (srfmp = &sr_file_mappings[0]; srfmp < &sr_file_mappings[files_count];
         srfmp++) {
      if (srfmp->vp != NULL) {
 ...
 */
#define SFM_MAX                                                                \
  (_SR_FILE_MAPPINGS_MAX_FILES * 8) /* max mapping structs allowed to pass in  \
                                     */

/*
 * This is the new interface for setting up shared region mappings.
 *
 * The slide used for shared regions setup using this interface is done
 * differently from the old interface. The slide value passed in the
 * shared_files_np represents a max value. The kernel will choose a random value
 * based on that, then use it for all shared regions.
 */
#if defined(__x86_64__)
...
static inline __result_use_check
    kern_return_t shared_region_map_and_slide_2_np_sanitize(
        struct proc *p, user_addr_t mappings_userspace_addr, unsigned int count,
  ...
  for (size_t i = 0; i < count; i++) {
     ...
     * avoid TOCTOU.
     */
    kr = shared_region_copyin(p, user_addr,
    ...
    kr = vm_sanitize_addr_size(
        mapping_u.sms_address_u, mapping_u.sms_size_u,
        VM_SANITIZE_CALLER_SHARED_REGION_MAP_AND_SLIDE_2_NP, map,
    ...
    kr = vm_sanitize_addr_size(
        mapping_u.sms_file_offset_u, mapping_u.sms_size_u,
        VM_SANITIZE_CALLER_SHARED_REGION_MAP_AND_SLIDE_2_NP, PAGE_MASK,
        (VM_SANITIZE_FLAGS_SIZE_ZERO_FALLTHROUGH |
         VM_SANITIZE_FLAGS_GET_UNALIGNED_VALUES),
        &offset, &offset_end, &offset_size);
    if (__improbable(kr != KERN_SUCCESS)) {
      return kr;
    }
     ...
     */
    mach_vm_size_ut sms_slide_size_u = vm_sanitize_wrap_size(
        VM_SANITIZE_UNSAFE_UNWRAP(mapping_u.sms_slide_size_u));

    kr = vm_sanitize_addr_size(
        mapping_u.sms_slide_start_u, sms_slide_size_u,
        VM_SANITIZE_CALLER_SHARED_REGION_MAP_AND_SLIDE_2_NP, map,
        (VM_SANITIZE_FLAGS_SIZE_ZERO_FALLTHROUGH |
         VM_SANITIZE_FLAGS_GET_UNALIGNED_VALUES),
        &slide_start, &slide_end, &slide_size);
    if (__improbable(kr != KERN_SUCCESS)) {
      return kr;
    }

    kr = vm_sanitize_cur_and_max_prots(
        mapping_u.sms_init_prot_u, mapping_u.sms_max_prot_u,
        VM_SANITIZE_CALLER_SHARED_REGION_MAP_AND_SLIDE_2_NP, map,
        VM_PROT_SFM_EXTENSIONS_MASK | VM_PROT_TPRO, &cur, &max);
    if (__improbable(kr != KERN_SUCCESS)) {
      return kr;
    }
    ...
    if (__improbable(os_add_overflow(
            user_addr, sizeof(shared_file_mapping_slide_np_ut), &user_addr))) {
      return KERN_INVALID_ARGUMENT;
    }
  }
...
int shared_region_map_and_slide_2_np(
    struct proc *p, struct shared_region_map_and_slide_2_np_args *uap,
    __unused int *retvalp) {
  ...
  if (files_count == 0) {
    SHARED_REGION_TRACE_INFO(("shared_region: %p [%d(%s)] map(): "
                              "no files\n",
                              (void *)VM_KERNEL_ADDRPERM(current_thread()),
                              proc_getpid(p), p->p_comm));
    ...
    SHARED_REGION_TRACE_ERROR(("shared_region: %p [%d(%s)] map(): "
                               ...
                               (void *)VM_KERNEL_ADDRPERM(current_thread()),
                               proc_getpid(p), p->p_comm, files_count,
  ...
  if (mappings_count == 0) {
    ...
    SHARED_REGION_TRACE_ERROR(("shared_region: %p [%d(%s)] map(): "
                               ...
                               (void *)VM_KERNEL_ADDRPERM(current_thread()),
                               proc_getpid(p), p->p_comm, mappings_count,
                               SFM_MAX));
    kr = KERN_FAILURE;
    goto done;
  }
   ...
   */
  kr = shared_region_copyin(p, uap->files, files_count, sizeof(shared_files[0]),
                            shared_files);
  if (kr != KERN_SUCCESS) {
    SHARED_REGION_TRACE_ERROR(
  ...
  kr = shared_region_map_and_slide_2_np_sanitize(p, uap->mappings_u,
  ...
  for (f = 0; f < files_count; ++f) {
    ...
    for (i = 0; i < shared_files[f].sf_mappings_count; ++i, ++m) {
      ...
      if (__improbable(os_add_overflow(mappings[m].sms_address, slide_amount,
      ...
      if (mappings[m].sms_slide_size != 0) {
        ...
        if (__improbable(
                os_add_overflow(mappings[m].sms_slide_start, slide_amount,
                                &mappings[m].sms_slide_start) ||
                os_add_overflow(mappings[m].sms_slide_start,
                                mappings[m].sms_slide_size, &discard))) {
          kr = KERN_INVALID_ARGUMENT;
          goto done;
        }
      }
  ...
  kr = _shared_region_map_and_slide(p, files_count, shared_files,
                                    mappings_count, mappings);
done:
...
/*
 * A syscall for dyld to use to map data pages that need load time relocation
 * fixups. The fixups are performed by a custom pager during page-in, so the
 * pages still appear "clean" and hence are easily discarded under memory
 * pressure. They can be re-paged-in on demand later, all w/o using the
 * compressor.
 *
 * Note these page are treated as MAP_PRIVATE. So if the application dirties any
 * pages while running, they are COW'd as normal.
 */
int map_with_linking_np(struct proc *p, struct map_with_linking_np_args *uap,
                        __unused int *retvalp) {
  ...
  if (link_info_size >= MWL_MAX_LINK_INFO_SIZE) {
    printf("%s: [%d(%s)]: link_info_size too big %d\n", __func__,
           proc_getpid(p), p->p_comm, link_info_size);
    kr = KERN_FAILURE;
    goto done;
  }
  ...
  kr = shared_region_copyin(p, uap->regions, region_count, sizeof(regions[0]),
                            regions);
  if (kr != KERN_SUCCESS) {
  ...
  if (info_hdr->mwli_version != MWL_INFO_VERS) {
    printf("%s: [%d(%s)]: unrecognized mwli_version=%d\n", __func__,
           proc_getpid(p), p->p_comm, info_hdr->mwli_version);
    kr = KERN_FAILURE;
    goto done;
  }
  ...
  if (info_hdr->mwli_binds_offset > link_info_size) {
    printf("%s: [%d(%s)]: mwli_binds_offset too large %d\n", __func__,
           proc_getpid(p), p->p_comm, info_hdr->mwli_binds_offset);
    kr = KERN_FAILURE;
    goto done;
  }
  ...
  if (binds_size > link_info_size - info_hdr->mwli_binds_offset) {
    printf("%s: [%d(%s)]: mwli_binds_count too large %d\n", __func__,
           proc_getpid(p), p->p_comm, info_hdr->mwli_binds_count);
    kr = KERN_FAILURE;
    goto done;
  }
  ...
  if (info_hdr->mwli_chains_offset > link_info_size) {
    printf("%s: [%d(%s)]: mwli_chains_offset too large %d\n", __func__,
           proc_getpid(p), p->p_comm, info_hdr->mwli_chains_offset);
    kr = KERN_FAILURE;
    goto done;
  }
   ...
   */
  if (info_hdr->mwli_chains_size <
      sizeof(struct dyld_chained_starts_in_image)) {
    printf("%s: [%d(%s)]: mwli_chains_size too small %d\n", __func__,
           proc_getpid(p), p->p_comm, info_hdr->mwli_chains_size);
    kr = KERN_FAILURE;
    goto done;
  }
  if (info_hdr->mwli_chains_size >
      link_info_size - info_hdr->mwli_chains_offset) {
  ...
  for (r = 0; r < region_count; ++r) {
    if (regions[r].mwlr_fd != fd) {
      printf("%s: [%d(%s)]: mwlr_fd mismatch %d and %d\n", __func__,
             proc_getpid(p), p->p_comm, fd, regions[r].mwlr_fd);
      kr = KERN_FAILURE;
      goto done;
    }
  ...
  for (r = 0; r < region_count; ++r) {
    ...
    error = mac_file_check_mmap(
        vfs_context_ucred(vfs_context_current()), fp->fp_glob, prot,
        MAP_FILE | MAP_PRIVATE | MAP_FIXED, rp->mwlr_file_offset, &prot);
    if (error) {
      printf(
    ...
    /* check that the mappings are properly covered by code signatures */
    if (cs_system_enforcement()) {
      if (!ubc_cs_is_range_codesigned(vp, rp->mwlr_file_offset,
                                      rp->mwlr_size)) {
        printf("%s: [%d(%s)]: region %d, not code signed\n", __func__,
               proc_getpid(p), p->p_comm, r);
        kr = KERN_FAILURE;
        goto done;
      }
    }
  ...
  kr = vm_map_with_linking(proc_task(p), regions, region_count, &link_info,
                           link_info_size, file_control);
...
SYSCTL_INT(_vm, OID_AUTO, dyld_pager_count, CTLFLAG_RD | CTLFLAG_LOCKED,
           &dyld_pager_count, 0, "");
SYSCTL_INT(_vm, OID_AUTO, dyld_pager_count_max, CTLFLAG_RD | CTLFLAG_LOCKED,
           &dyld_pager_count_max, 0, "");
...
/* vm_page_free_target is provided as a makeshift solution for applications that
 * want to allocate buffer space, possibly purgeable memory, but not cause
 * inactive pages to be reclaimed. It allows the app to calculate how much
 * memory is free outside the free target. */
...
static int vm_ctl_page_free_wanted SYSCTL_HANDLER_ARGS {
...
SYSCTL_INT(_vm, OID_AUTO, page_purgeable_wired_count,
           CTLFLAG_RD | CTLFLAG_LOCKED, &vm_page_purgeable_wired_count, 0,
           "Wired purgeable page count");
...
SYSCTL_SCALABLE_COUNTER(_vm, pages_grabbed, vm_page_grab_count,
                        "Total pages grabbed");
SCALABLE_COUNTER_DECLARE(vm_page_grab_count_kern);
SYSCTL_SCALABLE_COUNTER(_vm, pages_grabbed_kern, vm_page_grab_count_kern,
                        "Total pages grabbed (kernel)");
SCALABLE_COUNTER_DECLARE(vm_page_grab_count_iopl);
SYSCTL_SCALABLE_COUNTER(_vm, pages_grabbed_iopl, vm_page_grab_count_iopl,
                        "Total pages grabbed (iopl)");
SCALABLE_COUNTER_DECLARE(vm_page_grab_count_upl);
SYSCTL_SCALABLE_COUNTER(_vm, pages_grabbed_upl, vm_page_grab_count_upl,
                        "Total pages grabbed (upl)");

#if DEVELOPMENT || DEBUG
SCALABLE_COUNTER_DECLARE(vm_page_deactivate_behind_count);
SYSCTL_SCALABLE_COUNTER(_vm, pages_deactivated_behind,
...
#endif /*__ARM_MIXED_PAGE_SIZE__ */
SYSCTL_INT(_debug, OID_AUTO, vm_mixed_pagesize_supported,
           CTLFLAG_ANYBODY | CTLFLAG_RD | CTLFLAG_LOCKED,
           &vm_mixed_pagesize_supported, 0,
           "kernel support for mixed pagesize");
...
SYSCTL_INT(_vm, OID_AUTO, pageout_purged_objects, CTLFLAG_RD | CTLFLAG_LOCKED,
           &vm_pageout_debug.vm_pageout_purged_objects, 0,
           "System purged object count");
SYSCTL_UINT(_vm, OID_AUTO, pageout_cleaned_busy, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_pageout_debug.vm_pageout_cleaned_busy, 0,
            "Cleaned pages busy (deactivated)");
SYSCTL_UINT(_vm, OID_AUTO, pageout_cleaned_nolock, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_pageout_debug.vm_pageout_cleaned_nolock, 0,
            "Cleaned pages no-lock (deactivated)");

SYSCTL_UINT(_vm, OID_AUTO, pageout_cleaned_volatile_reactivated,
            CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_pageout_debug.vm_pageout_cleaned_volatile_reactivated, 0,
            "Cleaned pages volatile reactivated");
SYSCTL_UINT(_vm, OID_AUTO, pageout_cleaned_fault_reactivated,
            CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_pageout_debug.vm_pageout_cleaned_fault_reactivated, 0,
            "Cleaned pages fault reactivated");
SYSCTL_UINT(_vm, OID_AUTO, pageout_cleaned_reactivated,
            CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_pageout_debug.vm_pageout_cleaned_reactivated, 0,
            "Cleaned pages reactivated"); /* sum of all reactivated AND busy and
                                             nolock (even though those actually
                                             get reDEactivated */
SYSCTL_ULONG(_vm, OID_AUTO, pageout_cleaned, CTLFLAG_RD | CTLFLAG_LOCKED,
             &vm_pageout_vminfo.vm_pageout_freed_cleaned,
             "Cleaned pages freed");
SYSCTL_UINT(_vm, OID_AUTO, pageout_cleaned_reference_reactivated,
            CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_pageout_debug.vm_pageout_cleaned_reference_reactivated, 0,
            "Cleaned pages reference reactivated");
SYSCTL_UINT(_vm, OID_AUTO, pageout_enqueued_cleaned,
            CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_pageout_debug.vm_pageout_enqueued_cleaned, 0,
            ""); /* sum of next two */
#endif           /* DEVELOPMENT || DEBUG */
...
SYSCTL_INT(_vm, OID_AUTO, madvise_free_debug_sometimes,
           CTLFLAG_RW | CTLFLAG_LOCKED, &madvise_free_debug_sometimes, 0,
           "sometimes zero-fill on madvise(MADV_FREE*)");
...
SYSCTL_UINT(_vm, OID_AUTO, page_cleaned_count, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_page_cleaned_count, 0, "Cleaned queue size");

extern unsigned int vm_page_pageable_internal_count,
    vm_page_pageable_external_count;
SYSCTL_UINT(_vm, OID_AUTO, page_pageable_internal_count,
            CTLFLAG_RD | CTLFLAG_LOCKED, &vm_page_pageable_internal_count, 0,
            "");
SYSCTL_UINT(_vm, OID_AUTO, page_pageable_external_count,
            CTLFLAG_RD | CTLFLAG_LOCKED, &vm_page_pageable_external_count, 0,
            "");

/* pageout counts */
SYSCTL_UINT(_vm, OID_AUTO, pageout_inactive_clean, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_pageout_state.vm_pageout_inactive_clean, 0, "");
SYSCTL_UINT(_vm, OID_AUTO, pageout_inactive_used, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_pageout_state.vm_pageout_inactive_used, 0, "");

SYSCTL_ULONG(_vm, OID_AUTO, pageout_inactive_dirty_internal,
             CTLFLAG_RD | CTLFLAG_LOCKED,
             &vm_pageout_vminfo.vm_pageout_inactive_dirty_internal, "");
SYSCTL_ULONG(_vm, OID_AUTO, pageout_inactive_dirty_external,
             CTLFLAG_RD | CTLFLAG_LOCKED,
             &vm_pageout_vminfo.vm_pageout_inactive_dirty_external, "");
SYSCTL_ULONG(_vm, OID_AUTO, pageout_speculative_clean,
             CTLFLAG_RD | CTLFLAG_LOCKED,
             &vm_pageout_vminfo.vm_pageout_freed_speculative, "");
SYSCTL_ULONG(_vm, OID_AUTO, pageout_freed_external, CTLFLAG_RD | CTLFLAG_LOCKED,
             &vm_pageout_vminfo.vm_pageout_freed_external, "");
SYSCTL_ULONG(_vm, OID_AUTO, pageout_freed_speculative,
             CTLFLAG_RD | CTLFLAG_LOCKED,
             &vm_pageout_vminfo.vm_pageout_freed_speculative, "");
SYSCTL_ULONG(_vm, OID_AUTO, pageout_freed_cleaned, CTLFLAG_RD | CTLFLAG_LOCKED,
             &vm_pageout_vminfo.vm_pageout_freed_cleaned, "");

SYSCTL_ULONG(_vm, OID_AUTO, pageout_protected_sharedcache,
             CTLFLAG_RD | CTLFLAG_LOCKED,
             &vm_pageout_vminfo.vm_pageout_protected_sharedcache, "");
SYSCTL_ULONG(_vm, OID_AUTO, pageout_forcereclaimed_sharedcache,
             CTLFLAG_RD | CTLFLAG_LOCKED,
             &vm_pageout_vminfo.vm_pageout_forcereclaimed_sharedcache, "");
SYSCTL_ULONG(_vm, OID_AUTO, pageout_protected_realtime,
             CTLFLAG_RD | CTLFLAG_LOCKED,
             &vm_pageout_vminfo.vm_pageout_protected_realtime, "");
SYSCTL_ULONG(_vm, OID_AUTO, pageout_forcereclaimed_realtime,
             CTLFLAG_RD | CTLFLAG_LOCKED,
             &vm_pageout_vminfo.vm_pageout_forcereclaimed_realtime, "");
extern unsigned int vm_page_realtime_count;
SYSCTL_UINT(_vm, OID_AUTO, page_realtime_count, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_page_realtime_count, 0, "");
extern int vm_pageout_protect_realtime;
SYSCTL_INT(_vm, OID_AUTO, pageout_protect_realtime, CTLFLAG_RW | CTLFLAG_LOCKED,
           &vm_pageout_protect_realtime, 0, "");
...
SYSCTL_QUAD(_vm, OID_AUTO, prefault_nb_pages, CTLFLAG_RW | CTLFLAG_LOCKED,
            &vm_prefault_nb_pages, "");
SYSCTL_QUAD(_vm, OID_AUTO, prefault_nb_bailout, CTLFLAG_RW | CTLFLAG_LOCKED,
            &vm_prefault_nb_bailout, "");
SYSCTL_QUAD(_vm, OID_AUTO, prefault_nb_no_page, CTLFLAG_RW | CTLFLAG_LOCKED,
            &vm_prefault_nb_no_page, "");
SYSCTL_QUAD(_vm, OID_AUTO, prefault_nb_wrong_page, CTLFLAG_RW | CTLFLAG_LOCKED,
            &vm_prefault_nb_wrong_page, "");

#if defined(__x86_64__)
extern unsigned int vm_clump_promote_threshold;
SYSCTL_UINT(_vm, OID_AUTO, vm_clump_promote_threshold,
            CTLFLAG_RW | CTLFLAG_LOCKED, &vm_clump_promote_threshold, 0,
            "clump size threshold for promotes");
#if DEVELOPMENT || DEBUG
extern unsigned long vm_clump_stats[];
SYSCTL_LONG(_vm, OID_AUTO, vm_clump_stats1, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_clump_stats[1], "free page allocations from clump of 1 page");
SYSCTL_LONG(_vm, OID_AUTO, vm_clump_stats2, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_clump_stats[2], "free page allocations from clump of 2 pages");
SYSCTL_LONG(_vm, OID_AUTO, vm_clump_stats3, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_clump_stats[3], "free page allocations from clump of 3 pages");
SYSCTL_LONG(_vm, OID_AUTO, vm_clump_stats4, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_clump_stats[4], "free page allocations from clump of 4 pages");
SYSCTL_LONG(_vm, OID_AUTO, vm_clump_stats5, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_clump_stats[5], "free page allocations from clump of 5 pages");
SYSCTL_LONG(_vm, OID_AUTO, vm_clump_stats6, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_clump_stats[6], "free page allocations from clump of 6 pages");
SYSCTL_LONG(_vm, OID_AUTO, vm_clump_stats7, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_clump_stats[7], "free page allocations from clump of 7 pages");
SYSCTL_LONG(_vm, OID_AUTO, vm_clump_stats8, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_clump_stats[8], "free page allocations from clump of 8 pages");
SYSCTL_LONG(_vm, OID_AUTO, vm_clump_stats9, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_clump_stats[9], "free page allocations from clump of 9 pages");
SYSCTL_LONG(_vm, OID_AUTO, vm_clump_stats10, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_clump_stats[10],
            "free page allocations from clump of 10 pages");
SYSCTL_LONG(_vm, OID_AUTO, vm_clump_stats11, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_clump_stats[11],
            "free page allocations from clump of 11 pages");
SYSCTL_LONG(_vm, OID_AUTO, vm_clump_stats12, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_clump_stats[12],
            "free page allocations from clump of 12 pages");
SYSCTL_LONG(_vm, OID_AUTO, vm_clump_stats13, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_clump_stats[13],
            "free page allocations from clump of 13 pages");
SYSCTL_LONG(_vm, OID_AUTO, vm_clump_stats14, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_clump_stats[14],
            "free page allocations from clump of 14 pages");
SYSCTL_LONG(_vm, OID_AUTO, vm_clump_stats15, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_clump_stats[15],
            "free page allocations from clump of 15 pages");
SYSCTL_LONG(_vm, OID_AUTO, vm_clump_stats16, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_clump_stats[16],
            "free page allocations from clump of 16 pages");
extern unsigned long vm_clump_allocs, vm_clump_inserts, vm_clump_inrange,
    vm_clump_promotes;
SYSCTL_LONG(_vm, OID_AUTO, vm_clump_alloc, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_clump_allocs, "free page allocations");
SYSCTL_LONG(_vm, OID_AUTO, vm_clump_inserts, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_clump_inserts, "free page insertions");
SYSCTL_LONG(_vm, OID_AUTO, vm_clump_inrange, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_clump_inrange,
            "free page insertions that are part of vm_pages");
SYSCTL_LONG(_vm, OID_AUTO, vm_clump_promotes, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_clump_promotes, "pages promoted to head");
#endif /* if DEVELOPMENT || DEBUG */
#endif /* #if defined (__x86_64__) */

#if CONFIG_SECLUDED_MEMORY

SYSCTL_UINT(_vm, OID_AUTO, num_tasks_can_use_secluded_mem,
            CTLFLAG_RD | CTLFLAG_LOCKED, &num_tasks_can_use_secluded_mem, 0,
            "");
...
SYSCTL_UINT(_vm, OID_AUTO, page_secluded_target, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_page_secluded_target, 0, "");
SYSCTL_UINT(_vm, OID_AUTO, page_secluded_count, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_page_secluded_count, 0, "");
SYSCTL_UINT(_vm, OID_AUTO, page_secluded_count_free,
            CTLFLAG_RD | CTLFLAG_LOCKED, &vm_page_secluded_count_free, 0, "");
SYSCTL_UINT(_vm, OID_AUTO, page_secluded_count_inuse,
            CTLFLAG_RD | CTLFLAG_LOCKED, &vm_page_secluded_count_inuse, 0, "");
SYSCTL_UINT(_vm, OID_AUTO, page_secluded_count_over_target,
            CTLFLAG_RD | CTLFLAG_LOCKED, &vm_page_secluded_count_over_target, 0,
            "");

extern struct vm_page_secluded_data vm_page_secluded;
SYSCTL_UINT(_vm, OID_AUTO, page_secluded_eligible, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_page_secluded.eligible_for_secluded, 0, "");
SYSCTL_UINT(_vm, OID_AUTO, page_secluded_grab_success_free,
            CTLFLAG_RD | CTLFLAG_LOCKED, &vm_page_secluded.grab_success_free, 0,
            "");
SYSCTL_UINT(_vm, OID_AUTO, page_secluded_grab_success_other,
            CTLFLAG_RD | CTLFLAG_LOCKED, &vm_page_secluded.grab_success_other,
            0, "");
SYSCTL_UINT(_vm, OID_AUTO, page_secluded_grab_failure_locked,
            CTLFLAG_RD | CTLFLAG_LOCKED, &vm_page_secluded.grab_failure_locked,
            0, "");
SYSCTL_UINT(_vm, OID_AUTO, page_secluded_grab_failure_state,
            CTLFLAG_RD | CTLFLAG_LOCKED, &vm_page_secluded.grab_failure_state,
            0, "");
SYSCTL_UINT(_vm, OID_AUTO, page_secluded_grab_failure_realtime,
            CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_page_secluded.grab_failure_realtime, 0, "");
SYSCTL_UINT(_vm, OID_AUTO, page_secluded_grab_failure_dirty,
            CTLFLAG_RD | CTLFLAG_LOCKED, &vm_page_secluded.grab_failure_dirty,
            0, "");
SYSCTL_UINT(_vm, OID_AUTO, page_secluded_grab_for_iokit,
            CTLFLAG_RD | CTLFLAG_LOCKED, &vm_page_secluded.grab_for_iokit, 0,
            "");
SYSCTL_UINT(_vm, OID_AUTO, page_secluded_grab_for_iokit_success,
            CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_page_secluded.grab_for_iokit_success, 0, "");

#endif /* CONFIG_SECLUDED_MEMORY */

#if CONFIG_DEFERRED_RECLAIM
#pragma mark Deferred Reclaim
SYSCTL_NODE(_vm, OID_AUTO, reclaim, CTLFLAG_RW | CTLFLAG_LOCKED, 0,
...
static int sysctl_vm_reclaim_wait_for_pid SYSCTL_HANDLER_ARGS {
...
static int sysctl_vm_reclaim_drain_pid SYSCTL_HANDLER_ARGS {
  int error = EINVAL;
  kern_return_t kr;
  pid_t pid;
  error = sysctl_handle_int(oidp, &pid, 0, req);
...
static int proc_filter_reclaimable(proc_t p, __unused void *arg) {
  task_t task = proc_task(p);
  return vm_deferred_reclamation_task_has_ring(task);
}

static int proc_reclaim_drain(proc_t p, __unused void *arg) {
  kern_return_t kr;
  task_t task = proc_task(p);
...
static int sysctl_vm_reclaim_drain_all SYSCTL_HANDLER_ARGS {
  int error;
  int val;
  if (!req->newptr) {
    return EINVAL;
...
SYSCTL_PROC(
    _vm_reclaim, OID_AUTO, drain_all,
    CTLTYPE_INT | CTLFLAG_WR | CTLFLAG_LOCKED | CTLFLAG_MASKED, 0, 0,
...
SYSCTL_UINT(_vm_reclaim, OID_AUTO, reclaim_buffer_count,
            CTLFLAG_RD | CTLFLAG_LOCKED, (uint32_t *)&vm_reclaim_buffer_count,
            0, "The number of deferred memory buffers currently alive");
...
SYSCTL_COMPAT_UINT(_vm_reclaim, OID_AUTO, debug, CTLFLAG_RW | CTLFLAG_LOCKED,
                   &vm_reclaim_debug, 0, "Debug logs for vm.reclaim");
#if XNU_TARGET_OS_IOS
SYSCTL_QUAD(
    _vm_reclaim, OID_AUTO, max_threshold, CTLFLAG_RW | CTLFLAG_LOCKED,
    &vm_reclaim_max_threshold,
    "Maximum amount of virtual memory (in B) that may be deferred without "
    "synchronous reclamation");
#else  /* !XNU_TARGET_OS_IOS */
SYSCTL_COMPAT_UINT(
    _vm_reclaim, OID_AUTO, enabled, CTLFLAG_RW | CTLFLAG_LOCKED,
    &vm_reclaim_enabled, 0,
...
SYSCTL_UINT(_vm_reclaim, OID_AUTO, autotrim_pct_normal,
            ...
            "Percentage of a task's lifetime max phys_footprint that must be "
            "reclaimable "
...
SYSCTL_UINT(
    _vm_reclaim, OID_AUTO, autotrim_pct_critical, CTLFLAG_RW | CTLFLAG_LOCKED,
    &vm_reclaim_autotrim_pct_critical, 0,
    "Percentage of a task's lifetime max phys_footprint that must be "
    "reclaimable "
    "to engage auto-trim when the system is under critical memory pressure");
SYSCTL_UINT(_vm_reclaim, OID_AUTO, wma_weight_base, CTLFLAG_RW | CTLFLAG_LOCKED,
            &vm_reclaim_wma_weight_base, 0,
            "Weight applied to historical minimum buffer size samples");
SYSCTL_UINT(_vm_reclaim, OID_AUTO, wma_weight_cur, CTLFLAG_RW | CTLFLAG_LOCKED,
            &vm_reclaim_wma_weight_cur, 0,
            "Weight applied to current sampled minimum buffer size");
SYSCTL_UINT(_vm_reclaim, OID_AUTO, wma_denom, CTLFLAG_RW | CTLFLAG_LOCKED,
            &vm_reclaim_wma_denom, 0,
            "Denominator for weighted moving average calculation");
SYSCTL_QUAD(
    _vm_reclaim, OID_AUTO, abandonment_threshold, CTLFLAG_RW | CTLFLAG_LOCKED,
    &vm_reclaim_abandonment_threshold,
    "The number of sampling periods between accounting updates that may elapse "
    "before the buffer is considered \"abandoned\"");
#endif /* XNU_TARGET_OS_IOS */

static int sysctl_vm_reclaim_sampling_period SYSCTL_HANDLER_ARGS {
  uint64_t new_val_ns;
  uint64_t old_val_ns = vm_reclaim_sampling_period_ns;
  int err = sysctl_io_number(req, vm_reclaim_sampling_period_ns,
                             sizeof(vm_reclaim_sampling_period_ns), &new_val_ns,
                             NULL);
  if (err || !req->newptr) {
    return err;
  }
  if (new_val_ns != old_val_ns) {
    ...
    nanoseconds_to_absolutetime(vm_reclaim_sampling_period_ns,
...
SYSCTL_PROC(
    _vm_reclaim, OID_AUTO, sampling_period_ns,
    CTLFLAG_RW | CTLTYPE_QUAD | CTLFLAG_LOCKED, NULL, 0,
    sysctl_vm_reclaim_sampling_period, "QU",
...
int vm_pressure_monitor(__unused struct proc *p,
                        struct vm_pressure_monitor_args *uap, int *retval) {
  kern_return_t kr;
  uint32_t pages_reclaimed;
  uint32_t pages_wanted;

  kr = mach_vm_pressure_monitor(
      (boolean_t)uap->wait_for_pressure, uap->nsecs_monitored,
      (uap->pages_reclaimed) ? &pages_reclaimed : NULL, &pages_wanted);
  ...
  if (uap->pages_reclaimed) {
    if (copyout((void *)&pages_reclaimed, uap->pages_reclaimed,
...
int kas_info(struct proc *p, struct kas_info_args *uap, int *retval __unused) {
  ...
  case KAS_INFO_KERNEL_SEGMENT_VMADDR_SELECTOR: {
    ...
    for (i = 0; i < mh->ncmds; i++) {
      if (cmd->cmd == LC_SEGMENT_KERNEL) {
        __IGNORE_WCASTALIGN(kernel_segment_command_t *sg =
...
#if CONFIG_SPTM
    const uint64_t slide = (selector == KAS_INFO_SPTM_TEXT_SLIDE_SELECTOR)
                               ? vm_sptm_offsets.slide
                               : vm_txm_offsets.slide;
#else
...
SYSCTL_ULONG(_vm, OID_AUTO, vm_min_kernel_address, CTLFLAG_RD,
             (unsigned long *)&vm_min_kernel_address, "");
SYSCTL_ULONG(_vm, OID_AUTO, vm_max_kernel_address, CTLFLAG_RD,
             (unsigned long *)&vm_max_kernel_address, "");
#pragma clang diagnostic pop

extern uint32_t vm_page_pages;
SYSCTL_UINT(_vm, OID_AUTO, pages, CTLFLAG_RD | CTLFLAG_LOCKED, &vm_page_pages,
            0, "");

extern uint32_t vm_page_busy_absent_skipped;
SYSCTL_UINT(_vm, OID_AUTO, page_busy_absent_skipped,
            CTLFLAG_RD | CTLFLAG_LOCKED, &vm_page_busy_absent_skipped, 0, "");

extern uint32_t vm_page_upl_tainted;
SYSCTL_UINT(_vm, OID_AUTO, upl_pages_tainted, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_page_upl_tainted, 0, "");

extern uint32_t vm_page_iopl_tainted;
SYSCTL_UINT(_vm, OID_AUTO, iopl_pages_tainted, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_page_iopl_tainted, 0, "");

#if __arm64__ && (DEVELOPMENT || DEBUG)
extern int vm_footprint_suspend_allowed;
SYSCTL_INT(_vm, OID_AUTO, footprint_suspend_allowed,
           CTLFLAG_RW | CTLFLAG_LOCKED, &vm_footprint_suspend_allowed, 0, "");

extern void pmap_footprint_suspend(vm_map_t map, boolean_t suspend);
static int sysctl_vm_footprint_suspend SYSCTL_HANDLER_ARGS {
#pragma unused(oidp, arg1, arg2)
  int error = 0;
  int new_value;
  ...
  DTRACE_VM2(footprint_suspend, vm_map_t, current_map(), int, new_value);
...
SYSCTL_QUAD(_vm, OID_AUTO, corpse_footprint_count, CTLFLAG_RD | CTLFLAG_LOCKED,
...
SYSCTL_QUAD(_vm, OID_AUTO, corpse_footprint_full, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_map_corpse_footprint_full, "");
SYSCTL_QUAD(_vm, OID_AUTO, corpse_footprint_no_buf, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_map_corpse_footprint_no_buf, "");

#if CODE_SIGNING_MONITOR
extern uint64_t vm_cs_defer_to_csm;
extern uint64_t vm_cs_defer_to_csm_not;
SYSCTL_QUAD(_vm, OID_AUTO, cs_defer_to_csm, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_cs_defer_to_csm, "");
SYSCTL_QUAD(_vm, OID_AUTO, cs_defer_to_csm_not, CTLFLAG_RD | CTLFLAG_LOCKED,
...
SYSCTL_INT(_vm, OID_AUTO, pmap_ledgers_panic_leeway,
           CTLFLAG_RW | CTLFLAG_LOCKED, &pmap_ledgers_panic_leeway, 0, "");
#endif /* MACH_ASSERT */
...
SYSCTL_QUAD(_vm, OID_AUTO, map_lookup_locked_copy_slowly_size,
            CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_map_lookup_and_lock_object_copy_slowly_size, "");
SYSCTL_QUAD(_vm, OID_AUTO, map_lookup_locked_copy_slowly_max,
            CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_map_lookup_and_lock_object_copy_slowly_max, "");
...
SYSCTL_QUAD(_vm, OID_AUTO, map_lookup_locked_copy_shadow_max,
            CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_map_lookup_and_lock_object_copy_shadow_max, "");

extern int vm_protect_privileged_from_untrusted;
SYSCTL_INT(_vm, OID_AUTO, protect_privileged_from_untrusted,
           CTLFLAG_RW | CTLFLAG_LOCKED, &vm_protect_privileged_from_untrusted,
           0, "");
...
SYSCTL_QUAD(_vm, OID_AUTO, copied_on_read, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_copied_on_read, "");
...
SYSCTL_INT(_vm, OID_AUTO, shared_region_count, CTLFLAG_RD | CTLFLAG_LOCKED,
           &vm_shared_region_count, 0, "");
SYSCTL_INT(_vm, OID_AUTO, shared_region_peak, CTLFLAG_RD | CTLFLAG_LOCKED,
           &vm_shared_region_peak, 0, "");
#if DEVELOPMENT || DEBUG
...
SYSCTL_INT(_vm, OID_AUTO, shared_region_key_count, CTLFLAG_RD | CTLFLAG_LOCKED,
           &shared_region_key_count, 0, "");
...
SYSCTL_INT(_vm, OID_AUTO, debug4k_filter, CTLFLAG_RW | CTLFLAG_LOCKED,
           &debug4k_filter, 0, "");
extern int debug4k_panic_on_terminate;
SYSCTL_INT(_vm, OID_AUTO, debug4k_panic_on_terminate,
           CTLFLAG_RW | CTLFLAG_LOCKED, &debug4k_panic_on_terminate, 0, "");
extern int debug4k_panic_on_exception;
SYSCTL_INT(_vm, OID_AUTO, debug4k_panic_on_exception,
           CTLFLAG_RW | CTLFLAG_LOCKED, &debug4k_panic_on_exception, 0, "");
extern int debug4k_panic_on_misaligned_sharing;
SYSCTL_INT(_vm, OID_AUTO, debug4k_panic_on_misaligned_sharing,
           CTLFLAG_RW | CTLFLAG_LOCKED, &debug4k_panic_on_misaligned_sharing, 0,
           "");
#endif /* MACH_ASSERT */
...
SYSCTL_QUAD(_vm, OID_AUTO, map_set_size_limit_count,
            CTLFLAG_RD | CTLFLAG_LOCKED, &vm_map_set_size_limit_count, "");
SYSCTL_QUAD(_vm, OID_AUTO, map_set_data_limit_count,
            CTLFLAG_RD | CTLFLAG_LOCKED, &vm_map_set_data_limit_count, "");
SYSCTL_QUAD(_vm, OID_AUTO, map_enter_RLIMIT_AS_count,
            CTLFLAG_RD | CTLFLAG_LOCKED, &vm_map_enter_RLIMIT_AS_count, "");
SYSCTL_QUAD(_vm, OID_AUTO, map_enter_RLIMIT_DATA_count,
            CTLFLAG_RD | CTLFLAG_LOCKED, &vm_map_enter_RLIMIT_DATA_count, "");
...
SYSCTL_QUAD(_vm, OID_AUTO, fault_resilient_media_initiate,
            CTLFLAG_RD | CTLFLAG_LOCKED, &vm_fault_resilient_media_initiate,
            "");
SYSCTL_QUAD(_vm, OID_AUTO, fault_resilient_media_retry,
            CTLFLAG_RD | CTLFLAG_LOCKED, &vm_fault_resilient_media_retry, "");
SYSCTL_QUAD(_vm, OID_AUTO, fault_resilient_media_proceed,
            CTLFLAG_RD | CTLFLAG_LOCKED, &vm_fault_resilient_media_proceed, "");
SYSCTL_QUAD(_vm, OID_AUTO, fault_resilient_media_release,
            CTLFLAG_RD | CTLFLAG_LOCKED, &vm_fault_resilient_media_release, "");
SYSCTL_QUAD(_vm, OID_AUTO, fault_resilient_media_abort1,
            CTLFLAG_RD | CTLFLAG_LOCKED, &vm_fault_resilient_media_abort1, "");
SYSCTL_QUAD(_vm, OID_AUTO, fault_resilient_media_abort2,
            CTLFLAG_RD | CTLFLAG_LOCKED, &vm_fault_resilient_media_abort2, "");
#if MACH_ASSERT
...
SYSCTL_INT(_vm, OID_AUTO, fault_resilient_media_inject_error1_rate,
           CTLFLAG_RW | CTLFLAG_LOCKED,
           &vm_fault_resilient_media_inject_error1_rate, 0, "");
SYSCTL_INT(_vm, OID_AUTO, fault_resilient_media_inject_error1,
           CTLFLAG_RD | CTLFLAG_LOCKED, &vm_fault_resilient_media_inject_error1,
           0, "");
SYSCTL_INT(_vm, OID_AUTO, fault_resilient_media_inject_error2_rate,
           CTLFLAG_RW | CTLFLAG_LOCKED,
           &vm_fault_resilient_media_inject_error2_rate, 0, "");
SYSCTL_INT(_vm, OID_AUTO, fault_resilient_media_inject_error2,
           CTLFLAG_RD | CTLFLAG_LOCKED, &vm_fault_resilient_media_inject_error2,
           0, "");
SYSCTL_INT(_vm, OID_AUTO, fault_resilient_media_inject_error3_rate,
           CTLFLAG_RW | CTLFLAG_LOCKED,
           &vm_fault_resilient_media_inject_error3_rate, 0, "");
SYSCTL_INT(_vm, OID_AUTO, fault_resilient_media_inject_error3,
           CTLFLAG_RD | CTLFLAG_LOCKED, &vm_fault_resilient_media_inject_error3,
           0, "");
#endif /* MACH_ASSERT */

extern uint64_t pmap_query_page_info_retries;
SYSCTL_QUAD(_vm, OID_AUTO, pmap_query_page_info_retries,
            CTLFLAG_RD | CTLFLAG_LOCKED, &pmap_query_page_info_retries, "");
 ...
 * the last existing user exits. A write of non-zero value causes that to
 * happen. This should only be used by launchd, so we check that this is
 * initproc.
 */
static int shared_region_pivot(__unused struct sysctl_oid *oidp,
...
SYSCTL_QUAD(_vm, OID_AUTO, object_upl_throttle_cnt, CTLFLAG_RD | CTLFLAG_LOCKED,
            ...
            "The number of times in which a UPL write was throttled due to "
            "pageout starvation");

SYSCTL_INT(_vm, OID_AUTO, vmtc_total, CTLFLAG_RD | CTLFLAG_LOCKED, &vmtc_total,
...
static int corrupt_text_addr(__unused struct sysctl_oid *oidp,
                             __unused void *arg1, __unused int arg2,
                             struct sysctl_req *req) {
  uint64_t value = 0;
...
SYSCTL_PROC(_vm, OID_AUTO, corrupt_text_addr,
            CTLTYPE_QUAD | CTLFLAG_WR | CTLFLAG_LOCKED | CTLFLAG_MASKED, 0, 0,
            corrupt_text_addr, "-", "");
#endif /* DEBUG || DEVELOPMENT */
 ...
 */
static int vm_map_malloc_ranges SYSCTL_HANDLER_ARGS {
  vm_map_t map = current_map();
  ...
  len =
      scnprintf(str, sizeof(str), "0x%llx:0x%llx 0x%llx:0x%llx", r1.max_address,
                r2.min_address, r2.max_address, right_hole_max);

  return SYSCTL_OUT(req, str, len);
}

SYSCTL_PROC(_vm, OID_AUTO, malloc_ranges,
            CTLTYPE_STRING | CTLFLAG_RD | CTLFLAG_LOCKED | CTLFLAG_MASKED, 0, 0,
            &vm_map_malloc_ranges, "A", "");

#if DEBUG || DEVELOPMENT
static int vm_map_user_range_default SYSCTL_HANDLER_ARGS {
#pragma unused(arg1, arg2, oidp)
...
static int vm_map_user_range_heap SYSCTL_HANDLER_ARGS {
#pragma unused(arg1, arg2, oidp)
  struct mach_vm_range range;
...
static int vm_map_user_range_large_file SYSCTL_HANDLER_ARGS {
#pragma unused(arg1, arg2, oidp)
  struct mach_vm_range range;
 ...
 */
SYSCTL_PROC(_vm, OID_AUTO, vm_map_user_range_default,
            CTLTYPE_STRUCT | CTLFLAG_RD | CTLFLAG_LOCKED, 0, 0,
            &vm_map_user_range_default, "S,mach_vm_range", "");
SYSCTL_PROC(_vm, OID_AUTO, vm_map_user_range_heap,
            CTLTYPE_STRUCT | CTLFLAG_RD | CTLFLAG_LOCKED, 0, 0,
            &vm_map_user_range_heap, "S,mach_vm_range", "");
SYSCTL_PROC(_vm, OID_AUTO, vm_map_user_range_large_file,
            CTLTYPE_STRUCT | CTLFLAG_RD | CTLFLAG_LOCKED, 0, 0,
            &vm_map_user_range_large_file, "S,mach_vm_range", "");
...
SYSCTL_QUAD(_vm, OID_AUTO, map_range_overflows_count,
            CTLFLAG_RD | CTLFLAG_LOCKED, &vm_map_range_overflows_count, "");
extern boolean_t vm_map_range_overflows_log;
SYSCTL_INT(_vm, OID_AUTO, map_range_oveflows_log, CTLFLAG_RW | CTLFLAG_LOCKED,
           &vm_map_range_overflows_log, 0, "");
...
SYSCTL_QUAD(_vm, OID_AUTO, c_seg_filled_no_contention,
            CTLFLAG_RD | CTLFLAG_LOCKED, &c_seg_filled_no_contention, "");
SYSCTL_QUAD(_vm, OID_AUTO, c_seg_filled_contention, CTLFLAG_RD | CTLFLAG_LOCKED,
            &c_seg_filled_contention, "");
SYSCTL_ULONG(_vm, OID_AUTO, c_seg_filled_contention_sec_max,
             CTLFLAG_RD | CTLFLAG_LOCKED, &c_seg_filled_contention_sec_max, "");
SYSCTL_UINT(_vm, OID_AUTO, c_seg_filled_contention_nsec_max,
            CTLFLAG_RD | CTLFLAG_LOCKED, &c_seg_filled_contention_nsec_max, 0,
            "");
...
SYSCTL_UINT(_vm, OID_AUTO, c_process_major_report_over_ms,
            CTLFLAG_RW | CTLFLAG_LOCKED, &c_process_major_report_over_ms, 0,
            "");
SYSCTL_INT(_vm, OID_AUTO, c_process_major_yield_after,
           CTLFLAG_RW | CTLFLAG_LOCKED, &c_process_major_yield_after, 0, "");
SYSCTL_QUAD(_vm, OID_AUTO, c_process_major_reports, CTLFLAG_RD | CTLFLAG_LOCKED,
            &c_process_major_reports, "");
SYSCTL_ULONG(_vm, OID_AUTO, c_process_major_max_sec,
             CTLFLAG_RD | CTLFLAG_LOCKED, &c_process_major_max_sec, "");
SYSCTL_UINT(_vm, OID_AUTO, c_process_major_max_nsec,
            CTLFLAG_RD | CTLFLAG_LOCKED, &c_process_major_max_nsec, 0, "");
SYSCTL_UINT(_vm, OID_AUTO, c_process_major_peak_segcount,
            CTLFLAG_RD | CTLFLAG_LOCKED, &c_process_major_peak_segcount, 0, "");
#endif /* (XNU_TARGET_OS_OSX && __arm64__) */

#if DEVELOPMENT || DEBUG
extern int panic_object_not_alive;
SYSCTL_INT(_vm, OID_AUTO, panic_object_not_alive,
           CTLFLAG_RW | CTLFLAG_LOCKED | CTLFLAG_ANYBODY,
           &panic_object_not_alive, 0, "");
#endif /* DEVELOPMENT || DEBUG */

#if FBDP_DEBUG_OBJECT_NO_PAGER
extern int fbdp_no_panic;
SYSCTL_INT(_vm, OID_AUTO, fbdp_no_panic,
           CTLFLAG_RW | CTLFLAG_LOCKED | CTLFLAG_ANYBODY, &fbdp_no_panic, 0,
           "");
#endif /* MACH_ASSERT */

extern uint64_t cluster_direct_write_wired;
SYSCTL_QUAD(_vm, OID_AUTO, cluster_direct_write_wired,
            CTLFLAG_RD | CTLFLAG_LOCKED, &cluster_direct_write_wired, "");
...
SYSCTL_QUAD(_vm, OID_AUTO, object_pageout_not_on_queue,
            CTLFLAG_RD | CTLFLAG_LOCKED, &vm_object_pageout_not_on_queue, "");
SYSCTL_QUAD(_vm, OID_AUTO, object_pageout_not_pageable,
            CTLFLAG_RD | CTLFLAG_LOCKED, &vm_object_pageout_not_pageable, "");
SYSCTL_QUAD(_vm, OID_AUTO, object_pageout_pageable, CTLFLAG_RD | CTLFLAG_LOCKED,
            &vm_object_pageout_pageable, "");
SYSCTL_QUAD(_vm, OID_AUTO, object_pageout_active_local,
            CTLFLAG_RD | CTLFLAG_LOCKED, &vm_object_pageout_active_local, "");
 ...
 * (sizeof(c_segment_info) + C_SLOT_MAX_INDEX * sizeof(c_slot_info)) + (data of
 * a single segment) */
...
/* This sysctl iterates over the populated c_segments and writes some info about
 * each one and its slots. instead of doing everything here, the function calls
 * a function vm_compressor.c. */
static int
sysctl_compressor_segments_stream(struct sysctl_req *req,
                                  vm_c_serialize_add_data_t with_data) {
  ...
  ((struct sysctl_buf_header *)buf)->magic =
      sysctl_compressor_seg_magic(with_data);
  offset += sizeof(uint32_t);

  while (segno < c_segments_available) {
    size_t left_sz = SYSCTL_SEG_BUF_SIZE - offset;
    kern_return_t kr = vm_compressor_serialize_segment_debug_info(
        segno, buf + offset, &left_sz, with_data);
    if (kr == KERN_NO_SPACE) {
      /* failed to add another segment, push the current buffer out and try
       * again */
      if (offset == 0) {
        error = EINVAL; /* no space to write but I didn't write anything,
      ...
      offset = 0;
      bzero(buf, SYSCTL_SEG_BUF_SIZE); /* zero any reserved bits that are not
                                          going to be filled */
...
out:
  kfree_data(buf, SYSCTL_SEG_BUF_SIZE) return error;
}

static int sysctl_compressor_segments(__unused struct sysctl_oid *oidp,
                                      __unused void *arg1, __unused int arg2,
                                      struct sysctl_req *req) {
  return sysctl_compressor_segments_stream(req, VM_C_SERIALIZE_DATA_NONE);
}
SYSCTL_PROC(_vm, OID_AUTO, compressor_segments,
            CTLTYPE_STRUCT | CTLFLAG_LOCKED | CTLFLAG_RD, 0, 0,
            sysctl_compressor_segments, "S", "");

extern uint32_t vm_compressor_fragmentation_level(void);

static int
sysctl_compressor_fragmentation_level(__unused struct sysctl_oid *oidp,
                                      __unused void *arg1, __unused int arg2,
                                      struct sysctl_req *req) {
...
SYSCTL_PROC(_vm, OID_AUTO, compressor_fragmentation_level,
            CTLTYPE_INT | CTLFLAG_RD | CTLFLAG_LOCKED, 0, 0,
            sysctl_compressor_fragmentation_level, "IU", "");

extern uint32_t vm_compressor_incore_fragmentation_wasted_pages(void);

static int sysctl_compressor_incore_fragmentation_wasted_pages(
...
SYSCTL_PROC(_vm, OID_AUTO, compressor_incore_fragmentation_wasted_pages,
            CTLTYPE_INT | CTLFLAG_RD | CTLFLAG_LOCKED, 0, 0,
            sysctl_compressor_incore_fragmentation_wasted_pages, "IU", "");

#define SYSCTL_VM_OBJECTS_SLOTMAP_BUF_SIZE (8 * 1024)

/* This sysctl iterates over all the entries of the vm_map of the a given
 * process and write some info about the vm_object pointed by the entries. This
 * can be used for mapping where are all the pages of a process located in the
 * compressor.
 */
static int sysctl_task_vm_objects_slotmap(__unused struct sysctl_oid *oidp,
                                          void *arg1, int arg2,
                                          struct sysctl_req *req) {
  int error = 0;
  char *buf = NULL;
  ...
  /* go from pid to proc to task to vm_map. see sysctl_procargsx() for another
   * example of this procession */
  int *name = arg1;
  int namelen = arg2;
  if (namelen < 1) {
    return EINVAL;
  ...
  kern_return_t (^write_header)(int) = ^kern_return_t(int nentries) {
    /* write the header, happens only once at the beginning so we should have
     * enough space */
    assert(offset + sizeof(struct vm_map_info_hdr) <
           SYSCTL_VM_OBJECTS_SLOTMAP_BUF_SIZE);
  ...
  kern_return_t (^write_entry)(void *) = ^kern_return_t(void *entry) {
    while (true) { /* try up to 2 times, first try write the the current buffer,
                      otherwise to a new buffer */
      size_t left_sz = SYSCTL_VM_OBJECTS_SLOTMAP_BUF_SIZE - offset;
      kern_return_t kr =
          vm_map_dump_entry_and_compressor_pager(entry, buf + offset, &left_sz);
      if (kr == KERN_NO_SPACE) {
        /* failed to write anything, flush the current buffer and try again */
        if (offset == 0) {
          return KERN_FAILURE; /* no space to write but I didn't write anything
                                  yet, shouldn't really happen */
        }
        /* write out chunk */
        ...
        offset = 0;
        bzero(buf, SYSCTL_VM_OBJECTS_SLOTMAP_BUF_SIZE); /* zero any reserved
                                                           bits that are not
                                                           going to be filled */
  ...
  /* this foreach first calls to the first callback with the number of entries,
   * then calls the second for every entry when the buffer is exhausted, it is
   * flushed to the sysctl and restarted */
...
SYSCTL_PROC(_vm, OID_AUTO, task_vm_objects_slotmap,
            CTLTYPE_NODE | CTLFLAG_LOCKED | CTLFLAG_RD, 0, 0,
            sysctl_task_vm_objects_slotmap, "S", "");
static int systctl_vm_reset_tag SYSCTL_HANDLER_ARGS {
#pragma unused(oidp, arg1, arg2)
  int error;
  int tag;
  kern_return_t kr;
...
SYSCTL_PROC(_vm, OID_AUTO, reset_tag,
            ...
            &systctl_vm_reset_tag, "I", "");

static int systctl_vm_reset_all_tags SYSCTL_HANDLER_ARGS {
#pragma unused(oidp, arg1, arg2)
