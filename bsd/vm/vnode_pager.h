 ...
 *  The are the link between memory objects and the backing store they
 * represent. For the vnode pager, backing store comes in two flavors: normal
 * files and swap files.
 *
 ...
 *  offsets and swap file offsets (vs_pmap).  Each entry in this mapping
 * specifies the pager file to use, and the offset of the page in that pager
 * file.  These mapping entries are of type pfMapEntry.
 */
