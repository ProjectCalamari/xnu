 ...
 */
int copyoutstr(const void *from, user_addr_t to, size_t maxlen,
               size_t *lencopied) {
  size_t slen;
  size_t len;
  int error = 0;
...
int copystr(const void *vfrom, void *vto, size_t maxlen, size_t *lencopied) {
  size_t l;
...
int objc_bp_assist_cfg_np(__unused struct proc *p,
