...
static int i386_cpu_info SYSCTL_HANDLER_ARGS {
  void *ptr = (uint8_t *)cpuid_info() + (uintptr_t)arg1;
  return _i386_cpu_info(oidp, ptr, arg2, req);
}

static int i386_cpu_info_nonzero SYSCTL_HANDLER_ARGS {
  void *ptr = (uint8_t *)cpuid_info() + (uintptr_t)arg1;
...
static int cpu_mwait SYSCTL_HANDLER_ARGS {
...
static int cpu_thermal SYSCTL_HANDLER_ARGS {
  i386_cpu_info_t *cpu_info = cpuid_info();
...
static int cpu_arch_perf SYSCTL_HANDLER_ARGS {
  i386_cpu_info_t *cpu_info = cpuid_info();
...
static int cpu_xsave SYSCTL_HANDLER_ARGS {
  i386_cpu_info_t *cpu_info = cpuid_info();
...
static int cpu_features SYSCTL_HANDLER_ARGS {
  __unused struct sysctl_oid *unused_oidp = oidp;
...
static int cpu_extfeatures SYSCTL_HANDLER_ARGS {
  __unused struct sysctl_oid *unused_oidp = oidp;
  __unused void *unused_arg1 = arg1;
  __unused int unused_arg2 = arg2;
  char buf[512];
...
static int cpu_leaf7_features SYSCTL_HANDLER_ARGS {
  __unused struct sysctl_oid *unused_oidp = oidp;
  __unused void *unused_arg1 = arg1;
  __unused int unused_arg2 = arg2;
  char buf[512];
...
static int cpu_logical_per_package SYSCTL_HANDLER_ARGS {
  __unused struct sysctl_oid *unused_oidp = oidp;
  __unused void *unused_arg1 = arg1;
  __unused int unused_arg2 = arg2;
  i386_cpu_info_t *cpu_info = cpuid_info();
...
static int cpu_flex_ratio_desired SYSCTL_HANDLER_ARGS {
  __unused struct sysctl_oid *unused_oidp = oidp;
  __unused void *unused_arg1 = arg1;
  __unused int unused_arg2 = arg2;
  i386_cpu_info_t *cpu_info = cpuid_info();
...
static int cpu_flex_ratio_min SYSCTL_HANDLER_ARGS {
  __unused struct sysctl_oid *unused_oidp = oidp;
  __unused void *unused_arg1 = arg1;
  __unused int unused_arg2 = arg2;
  i386_cpu_info_t *cpu_info = cpuid_info();
...
static int cpu_flex_ratio_max SYSCTL_HANDLER_ARGS {
  __unused struct sysctl_oid *unused_oidp = oidp;
  __unused void *unused_arg1 = arg1;
  __unused int unused_arg2 = arg2;
  i386_cpu_info_t *cpu_info = cpuid_info();
...
static int cpu_ucode_update SYSCTL_HANDLER_ARGS {
...
static int panic_set_restart_timeout(__unused struct sysctl_oid *oidp,
  ...
  if (error == 0 && changed) {
    if (new_value >= 0) {
      nanoseconds_to_absolutetime(((uint64_t)new_value) * NSEC_PER_SEC,
 ...
 * interrupt latency
 */
static int misc_interrupt_latency_max(__unused struct sysctl_oid *oidp,
                                      __unused void *arg1, __unused int arg2,
                                      struct sysctl_req *req) {
  int changed = 0, error;
  char buf[128];
 ...
 */
static int x86_cpu_tsc_deltas(__unused struct sysctl_oid *oidp,
                              __unused void *arg1, __unused int arg2,
                              struct sysctl_req *req) {
  int err;
...
static int misc_machine_check_panic(__unused struct sysctl_oid *oidp,
                                    __unused void *arg1, __unused int arg2,
                                    struct sysctl_req *req) {
  int changed = 0, error;
  char buf[128];
...
/*
 * Triggers a non-responsive processor timeout panic - for a suitably configured
 * kernel only.
 */
static uint64_t kernel_timeout_spin = 0;
static int misc_kernel_timeout_spin(__unused struct sysctl_oid *oidp,
                                    __unused void *arg1, __unused int arg2,
                                    struct sysctl_req *req) {
  uint64_t old_value;
  uint64_t new_value;
...
SYSCTL_PROC(_machdep_cpu, OID_AUTO, max_basic,
            CTLTYPE_INT | CTLFLAG_RD | CTLFLAG_LOCKED,
            (void *)offsetof(i386_cpu_info_t, cpuid_max_basic),
            sizeof(uint32_t), i386_cpu_info, "IU",
            "Max Basic Information value");

SYSCTL_PROC(_machdep_cpu, OID_AUTO, max_ext,
            CTLTYPE_INT | CTLFLAG_RD | CTLFLAG_LOCKED,
            (void *)offsetof(i386_cpu_info_t, cpuid_max_ext), sizeof(uint32_t),
            i386_cpu_info, "IU", "Max Extended Function Information value");

SYSCTL_PROC(_machdep_cpu, OID_AUTO, vendor,
            CTLTYPE_STRING | CTLFLAG_RD | CTLFLAG_LOCKED,
            (void *)offsetof(i386_cpu_info_t, cpuid_vendor), 0, i386_cpu_info,
            "A", "CPU vendor");
...
SYSCTL_PROC(_machdep_cpu, OID_AUTO, leaf7_feature_bits,
            ...
            sizeof(uint64_t), i386_cpu_info_nonzero, "IU",
            "CPU Leaf7 features [EBX ECX]");

SYSCTL_PROC(_machdep_cpu, OID_AUTO, leaf7_feature_bits_edx,
            CTLTYPE_INT | CTLFLAG_RD | CTLFLAG_LOCKED,
            (void *)offsetof(i386_cpu_info_t, cpuid_leaf7_extfeatures),
            sizeof(uint32_t), i386_cpu_info_nonzero, "IU",
            "CPU Leaf7 features [EDX]");

SYSCTL_PROC(_machdep_cpu, OID_AUTO, extfeature_bits,
            CTLTYPE_QUAD | CTLFLAG_RD | CTLFLAG_LOCKED,
            (void *)offsetof(i386_cpu_info_t, cpuid_extfeatures),
            sizeof(uint64_t), i386_cpu_info, "IU", "CPU extended features");

SYSCTL_PROC(_machdep_cpu, OID_AUTO, signature,
            CTLTYPE_INT | CTLFLAG_RD | CTLFLAG_LOCKED,
            (void *)offsetof(i386_cpu_info_t, cpuid_signature),
            sizeof(uint32_t), i386_cpu_info, "I", "CPU signature");

SYSCTL_PROC(_machdep_cpu, OID_AUTO, brand,
            CTLTYPE_INT | CTLFLAG_RD | CTLFLAG_LOCKED,
            (void *)offsetof(i386_cpu_info_t, cpuid_brand), sizeof(uint8_t),
            i386_cpu_info, "I", "CPU brand");

SYSCTL_PROC(_machdep_cpu, OID_AUTO, features,
            CTLTYPE_STRING | CTLFLAG_RD | CTLFLAG_LOCKED, 0, 0, cpu_features,
            "A", "CPU feature names");
...
SYSCTL_PROC(_machdep_cpu, OID_AUTO, extfeatures,
            CTLTYPE_STRING | CTLFLAG_RD | CTLFLAG_LOCKED, 0, 0, cpu_extfeatures,
...
SYSCTL_PROC(_machdep_cpu_thermal, OID_AUTO, sensor,
            CTLTYPE_INT | CTLFLAG_RD | CTLFLAG_LOCKED,
            (void *)offsetof(cpuid_thermal_leaf_t, sensor), sizeof(boolean_t),
...
SYSCTL_PROC(_machdep_cpu_thermal, OID_AUTO, energy_policy,
            ...
            sizeof(boolean_t), cpu_thermal, "I",
            "Energy Efficient Policy Support");
...
SYSCTL_PROC(_machdep_cpu_xsave, OID_AUTO, extended_state,
            CTLTYPE_INT | CTLFLAG_RD | CTLFLAG_LOCKED, (void *)0,
            sizeof(cpuid_xsave_leaf_t), cpu_xsave, "IU",
            "XSAVE Extended State Main Leaf");

SYSCTL_PROC(_machdep_cpu_xsave, OID_AUTO, extended_state1,
            CTLTYPE_INT | CTLFLAG_RD | CTLFLAG_LOCKED,
            (void *)sizeof(cpuid_xsave_leaf_t), sizeof(cpuid_xsave_leaf_t),
...
SYSCTL_PROC(_machdep_cpu_arch_perf, OID_AUTO, events_number,
            ...
            sizeof(uint8_t), cpu_arch_perf, "I", "Number of monitoring events");

SYSCTL_PROC(_machdep_cpu_arch_perf, OID_AUTO, events,
            CTLTYPE_INT | CTLFLAG_RD | CTLFLAG_LOCKED,
            (void *)offsetof(cpuid_arch_perf_leaf_t, events), sizeof(uint32_t),
...
SYSCTL_PROC(_machdep_cpu_arch_perf, OID_AUTO, fixed_number,
            ...
            sizeof(uint8_t), cpu_arch_perf, "I",
...
SYSCTL_PROC(_machdep_cpu_arch_perf, OID_AUTO, fixed_width,
            ...
            sizeof(uint8_t), cpu_arch_perf, "I",
            "Bit-width of fixed-function counters");
...
SYSCTL_PROC(_machdep_cpu_cache, OID_AUTO, linesize,
            ...
            sizeof(uint32_t), i386_cpu_info, "I", "Cacheline size");

SYSCTL_PROC(_machdep_cpu_cache, OID_AUTO, L2_associativity,
            CTLTYPE_INT | CTLFLAG_RD | CTLFLAG_LOCKED,
            (void *)offsetof(i386_cpu_info_t, cpuid_cache_L2_associativity),
            sizeof(uint32_t), i386_cpu_info, "I", "L2 cache associativity");

SYSCTL_PROC(_machdep_cpu_cache, OID_AUTO, size,
            CTLTYPE_INT | CTLFLAG_RD | CTLFLAG_LOCKED,
            (void *)offsetof(i386_cpu_info_t, cpuid_cache_size),
            sizeof(uint32_t), i386_cpu_info, "I", "Cache size (in Kbytes)");

SYSCTL_NODE(_machdep_cpu, OID_AUTO, tlb, CTLFLAG_RW | CTLFLAG_LOCKED, 0, "tlb");
...
SYSCTL_PROC(_machdep_cpu_tlb_inst, OID_AUTO, small,
            ...
            sizeof(uint32_t), i386_cpu_info_nonzero, "I",
...
SYSCTL_PROC(_machdep_cpu_tlb, OID_AUTO, shared,
            CTLTYPE_INT | CTLFLAG_RD | CTLFLAG_LOCKED,
            (void *)offsetof(i386_cpu_info_t, cpuid_stlb), sizeof(uint32_t),
            i386_cpu_info_nonzero, "I", "Number of shared TLBs");

SYSCTL_NODE(_machdep_cpu, OID_AUTO, address_bits, CTLFLAG_RW | CTLFLAG_LOCKED,
            0, "address_bits");

SYSCTL_PROC(_machdep_cpu_address_bits, OID_AUTO, physical,
            CTLTYPE_INT | CTLFLAG_RD | CTLFLAG_LOCKED,
            (void *)offsetof(i386_cpu_info_t, cpuid_address_bits_physical),
            sizeof(uint32_t), i386_cpu_info, "I",
...
SYSCTL_PROC(_machdep_cpu, OID_AUTO, core_count,
            CTLTYPE_INT | CTLFLAG_RD | CTLFLAG_LOCKED,
            (void *)offsetof(i386_cpu_info_t, core_count), sizeof(uint32_t),
            i386_cpu_info, "I", "Number of enabled cores per package");

SYSCTL_PROC(_machdep_cpu, OID_AUTO, thread_count,
            CTLTYPE_INT | CTLFLAG_RD | CTLFLAG_LOCKED,
            (void *)offsetof(i386_cpu_info_t, thread_count), sizeof(uint32_t),
...
SYSCTL_PROC(_machdep_cpu_flex_ratio, OID_AUTO, min,
            CTLTYPE_INT | CTLFLAG_RD | CTLFLAG_LOCKED, 0, 0, cpu_flex_ratio_min,
            "I", "Flex ratio min (efficiency)");

SYSCTL_PROC(_machdep_cpu_flex_ratio, OID_AUTO, max,
            CTLTYPE_INT | CTLFLAG_RD | CTLFLAG_LOCKED, 0, 0, cpu_flex_ratio_max,
            "I", "Flex ratio max (non-turbo)");

SYSCTL_PROC(_machdep_cpu, OID_AUTO, ucupdate,
            CTLTYPE_INT | CTLFLAG_WR | CTLFLAG_LOCKED, 0, 0, cpu_ucode_update,
...
SYSCTL_PROC(_machdep_cpu_tsc_ccc, OID_AUTO, numerator,
            ...
            sizeof(uint32_t), i386_cpu_info, "I", "Numerator of TSC/CCC ratio");

SYSCTL_PROC(_machdep_cpu_tsc_ccc, OID_AUTO, denominator,
            CTLTYPE_INT | CTLFLAG_RD | CTLFLAG_LOCKED,
            (void *)offsetof(i386_cpu_info_t, cpuid_tsc_leaf.denominator),
            sizeof(uint32_t), i386_cpu_info, "I",
            "Denominator of TSC/CCC ratio");

static const uint32_t apic_timer_vector =
    (LAPIC_DEFAULT_INTERRUPT_BASE + LAPIC_TIMER_INTERRUPT);
static const uint32_t apic_IPI_vector =
...
SYSCTL_UINT(_machdep_vectors, OID_AUTO, timer,
            CTLFLAG_RD | CTLFLAG_KERN | CTLFLAG_LOCKED,
            __DECONST(uint32_t *, &apic_timer_vector), 0, "");
SYSCTL_UINT(_machdep_vectors, OID_AUTO, IPI,
            CTLFLAG_RD | CTLFLAG_KERN | CTLFLAG_LOCKED,
            __DECONST(uint32_t *, &apic_IPI_vector), 0, "");
...
SYSCTL_QUAD(_machdep_pmap, OID_AUTO, hashwalks,
            CTLFLAG_RD | CTLFLAG_KERN | CTLFLAG_LOCKED, &pmap_pv_hashlist_walks,
            "");
SYSCTL_QUAD(_machdep_pmap, OID_AUTO, hashcnts,
            CTLFLAG_RD | CTLFLAG_KERN | CTLFLAG_LOCKED, &pmap_pv_hashlist_cnts,
            "");
SYSCTL_INT(_machdep_pmap, OID_AUTO, hashmax,
           CTLFLAG_RD | CTLFLAG_KERN | CTLFLAG_LOCKED, &pmap_pv_hashlist_max, 0,
           "");
SYSCTL_INT(_machdep_pmap, OID_AUTO, kernel_text_ps,
           CTLFLAG_RD | CTLFLAG_KERN | CTLFLAG_LOCKED, &pmap_kernel_text_ps, 0,
           "");
SYSCTL_INT(_machdep_pmap, OID_AUTO, kern_pv_reserve,
           CTLFLAG_RW | CTLFLAG_KERN | CTLFLAG_LOCKED,
           &pv_hashed_kern_low_water_mark, 0, "");

SYSCTL_NODE(_machdep, OID_AUTO, memmap, CTLFLAG_RD | CTLFLAG_LOCKED, NULL,
            "physical memory map");
...
SYSCTL_QUAD(_machdep_memmap, OID_AUTO, Conventional,
            CTLFLAG_RD | CTLFLAG_LOCKED, &firmware_Conventional_bytes, "");
SYSCTL_QUAD(_machdep_memmap, OID_AUTO, RuntimeServices,
            CTLFLAG_RD | CTLFLAG_LOCKED, &firmware_RuntimeServices_bytes, "");
SYSCTL_QUAD(_machdep_memmap, OID_AUTO, ACPIReclaim, CTLFLAG_RD | CTLFLAG_LOCKED,
            &firmware_ACPIReclaim_bytes, "");
SYSCTL_QUAD(_machdep_memmap, OID_AUTO, ACPINVS, CTLFLAG_RD | CTLFLAG_LOCKED,
            &firmware_ACPINVS_bytes, "");
SYSCTL_QUAD(_machdep_memmap, OID_AUTO, PalCode, CTLFLAG_RD | CTLFLAG_LOCKED,
            &firmware_PalCode_bytes, "");
SYSCTL_QUAD(_machdep_memmap, OID_AUTO, Reserved, CTLFLAG_RD | CTLFLAG_LOCKED,
            &firmware_Reserved_bytes, "");
SYSCTL_QUAD(_machdep_memmap, OID_AUTO, Unusable, CTLFLAG_RD | CTLFLAG_LOCKED,
            &firmware_Unusable_bytes, "");
SYSCTL_QUAD(_machdep_memmap, OID_AUTO, Other, CTLFLAG_RD | CTLFLAG_LOCKED,
            &firmware_other_bytes, "");

SYSCTL_NODE(_machdep, OID_AUTO, tsc, CTLFLAG_RD | CTLFLAG_LOCKED, NULL,
            "Timestamp counter parameters");

SYSCTL_QUAD(_machdep_tsc, OID_AUTO, frequency, CTLFLAG_RD | CTLFLAG_LOCKED,
            &tscFreq, "");
...
SYSCTL_QUAD(_machdep_tsc, OID_AUTO, at_boot, CTLFLAG_RD | CTLFLAG_LOCKED,
            &tsc_at_boot, "");
...
SYSCTL_PROC(_machdep_tsc, OID_AUTO, synch_deltas,
            CTLTYPE_STRING | CTLFLAG_RD | CTLFLAG_LOCKED, 0, 0,
            x86_cpu_tsc_deltas, "A", "TSC synch deltas");
#endif

SYSCTL_NODE(_machdep_tsc, OID_AUTO, nanotime, CTLFLAG_RD | CTLFLAG_LOCKED, NULL,
...
SYSCTL_UINT(_machdep_tsc_nanotime, OID_AUTO, scale, CTLFLAG_RD | CTLFLAG_LOCKED,
            __DECONST(uint32_t *, &pal_rtc_nanotime_info.scale), 0, "");
SYSCTL_UINT(_machdep_tsc_nanotime, OID_AUTO, shift, CTLFLAG_RD | CTLFLAG_LOCKED,
...
SYSCTL_INT(_machdep, OID_AUTO, x2apic_enabled,
           CTLFLAG_KERN | CTLFLAG_RD | CTLFLAG_LOCKED, &is_x2apic, 0, "");
...
SYSCTL_PROC(_machdep_misc, OID_AUTO, kernel_timeout_spin,
            CTLTYPE_QUAD | CTLFLAG_RW | CTLFLAG_LOCKED, 0,
            sizeof(kernel_timeout_spin), misc_kernel_timeout_spin, "Q",
            "Kernel timeout panic test");

SYSCTL_QUAD(_machdep, OID_AUTO, reportphyreadabs,
            CTLFLAG_KERN | CTLFLAG_RW | CTLFLAG_LOCKED, &report_phy_read_delay,
            "");
SYSCTL_QUAD(_machdep, OID_AUTO, reportphywriteabs,
            CTLFLAG_KERN | CTLFLAG_RW | CTLFLAG_LOCKED, &report_phy_write_delay,
            "");
SYSCTL_QUAD(_machdep, OID_AUTO, tracephyreadabs,
            CTLFLAG_KERN | CTLFLAG_RW | CTLFLAG_LOCKED, &trace_phy_read_delay,
            "");
SYSCTL_QUAD(_machdep, OID_AUTO, tracephywriteabs,
            CTLFLAG_KERN | CTLFLAG_RW | CTLFLAG_LOCKED, &trace_phy_write_delay,
            "");
SYSCTL_INT(_machdep, OID_AUTO, phyreaddelaypanic,
           CTLFLAG_KERN | CTLFLAG_RW | CTLFLAG_LOCKED, &phy_read_panic, 0, "");
SYSCTL_INT(_machdep, OID_AUTO, phywritedelaypanic,
           CTLFLAG_KERN | CTLFLAG_RW | CTLFLAG_LOCKED, &phy_write_panic, 0, "");
#if DEVELOPMENT || DEBUG
extern uint64_t simulate_stretched_io;
SYSCTL_QUAD(_machdep, OID_AUTO, sim_stretched_io_ns,
            CTLFLAG_KERN | CTLFLAG_RW | CTLFLAG_LOCKED, &simulate_stretched_io,
            "");
#endif
...
SYSCTL_INT(_machdep, OID_AUTO, pmap_asserts,
           CTLFLAG_KERN | CTLFLAG_RW | CTLFLAG_LOCKED, &pmap_asserts_enabled, 0,
           "");
/* Transform pmap assertions into kernel trace terminations */
SYSCTL_INT(_machdep, OID_AUTO, pmap_asserts_traced,
           CTLFLAG_KERN | CTLFLAG_RW | CTLFLAG_LOCKED, &pmap_asserts_traced, 0,
           "");

static int misc_svisor_read(__unused struct sysctl_oid *oidp,
                            __unused void *arg1, __unused int arg2,
                            struct sysctl_req *req) {
...
SYSCTL_PROC(_machdep_misc, OID_AUTO, misc_svisor_read,
            CTLTYPE_QUAD | CTLFLAG_RW | CTLFLAG_LOCKED, 0, 0, misc_svisor_read,
            "I", "supervisor mode read");

#endif /* DEVELOPMENT || DEBUG */

extern void timer_queue_trace_cpu(int);
static int misc_timer_queue_trace(__unused struct sysctl_oid *oidp,
                                  __unused void *arg1, __unused int arg2,
                                  struct sysctl_req *req) {
  int changed = 0, error;
  char buf[128];
...
static int misc_nmis(__unused struct sysctl_oid *oidp, __unused void *arg1,
...
SYSCTL_PROC(_machdep_misc, OID_AUTO, nmis,
            CTLTYPE_INT | CTLFLAG_RW | CTLFLAG_LOCKED, 0, 0, misc_nmis, "I",
            "Report/increment NMI count");
...
SYSCTL_QUAD(_machdep, OID_AUTO, x86_fp_simd_isr_uses,
            CTLFLAG_KERN | CTLFLAG_RW | CTLFLAG_LOCKED, &x86_isr_fp_simd_use,
            "");

static int sysctl_kern_insn_copy_optout_task SYSCTL_HANDLER_ARGS {
#pragma unused(oidp, arg1, arg2)
  uint32_t soflags = 0;
...
SYSCTL_INT(_machdep, OID_AUTO, pltrace,
           CTLFLAG_KERN | CTLFLAG_RW | CTLFLAG_LOCKED, &plctrace_enabled, 0,
           "");

extern int fpsimd_fault_popc;
SYSCTL_INT(_machdep, OID_AUTO, fpsimd_fault_popc,
           CTLFLAG_KERN | CTLFLAG_RW | CTLFLAG_LOCKED, &fpsimd_fault_popc, 0,
           "");

volatile int stop_spinning;
static int spin_in_the_kernel(__unused struct sysctl_oid *oidp,
                              __unused void *arg1, __unused int arg2,
                              struct sysctl_req *req) {
  int new = 0, old = 0, changed = 0, error;
...
SYSCTL_INT(
    _machdep_misc, OID_AUTO, fake_pte_corruption,
    CTLFLAG_KERN | CTLFLAG_RW | CTLFLAG_LOCKED, &pmap_inject_pte_corruption, 0,
...
SYSCTL_INT(_machdep_misc, OID_AUTO, traptrace_enabled,
           CTLFLAG_KERN | CTLFLAG_RW | CTLFLAG_LOCKED, &traptrace_enabled, 0,
           "Enabled/disable trap trace");
