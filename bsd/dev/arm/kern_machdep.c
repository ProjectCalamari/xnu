 ...
 */
static cpu_subtype_t cpu_subtype32() {
  switch (cpu_subtype()) {
...
static int grade_arm64e_binary(cpu_subtype_t execfeatures) {
  ...
  /* Non-preferred future and older ABIs are allowed, but exec_mach_imgact may
   * treat them like an arm64 slice */
  return 11;
}
#endif /* __arm64__ */
 ...
 *		not acceptable.
 **********************************************************************/
int ml_grade_binary(cpu_type_t exectype, cpu_subtype_t execsubtype,
