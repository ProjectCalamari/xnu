...
sdt_argdesc_t sdt_args[] = {
    ...
    {"nfsv4", "op-release-lockowner-start", 0, 0, "struct compound_state *",
     "conninfo_t *"},
    {"nfsv4", "op-release-lockowner-start", 1, 0, "struct compound_state *",
     "nfsv4opinfo_t *"},
    {"nfsv4", "op-release-lockowner-start", 2, 1, "RELEASE_LOCKOWNER4args *",
     NULL},
    {"nfsv4", "op-release-lockowner-done", 0, 0, "struct compound_state *",
     "conninfo_t *"},
    {"nfsv4", "op-release-lockowner-done", 1, 0, "struct compound_state *",
     "nfsv4opinfo_t *"},
    ...
    {"nfsv4", "op-setclientid-confirm-start", 0, 0, "struct compound_state *",
     "conninfo_t *"},
    {"nfsv4", "op-setclientid-confirm-start", 1, 0, "struct compound_state *",
     "nfsv4opinfo_t *"},
    {"nfsv4", "op-setclientid-confirm-start", 2, 1,
     "SETCLIENTID_CONFIRM4args *", NULL},
    {"nfsv4", "op-setclientid-confirm-done", 0, 0, "struct compound_state *",
     "conninfo_t *"},
    {"nfsv4", "op-setclientid-confirm-done", 1, 0, "struct compound_state *",
     "nfsv4opinfo_t *"},
    ...
    {"vminfo", "vm_map_lookup_entry_failure", 0, 0, "vm_map_offset_t",
     "vm_map_offset_t"},
    {"vminfo", "vm_map_lookup_entry_failure", 1, 1, "vm_map_offset_t",
     "vm_map_offset_t"},
    ...
    {"vminfo", "corpse_footprint_collect", 1, 1, "vm_map_offset_t",
     "vm_map_offset_t"},
    {"vminfo", "corpse_footprint_collect", 2, 2, "uint32_t", "uint32_t"},
    {"vminfo", "corpse_footprint_collect", 3, 3, "vm_map_offset_t",
     "vm_map_offset_t"},
    {"vminfo", "corpse_footprint_collect_new_region", 0, 0, "vm_map_offset_t",
     "vm_map_offset_t"},
    {"vminfo", "corpse_footprint_collect_new_region", 1, 1, "vm_map_offset_t",
     "vm_map_offset_t"},
    {"vminfo", "corpse_footprint_collect_new_region", 2, 2, "uint64_t",
     "uint64_t"},
    {"vminfo", "corpse_footprint_collect_zero_gap", 0, 0, "vm_map_offset_t",
     "vm_map_offset_t"},
    {"vminfo", "corpse_footprint_collect_zero_gap", 1, 1, "vm_map_offset_t",
     "vm_map_offset_t"},
    {"vminfo", "corpse_footprint_collect_zero_gap", 2, 2, "uint64_t",
     "uint64_t"},
    {"vminfo", "corpse_footprint_collect_page_info", 0, 0, "vm_map_offset_t",
     "vm_map_offset_t"},
    {"vminfo", "corpse_footprint_collect_page_info", 1, 1, "uint8_t",
     "uint8_t"},
    {"vminfo", "reclaim_ring_allocate", 0, 0, "mach_vm_address_t",
     "mach_vm_address_t"},
    {"vminfo", "reclaim_ring_allocate", 1, 1, "mach_vm_reclaim_count_t",
     "mach_vm_reclaim_count_t"},
    {"vminfo", "reclaim_ring_allocate", 2, 2, "mach_vm_reclaim_count_t",
     "mach_vm_reclaim_count_t"},
    {"vminfo", "reclaim_ring_resize", 0, 0, "mach_vm_reclaim_count_t",
     "mach_vm_reclaim_count_t"},
    {"vminfo", "reclaim_ring_resize", 1, 1, "mach_vm_reclaim_count_t",
     "mach_vm_reclaim_count_t"},
    {"vminfo", "reclaim_flush", 0, 0, "mach_vm_reclaim_count_t",
     "mach_vm_reclaim_count_t"},
    ...
    {"vminfo", "reclaim_entry", 3, 3, "mach_vm_reclaim_action_t",
    ...
    {"hv", "apic_access-exit-begin", 2, 2, "uint64_t",
    ...
    {"hv", "ept_violation-exit-begin", 2, 2, "uint64_t",
...
#pragma unused(arg, id)
  ...
  for (i = 0; sdt_args[i].sda_provider != NULL; i++) {
    ...
    if (strncmp(sdp->sdp_provider->sdtp_name, a->sda_provider,
                strlen(a->sda_provider) + 1) != 0) {
      continue;
    }
