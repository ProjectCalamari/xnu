 ...
 */
static int sysctl_run_ptrauth_data_tests SYSCTL_HANDLER_ARGS {
#pragma unused(arg1, arg2, oidp)
  ...
  ALLOC_VALIDATE_DATA_PTR(struct proc, struct vnode *, p_textvp,
                          "proc.p_textvp");
  ALLOC_VALIDATE_DATA_PTR(struct proc, struct pgrp *, p_pgrp.__smr_ptr,
                          "proc.p_pgrp");
...
SYSCTL_PROC(_kern, OID_AUTO, run_ptrauth_data_tests,
            ...
            sysctl_run_ptrauth_data_tests, "I", "");
