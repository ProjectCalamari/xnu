...
struct sockaddr src_sockaddr = {.sa_len = 16,
                                .sa_family = AF_UNSPEC,
                                .sa_data = {
                                    0,
                                }};
...
struct sockaddr_storage src_sockaddr_storage = {.ss_len = 255,
                                                .ss_family = AF_UNSPEC};
struct sockaddr_storage *sockaddr_storage_ptr = &src_sockaddr_storage;
const struct sockaddr_storage *sockaddr_storage_const_ptr =
    &src_sockaddr_storage;

struct sockaddr_ctl src_sockaddr_ctl = {.sc_len = 16, .sc_family = AF_SYSTEM};
...
struct sockaddr_in src_sockaddr_in = {.sin_len = 16,
                                      .sin_family = AF_INET,
...
const struct sockaddr_inifscope *sockaddr_inifscope_const_ptr =
    &src_sockaddr_inifscope;
...
struct sockaddr_sys src_sockaddr_sys = {.ss_len = 16, .ss_family = AF_SYSTEM};
struct sockaddr_sys *sockaddr_sys_ptr = &src_sockaddr_sys;
const struct sockaddr_sys *sockaddr_sys_const_ptr = &src_sockaddr_sys;

struct sockaddr_un src_sockaddr_un = {.sun_len = 106, .sun_family = AF_UNIX};
...
union sockaddr_in_4_6 src_sockaddr_in_4_6 = {
    .sa = {.sa_len = 28, .sa_family = AF_INET6},
};
...
validate_conversion_result(const void *result) {
  T_ASSERT_NOTNULL(result, "The conversion is invalid at %s:%u", __FILE__,
                   __LINE__);
}

static void test_valid_conversions_to_bytes() {
  uint8_t *result;
...
static void test_valid_conversions_to_sockaddr() {
  ...
  result =
      __SA_UTILS_DECONST_AND_CONV_TO_SOCKADDR(sockaddr_inifscope_const_ptr);
  validate_conversion_result(result);
...
static void test_valid_conversions_to_sockaddr_ctl() {
  ...
  result =
      __SA_UTILS_DECONST_AND_CONV_TO_SOCKADDR_CTL(sockaddr_storage_const_ptr);
  validate_conversion_result(result);
...
static void test_valid_conversions_to_sockaddr_dl() {
  ...
  result =
      __SA_UTILS_DECONST_AND_CONV_TO_SOCKADDR_DL(sockaddr_storage_const_ptr);
  validate_conversion_result(result);
...
static void test_valid_conversions_to_sockaddr_in() {
  ...
  result =
      __SA_UTILS_DECONST_AND_CONV_TO_SOCKADDR_IN(sockaddr_storage_const_ptr);
  validate_conversion_result(result);
  ...
  result =
      __SA_UTILS_DECONST_AND_CONV_TO_SOCKADDR_IN(sockaddr_in_4_6_const_ptr);
  validate_conversion_result(result);
}

static void test_valid_conversions_to_sockaddr_in6() {
  ...
  result =
      __SA_UTILS_DECONST_AND_CONV_TO_SOCKADDR_IN6(sockaddr_storage_const_ptr);
  validate_conversion_result(result);
  ...
  result =
      __SA_UTILS_DECONST_AND_CONV_TO_SOCKADDR_IN6(sockaddr_in_4_6_const_ptr);
  validate_conversion_result(result);
}

static void test_valid_conversions_to_sockaddr_inarp() {
  ...
  result =
      __SA_UTILS_DECONST_AND_CONV_TO_SOCKADDR_INARP(sockaddr_storage_const_ptr);
  validate_conversion_result(result);

  result =
      __SA_UTILS_DECONST_AND_CONV_TO_SOCKADDR_INARP(sockaddr_inarp_const_ptr);
  validate_conversion_result(result);
}

static void test_valid_conversions_to_sockaddr_inifscope() {
  ...
  const_result =
      __SA_UTILS_CONV_TO_SOCKADDR_INIFSCOPE(sockaddr_storage_const_ptr);
  validate_conversion_result(const_result);

  const_result =
      __SA_UTILS_CONV_TO_SOCKADDR_INIFSCOPE(sockaddr_inifscope_const_ptr);
  validate_conversion_result(const_result);

  const_result =
      __SA_UTILS_CONV_TO_SOCKADDR_INIFSCOPE(sockaddr_in_4_6_const_ptr);
  validate_conversion_result(const_result);
  ...
  /* Const to non-const (a.k.a. "deconst") conversions. */
  result =
      __SA_UTILS_DECONST_AND_CONV_TO_SOCKADDR_INIFSCOPE(sockaddr_const_ptr);
  validate_conversion_result(result);

  result = __SA_UTILS_DECONST_AND_CONV_TO_SOCKADDR_INIFSCOPE(
      sockaddr_storage_const_ptr);
  validate_conversion_result(result);

  result = __SA_UTILS_DECONST_AND_CONV_TO_SOCKADDR_INIFSCOPE(
      sockaddr_inifscope_const_ptr);
  validate_conversion_result(result);

  result = __SA_UTILS_DECONST_AND_CONV_TO_SOCKADDR_INIFSCOPE(
      sockaddr_in_4_6_const_ptr);
  validate_conversion_result(result);
}

static void test_valid_conversions_to_sockaddr_ndrv() {
  ...
  result =
      __SA_UTILS_DECONST_AND_CONV_TO_SOCKADDR_NDRV(sockaddr_storage_const_ptr);
  validate_conversion_result(result);

  result =
      __SA_UTILS_DECONST_AND_CONV_TO_SOCKADDR_NDRV(sockaddr_ndrv_const_ptr);
  validate_conversion_result(result);
}

static void test_valid_conversions_to_sockaddr_sys() {
  ...
  result =
      __SA_UTILS_DECONST_AND_CONV_TO_SOCKADDR_SYS(sockaddr_storage_const_ptr);
  validate_conversion_result(result);
...
static void test_valid_conversions_to_sockaddr_un() {
  ...
  result =
      __SA_UTILS_DECONST_AND_CONV_TO_SOCKADDR_UN(sockaddr_storage_const_ptr);
  validate_conversion_result(result);
...
static int sockaddr_utils_test_run(__unused int64_t in, int64_t *out) {
