...
typedef struct fasttrap_machtp {
  ...
  /* Once the tracepoint is initialized, fntype will be FN_DONE_INIT and thumb
   * will be 0 for ARM, 1 for Thumb */
  uint8_t ftmt_thumb;
...
#define FASTTRAP_T_ARM64_STANDARD_FUNCTION_ENTRY                               \
  16 /* stp fp, lr, [sp, #-16]! */
...
#if defined(__arm64__)
#define FASTTRAP_ARM64_OP_VALUE_FUNC_ENTRY                                     \
  0xa9bf7bfd /* stp fp, lr, [sp, #-16]! */

#define FASTTRAP_ARM64_OP_MASK_LDR_S_PC_REL                                    \
  0xff000000 /* Bits to check for ldr St, label */
#define FASTTRAP_ARM64_OP_VALUE_LDR_S_PC_REL 0x1c000000 /* Value to find */

#define FASTTRAP_ARM64_OP_MASK_LDR_W_PC_REL                                    \
  0xff000000 /* Bits to check for ldr Wt, label */
#define FASTTRAP_ARM64_OP_VALUE_LDR_W_PC_REL 0x18000000 /* Value to find */

#define FASTTRAP_ARM64_OP_MASK_LDR_D_PC_REL                                    \
  0xff000000 /* Bits to check for ldr Dt, label */
#define FASTTRAP_ARM64_OP_VALUE_LDR_D_PC_REL 0x5c000000 /* Value to find */

#define FASTTRAP_ARM64_OP_MASK_LDR_X_PC_REL                                    \
  0xff000000 /* Bits to check for ldr Xt, label */
#define FASTTRAP_ARM64_OP_VALUE_LDR_X_PC_REL 0x58000000 /* Value to find */

#define FASTTRAP_ARM64_OP_MASK_LDR_Q_PC_REL                                    \
  0xff000000 /* Bits to check for ldr Qt, label */
#define FASTTRAP_ARM64_OP_VALUE_LDR_Q_PC_REL 0x9c000000 /* Value to find */

#define FASTTRAP_ARM64_OP_MASK_LRDSW_PC_REL                                    \
  0xff000000 /* Bits to check for ldrsw <reg>, label */
#define FASTTRAP_ARM64_OP_VALUE_LRDSW_PC_REL 0x98000000 /* Value to find */

#define FASTTRAP_ARM64_OP_MASK_B_COND_PC_REL                                   \
  0xff000010 /* Bits to check for b.cond label */
#define FASTTRAP_ARM64_OP_VALUE_B_COND_PC_REL 0x54000000 /* Value to find */

#define FASTTRAP_ARM64_OP_MASK_CBNZ_W_PC_REL                                   \
  0xff000000 /* Bits to check for cbnz Wt, _label */
#define FASTTRAP_ARM64_OP_VALUE_CBNZ_W_PC_REL 0x35000000 /* Value to find */

#define FASTTRAP_ARM64_OP_MASK_CBNZ_X_PC_REL                                   \
  0xff000000 /* Bits to check for cbnz Xt, _label */
#define FASTTRAP_ARM64_OP_VALUE_CBNZ_X_PC_REL 0xb5000000 /* Value to find */

#define FASTTRAP_ARM64_OP_MASK_CBZ_W_PC_REL                                    \
  0xff000000 /* Bits to check for cbz Wt, _label */
#define FASTTRAP_ARM64_OP_VALUE_CBZ_W_PC_REL 0x34000000 /* Value to find */

#define FASTTRAP_ARM64_OP_MASK_CBZ_X_PC_REL                                    \
  0xff000000 /* Bits to check for cbz Xt, _label */
#define FASTTRAP_ARM64_OP_VALUE_CBZ_X_PC_REL 0xb4000000 /* Value to find */

#define FASTTRAP_ARM64_OP_MASK_TBNZ_PC_REL                                     \
  0x7f000000 /* Bits to check for tbnz Xt, _label */
#define FASTTRAP_ARM64_OP_VALUE_TBNZ_PC_REL 0x37000000 /* Value to find */

#define FASTTRAP_ARM64_OP_MASK_TBZ_PC_REL                                      \
  0x7f000000 /* Bits to check for tbz Xt, _label */
#define FASTTRAP_ARM64_OP_VALUE_TBZ_PC_REL 0x36000000 /* Value to find */

#define FASTTRAP_ARM64_OP_MASK_B_PC_REL                                        \
  0xfc000000 /* Bits to check for b _label */
#define FASTTRAP_ARM64_OP_VALUE_B_PC_REL 0x14000000 /* Value to find */

#define FASTTRAP_ARM64_OP_MASK_BL_PC_REL                                       \
  0xfc000000 /* Bits to check for bl _label */
...
#define FASTTRAP_ARM64_OP_MASK_ADRP                                            \
  0x9f000000 /* Bits to check for adrp Xt, label*/
#define FASTTRAP_ARM64_OP_VALUE_ADRP 0x90000000 /* Value to find */

#define FASTTRAP_ARM64_OP_MASK_ADR                                             \
  0x9f000000 /* Bits to check for adr Xt, label*/
#define FASTTRAP_ARM64_OP_VALUE_ADR 0x10000000 /* Value to find */

#define FASTTRAP_ARM64_OP_MASK_PRFM                                            \
  0xff000000 /* Bits to check for adr Xt, label*/
#define FASTTRAP_ARM64_OP_VALUE_PRFM 0xd8000000 /* Value to find */

#define FASTTRAP_ARM64_OP_MASK_EXCL_MEM                                        \
  0x3f000000 /* Bits  to check for exclusive memory operation */
