...
int proc_info_internal(int callnum, int pid, uint32_t flags, uint64_t ext_id,
                       int flavor, uint64_t arg, user_addr_t buffer,
...
proc_listpids(uint32_t type, uint32_t tyoneinfo, user_addr_t buffer,
              uint32_t buffersize, int32_t *retval);
static int __attribute__((noinline))
proc_pidinfo(int pid, uint32_t flags, uint64_t ext_id, int flavor, uint64_t arg,
             user_addr_t buffer, uint32_t buffersize, int32_t *retval);
static int __attribute__((noinline)) proc_pidfdinfo(int pid, int flavor, int fd,
                                                    user_addr_t buffer,
                                                    uint32_t buffersize,
                                                    int32_t *retval);
static int __attribute__((noinline))
...
static int __attribute__((noinline))
proc_setcontrol(int pid, int flavor, uint64_t arg, user_addr_t buffer,
                uint32_t buffersize, int32_t *retval);
static int __attribute__((noinline))
...
static int __attribute__((noinline))
proc_pid_rusage(int pid, int flavor, user_addr_t buffer, int32_t *retval);
static int __attribute__((noinline)) proc_pidoriginatorinfo(int pid, int flavor,
                                                            user_addr_t buffer,
                                                            uint32_t buffersize,
                                                            int32_t *retval);
static int __attribute__((noinline))
proc_listcoalitions(int flavor, int coaltype, user_addr_t buffer,
                    uint32_t buffersize, int32_t *retval);
static int __attribute__((noinline))
proc_can_use_foreground_hw(int pid, user_addr_t reason, uint32_t resonsize,
                           int32_t *retval);
static int __attribute__((noinline)) proc_set_dyld_images(int pid,
                                                          user_addr_t buffer,
                                                          uint32_t buffersize,
                                                          int32_t *retval);

/* protos for procpidinfo calls */
static int __attribute__((noinline)) proc_pidfdlist(proc_t p,
                                                    user_addr_t buffer,
                                                    uint32_t buffersize,
                                                    int32_t *retval);
static int __attribute__((noinline))
...
static int __attribute__((noinline))
proc_pidshortbsdinfo(proc_t p, struct proc_bsdshortinfo *pbsd_shortp,
                     int zombie);
static int __attribute__((noinline))
proc_pidtaskinfo(proc_t p, struct proc_taskinfo *ptinfo);
static int __attribute__((noinline))
proc_pidthreadinfo(proc_t p, uint64_t arg, bool thuniqueid,
                   struct proc_threadinfo *pthinfo);
static int __attribute__((noinline))
proc_pidthreadpathinfo(proc_t p, uint64_t arg,
                       struct proc_threadwithpathinfo *pinfo);
static int __attribute__((noinline))
proc_pidthreadschedinfo(proc_t p, uint64_t arg,
                        struct proc_threadschedinfo *schedinfo);
static int __attribute__((noinline))
proc_pidlistthreads(proc_t p, bool thuniqueid, user_addr_t buffer,
                    uint32_t buffersize, int32_t *retval);
static int __attribute__((noinline)) proc_pidregioninfo(proc_t p, uint64_t arg,
                                                        user_addr_t buffer,
                                                        uint32_t buffersize,
                                                        int32_t *retval);
static int __attribute__((noinline))
proc_pidregionpathinfo(proc_t p, uint64_t arg, user_addr_t buffer,
                       uint32_t buffersize, int32_t *retval);
static int __attribute__((noinline))
proc_pidregionpathinfo2(proc_t p, uint64_t arg, user_addr_t buffer,
                        uint32_t buffersize, int32_t *retval);
static int __attribute__((noinline))
proc_pidregionpathinfo3(proc_t p, uint64_t arg, user_addr_t buffer,
                        uint32_t buffersize, int32_t *retval);
static int __attribute__((noinline))
proc_pidvnodepathinfo(proc_t p, uint64_t arg, user_addr_t buffer,
                      uint32_t buffersize, int32_t *retval);
static int __attribute__((noinline)) proc_pidpathinfo(proc_t p, uint64_t arg,
                                                      user_addr_t buffer,
                                                      uint32_t buffersize,
                                                      int32_t *retval);
static int __attribute__((noinline))
proc_pidworkqueueinfo(proc_t p, struct proc_workqueueinfo *pwqinfo);
static int __attribute__((noinline)) proc_pidfileportlist(proc_t p,
                                                          user_addr_t buffer,
                                                          size_t buffersize,
                                                          int32_t *retval);
...
static void __attribute__((noinline)) proc_archinfo(proc_t p,
                                                    struct proc_archinfo *pai);
static void __attribute__((noinline))
proc_pidcoalitioninfo(proc_t p, struct proc_pidcoalitioninfo *pci);
static int __attribute__((noinline)) proc_pidnoteexit(proc_t p, uint64_t arg,
                                                      uint32_t *data);
static int __attribute__((noinline))
proc_pidexitreasoninfo(proc_t p, struct proc_exitreasoninfo *peri,
                       struct proc_exitreasonbasicinfo *pberi);
static int __attribute__((noinline)) proc_pidlistuptrs(proc_t p,
                                                       user_addr_t buffer,
                                                       uint32_t buffersize,
                                                       int32_t *retval);
static int __attribute__((noinline))
proc_piddynkqueueinfo(pid_t pid, int flavor, kqueue_id_t id, user_addr_t buffer,
                      uint32_t buffersize, int32_t *retval);
static int __attribute__((noinline))
proc_pidregionpath(proc_t p, uint64_t arg, user_addr_t buffer,
                   __unused uint32_t buffersize, int32_t *retval);
static int __attribute__((noinline))
proc_pidipctableinfo(proc_t p, struct proc_ipctableinfo *table_info);

#if CONFIG_PROC_UDATA_STORAGE
int __attribute__((noinline)) proc_udata_info(pid_t pid, int flavor,
                                              user_addr_t buffer,
                                              uint32_t buffersize,
                                              int32_t *retval);
#endif
...
static int __attribute__((noinline))
pid_vnodeinfo(vnode_t vp, struct fileproc *fp, proc_t proc, user_addr_t buffer,
              uint32_t buffersize, int32_t *retval);
static int __attribute__((noinline))
pid_vnodeinfopath(vnode_t vp, struct fileproc *fp, proc_t proc,
                  user_addr_t buffer, uint32_t buffersize, int32_t *retval);
static int __attribute__((noinline))
pid_socketinfo(socket_t so, struct fileproc *fp, proc_t proc,
               user_addr_t buffer, uint32_t buffersize, int32_t *retval);
static int __attribute__((noinline))
pid_channelinfo(struct kern_channel *chan, struct fileproc *fp, proc_t proc,
                user_addr_t buffer, uint32_t buffersize, int32_t *retval);
static int __attribute__((noinline))
pid_pseminfo(struct psemnode *psem, struct fileproc *fp, proc_t proc,
             user_addr_t buffer, uint32_t buffersize, int32_t *retval);
static int __attribute__((noinline))
pid_pshminfo(struct pshmnode *pshm, struct fileproc *fp, proc_t proc,
             user_addr_t buffer, uint32_t buffersize, int32_t *retval);
static int __attribute__((noinline))
pid_pipeinfo(struct pipe *p, struct fileproc *fp, proc_t proc,
             user_addr_t buffer, uint32_t buffersize, int32_t *retval);
static int __attribute__((noinline))
pid_kqueueinfo(struct kqueue *kq, struct fileproc *fp, proc_t proc,
               user_addr_t buffer, uint32_t buffersize, int32_t *retval);

/* protos for misc */

static int proc_terminate_all_rsr(__unused int pid, __unused int flavor,
                                  int arg, int32_t *retval);
...
static int proc_signal_with_audittoken(user_addr_t buffer, size_t buffersize,
                                       int signum, int32_t *retval);
static int proc_terminate_with_audittoken(user_addr_t buffer, size_t buffersize,
                                          int32_t *retval);
static int proc_signal_delegate(user_addr_t buffer, size_t buffersize,
                                int signum, int32_t *retval);
static int proc_terminate_delegate(user_addr_t buffer, size_t buffersize,
                                   int32_t *retval);
static int fill_vnodeinfo(vnode_t vp, struct vnode_info *vinfo,
                          boolean_t check_fsgetpath);
static void fill_fileinfo(struct fileproc *fp, proc_t proc,
                          struct proc_fileinfo *finfo);
static int proc_security_policy(proc_t targetp, int callnum, int flavor,
...
extern int proc_pidpathinfo_internal(proc_t p, __unused uint64_t arg, char *buf,
                                     uint32_t buffersize,
                                     __unused int32_t *retval);
extern bool cansignal(struct proc *, kauth_cred_t, struct proc *, int);
extern bool cansignal_nomac(proc_t src, kauth_cred_t uc_src, proc_t dst,
                            int signum);
extern int proc_get_rusage(proc_t proc, int flavor, user_addr_t buffer,
                           int is_zombie);
...
int proc_info(__unused struct proc *p, struct proc_info_args *uap,
              int32_t *retval) {
  return proc_info_internal(uap->callnum, uap->pid, 0, 0, uap->flavor, uap->arg,
                            uap->buffer, uap->buffersize, retval);
}

int proc_info_extended_id(__unused struct proc *p,
                          struct proc_info_extended_id_args *uap,
                          int32_t *retval) {
  uint32_t flags = uap->flags;

  if ((flags & (PIF_COMPARE_IDVERSION | PIF_COMPARE_UNIQUEID)) ==
      (PIF_COMPARE_IDVERSION | PIF_COMPARE_UNIQUEID)) {
    return EINVAL;
  }

  return proc_info_internal(uap->callnum, uap->pid, flags, uap->ext_id,
                            uap->flavor, uap->arg, uap->buffer, uap->buffersize,
                            retval);
}
...
int proc_info_internal(int callnum, int pid, uint32_t flags, uint64_t ext_id,
  ...
  case PROC_INFO_CALL_PIDINFO:
    return proc_pidinfo(pid, flags, ext_id, flavor, arg, buffer, buffersize,
                        retval);
  ...
  case PROC_INFO_CALL_PIDFILEPORTINFO:
    return proc_pidfileportinfo(pid, flavor, (mach_port_name_t)arg, buffer,
                                buffersize, retval);
  ...
  case PROC_INFO_CALL_PIDDYNKQUEUEINFO:
    return proc_piddynkqueueinfo(pid, flavor, (kqueue_id_t)arg, buffer,
                                 buffersize, retval);
#if CONFIG_PROC_UDATA_STORAGE
...
int proc_listpids(uint32_t type, uint32_t typeinfo, user_addr_t buffer,
                  uint32_t buffersize, int32_t *retval) {
  uint32_t numprocs = 0;
  uint32_t wantpids;
  int *kbuf;
  ...
  if ((error = proc_security_policy(PROC_NULL, PROC_INFO_CALL_LISTPIDS, type,
                                    NO_CHECK_SAME_USER))) {
    return error;
  }
...
proc_loop:
  LIST_FOREACH(p, current_list, p_list) {
    ...
    case PROC_PGRP_ONLY:
      ...
      break;
    case PROC_PPID_ONLY:
      if ((p->p_ppid != (pid_t)typeinfo) && (((p->p_lflag & P_LTRACED) == 0) ||
                                             (p->p_oppid != (pid_t)typeinfo))) {
        skip = 1;
      }
      break;
    ...
    case PROC_TTY_ONLY:
      if (p->p_flag & P_CONTROLT) {
        ...
        skip = pg != PGRP_NULL && os_atomic_load(&pg->pg_session->s_ttydev,
                                                 relaxed) != (dev_t)typeinfo;
      } else {
        skip = 1;
      }
      break;
    case PROC_UID_ONLY:
      ...
      skip = cred == NOCRED || kauth_cred_getuid(cred) != (uid_t)typeinfo;
      smr_proc_task_leave();
      break;
    case PROC_RUID_ONLY:
      smr_proc_task_enter();
      cred = proc_ucred_smr(p);
      skip = cred == NOCRED || kauth_cred_getruid(cred) != (uid_t)typeinfo;
      smr_proc_task_leave();
      break;
    case PROC_KDBG_ONLY:
      if (p->p_kdebug == 0) {
...
static size_t proc_fdlist_internal(proc_t p, struct proc_fdinfo *pfd,
                                   size_t numfds) {
  struct fileproc *fp;
  size_t count = 0;
  ...
  fdt_foreach(fp, p) {
    ...
    pfd[count].proc_fdtype =
        (fdtype != DTYPE_ATALK) ? fdtype : PROX_FDTYPE_ATALK;
    count++;
  }
...
int proc_pidfdlist(proc_t p, user_addr_t buffer, uint32_t buffersize,
                   int32_t *retval) {
  uint32_t numfds = 0;
  uint32_t needfds;
  char *kbuf;
  ...
  kbuf = (char *)kalloc_data(numfds * sizeof(struct proc_fdinfo),
                             Z_WAITOK | Z_ZERO);
  if (kbuf == NULL) {
    return ENOMEM;
  }
  ...
  count = (uint32_t)proc_fdlist_internal(p, (struct proc_fdinfo *)kbuf,
                                         (size_t)numfds);
 ...
 */
int proc_fdlist(proc_t p, struct proc_fdinfo *buf, size_t *count) {
...
int proc_pidfileportlist(proc_t p, user_addr_t buffer, size_t buffersize,
                         int32_t *retval) {
  void *kbuf;
  size_t kbufsize;
...
int proc_pidshortbsdinfo(proc_t p, struct proc_bsdshortinfo *pbsd_shortp,
                         int zombie) {
...
int proc_pidthreadinfo(proc_t p, uint64_t arg, bool thuniqueid,
                       struct proc_threadinfo *pthinfo) {
  int error = 0;
  ...
  error = fill_taskthreadinfo(proc_task(p), threadaddr, thuniqueid,
                              (struct proc_threadinfo_internal *)pthinfo, NULL,
                              NULL);
  if (error) {
    return ESRCH;
  } else {
...
/*
 * This is known to race with regards to the contents of the thread name;
 * concurrent callers may result in a garbled name.
 */
void bsd_setthreadname(void *uth, uint64_t tid, const char *name) {
  struct uthread *ut = (struct uthread *)uth;
  char *name_buf = NULL;
  ...
  if (!ut->pth_name) {
    ...
    name_buf = kalloc_data(MAXTHREADNAMESIZE, Z_WAITOK | Z_ZERO | Z_NOFAIL);
...
void bsd_copythreadname(void *dst_uth, void *src_uth) {
...
int proc_pidthreadpathinfo(proc_t p, uint64_t arg,
                           struct proc_threadwithpathinfo *pinfo) {
  vnode_t vp = NULLVP;
  int vid;
  int error = 0;
  ...
  error = fill_taskthreadinfo(proc_task(p), threadaddr, 0,
                              (struct proc_threadinfo_internal *)&pinfo->pt,
                              (void *)&vp, &vid);
  if (error) {
    return ESRCH;
  }
...
int proc_pidlistthreads(proc_t p, bool thuniqueid, user_addr_t buffer,
                        uint32_t buffersize, int32_t *retval) {
  uint32_t count = 0;
  int ret = 0;
  int error = 0;
...
int proc_pidregioninfo(proc_t p, uint64_t arg, user_addr_t buffer,
                       __unused uint32_t buffersize, int32_t *retval) {
  struct proc_regioninfo preginfo;
  int ret, error = 0;

  bzero(&preginfo, sizeof(struct proc_regioninfo));
  ret = fill_procregioninfo(proc_task(p), arg,
                            (struct proc_regioninfo_internal *)&preginfo,
...
int proc_pidregionpathinfo(proc_t p, uint64_t arg, user_addr_t buffer,
                           __unused uint32_t buffersize, int32_t *retval) {
  ...
  ret = fill_procregioninfo(
      proc_task(p), arg,
      (struct proc_regioninfo_internal *)&preginfo.prp_prinfo,
...
int proc_pidregionpathinfo2(proc_t p, uint64_t arg, user_addr_t buffer,
                            __unused uint32_t buffersize, int32_t *retval) {
  struct proc_regionwithpathinfo preginfo;
  int ret, error = 0;
  uintptr_t vnodeaddr = 0;
...
int proc_pidregionpath(proc_t p, uint64_t arg, user_addr_t buffer,
                       __unused uint32_t buffersize, int32_t *retval) {
  ...
  ret = task_find_region_details(
      proc_task(p), (vm_map_offset_t)arg, FIND_REGION_DETAILS_OPTIONS_NONE,
...
int proc_pidregionpathinfo3(proc_t p, uint64_t arg, user_addr_t buffer,
                            __unused uint32_t buffersize, int32_t *retval) {
  struct proc_regionwithpathinfo preginfo;
  int ret, error = 0;
  uintptr_t vnodeaddr;
  ...
  do {
    ...
    vp = (vnode_t)vnodeaddr;
    if ((vnode_getwithvid(vp, vnodeid)) == 0) {
      /* Check if the vnode matches the filter, otherwise loop looking for the
       * next memory region backed by a vnode */
 ...
 * thread directory.
 */
int proc_pidvnodepathinfo(proc_t p, __unused uint64_t arg, user_addr_t buffer,
                          __unused uint32_t buffersize, int32_t *retval) {
...
int proc_pidpathinfo(proc_t p, __unused uint64_t arg, user_addr_t buffer,
                     uint32_t buffersize, __unused int32_t *retval) {
  int error;
  vnode_t tvp;
  int len = buffersize;
  char *buf;
...
int proc_pidpathinfo_internal(proc_t p, __unused uint64_t arg, char *buf,
                              uint32_t buffersize, __unused int32_t *retval) {
  vnode_t tvp;
  int vid, error;
  int len = buffersize;
    ...
    if (error == 0) {
      ...
      if (error == 0) {
        ...
        if (error == EACCES) {
          ...
          os_log(
              OS_LOG_DEFAULT,
              "%s : EACCES returned by vnode_lookup for path %s for uid %d\n",
          ...
          if (error == 0) {
            ...
            os_log(
                OS_LOG_DEFAULT,
                "%s : EACCES returned by vnode_lookup for path %s for uid 0\n",
                __FUNCTION__, buf);
#else
            os_log(OS_LOG_DEFAULT,
...
#if DEVELOPMENT || DEBUG
            os_log(OS_LOG_DEFAULT,
                   "%s : vnode_lookup for path %s returned error %d\n",
...
void proc_piduniqidentifierinfo(proc_t p,
                                struct proc_uniqidentifierinfo *p_uniqidinfo) {
  p_uniqidinfo->p_uniqueid = proc_uniqueid(p);
  proc_getexecutableuuid(p, (unsigned char *)&p_uniqidinfo->p_uuid,
                         sizeof(p_uniqidinfo->p_uuid));
 ...
 */
int proc_pidoriginatorpid_uuid(uuid_t uuid, uint32_t buffersize, pid_t *pid) {
 ...
 */
int proc_pidoriginatoruuid(uuid_t uuid, uint32_t buffersize) {
  pid_t originator_pid;
 ...
 */
int proc_pidipctableinfo(proc_t p, struct proc_ipctableinfo *table_info) {
  task_t task;
  int error = 0;
  ...
  error = fill_taskipctableinfo(task, &(table_info->table_size),
...
int proc_pidthreadschedinfo(proc_t p, uint64_t arg,
  ...
  error = fill_taskthreadschedinfo(
      task, thread_id, (struct proc_threadschedinfo_internal *)sched_info);
...
int proc_pidoriginatorinfo(int pid, int flavor, user_addr_t buffer,
                           uint32_t buffersize, int32_t *retval) {
  int error = ENOTSUP;
  uint32_t size;
  ...
  case PROC_PIDORIGINATOR_PID_UUID: {
    ...
    error = proc_pidoriginatorpid_uuid(originator_info.originator_uuid,
                                       sizeof(uuid_t),
                                       &originator_info.originator_pid);
    if (error != 0) {
      goto out;
    }
 ...
 * **************************/
int proc_can_use_foreground_hw(int pid, user_addr_t u_reason,
                               uint32_t reasonsize, int32_t *retval) {
  proc_t p = PROC_NULL;
  int error = 0;
  ...
  *retval = 0;
  ...
  task = proc_task(p);
  if (coalition_is_leader(task,
                          task_get_coalition(task, COALITION_TYPE_JETSAM))) {
    task_reference(task);
  } else {
...
no_leader:
   ...
   *       proc_pidoriginatorinfo(PROC_PIDORIGINATOR_BGSTATE, &isBG,
   * sizeof(isBG))
   */
  isBG = 1;
 ...
 */
static void __attribute__((noinline)) PROC_UNPERMITTED_PIDINFO_FLAVOR(void) {
  ...
  task_enqueue_exception_with_corpse(current_task(), EXC_GUARD, code,
                                     EXCEPTION_CODE_MAX, NULL, TRUE);
}

/********************************** proc_pidinfo
 * ********************************/

int proc_pidinfo(int pid, uint32_t flags, uint64_t ext_id, int flavor,
                 uint64_t arg, user_addr_t buffer, uint32_t buffersize,
                 int32_t *retval) {
  struct proc *p = PROC_NULL;
  int error = ENOTSUP;
  int gotref = 0;
  ...
  if ((flavor == PROC_PIDTBSDINFO) || (flavor == PROC_PIDT_SHORTBSDINFO) ||
      (flavor == PROC_PIDT_BSDINFOWITHUNIQID) ||
  ...
  /* Do we have permission to look into this? */
  if ((error = proc_security_policy(p, PROC_INFO_CALL_PIDINFO, flavor,
                                    check_same_user))) {
    goto out;
  }
  ...
  switch (flavor) {
  case PROC_PIDLISTFDS: {
    if ((error = proc_security_policy(p, PROC_INFO_CALL_PIDFDINFO, flavor,
                                      check_same_user))) {
      goto out;
    }
  ...
  case PROC_PIDUNIQIDENTIFIERINFO: {
    ...
    error =
        copyout(&p_uniqidinfo, buffer, sizeof(struct proc_uniqidentifierinfo));
    if (error == 0) {
  ...
  case PROC_PIDTBSDINFO: {
    ...
    if (error == 0) {
      if (shortversion != 0) {
        ...
        error = copyout(&pbsd_uniqid, buffer,
  ...
  case PROC_PIDTHREADPATHINFO: {
    ...
    if (error == 0) {
      error = copyout((caddr_t)&pinfo, buffer,
  ...
  case PROC_PIDVMRTFAULTINFO: {
    ...
    *retval = 0;
    ...
    int vmf_residue =
        vmrtf_extract(effpid, isroot, kbufsz, vmrtfbuf, &num_extracted);
...
int pid_vnodeinfo(vnode_t vp, struct fileproc *fp, proc_t proc,
                  user_addr_t buffer, __unused uint32_t buffersize,
                  int32_t *retval) {
...
int pid_vnodeinfopath(vnode_t vp, struct fileproc *fp, proc_t proc,
                      user_addr_t buffer, __unused uint32_t buffersize,
                      int32_t *retval) {
  ...
  if (error == 0) {
    ...
    vnode_put(vp);
    error =
        copyout((caddr_t)&vfip, buffer, sizeof(struct vnode_fdinfowithpath));
    if (error == 0) {
...
void fill_fileinfo(struct fileproc *fp, proc_t proc,
                   struct proc_fileinfo *fproc) {
...
int pid_socketinfo(socket_t so, struct fileproc *fp, proc_t proc,
                   user_addr_t buffer, __unused uint32_t buffersize,
                   int32_t *retval) {
#if SOCKETS
...
int pid_pseminfo(struct psemnode *psem, struct fileproc *fp, proc_t proc,
                 user_addr_t buffer, __unused uint32_t buffersize,
                 int32_t *retval) {
...
int pid_pshminfo(struct pshmnode *pshm, struct fileproc *fp, proc_t proc,
                 user_addr_t buffer, __unused uint32_t buffersize,
                 int32_t *retval) {
...
int pid_pipeinfo(struct pipe *p, struct fileproc *fp, proc_t proc,
                 user_addr_t buffer, __unused uint32_t buffersize,
                 int32_t *retval) {
...
int pid_kqueueinfo(struct kqueue *kq, struct fileproc *fp, proc_t proc,
                   user_addr_t buffer, __unused uint32_t buffersize,
                   int32_t *retval) {
...
int pid_channelinfo(struct kern_channel *chan, struct fileproc *fp, proc_t proc,
                    user_addr_t buffer, __unused uint32_t buffersize,
                    int32_t *retval) {
#if SKYWALK
  ...
  if ((error = fill_channelinfo(chan, &channel_info.channelinfo)) == 0) {
    if ((error = copyout(&channel_info, buffer,
                         sizeof(struct channel_fdinfo))) == 0) {
...
int proc_pidfdinfo(int pid, int flavor, int fd, user_addr_t buffer,
                   uint32_t buffersize, int32_t *retval) {
  proc_t p;
  int error = ENOTSUP;
  ...
  case PROC_PIDFDVNODEINFO: {
    ...
    error = pid_vnodeinfo((vnode_t)fp_get_data(fp), fp, p, buffer, buffersize,
                          retval);
  } break;
  ...
  case PROC_PIDFDVNODEPATHINFO: {
    ...
    error = pid_vnodeinfopath((vnode_t)fp_get_data(fp), fp, p, buffer,
                              buffersize, retval);
  } break;
  ...
  case PROC_PIDFDSOCKETINFO: {
    ...
    error = pid_socketinfo((socket_t)fp_get_data(fp), fp, p, buffer, buffersize,
                           retval);
  } break;
  ...
  case PROC_PIDFDPSEMINFO: {
    ...
    error = pid_pseminfo((struct psemnode *)fp_get_data(fp), fp, p, buffer,
                         buffersize, retval);
  } break;
  ...
  case PROC_PIDFDPSHMINFO: {
    ...
    error = pid_pshminfo((struct pshmnode *)fp_get_data(fp), fp, p, buffer,
                         buffersize, retval);
  } break;
  ...
  case PROC_PIDFDPIPEINFO: {
    ...
    error = pid_pipeinfo((struct pipe *)fp_get_data(fp), fp, p, buffer,
                         buffersize, retval);
  } break;
  ...
  case PROC_PIDFDCHANNELINFO: {
    ...
    error = pid_channelinfo((struct kern_channel *)fp_get_data(fp), fp, p,
                            buffer, buffersize, retval);
  } break;
...
int proc_pidlistuptrs(proc_t p, user_addr_t buffer, uint32_t buffersize,
                      int32_t *retval) {
  uint32_t count = 0;
  int error = 0;
  void *kbuf = NULL;
...
static kern_return_t proc_fileport_info(__unused mach_port_name_t name,
  ...
  case PROC_PIDFILEPORTVNODEPATHINFO: {
    ...
    error = pid_vnodeinfopath(vp, fp, PROC_NULL, fia->fia_buffer,
                              fia->fia_buffersize, fia->fia_retval);
  } break;
  ...
  case PROC_PIDFILEPORTSOCKETINFO: {
    ...
    error = pid_socketinfo(so, fp, PROC_NULL, fia->fia_buffer,
                           fia->fia_buffersize, fia->fia_retval);
  } break;
  ...
  case PROC_PIDFILEPORTPSHMINFO: {
    ...
    error = pid_pshminfo(pshm, fp, PROC_NULL, fia->fia_buffer,
                         fia->fia_buffersize, fia->fia_retval);
  } break;
  ...
  case PROC_PIDFILEPORTPIPEINFO: {
    ...
    error = pid_pipeinfo(cpipe, fp, PROC_NULL, fia->fia_buffer,
                         fia->fia_buffersize, fia->fia_retval);
  } break;
...
int proc_pidfileportinfo(int pid, int flavor, mach_port_name_t name,
                         user_addr_t buffer, uint32_t buffersize,
                         int32_t *retval) {
  proc_t p;
  int error = ENOTSUP;
  uint32_t size;
  ...
  /* Do we have permission to look into this? */
  if ((error = proc_security_policy(p, PROC_INFO_CALL_PIDFILEPORTINFO, flavor,
                                    CHECK_SAME_USER))) {
    goto out1;
  }
  ...
  if (fileport_invoke(proc_task(p), name, proc_fileport_info, &fia, &error) !=
      KERN_SUCCESS) {
    error = EINVAL;
  }
out1:
...
int proc_security_policy(proc_t targetp, __unused int callnum,
                         __unused int flavor, boolean_t check_same_user) {
#if CONFIG_MACF
  int error = 0;

  if ((error = mac_proc_check_proc_info(current_proc(), targetp, callnum,
                                        flavor))) {
    return error;
  }
#endif
  ...
  if (targetp == PROC_NULL) {
    assert(callnum == PROC_INFO_CALL_LISTPIDS &&
           check_same_user == NO_CHECK_SAME_USER);
    return 0;
  }
...
int proc_setcontrol(int pid, int flavor, uint64_t arg, user_addr_t buffer,
                    uint32_t buffersize, __unused int32_t *retval) {
  ...
  /* Do we have permission to look into this? */
  if ((error = proc_security_policy(pself, PROC_INFO_CALL_SETCONTROL, flavor,
                                    NO_CHECK_SAME_USER))) {
    goto out;
  }
...
int proc_dirtycontrol(int pid, int flavor, uint64_t arg, int32_t *retval) {
  ...
  /* Do we have permission to look into this? */
  if ((error = proc_security_policy(target_p, PROC_INFO_CALL_DIRTYCONTROL,
                                    flavor, NO_CHECK_SAME_USER))) {
    goto out;
  }
  ...
  case PROC_DIRTYCONTROL_SET: {
    /* Check privileges; use cansignal() here since the process could be
     * terminated */
...
int proc_dirtycontrol(__unused int pid, __unused int flavor,
                      __unused uint64_t arg, __unused int32_t *retval) {
  return ENOTSUP;
}
 ...
 * SIGTERM is sent.
 */
static int proc_terminate_with_proc(proc_t p, int32_t *retval) {
  int sig;
...
static int sysctl_proc_rsr_in_progress SYSCTL_HANDLER_ARGS {
  int error = 0;
...
SYSCTL_PROC(_kern, OID_AUTO, proc_rsr_in_progress,
            ...
            &proc_rsr_in_progress, 0, sysctl_proc_rsr_in_progress, "I", "");
 ...
 */
static int proc_ident_for_audit_token(proc_ident_t out, audit_token_t token) {
  int result = 0;
  proc_t p = PROC_NULL;
 ...
 *
 * @note Invokes proc_terminate_with_proc if should_terminate is true, otherwise
 * invokes psignal with the signal.
 *
 ...
 */
static int psignal_by_audit_token(audit_token_t *instigator,
                                  audit_token_t target, int signum,
                                  bool should_terminate, int32_t *retval) {
  int error = 0;
  ...
  if (instigator != NULL &&
      (proc_ident_for_audit_token(&i_ident, *instigator) != 0)) {
    error = ESRCH;
    goto out;
  }
  ...
  // Check MACF policy without holding any refs, proceed if the signal is
  // allowed to be sent.
  if (mac_proc_check_signal(current_proc(),
                            instigator == NULL ? NULL : &i_ident, &t_ident,
                            signum) != 0) {
    error = EPERM;
    goto out;
  }
...
static int proc_signal_delegate(user_addr_t buffer, size_t buffersize,
  ...
  if (buffer == USER_ADDR_NULL ||
      buffersize != sizeof(struct proc_delegated_signal_info)) {
    return EINVAL;
  }
  ...
  return psignal_by_audit_token(&info.instigator, info.target, signum, false,
                                retval);
}
...
static int proc_terminate_delegate(user_addr_t buffer, size_t buffersize,
  ...
  /* Final signal checks on current_proc */
  return psignal_by_audit_token(&info.instigator, info.target, SIGTERM, true,
                                retval);
}
...
/*
 * proc_terminate_with_audittoken() provides support for sudden termination by
 * audit token. SIGKILL is issued to tracked, clean processes; otherwise,
 * SIGTERM is sent.
 */
static int proc_terminate_with_audittoken(user_addr_t buffer, size_t buffersize,
                                          int32_t *retval) {
...
int proc_pid_rusage(int pid, int flavor, user_addr_t buffer,
                    __unused int32_t *retval) {
  proc_t p;
  int error;
  int zombie = 0;
  ...
  /* Do we have permission to look into this? */
  if ((error = proc_security_policy(p, PROC_INFO_CALL_PIDRUSAGE, flavor,
                                    CHECK_SAME_USER))) {
    goto out;
  }
...
void proc_archinfo(proc_t p, struct proc_archinfo *pai) {
  proc_lock(p);
...
void proc_pidcoalitioninfo(proc_t p, struct proc_pidcoalitioninfo *ppci) {
  bzero(ppci, sizeof(*ppci));
  proc_coalitionids(p, ppci->coalition_id);
}

int proc_pidexitreasoninfo(proc_t p, struct proc_exitreasoninfo *peri,
                           struct proc_exitreasonbasicinfo *pberi) {
  ...
  if (p->p_exit_reason->osr_kcd_buf != NULL) {
    reason_data_size = (uint32_t)kcdata_memory_get_used_bytes(
        &p->p_exit_reason->osr_kcd_descriptor);
  }
  ...
  if (peri != NULL) {
    ...
    if (reason_data_size != 0) {
      error = copyout(p->p_exit_reason->osr_kcd_buf,
                      (user_addr_t)peri->eri_kcd_buf, reason_data_size);
    }
  } else {
 ...
 */
int proc_pidnoteexit(proc_t p, uint64_t flags, uint32_t *data) {
...
int proc_piddynkqueueinfo(int pid, int flavor, kqueue_id_t kq_id,
  ...
  err = proc_security_policy(p, PROC_INFO_CALL_PIDDYNKQUEUEINFO, 0,
                             CHECK_SAME_USER);
  if (err) {
    goto out;
  }
...
#if CONFIG_PROC_UDATA_STORAGE
int proc_udata_info(int pid, int flavor, user_addr_t buffer, uint32_t bufsize,
                    int32_t *retval) {
  int err = 0;
  proc_t p;
...
int proc_set_dyld_images(int pid, user_addr_t buffer, uint32_t buffersize,
                         int32_t *retval) {
  struct proc *pself = PROC_NULL;
  task_t task = TASK_NULL;
  ...
  if (task != TASK_NULL) {
    /* don't need to copyin the buffer. just setting the buffer range in the
     * task struct */
