...
#define _PTHREAD_PRIORITY_DEFAULTQUEUE_FLAG                                    \
  _PTHREAD_PRIORITY_FALLBACK_FLAG // compat
#define _PTHREAD_PRIORITY_OVERRIDE_QOS_FLAG 0x00800000u

#define _PTHREAD_PRIORITY_THREAD_TYPE_MASK                                     \
  (_PTHREAD_PRIORITY_COOPERATIVE_FLAG | _PTHREAD_PRIORITY_OVERCOMMIT_FLAG)
...
__attribute__((always_inline, const)) static inline bool
...
__attribute__((always_inline, const)) static inline pthread_priority_compact_t
...
__attribute__((always_inline, const)) static inline thread_qos_t
...
__attribute__((always_inline, const)) static inline int
...
_pthread_priority_is_nonovercommit(pthread_priority_t pp) {
  return !_pthread_priority_is_cooperative(pp) &&
         !_pthread_priority_is_overcommit(pp);
}
 ...
 */
__attribute__((const)) pthread_priority_compact_t
