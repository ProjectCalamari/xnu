...
void kcov_ksancov_trace_cmp(kcov_thread_data_t *, uint32_t, uint64_t, uint64_t,
                            void *);
void kcov_ksancov_trace_cmp_func(kcov_thread_data_t *, uint32_t, const void *,
                                 size_t, const void *, size_t, void *, bool);
...
#define kcov_ksancov_trace_cmp_func(data, type, arg1, arg2, size, caller,      \
                                    always_log)
