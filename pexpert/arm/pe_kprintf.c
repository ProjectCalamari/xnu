...
__startup_func static void PE_init_kprintf_config(void) {
  ...
  if (PE_parse_boot_argn("-enable_kprintf_spam", &enable_kprintf_spam,
...
void serial_putc_options(char c, bool poll) { uart_putc_options(c, poll); }
