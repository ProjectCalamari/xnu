...
typedef struct boot_args {
  ...
  uint32_t efiRuntimeServicesPageStart; /* physical address of defragmented
                                           runtime pages */
  uint32_t efiRuntimeServicesPageCount;
  uint64_t efiRuntimeServicesVirtualPageStart; /* virtual address of
                                                  defragmented runtime pages */

  uint32_t
      efiSystemTable; /* physical address of system table in runtime area */
  uint32_t kslide;
  ...
  uint64_t
      arvRootHashStart; /* Physical address of system volume root hash file */
  uint64_t arvRootHashSize;

  uint64_t
      arvManifestStart; /* Physical address of system volume manifest file */
  uint64_t arvManifestSize;

  uint64_t
      bsARVRootHashStart; /* Physical address of base system root hash file */
  uint64_t bsARVRootHashSize;

  uint64_t
      bsARVManifestStart; /* Physical address of base system manifest file */
