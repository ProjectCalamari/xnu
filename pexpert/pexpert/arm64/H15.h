...
#define HAS_NEX_PG                                                             \
  1 /* Supports p-Core NEX powergating during Neon inactivity */
#define HAS_BP_RET                                                             \
  1 /* Supports branch predictor state retention across ACC sleep */
...
#define HAS_ARM_FEAT_SSBS2                                                     \
  1 /* Supports Speculative Store Bypass Safe with MSR controls */
#define HAS_E0PD                                                               \
