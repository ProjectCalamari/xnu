...
#define HAS_CONTINUOUS_HWCLOCK                                                 \
  1                           /* Has a hardware clock that ticks during sleep */
...
#define HAS_UCNORMAL_MEM                                                       \
  1 /* Supports completely un-cacheable normal memory type */
#define HAS_FAST_CNTVCT 1
#define HAS_E0PD                                                               \
  1 /* Supports E0PD0 and E0PD1 in TCR for Meltdown mitigation (ARMv8.5)*/
...
#define HAS_CPM_PWRDN_CTL                                                      \
  1 /* Supports CPM_PWRDN_CTL system register for deep sleep */
#define HAS_EL1_SHAREABILITY_BOUNDARY                                          \
  1 /* Supports shareability boundary on TLBI/SDSB instructions executed at    \
       EL1 */
#define HAS_CPU_DPE_COUNTER                                                    \
  1 /* Has a hardware counter for digital power estimation */
#define HAS_GUARDED_IO_FILTER                                                  \
  1 /* Has a guarded runtime dedicated to the fine-grained IO access filter */
#define HAS_ACFG_DIS_DC_OPS                                                    \
  1 /* Has DCache maintenance op disable controls in ACFG_EL1 */
#define HAS_16BIT_ASID 1 /* Supports 16-bit hardware ASIDs */
#define HAS_FEAT_XS                                                            \
  1 /* Supports distinction between XS and non-XS memory transactions */
