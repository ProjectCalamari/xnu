 ...
 */
OS_ENUM(firehose_stream, uint8_t, firehose_stream_persist = 0,
        firehose_stream_special = 1, firehose_stream_memory = 2,
        firehose_stream_metadata = 3, firehose_stream_signpost = 4,
        firehose_stream_memory_wifi = 5, firehose_stream_memory_baseband = 6,
        firehose_stream_metric = 7,

        _firehose_stream_max, _firehose_stream_disabled = (uint8_t)-1, );
