...
OS_INLINE
uint16_t _OSReadSwapInt16(const volatile void *_base, uintptr_t _offset) {
  return _OSSwapInt16(
      ((struct _OSUnalignedU16 *)((uintptr_t)_base + _offset))->__val);
}
#else
OS_INLINE
...
#if defined(_POSIX_C_SOURCE) || defined(_XOPEN_SOURCE)
OS_INLINE
uint32_t _OSReadSwapInt32(const volatile void *_base, uintptr_t _offset) {
  return _OSSwapInt32(
      ((struct _OSUnalignedU32 *)((uintptr_t)_base + _offset))->__val);
}
#else
OS_INLINE
...
#if defined(_POSIX_C_SOURCE) || defined(_XOPEN_SOURCE)
OS_INLINE
uint64_t _OSReadSwapInt64(const volatile void *_base, uintptr_t _offset) {
  return _OSSwapInt64(
      ((struct _OSUnalignedU64 *)((uintptr_t)_base + _offset))->__val);
}
#else
OS_INLINE
...
#if defined(_POSIX_C_SOURCE) || defined(_XOPEN_SOURCE)
OS_INLINE
void _OSWriteSwapInt16(volatile void *_base, uintptr_t _offset,
                       uint16_t _data) {
  ((struct _OSUnalignedU16 *)((uintptr_t)_base + _offset))->__val =
      _OSSwapInt16(_data);
}
...
#if defined(_POSIX_C_SOURCE) || defined(_XOPEN_SOURCE)
OS_INLINE
void _OSWriteSwapInt32(volatile void *_base, uintptr_t _offset,
                       uint32_t _data) {
  ((struct _OSUnalignedU32 *)((uintptr_t)_base + _offset))->__val =
      _OSSwapInt32(_data);
}
...
#if defined(_POSIX_C_SOURCE) || defined(_XOPEN_SOURCE)
OS_INLINE
void _OSWriteSwapInt64(volatile void *_base, uintptr_t _offset,
                       uint64_t _data) {
  ((struct _OSUnalignedU64 *)((uintptr_t)_base + _offset))->__val =
      _OSSwapInt64(_data);
}
