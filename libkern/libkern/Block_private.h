...
#define _Block_set_function_pointer(field, value)                              \
  ((value) ? ((field) = (__typeof__(field))ptrauth_auth_and_resign(            \
                  (void *)(value), ptrauth_key_function_pointer, 0,            \
                  ptrauth_key_block_function, &(field)))                       \
           : ((field) = 0))

#define _Block_get_function_pointer(field)                                     \
  ((field) ? (__typeof__(field))ptrauth_auth_function(                         \
                 (void *)(field), ptrauth_key_block_function, &(field))        \
           : (__typeof__(field))0)
...
#define _Block_set_function_pointer(field, value) (field) = (value)

#define _Block_get_function_pointer(field) (field)
...
template <typename Fn, ptrauth_key Key> class StorageSignedFunctionPointer {
  uintptr_t bits;
...
public:
  ...
  uintptr_t prepareWrite(Fn fn) const {
    if (fn == nullptr) {
      ...
      return (uintptr_t)ptrauth_auth_and_resign(
          fn, ptrauth_key_function_pointer,
          ptrauth_function_pointer_type_discriminator(Fn), Key, &bits);
    }
  }
  ...
  uintptr_t prepareWrite(const StorageSignedFunctionPointer &other) const {
    if (other.bits == 0) {
      ...
      return (uintptr_t)ptrauth_auth_and_resign((void *)other.bits, Key,
                                                &other.bits, Key, &bits);
    }
  }
  ...
  StorageSignedFunctionPointer(Fn value) : bits(prepareWrite(value)) {}

  StorageSignedFunctionPointer(const StorageSignedFunctionPointer &value)
      : bits(prepareWrite(value)) {}

  StorageSignedFunctionPointer &operator=(Fn rhs) {
  ...
  operator Fn() const { return completeReadFn(bits); }

  explicit operator void *() const { return completeReadRaw(bits); }

  explicit operator bool() const { return completeReadRaw(bits) != nullptr; }
};

using BlockCopyFunction =
    StorageSignedFunctionPointer<void (*)(void *, const void *),
                                 ptrauth_key_block_function>;

using BlockDisposeFunction =
    StorageSignedFunctionPointer<void (*)(const void *),
                                 ptrauth_key_block_function>;

using BlockInvokeFunction =
    StorageSignedFunctionPointer<void (*)(void *, ...),
                                 ptrauth_key_block_function>;

using BlockByrefKeepFunction =
    StorageSignedFunctionPointer<void (*)(struct Block_byref *,
                                          struct Block_byref *),
                                 ptrauth_key_block_function>;

using BlockByrefDestroyFunction =
    StorageSignedFunctionPointer<void (*)(struct Block_byref *),
                                 ptrauth_key_block_function>;
...
typedef void (*BlockByrefKeepFunction)(struct Block_byref *,
                                       struct Block_byref *);
...
#define _Block_get_relative_function_pointer(aBlock, field, type)              \
  ({                                                                           \
    struct Block_descriptor_small *_bds =                                      \
        (struct Block_descriptor_small *)(aBlock)->descriptor;                 \
...
static inline void _Block_set_invoke_fn(struct Block_layout *block,
                                        void (*fn)(void *, ...)) {
...
_Block_get_copy_fn(struct Block_descriptor_2 *desc) {
  return (void (*)(void *, const void *))_Block_get_function_pointer(
      desc->copy);
}

static inline void _Block_set_copy_fn(struct Block_descriptor_2 *desc,
...
static inline void _Block_set_dispose_fn(struct Block_descriptor_2 *desc,
                                         void (*fn)(const void *)) {
...
_Block_get_copy_function(struct Block_layout *aBlock) {
  ...
  if (aBlock->flags & BLOCK_SMALL_DESCRIPTOR) {
    return _Block_get_relative_function_pointer(aBlock, copy,
...
#if BLOCK_SMALL_DESCRIPTOR_SUPPORTED
  if (aBlock->flags & BLOCK_SMALL_DESCRIPTOR) {
    return _Block_get_relative_function_pointer(aBlock, dispose,
                                                void (*)(const void *));
  }
#endif
...
BLOCK_EXPORT void *
    _NSConcreteMallocBlock[32] __OSX_AVAILABLE_STARTING(__MAC_10_6,
                                                        __IPHONE_3_2);
BLOCK_EXPORT void *
    _NSConcreteAutoBlock[32] __OSX_AVAILABLE_STARTING(__MAC_10_6, __IPHONE_3_2);
BLOCK_EXPORT void *
    _NSConcreteFinalizingBlock[32] __OSX_AVAILABLE_STARTING(__MAC_10_6,
                                                            __IPHONE_3_2);
BLOCK_EXPORT void *
    _NSConcreteWeakBlockVariable[32] __OSX_AVAILABLE_STARTING(__MAC_10_6,
                                                              __IPHONE_3_2);
// declared in Block.h
