...
int chacha20poly1305_aad(chacha20poly1305_ctx *ctx, size_t nbytes,
                         const void *aad);
int chacha20poly1305_encrypt(chacha20poly1305_ctx *ctx, size_t nbytes,
                             const void *ptext, void *ctext);
int chacha20poly1305_finalize(chacha20poly1305_ctx *ctx, uint8_t *tag);
int chacha20poly1305_decrypt(chacha20poly1305_ctx *ctx, size_t nbytes,
                             const void *ctext, void *ptext);
