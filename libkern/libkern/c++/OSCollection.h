...
template <typename T> using OSCollectionTaggedPtr = T *;
...
protected:
   ...
   * The collection object should interpret <code>iterationContext</code>
   * appropriately and initialize its contents to begin an iteration.
   *
   ...
   * If there is no next object, the collection object must return
   * <code>false</code>.
   *
   ...
   */
  virtual bool getNextObjectForIterator(void *iterationContext,
