...
public:
   ...
   * @param context  A pointer to a user-provided context. May be
   * <code>NULL</code>.
   *
   * @result
...
public:
   ...
   */
  static OSPtr<OSOrderedSet> withCapacity(unsigned int capacity,
   ...
   *
   * A <code>false</code> return value can mean either that
   * <code>anObject</code> is already present in the set, or that a memory
   * allocation failure occurred. If you need to know whether the object is
   * already present, use <code>@link
   * //apple_ref/cpp/instm/OSOrderedSet/containsObject/virtualbool/(constOSMetaClassBase*)
   * containsObject(const OSMetaClassBase *)@/link</code>.
   */
