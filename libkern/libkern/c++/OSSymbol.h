...
/* OSSymbol must be created through the factory methods and thus is not
 * subclassable. */
...
public:
   ...
   * @result         Returns <code>true</code> if the two objects are
  ...
  static unsigned int bsearch(const void *key, const void *array,
