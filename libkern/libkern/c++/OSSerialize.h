...
public:
  typedef const OSMetaClassBase *(*Editor)(void *reference, OSSerialize *s,
  ...
  bool addBinaryObject(const OSMetaClassBase *o, uint32_t key,
                       const void *_bits, uint32_t size,
...
public:
  ...
  static OSPtr<OSSerialize> binaryWithCapacity(unsigned int inCapacity,
                                               Editor editor = NULL,
                                               void *reference = NULL);
   ...
   */
  virtual bool addXMLStartTag(const OSMetaClassBase *object,
...
public:
  ...
  forTarget(void *target, OSSerializerCallback callback, void *ref = NULL);

#ifdef __BLOCKS__
  static OSPtr<OSSerializer> withBlock(OSSerializerBlock callback);
#endif

  virtual void free(void) APPLE_KEXT_OVERRIDE;

#if XNU_KERNEL_PRIVATE
  static bool callbackToBlock(void *target, void *ref, OSSerialize *serializer);
