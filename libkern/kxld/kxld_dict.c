...
typedef enum { EMPTY = 0, USED = 1, DELETED = 2 } DictEntryState;
...
/*******************************************************************************
*******************************************************************************/
void kxld_dict_iterator_reset(KXLDDictIterator *iter) { iter->idx = 0; }
 ...
 *******************************************************************************/
u_int kxld_dict_string_hash(const KXLDDict *dict, const void *_key) {
  const char *key = _key;
  u_int c = 0;
  u_int hash_val = 5381;
...
u_int kxld_dict_uint32_hash(const KXLDDict *dict, const void *_key) {
...
u_int kxld_dict_kxldaddr_hash(const KXLDDict *dict, const void *_key) {
