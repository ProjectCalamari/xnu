 ...
 *   - The reset, clear, deinit functions will accept a NULL pointer to an
 * array.
 *******************************************************************************/
...
void kxld_array_reset(KXLDArray *array) __attribute__((visibility("hidden")));

/* Zeroes out the array and sets nitems to 0 */
void kxld_array_clear(KXLDArray *array) __attribute__((visibility("hidden")));

/* Frees the array's internal buffer */
void kxld_array_deinit(KXLDArray *array) __attribute__((visibility("hidden")));
