...
size_t kxld_object_sizeof(void) __attribute__((const, visibility("hidden")));

kern_return_t
kxld_object_init_from_macho(KXLDObject *object, u_char *file, u_long size,
                            const char *name, struct kxld_array *section_order,
...
const struct kxld_relocator *kxld_object_get_relocator(const KXLDObject *object)
    __attribute__((pure, nonnull, visibility("hidden")));

const struct kxld_reloc *
kxld_object_get_reloc_at_symbol(const KXLDObject *object,
                                const struct kxld_sym *sym)
    __attribute__((pure, nonnull, visibility("hidden")));

const struct kxld_sym *
kxld_object_get_symbol_of_reloc(const KXLDObject *object,
                                const struct kxld_reloc *reloc,
...
const struct kxld_array *kxld_object_get_extrelocs(const KXLDObject *object)
    __attribute__((pure, nonnull, visibility("hidden")));
...
void kxld_object_set_link_info(KXLDObject *object, splitKextLinkInfo *link_info)
    __attribute__((nonnull, visibility("hidden")));
