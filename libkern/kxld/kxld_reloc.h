...
typedef kern_return_t (*ProcessReloc)(const KXLDRelocator *relocator,
                                      u_char *instruction, u_int length,
                                      u_int pcrel, kxld_addr_t base_pc,
                                      kxld_addr_t link_pc,
                                      kxld_addr_t link_disp, u_int type,
                                      kxld_addr_t target,
...
kern_return_t
kxld_reloc_get_reloc_index_by_offset(const struct kxld_array *relocs,
