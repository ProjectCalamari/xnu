...
size_t kxld_kext_sizeof(void) __attribute__((const, visibility("hidden")));
...
kern_return_t kxld_kext_export_vtables(
    KXLDKext *kext, const struct kxld_dict *defined_cxx_symbols,
    const struct kxld_dict *defined_symbols, struct kxld_dict *vtables)
    __attribute__((nonnull, visibility("hidden")));
