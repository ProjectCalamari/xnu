...
__enum_closed_decl(reflog_op_t, uint8_t,
                   {REFLOG_RETAIN = 1, REFLOG_RELEASE = 2});
...
void os_ref_panic_live(void *rc) {
  panic("os_refcnt: unexpected release of final reference (rc=%p)", rc);
  __builtin_unreachable();
}
void os_ref_panic_last(void *rc) {
  panic("os_refcnt: expected release of final reference but rc %p!=0\n", rc);
  __builtin_unreachable();
}

__abortlike static void os_ref_panic_underflow(void *rc) {
  panic("os_refcnt: underflow (rc=%p)", rc);
  __builtin_unreachable();
}

__abortlike static void os_ref_panic_overflow(os_ref_atomic_t *rc) {
  panic("os_refcnt: overflow (rc=%p, count=%u, max=%u)", rc,
        os_atomic_load(rc, relaxed), OS_REFCNT_MAX_COUNT);
  __builtin_unreachable();
}

__abortlike static void os_ref_panic_retain(os_ref_atomic_t *rc) {
...
static inline void os_ref_check_underflow(void *rc, os_ref_count_t count,
                                          os_ref_count_t n) {
...
static inline void os_ref_check_overflow(os_ref_atomic_t *rc,
...
static inline void os_ref_check_retain(os_ref_atomic_t *rc,
                                       os_ref_count_t count, os_ref_count_t n) {
...
__attribute__((cold, noinline)) static void ref_log_drop(struct os_refgrp *grp,
                                                         void *elem) {
...
__attribute__((cold, noinline)) void os_ref_log_init(struct os_refgrp *grp) {
  if (grp->grp_log != NULL) {
    return;
  }
  ...
  while ((g = strsep(&refgrp, ",")) != NULL) {
    if (strcmp(g, grp->grp_name) == 0) {
      ...
      grp->grp_log = btlog_create(BTLOG_HASH, ref_log_nrecords, 0);
      return;
    }
  }
}

__attribute__((cold, noinline)) void os_ref_log_fini(struct os_refgrp *grp) {
  if (grp->grp_log == NULL) {
    return;
  }
...
inline void os_ref_log_fini(struct os_refgrp *grp __unused) {}
#endif

#ifndef os_ref_log_init
inline void os_ref_log_init(struct os_refgrp *grp __unused) {}
#endif
#ifndef ref_log_op
static inline void ref_log_op(struct os_refgrp *grp __unused, void *rc __unused,
                              reflog_op_t op __unused) {}
#endif
#ifndef ref_log_drop
static inline void ref_log_drop(struct os_refgrp *grp __unused,
                                void *rc __unused) {}
#endif
 ...
 */
__attribute__((cold, noinline)) static void
ref_attach_to_group(os_ref_atomic_t *rc, struct os_refgrp *grp,
                    os_ref_count_t init_count) {
  if (grp == NULL) {
    return;
  }

  if (atomic_fetch_add_explicit(&grp->grp_children, 1, memory_order_relaxed) ==
      0) {
  ...
  atomic_fetch_add_explicit(&grp->grp_retain_total, init_count,
...
static void ref_retain_group(struct os_refgrp *grp) {
  if (grp) {
...
__attribute__((cold, noinline)) static os_ref_count_t
...
void os_ref_init_count_internal(os_ref_atomic_t *rc,
...
static inline void __os_ref_retain(os_ref_atomic_t *rc, os_ref_count_t f,
                                   struct os_refgrp *__debug_only grp) {
...
void os_ref_retain_internal(os_ref_atomic_t *rc, struct os_refgrp *grp) {
  __os_ref_retain(rc, 1, grp);
}

void os_ref_retain_floor_internal(os_ref_atomic_t *rc, os_ref_count_t f,
                                  struct os_refgrp *grp) {
  __os_ref_retain(rc, f, grp);
}

static inline bool __os_ref_retain_try(os_ref_atomic_t *rc, os_ref_count_t f,
                                       struct os_refgrp *__debug_only grp) {
...
bool os_ref_retain_try_internal(os_ref_atomic_t *rc, struct os_refgrp *grp) {
  return __os_ref_retain_try(rc, 1, grp);
}

bool os_ref_retain_floor_try_internal(os_ref_atomic_t *rc, os_ref_count_t f,
                                      struct os_refgrp *grp) {
  return __os_ref_retain_try(rc, f, grp);
}

__attribute__((always_inline)) static inline os_ref_count_t
...
#if OS_REFCNT_DEBUG
__attribute__((noinline)) static os_ref_count_t os_ref_release_n_internal(
    os_ref_atomic_t *rc, os_ref_count_t n, struct os_refgrp *__debug_only grp,
    memory_order release_order, memory_order dealloc_order) {
...
__attribute__((noinline)) os_ref_count_t os_ref_release_internal(
    os_ref_atomic_t *rc, struct os_refgrp *__debug_only grp,
    memory_order release_order, memory_order dealloc_order) {
  // Legacy exported interface with bad codegen due to the barriers
  // not being immediate
  //
...
#if OS_REFCNT_DEBUG
  if (REFLOG_GRP_DEBUG_ENABLED(grp)) {
    return os_ref_release_internal(rc, grp, memory_order_release,
                                   memory_order_acquire);
  }
#endif
  return _os_ref_release_inline(rc, 1, NULL, memory_order_release,
                                memory_order_acquire);
}
...
#if OS_REFCNT_DEBUG
  if (REFLOG_GRP_DEBUG_ENABLED(grp)) {
    return os_ref_release_internal(rc, grp, memory_order_relaxed,
                                   memory_order_relaxed);
  }
#endif
  return _os_ref_release_inline(rc, 1, NULL, memory_order_relaxed,
                                memory_order_relaxed);
}

static inline void __os_ref_retain_locked(os_ref_atomic_t *rc, os_ref_count_t f,
                                          struct os_refgrp *__debug_only grp) {
...
void os_ref_retain_locked_internal(os_ref_atomic_t *rc, struct os_refgrp *grp) {
  __os_ref_retain_locked(rc, 1, grp);
}

void os_ref_retain_floor_locked_internal(os_ref_atomic_t *rc, os_ref_count_t f,
                                         struct os_refgrp *grp) {
  __os_ref_retain_locked(rc, f, grp);
}

os_ref_count_t
os_ref_release_locked_internal(os_ref_atomic_t *rc,
                               struct os_refgrp *__debug_only grp) {
#if OS_REFCNT_DEBUG
  if (REFLOG_GRP_DEBUG_ENABLED(grp)) {
    ref_release_debug(rc, grp);
...
void os_ref_init_count_mask(os_ref_atomic_t *rc, uint32_t b,
                            struct os_refgrp *__debug_only grp,
...
void os_ref_retain_mask_internal(os_ref_atomic_t *rc, uint32_t n,
                                 struct os_refgrp *__debug_only grp) {
  os_ref_retain_mask_inline(rc, n, grp, memory_order_relaxed);
}

void os_ref_retain_acquire_mask_internal(os_ref_atomic_t *rc, uint32_t n,
                                         struct os_refgrp *__debug_only grp) {
...
#if OS_REFCNT_DEBUG
  if (REFLOG_GRP_DEBUG_ENABLED(grp)) {
    return os_ref_release_n_internal(rc, n, grp, memory_order_release,
                                     memory_order_acquire);
  }
#endif

  return _os_ref_release_inline(rc, n, NULL, memory_order_release,
                                memory_order_acquire);
}
...
#if OS_REFCNT_DEBUG
  if (REFLOG_GRP_DEBUG_ENABLED(grp)) {
    return os_ref_release_n_internal(rc, n, grp, memory_order_relaxed,
                                     memory_order_relaxed);
  }
#endif

  return _os_ref_release_inline(rc, n, NULL, memory_order_relaxed,
                                memory_order_relaxed);
}

uint32_t os_ref_retain_try_mask_internal(os_ref_atomic_t *rc, uint32_t n,
...
bool os_ref_retain_try_acquire_mask_internal(
    os_ref_atomic_t *rc, uint32_t n, uint32_t reject_mask,
    struct os_refgrp *__debug_only grp) {
  os_ref_count_t cur, next;
...
static inline __os_pcpu_ref_t os_pcpu_get(os_pcpu_ref_t ref) {
  return (__os_pcpu_ref_t)ref;
}

static inline uint64_t os_pcpu_count_to_value(os_ref_count_t cnt) {
  return cnt * OS_PCPU_REF_INC;
}

static inline os_ref_count_t os_pcpu_value_to_count(uint64_t v) {
  return (os_ref_count_t)(v / OS_PCPU_REF_INC);
}

__abortlike static void __os_pcpu_ref_destroy_panic(os_pcpu_ref_t *ref,
                                                    uint64_t n) {
  if (n & OS_PCPU_REF_LIVE) {
    panic("os_pcpu_ref: destroying live refcount %p at %p", os_pcpu_get(*ref),
          ref);
  }
  ...
  panic("os_pcpu_ref: destroying non-zero refcount %p at %p", os_pcpu_get(*ref),
        ref);
}

__abortlike static void __os_pcpu_ref_overflow_panic(__os_pcpu_ref_t rc) {
  panic("os_pcpu_ref: overflow (rc=%p)", rc);
}

__abortlike static void __os_pcpu_ref_retain_panic(__os_pcpu_ref_t rc,
                                                   uint64_t v) {
  if (v == 0) {
...
__abortlike static void __os_pcpu_ref_release_live_panic(__os_pcpu_ref_t rc) {
  panic("os_pcpu_ref: unexpected release of final reference (rc=%p)", rc);
}

__abortlike static void __os_pcpu_ref_release_panic(__os_pcpu_ref_t rc) {
  panic("os_pcpu_ref: over-release (rc=%p)", rc);
}

__abortlike static void __os_pcpu_ref_kill_panic(__os_pcpu_ref_t rc) {
  panic("os_pcpu_ref: double-kill (rc=%p)", rc);
}

__abortlike static void __os_pcpu_ref_invalid_wait_panic(__os_pcpu_ref_t rc,
                                                         uint64_t ov) {
...
void(os_pcpu_ref_init)(os_pcpu_ref_t *ref, struct os_refgrp *__debug_only grp) {
  __os_pcpu_ref_t rc;
...
void(os_pcpu_ref_destroy)(os_pcpu_ref_t *ref,
                          struct os_refgrp *__debug_only grp) {
...
os_ref_count_t os_pcpu_ref_count(os_pcpu_ref_t ref) {
  uint64_t v;
...
static inline uint64_t __os_pcpu_ref_delta(__os_pcpu_ref_t rc, int delta,
                                           int *cpup) {
...
__os_pcpu_ref_retain_slow(__os_pcpu_ref_t rc, int cpu, uint64_t v) {
  if (cpu > 0) {
    os_atomic_sub(zpercpu_get_cpu(rc, cpu), OS_PCPU_REF_INC, relaxed);
  }

  if (cpu != 0) {
    v = os_atomic_add_orig(zpercpu_get_cpu(rc, 0), OS_PCPU_REF_INC, relaxed);
    if (v & OS_PCPU_REF_LIVE) {
...
void(os_pcpu_ref_retain)(os_pcpu_ref_t ref,
                         struct os_refgrp *__debug_only grp) {
  __os_pcpu_ref_t rc = os_pcpu_get(ref);
  uint64_t v;
  int cpu;
...
bool(os_pcpu_ref_retain_try)(os_pcpu_ref_t ref,
                             struct os_refgrp *__debug_only grp) {
  __os_pcpu_ref_t rc = os_pcpu_get(ref);
...
__os_pcpu_ref_release_live_slow(__os_pcpu_ref_t rc, int cpu, uint64_t v) {
  if (cpu > 0) {
    os_atomic_add(zpercpu_get_cpu(rc, cpu), OS_PCPU_REF_INC, relaxed);
  }
  if (cpu != 0) {
    v = os_atomic_sub_orig(zpercpu_get_cpu(rc, 0), OS_PCPU_REF_INC, release);
    if (v & OS_PCPU_REF_LIVE) {
      /* we're doing this concurrently to an os_pcpu_ref_kill */
      return;
    }
...
void(os_pcpu_ref_release_live)(os_pcpu_ref_t ref,
                               struct os_refgrp *__debug_only grp) {
  __os_pcpu_ref_t rc = os_pcpu_get(ref);
  uint64_t v;
  int cpu;
...
__attribute__((noinline)) static os_ref_count_t
__os_pcpu_ref_release_slow(__os_pcpu_ref_t rc, int cpu,
                           uint64_t v __os_refgrp_arg(struct os_refgrp *grp)) {
...
os_ref_count_t(os_pcpu_ref_release)(os_pcpu_ref_t ref,
                                    struct os_refgrp *__debug_only grp) {
  __os_pcpu_ref_t rc = os_pcpu_get(ref);
  uint64_t v;
  int cpu;
...
os_ref_count_t(os_pcpu_ref_kill)(os_pcpu_ref_t ref,
                                 struct os_refgrp *__debug_only grp) {
  __os_pcpu_ref_t rc = os_pcpu_get(ref);
  uint64_t v = 0, t = 0;
...
void os_pcpu_ref_wait_for_death(os_pcpu_ref_t ref) {
  __os_pcpu_ref_t rc = os_pcpu_get(ref);
  uint64_t _Atomic *rc0 = zpercpu_get_cpu(rc, 0);
  uint64_t ov, nv;
