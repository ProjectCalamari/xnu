 ...
 * functions return non-zero if overflow occured, zero otherwise. In either
 * case, the potentially overflowing operation is fully performed, mod the size
 * of the output type. See:
...
#define os_add_overflow(a, b, res)                                             \
  __os_warn_unused(__builtin_add_overflow((a), (b), (res)))
#define os_sub_overflow(a, b, res)                                             \
  __os_warn_unused(__builtin_sub_overflow((a), (b), (res)))
#define os_mul_overflow(a, b, res)                                             \
  __os_warn_unused(__builtin_mul_overflow((a), (b), (res)))
...
#define os_add3_overflow(a, b, c, res)                                         \
  __os_warn_unused(__extension__({                                             \
    __typeof(*(res)) _tmp;                                                     \
    bool _s, _t;                                                               \
...
#define os_sub3_overflow(a, b, c, res)                                         \
  __os_warn_unused(__extension__({                                             \
    __typeof(*(res)) _tmp;                                                     \
    bool _s, _t;                                                               \
...
#define os_mul3_overflow(a, b, c, res)                                         \
  __os_warn_unused(__extension__({                                             \
    __typeof(*(res)) _tmp;                                                     \
    bool _s, _t;                                                               \
...
#define os_mul_and_add_overflow(a, x, b, res)                                  \
  __os_warn_unused(__extension__({                                             \
    __typeof(*(res)) _tmp;                                                     \
    bool _s, _t;                                                               \
