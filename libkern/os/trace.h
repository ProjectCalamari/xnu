...
OS_ALWAYS_INLINE
static inline void _os_trace_verify_printf(const char *msg, ...)
...
#define OS_COUNT_ARGS(...)                                                     \
  OS_COUNT_ARGS1(, ##__VA_ARGS__, _8, _7, _6, _5, _4, _3, _2, _1, _0)
...
#define _os_trace_1(_l, _m, _t, _1)                                            \
  __extension__({                                                              \
...
#define _os_trace_2(_l, _m, _t, _1, _2)                                        \
  __extension__({                                                              \
    _Pragma("clang diagnostic push")                                           \
        _Pragma("clang diagnostic ignored \"-Wpacked\"")                       \
            const __typeof__(_1) _c1 = _1;                                     \
...
#define _os_trace_3(_l, _m, _t, _1, _2, _3)                                    \
  __extension__({                                                              \
    _Pragma("clang diagnostic push")                                           \
        _Pragma("clang diagnostic ignored \"-Wpacked\"")                       \
            const __typeof__(_1) _c1 = _1;                                     \
...
#define _os_trace_4(_l, _m, _t, _1, _2, _3, _4)                                \
  __extension__({                                                              \
    _Pragma("clang diagnostic push")                                           \
        _Pragma("clang diagnostic ignored \"-Wpacked\"")                       \
            const __typeof__(_1) _c1 = _1;                                     \
...
#define _os_trace_5(_l, _m, _t, _1, _2, _3, _4, _5)                            \
  __extension__({                                                              \
    _Pragma("clang diagnostic push")                                           \
        _Pragma("clang diagnostic ignored \"-Wpacked\"")                       \
            const __typeof__(_1) _c1 = _1;                                     \
...
#define _os_trace_6(_l, _m, _t, _1, _2, _3, _4, _5, _6)                        \
  __extension__({                                                              \
    _Pragma("clang diagnostic push")                                           \
        _Pragma("clang diagnostic ignored \"-Wpacked\"")                       \
            const __typeof__(_1) _c1 = _1;                                     \
...
#define _os_trace_7(_l, _m, _t, _1, _2, _3, _4, _5, _6, _7)                    \
  __extension__({                                                              \
    _Pragma("clang diagnostic push")                                           \
        _Pragma("clang diagnostic ignored \"-Wpacked\"")                       \
            const __typeof__(_1) _c1 = _1;                                     \
...
#define _os_trace_with_payload_2(_l, _m, _t, _1, _payload)                     \
  __extension__({                                                              \
    _Pragma("clang diagnostic push")                                           \
        _Pragma("clang diagnostic ignored \"-Wpacked\"")                       \
            const __typeof__(_1) _c1 = _1;                                     \
    ...
    _os_trace_with_buffer(&__dso_handle, _m, _t, &_buf, sizeof(_buf),          \
                          _payload);                                           \
    __asm__(""); /* avoid tailcall */                                          \
    _Pragma("clang diagnostic pop")                                            \
  })

#define _os_trace_with_payload_3(_l, _m, _t, _1, _2, _payload)                 \
  __extension__({                                                              \
    _Pragma("clang diagnostic push")                                           \
        _Pragma("clang diagnostic ignored \"-Wpacked\"")                       \
            const __typeof__(_1) _c1 = _1;                                     \
...
#define _os_trace_with_payload_4(_l, _m, _t, _1, _2, _3, _payload)             \
  __extension__({                                                              \
    _Pragma("clang diagnostic push")                                           \
        _Pragma("clang diagnostic ignored \"-Wpacked\"")                       \
            const __typeof__(_1) _c1 = _1;                                     \
...
#define _os_trace_with_payload_5(_l, _m, _t, _1, _2, _3, _4, _payload)         \
  __extension__({                                                              \
    _Pragma("clang diagnostic push")                                           \
        _Pragma("clang diagnostic ignored \"-Wpacked\"")                       \
            const __typeof__(_1) _c1 = _1;                                     \
...
#define _os_trace_with_payload_6(_l, _m, _t, _1, _2, _3, _4, _5, _payload)     \
  __extension__({                                                              \
    _Pragma("clang diagnostic push")                                           \
        _Pragma("clang diagnostic ignored \"-Wpacked\"")                       \
            const __typeof__(_1) _c1 = _1;                                     \
...
#define _os_trace_with_payload_7(_l, _m, _t, _1, _2, _3, _4, _5, _6, _payload) \
  __extension__({                                                              \
    _Pragma("clang diagnostic push")                                           \
        _Pragma("clang diagnostic ignored \"-Wpacked\"")                       \
            const __typeof__(_1) _c1 = _1;                                     \
...
#define _os_trace_with_payload_8(_l, _m, _t, _1, _2, _3, _4, _5, _6, _7,       \
                                 _payload)                                     \
  __extension__({                                                              \
    _Pragma("clang diagnostic push")                                           \
        _Pragma("clang diagnostic ignored \"-Wpacked\"")                       \
...
#define OS_TRACE_CALL(format, _m, _t, ...)                                     \
  __extension__({                                                              \
    _Pragma("clang diagnostic push")                                           \
        _Pragma("clang diagnostic ignored \"-Wc++98-compat-pedantic\"")        \
            OS_CONCAT(_os_trace, OS_COUNT_ARGS(__VA_ARGS__))(format, _m, _t,   \
                                                             ##__VA_ARGS__);   \
    _Pragma("clang diagnostic pop")                                            \
  })
...
#define _os_trace_with_payload_6(_l, _m, _t, _1, _2, _3, _4, _5, _payload)     \
  __extension__({                                                              \
    ...
    uint8_t buf[1024];                                                         \
    size_t buf_size =                                                          \
        _os_trace_encode(buf, sizeof(buf), _m, _1, _2, _3, _4, _5);            \
    _os_trace_internal(&__dso_handle, _t, _m, buf, buf_size, _payload);        \
    __asm__(""); /* avoid tailcall */                                          \
  })
...
#define _os_trace_with_payload_7(_l, _m, _t, _1, _2, _3, _4, _5, _6, _payload) \
  __extension__({                                                              \
    ...
    uint8_t buf[1024];                                                         \
    size_t buf_size =                                                          \
        _os_trace_encode(buf, sizeof(buf), _m, _1, _2, _3, _4, _5, _6);        \
    _os_trace_internal(&__dso_handle, _t, _m, buf, buf_size, _payload);        \
    __asm__(""); /* avoid tailcall */                                          \
  })
...
#define _os_trace_with_payload_8(_l, _m, _t, _1, _2, _3, _4, _5, _6, _7,       \
  ...
  __extension__({                                                              \
    ...
    uint8_t buf[1024];                                                         \
    size_t buf_size =                                                          \
        _os_trace_encode(buf, sizeof(buf), _m, _1, _2, _3, _4, _5, _6, _7);    \
    _os_trace_internal(&__dso_handle, _t, _m, buf, buf_size, _payload);        \
    __asm__(""); /* avoid tailcall */                                          \
  })
 ...
 * what API you use. A hashtag is composed of a hash (#) symbol, followed by at
 * least three non-whitespace characters, terminated by whitespace or the end of
 * the message. Hashtags may not begin with a number.
 *
 ...
 * deprecated APIs and debugging messages. #Attention  - Message that should be
 * investigated by a system administrator, because it may be a sign of a larger
 * issue. For example, errors from a hard drive controller that typically occur
 * when the drive is about to fail. #Critical   - Message in the context of a
 * critical event or critical failure. #Error      - Message that is a
 * noncritical error. #Comment    - Message that is a comment. #Marker     -
 * Message that marks a change to divide the messages around it into those
 * before and those after the change. #Clue       - Message containing extra
 * key/value pairs with additional information to help reconstruct the context.
 ...
 * work load #State      - Message describing state changed, e.g., global state,
 * preference, etc. #Graphics   - Message describing significant graphics event
 ...
 * represent complex data. This block will only be invoked under conditions
 * where tools have attached to the process. The payload can be used to send
 * arbitrary data via the trace call. Tools may use the data to validate state
 * for integration tests or provide other introspection services. No assumptions
 * are made about the format or structure of the data.
 */
...
#define os_trace(format, ...)                                                  \
  __extension__({                                                              \
    ...
    __attribute__((section("__TEXT,__os_trace"))) static const char _m[] =     \
        format;                                                                \
 ...
 */
__OSX_AVAILABLE(10.10)
__IOS_AVAILABLE(8.0) __WATCHOS_AVAILABLE(1.0)
    __TVOS_AVAILABLE(9.0) OS_EXPORT OS_NOTHROW OS_WARN_RESULT
 ...
 *
 *		// validate the network interface and address where what was
 * expected xpc_dictionary_set_string(xdict, "network", ifp->ifa_name);
 *		xpc_dictionary_set_string(xdict, "ip_address",
 * _get_address(ifp));
 *   });
 */
...
#define os_trace_info_with_payload(format, ...)                                \
  __extension__({                                                              \
    ...
    __attribute__((section("__TEXT,__os_trace"))) static const char _m[] =     \
        format;                                                                \
    OS_CONCAT(_os_trace_with_payload, OS_COUNT_ARGS(__VA_ARGS__))(             \
        format, _m, OS_TRACE_TYPE_INFO, ##__VA_ARGS__);                        \
  })
...
#define os_trace_debug_with_payload(format, ...)                               \
  __extension__({                                                              \
    ...
    __attribute__((section("__TEXT,__os_trace"))) static const char _m[] =     \
        format;                                                                \
    OS_CONCAT(_os_trace_with_payload, OS_COUNT_ARGS(__VA_ARGS__))(             \
        format, _m, OS_TRACE_TYPE_DEBUG, ##__VA_ARGS__);                       \
  })
...
#define os_trace_error_with_payload(format, ...)                               \
  __extension__({                                                              \
    ...
    __attribute__((section("__TEXT,__os_trace"))) static const char _m[] =     \
        format;                                                                \
    OS_CONCAT(_os_trace_with_payload, OS_COUNT_ARGS(__VA_ARGS__))(             \
        format, _m, OS_TRACE_TYPE_ERROR, ##__VA_ARGS__);                       \
  })
...
#define os_trace_fault_with_payload(format, ...)                               \
  __extension__({                                                              \
    ...
    __attribute__((section("__TEXT,__os_trace"))) static const char _m[] =     \
        format;                                                                \
    OS_CONCAT(_os_trace_with_payload, OS_COUNT_ARGS(__VA_ARGS__))(             \
        format, _m, OS_TRACE_TYPE_FAULT, ##__VA_ARGS__);                       \
  })
...
__OSX_AVAILABLE_STARTING(__MAC_10_12, __IPHONE_10_0)
OS_EXPORT OS_NOTHROW size_t _os_trace_encode(uint8_t *buf, size_t buf_size,
                                             const char *format, ...);

__OSX_AVAILABLE_STARTING(__MAC_10_12, __IPHONE_10_0)
OS_EXPORT OS_NOTHROW void _os_trace_internal(void *dso, uint8_t type,
                                             const char *format,
                                             const uint8_t *buf,
                                             size_t buf_size,
...
__OSX_AVAILABLE(10.10)
__IOS_AVAILABLE(8.0) __WATCHOS_AVAILABLE(1.0)
    __TVOS_AVAILABLE(9.0) OS_EXPORT OS_NOTHROW
    void _os_trace_with_buffer(void *dso, const char *message, uint8_t type,
