...
/* As these are part of the KPI, we need to stub them out for any kernel
 * configuration that does not support SHA2. */
...
void UNSUPPORTED_API(SHA256_Update, SHA256_CTX *ctx, const void *data,
                     size_t len);
void UNSUPPORTED_API(SHA384_Update, SHA384_CTX *ctx, const void *data,
                     size_t len);
void UNSUPPORTED_API(SHA512_Update, SHA512_CTX *ctx, const void *data,
                     size_t len);
