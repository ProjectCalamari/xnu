...
#define ccn_nof(_bits_)                                                        \
  (((_bits_) + CCN_UNIT_BITS - 1) >> CCN_LOG2_BITS_PER_UNIT)
...
#define ccn_nof_size(_size_)                                                   \
  (((_size_) + sizeof(cc_unit) - 1) / sizeof(cc_unit))
...
#if CCN_UNIT_SIZE == 8
#define CCN64_C(a7, a6, a5, a4, a3, a2, a1, a0)                                \
  CC_UNIT_C(0x##a7##a6##a5##a4##a3##a2##a1##a0)
#define CCN40_C(a4, a3, a2, a1, a0) CC_UNIT_C(0x##a4##a3##a2##a1##a0)
#define ccn64_v(a0) (a0)
#else
#define CCN64_C(a7, a6, a5, a4, a3, a2, a1, a0)                                \
  CCN32_C(a3, a2, a1, a0), CCN32_C(a7, a6, a5, a4)
#define CCN40_C(a4, a3, a2, a1, a0) CCN32_C(a3, a2, a1, a0), CCN8_C(a4)
#define ccn64_v(a0)                                                            \
  ccn32_v((uint64_t)a0 &UINT32_C(0xffffffff)), ccn32_v((uint64_t)a0 >> 32)
#endif
...
#define ccn192_32(a5, a4, a3, a2, a1, a0)                                      \
  ccn64_32(a1, a0), ccn64_32(a3, a2), ccn64_32(a5, a4)
#define ccn224_32(a6, a5, a4, a3, a2, a1, a0)                                  \
  ccn64_32(a1, a0), ccn64_32(a3, a2), ccn64_32(a5, a4), ccn32_32(a6)
#define ccn256_32(a7, a6, a5, a4, a3, a2, a1, a0)                              \
  ccn64_32(a1, a0), ccn64_32(a3, a2), ccn64_32(a5, a4), ccn64_32(a7, a6)
#define ccn384_32(a11, a10, a9, a8, a7, a6, a5, a4, a3, a2, a1, a0)            \
  ccn64_32(a1, a0), ccn64_32(a3, a2), ccn64_32(a5, a4), ccn64_32(a7, a6),      \
      ccn64_32(a9, a8), ccn64_32(a11, a10)

#define CCN192_C(c7, c6, c5, c4, c3, c2, c1, c0, b7, b6, b5, b4, b3, b2, b1,   \
                 b0, a7, a6, a5, a4, a3, a2, a1, a0)                           \
  CCN64_C(a7, a6, a5, a4, a3, a2, a1, a0),                                     \
      CCN64_C(b7, b6, b5, b4, b3, b2, b1, b0),                                 \
      CCN64_C(c7, c6, c5, c4, c3, c2, c1, c0)

#define CCN200_C(d0, c7, c6, c5, c4, c3, c2, c1, c0, b7, b6, b5, b4, b3, b2,   \
                 b1, b0, a7, a6, a5, a4, a3, a2, a1, a0)                       \
  CCN192_C(c7, c6, c5, c4, c3, c2, c1, c0, b7, b6, b5, b4, b3, b2, b1, b0, a7, \
           a6, a5, a4, a3, a2, a1, a0),                                        \
      CCN8_C(d0)

#define CCN224_C(d3, d2, d1, d0, c7, c6, c5, c4, c3, c2, c1, c0, b7, b6, b5,   \
                 b4, b3, b2, b1, b0, a7, a6, a5, a4, a3, a2, a1, a0)           \
  CCN192_C(c7, c6, c5, c4, c3, c2, c1, c0, b7, b6, b5, b4, b3, b2, b1, b0, a7, \
           a6, a5, a4, a3, a2, a1, a0),                                        \
      CCN32_C(d3, d2, d1, d0)

#define CCN232_C(d4, d3, d2, d1, d0, c7, c6, c5, c4, c3, c2, c1, c0, b7, b6,   \
                 b5, b4, b3, b2, b1, b0, a7, a6, a5, a4, a3, a2, a1, a0)       \
  CCN192_C(c7, c6, c5, c4, c3, c2, c1, c0, b7, b6, b5, b4, b3, b2, b1, b0, a7, \
           a6, a5, a4, a3, a2, a1, a0),                                        \
      CCN40_C(d4, d3, d2, d1, d0)

#define CCN256_C(d7, d6, d5, d4, d3, d2, d1, d0, c7, c6, c5, c4, c3, c2, c1,   \
                 c0, b7, b6, b5, b4, b3, b2, b1, b0, a7, a6, a5, a4, a3, a2,   \
                 a1, a0)                                                       \
  CCN192_C(c7, c6, c5, c4, c3, c2, c1, c0, b7, b6, b5, b4, b3, b2, b1, b0, a7, \
           a6, a5, a4, a3, a2, a1, a0),                                        \
      CCN64_C(d7, d6, d5, d4, d3, d2, d1, d0)

#define CCN384_C(f7, f6, f5, f4, f3, f2, f1, f0, e7, e6, e5, e4, e3, e2, e1,   \
                 e0, d7, d6, d5, d4, d3, d2, d1, d0, c7, c6, c5, c4, c3, c2,   \
                 c1, c0, b7, b6, b5, b4, b3, b2, b1, b0, a7, a6, a5, a4, a3,   \
                 a2, a1, a0)                                                   \
  CCN256_C(d7, d6, d5, d4, d3, d2, d1, d0, c7, c6, c5, c4, c3, c2, c1, c0, b7, \
           b6, b5, b4, b3, b2, b1, b0, a7, a6, a5, a4, a3, a2, a1, a0),        \
      CCN64_C(e7, e6, e5, e4, e3, e2, e1, e0),                                 \
      CCN64_C(f7, f6, f5, f4, f3, f2, f1, f0)

#define CCN448_C(g7, g6, g5, g4, g3, g2, g1, g0, f7, f6, f5, f4, f3, f2, f1,   \
                 f0, e7, e6, e5, e4, e3, e2, e1, e0, d7, d6, d5, d4, d3, d2,   \
                 d1, d0, c7, c6, c5, c4, c3, c2, c1, c0, b7, b6, b5, b4, b3,   \
                 b2, b1, b0, a7, a6, a5, a4, a3, a2, a1, a0)                   \
  CCN256_C(d7, d6, d5, d4, d3, d2, d1, d0, c7, c6, c5, c4, c3, c2, c1, c0, b7, \
           b6, b5, b4, b3, b2, b1, b0, a7, a6, a5, a4, a3, a2, a1, a0),        \
      CCN192_C(g7, g6, g5, g4, g3, g2, g1, g0, f7, f6, f5, f4, f3, f2, f1, f0, \
               e7, e6, e5, e4, e3, e2, e1, e0)

#define CCN528_C(i1, i0, h7, h6, h5, h4, h3, h2, h1, h0, g7, g6, g5, g4, g3,   \
                 g2, g1, g0, f7, f6, f5, f4, f3, f2, f1, f0, e7, e6, e5, e4,   \
                 e3, e2, e1, e0, d7, d6, d5, d4, d3, d2, d1, d0, c7, c6, c5,   \
                 c4, c3, c2, c1, c0, b7, b6, b5, b4, b3, b2, b1, b0, a7, a6,   \
                 a5, a4, a3, a2, a1, a0)                                       \
  CCN256_C(d7, d6, d5, d4, d3, d2, d1, d0, c7, c6, c5, c4, c3, c2, c1, c0, b7, \
           b6, b5, b4, b3, b2, b1, b0, a7, a6, a5, a4, a3, a2, a1, a0),        \
      CCN256_C(h7, h6, h5, h4, h3, h2, h1, h0, g7, g6, g5, g4, g3, g2, g1, g0, \
               f7, f6, f5, f4, f3, f2, f1, f0, e7, e6, e5, e4, e3, e2, e1,     \
               e0),                                                            \
      CCN16_C(i1, i0)
...
#define ccn_is_zero_or_one(_n_, _s_)                                           \
  (((_n_) == 0) || ((ccn_n((_n_), (_s_)) <= 1) && ((_s_)[0] <= 1)))

/* s < t -> return - 1 | s == t -> return 0 | s > t -> return 1
 { N bit, N bit -> int } N = n * sizeof(cc_unit) * 8 */
CC_PURE CC_NONNULL((2, 3)) int ccn_cmp(cc_size n,
                                       const cc_unit *cc_counted_by(n) s,
                                       const cc_unit *cc_counted_by(n)
                                           t) __asm__("_ccn_cmp");
 ...
 */
CC_NONNULL_ALL
int ccn_cmpn(cc_size ns, const cc_unit *cc_counted_by(ns) s, cc_size nt,
             const cc_unit *cc_counted_by(nt) t);

/* s - t -> r return 1 iff t > s
 { N bit, N bit -> N bit } N = n * sizeof(cc_unit) * 8 */
CC_NONNULL((2, 3, 4))
cc_unit ccn_sub(cc_size n, cc_unit *cc_counted_by(n) r,
                const cc_unit *cc_counted_by(n) s,
                const cc_unit *cc_counted_by(n) t) __asm__("_ccn_sub");

/* s + t -> r return carry if result doesn't fit in n bits.
 { N bit, N bit -> N bit } N = n * sizeof(cc_unit) * 8 */
CC_NONNULL((2, 3, 4))
cc_unit ccn_add(cc_size n, cc_unit *cc_counted_by(n) r,
                const cc_unit *cc_counted_by(n) s,
                const cc_unit *cc_counted_by(n) t) __asm__("_ccn_add");

/* s + v -> r return carry if result doesn't fit in n bits.
 { N bit, sizeof(cc_unit) * 8 bit -> N bit } N = n * sizeof(cc_unit) * 8 */
CC_NONNULL((2, 3))
cc_unit ccn_add1(cc_size n, cc_unit *cc_counted_by(n) r,
...
/*!
 ...
 @return 0 if no error, !=0 if the big number cannot be represented in the
 allocated cc_unit array.

 @discussion The execution pattern of this function depends on both n and
 data_nbytes but not on data values except the handling of the error case.
 */

CC_NONNULL((2, 4))
int ccn_read_uint(cc_size n, cc_unit *cc_counted_by(n) r, size_t data_nbytes,
                  const uint8_t *cc_sized_by(data_nbytes) data);
...
/*!
 ...
 However, the use of the returned value may leak the position of the most
 significant byte
 */
CC_PURE CC_NONNULL((2)) size_t
    ccn_write_uint_size(cc_size n, const cc_unit *cc_counted_by(n) s);
...
CC_NONNULL((2, 4))
void ccn_write_uint(cc_size n, const cc_unit *cc_counted_by(n) s,
                    size_t out_size, void *cc_sized_by(out_size) out);
...
/*!
 ...
 @return number of leading zero bytes in case of success, a negative error value
 in case of failure

 @result  This function writes exactly out_size byte, padding with zeroes when
 necessary. This function DOES NOT support truncation and returns an error if
 out_size < ccn_write_uint_size

 @discussion The execution flow of function is independent on the value of the
 big integer However, the processing of the return value by the caller may
 expose the position of the most significant byte
 */
CC_NONNULL((2, 4))
int ccn_write_uint_padded_ct(cc_size n, const cc_unit *cc_sized_by(n) s,
                             size_t out_size,
                             uint8_t *cc_counted_by(out_size) out);

/*!
 @function   ccn_write_uint_padded
 @abstract   Serialize the big integer into a big endian byte buffer
 Not recommended, for most cases ccn_write_uint_padded_ct is more appropriate
 Sensitive big integers are exposed since the processing expose the position of
 the MS byte
 ...
 @result  This function writes exactly out_size byte, padding with zeroes when
 necessary. This function DOES support truncation when
 out_size<ccn_write_uint_size()

 @discussion The execution flow of this function DEPENDS on the position of the
 most significant byte in case truncation is required.
 */

CC_NONNULL((2, 4))
size_t ccn_write_uint_padded(cc_size n, const cc_unit *cc_counted_by(n) s,
                             size_t out_size,
                             uint8_t *cc_sized_by(out_size) out);

/*  Return actual size in bytes needed to serialize s as int
    (adding leading zero if high bit is set). */
CC_PURE CC_NONNULL((2)) size_t
    ccn_write_int_size(cc_size n, const cc_unit *cc_counted_by(n) s);
...
CC_NONNULL((2, 4))
void ccn_write_int(cc_size n, const cc_unit *cc_counted_by(n) s,
                   size_t out_size, void *cc_sized_by(out_size) out);
...
#define CC_SWAP_HOST_BIG_16(x) ((((x) & 0xff00) >> 8) | (((x) & 0x00ff) << 8))
...
/*!
 @function ccn_swap
 @discussion Swaps r inplace from cc_unit vector byte order to big endian byte
 order (or back)
 */
CC_NONNULL((2))
...
CC_NONNULL((2, 3, 4))
void ccn_xor(cc_size n, cc_unit *cc_counted_by(n) r,
             const cc_unit *cc_counted_by(n) s,
...
CC_NONNULL((3))
void ccn_lprint(cc_size n, const char *cc_cstring label,
                const cc_unit *cc_counted_by(n) s);
