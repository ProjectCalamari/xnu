...
#define CC_FAULT_CANARY_MEMCPY(_dst_, _src_)                                   \
  cc_memcpy(_dst_, _src_, CC_FAULT_CANARY_SIZE)
#define CC_FAULT_CANARY_CLEAR(_name_)                                          \
  cc_memset(_name_, 0x00, CC_FAULT_CANARY_SIZE)
#define CC_FAULT_CANARY_EQUAL(_a_, _b_)                                        \
  (cc_cmp_safe(CC_FAULT_CANARY_SIZE, _a_, _b_) == 0)
