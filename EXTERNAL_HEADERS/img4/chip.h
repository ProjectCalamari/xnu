 ...
 */
#define IMG4_CHIP_INSTANCE_INIT(_family)                                       \
  (img4_chip_instance_t) {                                                     \
    .chid_version = IMG4_CHIP_INSTANCE_STRUCT_VERSION,                         \
    .chid_chip_family = (_family), .chid_omit = 0, .chid_cepo = 0,             \
    .chid_bord = 0, .chid_chip = 0, .chid_sdom = 0, .chid_ecid = 0,            \
    .chid_cpro = false, .chid_csec = false, .chid_epro = false,                \
    .chid_esec = false, .chid_iuou = false, .chid_rsch = false,                \
    .chid_euou = false, .chid_esdm = 0, .chid_fpgt = false, .chid_udid = {0},  \
    .chid_fchp = 0, .chid_type = 0, .chid_styp = 0, .chid_clas = 0,            \
  }
...
IMG4_API_AVAILABLE_20200508
OS_EXPORT OS_WARN_RESULT OS_NONNULL1 img4_chip_t *
...
#if !XNU_KERNEL_PRIVATE
IMG4_API_AVAILABLE_20200508
OS_EXPORT OS_WARN_RESULT const img4_chip_t *
...
OS_EXPORT OS_WARN_RESULT const img4_chip_t
    *_Nullable img4_chip_select_personalized_sep(void);
#else
...
OS_EXPORT OS_WARN_RESULT const img4_chip_t
    *_Nullable img4_chip_select_categorized_ap(void);
#else
...
#if !XNU_KERNEL_PRIVATE
IMG4_API_AVAILABLE_20200508
OS_EXPORT OS_WARN_RESULT const img4_chip_t *img4_chip_select_effective_ap(void);
#else
...
OS_EXPORT OS_WARN_RESULT OS_NONNULL1 const img4_chip_t
    *_Nullable img4_chip_get_cryptex1_boot(const img4_chip_t *chip);
#else
...
IMG4_API_AVAILABLE_20220401
OS_EXPORT OS_WARN_RESULT OS_NONNULL1 const img4_chip_t
    *_Nullable img4_chip_get_cryptex1_boot_proposal(const img4_chip_t *chip);
#else
...
#if !XNU_KERNEL_PRIVATE
IMG4_API_AVAILABLE_20200508
OS_EXPORT OS_WARN_RESULT OS_NONNULL1 OS_NONNULL2 errno_t img4_chip_instantiate(
    const img4_chip_t *chip, img4_chip_instance_t *chip_instance);
#else
