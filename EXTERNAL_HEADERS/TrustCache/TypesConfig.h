...
#if !XNU_KERNEL_PRIVATE
/*
 * XNU does not make this header available and uses different availability
 * macros than kernel extensions or base user-space applications.
 */
...
static const img4_chip_t *chipEnvironmentPersonalized(void) {
  return img4_chip_select_personalized_ap();
}

static const img4_chip_t *chipEnvironmentCategorized(void) {
  return img4_chip_select_categorized_ap();
}

static const img4_chip_t *chipEnvironmentGlobalFF00(void) {
  return IMG4_CHIP_AP_SOFTWARE_FF00;
}

static const img4_chip_t *chipEnvironmentGlobalFF01(void) {
  return IMG4_CHIP_AP_SOFTWARE_FF01;
}

static const img4_chip_t *chipEnvironmentGlobalFF06(void) {
  return IMG4_CHIP_AP_SOFTWARE_FF06;
}

static const img4_chip_t *chipEnvironmentEphemeralCryptex(void) {
  return IMG4_CHIP_AP_SUPPLEMENTAL;
}

static const img4_chip_t *chipEnvironmentCryptex1Boot(void) {
...
static const img4_chip_t *chipEnvironmentCryptex1PreBoot(void) {
#if IMG4_API_VERSION >= 20211126
...
static const img4_chip_t *chipEnvironmentCryptex1MobileAsset(void) {
#if IMG4_API_VERSION >= 20211126
...
static const img4_chip_t *chipEnvironmentSafariDownlevel(void) {
#if IMG4_API_VERSION >= 20211126
...
static const img4_chip_t *chipEnvironmentSupplemental(void) {
  return IMG4_CHIP_AP_SUPPLEMENTAL;
}

static const img4_chip_t *chipEnvironmentCryptex1Generic(void) {
...
static const img4_chip_t *chipEnvironmentCryptex1GenericSupplemental(void) {
#if IMG4_API_VERSION >= 20221202
...
static const img4_nonce_domain_t *nonceDomainTrustCache(void) {
  return IMG4_NONCE_DOMAIN_TRUST_CACHE;
}

static const img4_nonce_domain_t *nonceDomainDDI(void) {
  return IMG4_NONCE_DOMAIN_DDI;
}

static const img4_nonce_domain_t *nonceDomainCryptex(void) {
  return IMG4_NONCE_DOMAIN_CRYPTEX;
}

static const img4_nonce_domain_t *nonceDomainEphemeralCryptex(void) {
  return IMG4_NONCE_DOMAIN_EPHEMERAL_CRYPTEX;
}

static const img4_nonce_domain_t *nonceDomainPDI(void) {
  return IMG4_NONCE_DOMAIN_PDI;
}

#pragma mark Firmware Flags

static img4_firmware_flags_t firmwareFlagsDTRS(void) {
  return IMG4_FIRMWARE_FLAG_RESPECT_AMNM;
}

static img4_firmware_flags_t firmwareFlagsSplat(void) {
#if XNU_TARGET_OS_OSX && (defined(__arm__) || defined(__arm64__))
  return IMG4_FIRMWARE_FLAG_SUBSEQUENT_STAGE;
#elif defined(TARGET_OS_OSX) && TARGET_OS_OSX &&                               \
    (TARGET_CPU_ARM || TARGET_CPU_ARM64)
  return IMG4_FIRMWARE_FLAG_SUBSEQUENT_STAGE;
#else
...
static const TrustCacheTypeConfig_t TCTypeConfig[kTCTypeTotal] = {
    ...
    [kTCTypeStatic] = {.chipEnvironment = NULL,
                       .nonceDomain = NULL,
                       .fourCC = 0,
                       .firmwareFlags = NULL,
    ...
    [kTCTypeEngineering] = {.chipEnvironment = NULL,
                            .nonceDomain = NULL,
                            .fourCC = 0,
                            .firmwareFlags = NULL,
                            .entitlementValue = NULL},
    ...
    [kTCTypeLegacy] = {.chipEnvironment = NULL,
                       .nonceDomain = NULL,
                       .fourCC = 0,
                       .firmwareFlags = NULL,
                       .entitlementValue = NULL},

    [kTCTypeDTRS] = {.chipEnvironment = chipEnvironmentPersonalized,
                     .nonceDomain = NULL,
                     .fourCC = 'dtrs',
                     .firmwareFlags = firmwareFlagsDTRS,
                     .entitlementValue = "personalized.engineering-root"},

    [kTCTypeLTRS] = {.chipEnvironment = chipEnvironmentPersonalized,
                     .nonceDomain = nonceDomainTrustCache,
                     .fourCC = 'ltrs',
                     .firmwareFlags = NULL,
                     .entitlementValue = "personalized.trust-cache"},

    [kTCTypePersonalizedDiskImage] = {.chipEnvironment =
                                          chipEnvironmentPersonalized,
                                      .nonceDomain = nonceDomainPDI,
                                      .fourCC = 'ltrs',
                                      .firmwareFlags = NULL,
                                      .entitlementValue = "personalized.pdi"},

    [kTCTypeDeveloperDiskImage] = {.chipEnvironment =
                                       chipEnvironmentCategorized,
                                   .nonceDomain = nonceDomainDDI,
                                   .fourCC = 'trdv',
                                   .firmwareFlags = NULL,
                                   .entitlementValue = "personalized.ddi"},

    [kTCTypeLTRSWithDDINonce] = {.chipEnvironment = chipEnvironmentPersonalized,
                                 .nonceDomain = nonceDomainDDI,
                                 .fourCC = 'ltrs',
                                 .firmwareFlags = NULL,
                                 .entitlementValue = "personalized.ddi"},

    [kTCTypeCryptex] = {.chipEnvironment = chipEnvironmentPersonalized,
                        .nonceDomain = nonceDomainCryptex,
                        .fourCC = 'ltrs',
                        .firmwareFlags = NULL,
                        .entitlementValue = "personalized.cryptex-research"},

    [kTCTypeEphemeralCryptex] = {.chipEnvironment =
                                     chipEnvironmentEphemeralCryptex,
    ...
    [kTCTypeUpdateBrain] = {.chipEnvironment = chipEnvironmentGlobalFF00,
                            .nonceDomain = NULL,
                            .fourCC = 'ltrs',
                            .firmwareFlags = NULL,
                            .entitlementValue = "global.ota-update-brain"},

    [kTCTypeInstallAssistant] = {.chipEnvironment = chipEnvironmentGlobalFF01,
                                 .nonceDomain = NULL,
                                 .fourCC = 'ltrs',
                                 .firmwareFlags = NULL,
                                 .entitlementValue =
    ...
    [kTCTypeBootabilityBrain] = {.chipEnvironment = chipEnvironmentGlobalFF06,
                                 .nonceDomain = NULL,
                                 .fourCC = 'trbb',
                                 .firmwareFlags = NULL,
                                 .entitlementValue =
    ...
    [kTCTypeCryptex1BootOS] = {.chipEnvironment = chipEnvironmentCryptex1Boot,
                               .nonceDomain = NULL,
                               .fourCC = 'trcs',
                               .firmwareFlags = firmwareFlagsSplat,
                               .entitlementValue = "cryptex1.boot.os"},

    [kTCTypeCryptex1BootApp] = {.chipEnvironment = chipEnvironmentCryptex1Boot,
                                .nonceDomain = NULL,
                                .fourCC = 'trca',
                                .firmwareFlags = firmwareFlagsSplat,
                                .entitlementValue = "cryptex1.boot.app"},

    [kTCTypeCryptex1PreBootApp] = {.chipEnvironment =
                                       chipEnvironmentCryptex1PreBoot,
                                   .nonceDomain = NULL,
                                   .fourCC = 'trca',
                                   .firmwareFlags = firmwareFlagsSplat,
                                   .entitlementValue = "cryptex1.preboot.app"},

    [kTCTypeGlobalDiskImage] = {.chipEnvironment = chipEnvironmentGlobalFF00,
                                .nonceDomain = NULL,
                                .fourCC = 'ltrs',
                                .firmwareFlags = NULL,
                                .entitlementValue = "global.pdi"},

    [kTCTypeMobileAssetBrain] = {.chipEnvironment =
                                     chipEnvironmentCryptex1MobileAsset,
                                 .nonceDomain = NULL,
                                 .fourCC = 'trab',
                                 .firmwareFlags = NULL,
                                 .entitlementValue =
    ...
    [kTCTypeSafariDownlevel] = {.chipEnvironment =
                                    chipEnvironmentSafariDownlevel,
                                .nonceDomain = NULL,
                                .fourCC = 'trca',
                                .firmwareFlags = NULL,
                                .entitlementValue =
    ...
    [kTCTypeCryptex1PreBootOS] = {.chipEnvironment =
                                      chipEnvironmentCryptex1PreBoot,
                                  .nonceDomain = NULL,
                                  .fourCC = 'trcs',
                                  .firmwareFlags = firmwareFlagsSplat,
    ...
    [kTCTypeCryptex1Generic] = {.chipEnvironment =
                                    chipEnvironmentCryptex1Generic,
                                .nonceDomain = NULL,
                                .fourCC = 'gtcd',
                                .firmwareFlags = NULL,
