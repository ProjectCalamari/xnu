 ...
 * Private API, converts a query context into an OSDictionary that can be handed
 * out to legacy users
 */
 ...
 * Private API, converts a query context into an OSObject that may be returned
 * dynamically
 */
