...
typedef CEReturn_t (^CEDictionaryIterateClosure_t)(
    const CEKeyValuePair_t *keyValuePair, CEIterateArgs_t *iterateArgs);

typedef CEReturn_t (^CEElementIterateClosure_t)(
    const CEValueTypePair_t *valueTypePair, CEIterateArgs_t *iterateArgs);
...
_CEClosureCallbackDictionary(const CEKeyValuePair_t *keyValuePair,
  ...
  const CEClosureFunctionPointer_t *__single args =
      (CEClosureFunctionPointer_t *)iterateArgs->userData;
 ...
 * by the closure.
 */
static inline CEReturn_t CEDictionaryIterateWithClosure(
    const CEElement_t *derDictionary,
    const CEDictionaryIterateClosure_t iterateClosure) {
  CEClosureFunctionPointer_t callback = {.dictionaryIterate = iterateClosure};
  return CEDictionaryIterate(derDictionary, _CEClosureCallbackDictionary,
                             &callback);
}
...
CEElementIterateWithClosure(const CEElement_t *derElement,
  ...
  CEClosureFunctionPointer_t callback = {.elementIterate = iterateClosure};
