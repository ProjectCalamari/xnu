...
#define ACPI_SRAT0_FLAG_OFFSET(f, o)                                           \
  ACPI_FLAG_OFFSET(STATIC_RESOURCE_ALLOC, f, o)
...
#define ACPI_MADT2_FLAG_OFFSET(f, o)                                           \
  ACPI_FLAG_OFFSET(MADT_INTERRUPT_OVERRIDE, f, o)
...
#define ACPI_MADT8_FLAG_OFFSET(f, o)                                           \
  ACPI_FLAG_OFFSET(MADT_INTERRUPT_SOURCE, f, o)
