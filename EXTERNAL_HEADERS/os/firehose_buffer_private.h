...
#define FIREHOSE_BUFFER_KERNEL_DEFAULT_CHUNK_COUNT                             \
  FIREHOSE_BUFFER_KERNEL_MIN_CHUNK_COUNT
...
#define FIREHOSE_BUFFER_CHUNK_PREALLOCATED_COUNT                               \
  (__firehose_buffer_kernel_chunk_count - 1) // the first chunk is the header
