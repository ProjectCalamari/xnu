...
extern const DERItemSpec
    DERSignedCertCrlItemSpecs[DER_counted_by(DERNumSignedCertCrlItemSpecs)];
...
extern const DERItemSpec
    DERTBSCertItemSpecs[DER_counted_by(DERNumTBSCertItemSpecs)];
...
extern const DERItemSpec
    DERValidityItemSpecs[DER_counted_by(DERNumValidityItemSpecs)];
...
extern const DERItemSpec DERAttributeTypeAndValueItemSpecs[DER_counted_by(
...
extern const DERItemSpec
    DERExtensionItemSpecs[DER_counted_by(DERNumExtensionItemSpecs)];
...
extern const DERItemSpec DERBasicConstraintsItemSpecs[DER_counted_by(
    DERNumBasicConstraintsItemSpecs)];
...
extern const DERItemSpec
    DERNameConstraintsItemSpecs[DER_counted_by(DERNumNameConstraintsItemSpecs)];
...
extern const DERItemSpec
    DERGeneralSubtreeItemSpecs[DER_counted_by(DERNumGeneralSubtreeItemSpecs)];
...
extern const DERItemSpec DERPrivateKeyUsagePeriodItemSpecs[DER_counted_by(
    DERNumPrivateKeyUsagePeriodItemSpecs)];
...
extern const DERItemSpec DERDistributionPointItemSpecs[DER_counted_by(
...
extern const DERItemSpec DERPolicyInformationItemSpecs[DER_counted_by(
...
extern const DERItemSpec DERPolicyQualifierInfoItemSpecs[DER_counted_by(
...
extern const DERItemSpec
    DERUserNoticeItemSpecs[DER_counted_by(DERNumUserNoticeItemSpecs)];
...
extern const DERItemSpec
    DERNoticeReferenceItemSpecs[DER_counted_by(DERNumNoticeReferenceItemSpecs)];
...
extern const DERItemSpec
    DERPolicyMappingItemSpecs[DER_counted_by(DERNumPolicyMappingItemSpecs)];
...
extern const DERItemSpec DERAccessDescriptionItemSpecs[DER_counted_by(
...
extern const DERItemSpec DERAuthorityKeyIdentifierItemSpecs[DER_counted_by(
...
extern const DERItemSpec
    DEROtherNameItemSpecs[DER_counted_by(DERNumOtherNameItemSpecs)];
...
extern const DERItemSpec DERPolicyConstraintsItemSpecs[DER_counted_by(
...
extern const DERItemSpec
    DERTBSCrlItemSpecs[DER_counted_by(DERNumTBSCrlItemSpecs)];
...
extern const DERItemSpec
    DERRevokedCertItemSpecs[DER_counted_by(DERNumRevokedCertItemSpecs)];
