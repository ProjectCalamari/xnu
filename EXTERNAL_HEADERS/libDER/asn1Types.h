...
#define ONE_BYTE_ASN1_CONSTR_SEQUENCE                                          \
  ((uint8_t)(ONE_BYTE_ASN1_CONSTRUCTED | ASN1_SEQUENCE))
#define ONE_BYTE_ASN1_CONSTR_SET                                               \
  ((uint8_t)(ONE_BYTE_ASN1_CONSTRUCTED | ASN1_SET))
