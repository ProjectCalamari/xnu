...
extern const DERItemSpec
    DERAlgorithmIdItemSpecs[DER_counted_by(DERNumAlgorithmIdItemSpecs)];
...
extern const DERItemSpec
    DERSubjPubKeyInfoItemSpecs[DER_counted_by(DERNumSubjPubKeyInfoItemSpecs)];
...
extern const DERItemSpec
    DERRSAPubKeyPKCS1ItemSpecs[DER_counted_by(DERNumRSAPubKeyPKCS1ItemSpecs)];
...
extern const DERItemSpec
    DERRSAPubKeyAppleItemSpecs[DER_counted_by(DERNumRSAPubKeyAppleItemSpecs)];
...
extern const DERItemSpec
    DERRSAPrivKeyCRTItemSpecs[DER_counted_by(DERNumRSAPrivKeyCRTItemSpecs)];
...
extern const DERItemSpec
    DERRSAKeyPairItemSpecs[DER_counted_by(DERNumRSAKeyPairItemSpecs)];
