...
extern const DERItem oidSubjectKeyIdentifier, oidKeyUsage,
    oidPrivateKeyUsagePeriod, oidSubjectAltName, oidIssuerAltName,
    oidBasicConstraints, oidNameConstraints, oidCrlDistributionPoints,
    oidCertificatePolicies, oidAnyPolicy, oidPolicyMappings,
    oidAuthorityKeyIdentifier, oidPolicyConstraints, oidExtendedKeyUsage,
    oidAnyExtendedKeyUsage, oidInhibitAnyPolicy, oidAuthorityInfoAccess,
    oidQCStatements, oidSubjectInfoAccess, oidAdOCSP, oidAdCAIssuer,
    oidNetscapeCertType, oidEntrustVersInfo, oidMSNTPrincipalName,
    oidOCSPNoCheck;

/* Policy Qualifier IDs for Internet policy qualifiers. */
extern const DERItem oidQtCps, oidQtUNotice;

/* X.501 Name IDs. */
extern const DERItem oidCommonName, oidCountryName, oidLocalityName,
    oidStateOrProvinceName, oidOrganizationName, oidOrganizationalUnitName,
    oidDescription, oidEmailAddress, oidFriendlyName, oidLocalKeyId,
    oidStreetAddress, oidUserId, oidCollectiveOrganizationName,
    oidCollectiveOrganizationalUnitName, oidCollectiveStateOrProvinceName,
    oidCollectiveStreetAddress;

/* X.509 Extended Key Usages */
extern const DERItem oidExtendedKeyUsageServerAuth,
    oidExtendedKeyUsageClientAuth, oidExtendedKeyUsageCodeSigning,
    oidExtendedKeyUsageEmailProtection, oidExtendedKeyUsageTimeStamping,
    oidExtendedKeyUsageOCSPSigning, oidExtendedKeyUsageIPSec,
...
/* Apple Oids */
extern const DERItem oidAppleSecureBootCertSpec,
    /* Ticket-Based Secure Boot Spec oid */
    oidAppleSecureBootTicketCertSpec,
    /* Image4 Manifest Signing Cert Spec */
    oidAppleImg4ManifestCertSpec, oidAppleProvisioningProfile,
    oidAppleApplicationSigning, oidAppleTVOSApplicationSigningProd,
    oidAppleTVOSApplicationSigningProdQA, oidAppleXROSApplicationSigningProd,
    oidAppleXROSApplicationSigningProdQA,
    oidAppleInstallerPackagingSigningExternal,
    oidAppleExtendedKeyUsageCodeSigning, oidAppleExtendedKeyUsageCodeSigningDev,
    oidAppleExtendedKeyUsageAppleID, oidAppleExtendedKeyUsagePassbook,
    oidAppleExtendedKeyUsageProfileSigning,
    oidAppleExtendedKeyUsageQAProfileSigning, oidAppleIntmMarkerAppleWWDR,
    oidAppleIntmMarkerAppleID, oidAppleIntmMarkerAppleID2,
    oidApplePushServiceClient, oidApplePolicyMobileStore,
    oidApplePolicyMobileStoreProdQA, oidApplePolicyEscrowService,
    oidAppleCertExtensionAppleIDRecordValidationSigning,
    oidAppleCertExtOSXProvisioningProfileSigning,
    oidAppleIntmMarkerAppleSystemIntg2, oidAppleIntmMarkerAppleSystemIntgG3,
    oidAppleCertExtAppleSMPEncryption, oidAppleCertExtAppleServerAuthentication,
    ...
    oidAppleCertExtApplePPQSigningProd, oidAppleCertExtApplePPQSigningProdQA,
    oidAppleCertExtATVAppSigningProd, oidAppleCertExtATVAppSigningProdQA,
    ...
    oidAppleCertExtHomeKitServerAuth, oidAppleIntmMarkerAppleHomeKitServerCA,
    ...
    oidAppleCertExtTrustCacheSigning, oidAppleCertExtTrustCacheSigningTest;

/* Microsoft Oids */
extern const DERItem oidMicrosoftSpcIndirectDataContext,
    oidMicrosoftSpcSpOpusInfo, oidMicrosoftSpcPEImageData;

/* CMS Oids */
extern const DERItem oidContentType, oidMessageDigest, oidPkcs7SignedData;

/* QC Statement Oids */
extern const DERItem oidQCSyntaxv1, oidQCSyntaxv2, oidSemanticsIdNatural,
    oidSemanticsIdLegal, oidSemanticsIdEidasNatural, oidSemanticsIdEidasLegal,
    oidQCCompliance, oidQCLimitValue, oidQCEuRetentionPeriod, oidQCDisclosures,
    oidQCType, oidQCTypeEsign, oidQCTypeEseal, oidQCTypeWeb;
